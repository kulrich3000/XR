...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_SummonGeist / 2))
	{	
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonGeist()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_Cost_SummonGeist / 2;
	}
	else
	{
