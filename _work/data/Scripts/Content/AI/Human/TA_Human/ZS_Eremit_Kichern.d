...
func int ZS_Eremit_Kichern_Loop ()
{
	...
	{	
		if (Npc_GetStateTime(self) >= Eremit_KichernFreq)
		{
			...
			if (rnd == 0)
			{
				AI_Output(self, NULL, "Info_Mod_Eremit_Kichern_04_00"); //(loud giggling)
			}
			else if (rnd == 1)
			{
				AI_Output(self, NULL, "Info_Mod_Eremit_Kichern_04_01"); //(loud giggling)
			}
			else if (rnd == 2)
			{
				AI_Output(self, NULL, "Info_Mod_Eremit_Kichern_04_02"); //(loud giggling)
			};
