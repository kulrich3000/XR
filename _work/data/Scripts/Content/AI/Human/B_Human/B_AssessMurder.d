...
FUNC VOID B_AssessMurder()
{
	...
	{
		if (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(HeroBot_NW))
		{
			return;
		};

		if (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(Kakos_11006_NW)) 
		|| (Hlp_GetInstanceID(victim) == Hlp_GetInstanceID(Kakos_11006_NW)) 
		|| (Hlp_GetInstanceID(victim) == Hlp_GetInstanceID(Mod_7214_OUT_Halunke_NW)) 
		|| (Hlp_GetInstanceID(victim) == Hlp_GetInstanceID(Mod_7215_OUT_Halunke_NW)) 
		|| (Hlp_GetInstanceID(victim) == Hlp_GetInstanceID(Mod_7216_OUT_Halunke_NW)) 
		|| (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(Mod_7214_OUT_Halunke_NW)) 
		|| (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(Mod_7215_OUT_Halunke_NW)) 
		|| (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(Mod_7216_OUT_Halunke_NW)) 
		{
			return;
		};
	};
	...
	&& (victim.aivar[AIV_MM_REAL_ID] != ID_RABBIT)
	{
