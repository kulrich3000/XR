...
func void UseMobsiBrief ()
{
		...
		nDocID =	Doc_Create		();
					...
					Doc_PrintLines	(nDocID,  0, "Teraz wszystko bedzie w porzadku"						);
					Doc_PrintLines	(nDocID,  0, "PLAYER_MOBSI_PRODUCTION = MOBSI_NONE;"			);
					Doc_PrintLines	(nDocID,  0, "jazn. aivar[AIV_INVINCIBLE] = FALSE;"				);
					Doc_Show		(nDocID);
};
...
func void B_SetHeroExp() 
{
    ...
    Attributes = "Poziomuj do góry! Punkty edukacyjne:";
    Attributes = ConcatStrings(Attributes, IntToString(hero.LP));
    Attributes = ConcatStrings(Attributes, "  Punkty odniesienia:");
...
FUNC VOID  CH_RESET_Info()
{
	...
	PrintScreen ("PC_ero przywrócony", - 1, - 1, FONT_Screen, 2);   
...
INSTANCE CH_Language (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Nauka jezyków obcych"; 
};
...
func VOID CH_Language_Info()
{
	...
	Info_AddChoice	(CH_Language, "Jezyk ksiezy (3)", CH_Language_Priest );
	Info_AddChoice	(CH_Language, "Jezyk wojowników (2)", CH_Language_Warrior );
	Info_AddChoice	(CH_Language, "Jezyk rolniczy (1)", CH_Language_Peasant );
};
...
func VOID CH_Guild_Info()
{
    ...
    Info_AddChoice	(CH_Guild, "najemnicy"   		, CH_SLD);
    Info_AddChoice	(CH_Guild, "mysliwy smok"       , CH_DJG);
    Info_AddChoice	(CH_Guild, "Miliz"       	, CH_MIL);    
    Info_AddChoice	(CH_Guild, "Paladin"  		, CH_PAL);
    Info_AddChoice	(CH_Guild, "dziewiaty"        	, CH_NONE);
    Info_AddChoice 	(CH_Guild, "Falszywy Bandit"        , CH_FakeBandit);	    
};
...
INSTANCE CH_Level_Start (C_INFO)
{
	...
	description		= "Poziomy, punkty nauki i umiejetnosci"; 
	permanent		=  TRUE;
};
...
func VOID CH_Lernpunkte_Info()
{
	...
	Info_AddChoice (CH_Lernpunkte,"Punkty + 50 pkt.",CH_Lernpunkte_50);
	Info_AddChoice (CH_Lernpunkte,"Punkty + 25 pkt.",CH_Lernpunkte_25);
	Info_AddChoice (CH_Lernpunkte,"Punkty nauki + 10 punktów nauczania",CH_Lernpunkte_10);
	Info_AddChoice (CH_Lernpunkte,"Punkty nauki + 5 pkt. ",CH_Lernpunkte_5);
};
...
FUNC VOID CH_Lernpunkte_25 ()
{
	...
	hero.LP = (hero.LP + 25);
	PrintScreen  ("25 + 25 punktów nauki", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
...
INSTANCE CH_Level_hoch (C_INFO)
{
	...
	description		= "Poziom Wybór 26 - 50"; 
	permanent		=  TRUE;
};
...
func void CH_Level46()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Poziom 49 Poziom" , CH_Level_49);
	Info_AddChoice		(CH_Level_hoch, "Poziom 48" , CH_Level_48);
	Info_AddChoice		(CH_Level_hoch, "Poziom 47 Poziom 47" , CH_Level_47);
	Info_AddChoice		(CH_Level_hoch, "Poziom 46 Poziom" , CH_Level_46);
};
func void CH_Level41()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Poziom zaawansowany" , CH_Level_45);
	Info_AddChoice		(CH_Level_hoch, "Poziom zaawansowany 44" , CH_Level_44);
	Info_AddChoice		(CH_Level_hoch, "Poziom 43 Poziom 43" , CH_Level_43);
	Info_AddChoice		(CH_Level_hoch, "Poziom 42 Poziom 42" , CH_Level_42);
	Info_AddChoice		(CH_Level_hoch, "Poziom 41 Poziom 41" , CH_Level_41);
};
func void CH_Level36()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Poziom 37 Poziom 37" , CH_Level_37);
	Info_AddChoice		(CH_Level_hoch, "Poziom 36 Poziom" , CH_Level_36);
};
func void CH_Level31()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Poziom 34 Poziom" , CH_Level_34);
	Info_AddChoice		(CH_Level_hoch, "Poziom 33 Poziom" , CH_Level_33);
	Info_AddChoice		(CH_Level_hoch, "Poziom 32 Poziom 32" , CH_Level_32);
...
func void CH_Level26()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Poziom 29 Poziom" , CH_Level_29);
	Info_AddChoice		(CH_Level_hoch, "Poziom" , CH_Level_28);
	Info_AddChoice		(CH_Level_hoch, "Poziom 27 Poziom 27" , CH_Level_27);
...
func void CH_Level21()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 25 Poziom" , CH_Level_25);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 24 Poziom 24" , CH_Level_24);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 23 Poziom" , CH_Level_23);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 22 Poziom 22" , CH_Level_22);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 21 Poziom 21 Poziom" , CH_Level_21);
...
func void CH_Level16()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Poziom 19 Poziom 19" , CH_Level_19);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 18 Poziom 18" , CH_Level_18);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 17 Poziom" , CH_Level_17);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 16 Poziom" , CH_Level_16);
};
...
func void CH_Level11()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Poziom 12 Poziom 12" , CH_Level_12);
	Info_AddChoice		(CH_Level_niedrig, "Poziom 11 Poziom 11" , CH_Level_11);
};
func void CH_Level6()
{
	Info_ClearChoices	(CH_Level_niedrig);
...
func void CH_Level1()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Poziom 2 Poziom 2" 	, CH_Level_2);
...
INSTANCE DIA_CH_Attribute_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Moc i umiejetnosci";
};                       
...
INSTANCE DIA_CH_Strength (C_INFO)
{
	...
	permanent	= TRUE;
	description = "zwiekszenie wytrzymalosci";
};                       
...
FUNC VOID DIA_CH_Strength_Info()
{
	...
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Wytrzymalosc + 20"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*20)		,DIA_CH_Strength_20);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Wytrzymalosc + 10"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*10)		,DIA_CH_Strength_10);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Wytrzymalosc + 5"			, B_GetLearnCostAttribute(other, ATR_STRENGTH)*5)		,DIA_CH_Strength_5);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Wytrzymalosc + 1"			, B_GetLearnCostAttribute(other, ATR_STRENGTH))			,DIA_CH_Strength_1);
...
INSTANCE DIA_CH_Dex (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zwiekszenie zrecznosci";
};                       
...
FUNC VOID DIA_CH_Dex_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Umiejetnosci + 20"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*20)		,DIA_CH_DEX_20);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Umiejetnosci + 10"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*10)		,DIA_CH_DEX_10);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Umiejetnosci + 5"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*5)		,DIA_CH_DEX_5);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Umiejetnosc + 1"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY))		,DIA_CH_DEX_1);
};
...
INSTANCE DIA_CH_MAGIE (C_INFO)
{
	...
	permanent	= TRUE;
	description = "MAGIE: Mana, Runes, okregi";
};                       
...
INSTANCE DIA_CH_KREISE (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Czarodziejskie kregi";
};                       
...
FUNC VOID DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice 	  (DIA_CH_KREISE,"Szóste kolo",CH_KREISE_6);
	Info_AddChoice 	  (DIA_CH_KREISE,"piaty okrag", CH_KREISE_5);
	Info_AddChoice 	  (DIA_CH_KREISE,"Czwarte kolo", CH_KREISE_4);
	Info_AddChoice 	  (DIA_CH_KREISE,"Trzecie kolo", CH_KREISE_3);
	Info_AddChoice 	  (DIA_CH_KREISE,"Drugie kolo", CH_KREISE_2);
	Info_AddChoice 	  (DIA_CH_KREISE,"Pierwsze kolo",  CH_KREISE_1);  
...
FUNC VOID DIA_CH_Runen_Info()
{
	...
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("6. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 6))			,DIA_CH_Runen_6);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 4)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("5. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 5))			,DIA_CH_Runen_5);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 3)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("4. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 4))			,DIA_CH_Runen_4);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 2)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("3. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 3))			,DIA_CH_Runen_3);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 1)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("2. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 2))			,DIA_CH_Runen_2);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) < 1)
	{ 
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("1. Kolo Magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 1))			,DIA_CH_Runen_1);
	};
};
//**********************************************************
// BACK
...
INSTANCE DIA_CH_Kampf_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Walka z talentami (walka bliska i bojowa)";
};                       
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bron jednoreczna + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bron jednoreczna + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bron jednoreczna + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bron jednoreczna + 1 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bron dwureczna + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("bron dwureczna + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bron dwureczna + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bron dwureczna + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
FUNC VOID DIA_CH_Kampf_Armbrust_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Krzyzówka + 20", 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*20)			,CH_Training_Combat_CROSSBOW_20);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Krzyzówka + 10", 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*10)			,CH_Training_Combat_CROSSBOW_10);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Krzyzówka + 5"	, 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*5)			,CH_Training_Combat_CROSSBOW_5);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Krzyzówka + 1"	, 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1))				,CH_Training_Combat_CROSSBOW_1);
};
...
INSTANCE DIA_CH_Dieb_Steal (C_INFO)
{
	...
	permanent	= TRUE;
	description = "kompletacja kieszonkowa";
};                       
...
FUNC VOID DIA_CH_Dieb_Steal_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Steal, B_BuildLearnString("kompletacja kieszonkowa"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKPOCKET, 1))		,CH_Training_Thief_Pickpocket);
};
//*********************************************
//Dieb Schleichen
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Picklock_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Picklock , B_BuildLearnString("sluzy chwytaki"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKLOCK, 1))		,CH_Training_Thief_Picklock);
};
//*********************************************
...
INSTANCE DIA_CH_Dieb_Alle (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Poznaj wszystkie talenty kradziezy.";
};                       
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Wszystkie talenty kradziezy", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Rózne napoje (napoje, trofea, kuznie, runy paladynowe, jezyk)";
};                       
...
INSTANCE DIA_CH_Misc_Alchemie (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Alchemia - sztuka piwowarska eliksiru";
};                       
...
INSTANCE DIA_CH_Misc_Health (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Eliksir leczniczy wszelkiego rodzaju";
};                       
...
FUNC VOID DIA_CH_Misc_Health_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Istota uzdrawiania", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_01)), CH_Training_Alchemy_POTION_Health_01);	  
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Health_02] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Ekstrakt z ekstraktu leczniczego", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_02)), CH_Training_Alchemy_POTION_Health_02);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Health_03] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Eliksir uzdrawiania", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_03)), CH_Training_Alchemy_POTION_Health_03);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_Health] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Trwaly zbiornik leczniczy", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_Health)), CH_Training_Alchemy_POTION_Perm_Health);
	};
};
...
INSTANCE DIA_CH_Misc_Mana (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Eliksir manatowy wszelkiego rodzaju";
};                       
...
FUNC VOID DIA_CH_Misc_Mana_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Mana, B_BuildLearnString ("Staly eliksir z manila"	, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_Mana)), CH_Training_Alchemy_POTION_Perm_Mana);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Mana_03] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Mana, B_BuildLearnString ("Manaelixir", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Mana_03)), CH_Training_Alchemy_POTION_Mana_03);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Mana_02] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Mana, B_BuildLearnString ("ekstrakt z maneny", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Mana_02)), CH_Training_Alchemy_POTION_Mana_02);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Mana_01] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Mana, B_BuildLearnString ("esencja maneny", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Mana_01)), CH_Training_Alchemy_POTION_Mana_01);
	};
};
...
FUNC VOID DIA_CH_Misc_Special_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Ladowanie oczu", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, CHARGE_Innoseye)), CH_Training_Alchemy_Charge_InnosEye);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Speed] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Szybkosc"	, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Speed)), CH_Training_Alchemy_POTION_Speed);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_STR] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Skrobia Eliksir"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_STR)), CH_Training_Alchemy_POTION_Perm_STR);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_DEX] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("sprawnosc eliksiru"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_DEX)), CH_Training_Alchemy_POTION_Perm_DEX);
	};
...
INSTANCE DIA_CH_Misc_SmithStart (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Kucie - meska grupa mezczyzn";
};                       
...
INSTANCE DIA_CH_Misc_Smithniedrig (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Pierwsze 5 sztuk broni";
};                       
...
INSTANCE DIA_CH_Misc_SmithHoch (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Ostatnie cztery rodzaje broni";
};                       
...
INSTANCE DIA_CH_Misc_Animal_allg (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zeby, siersc, pazury, szpony, serca";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_allg_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("rozdarte zeby",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Teeth)),  CH_Training_TROPHYS_Teeth);
	};
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("skórka",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Fur)),  CH_Training_TROPHYS_Fur);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Heart] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("wziac serca",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Heart)),  CH_Training_TROPHYS_Heart);
	};
};
...
INSTANCE DIA_CH_Misc_Animal_Speziell (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Sciernice, pryzmaty, szczypce, plytki";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_Speziell_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Krwi kregoslup",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSting)),  CH_Training_TROPHYS_BFSting);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_BFWing] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("mucha",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWing)),  CH_Training_TROPHYS_BFWing);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_CrawlerPlate] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Zdjac plyty gasienicowe",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CrawlerPlate)),  CH_Training_TROPHYS_CrawlerPlate	);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Mandibles] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("obciac szczypce",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Mandibles)),  CH_Training_TROPHYS_Mandibles	);
	};
};
//--------------------------------------------
...
INSTANCE DIA_CH_Misc_Animal_other (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Krew, lupiez, rogi, jezyk";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_other_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Róg toru cieniowego",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_ShadowHorn)),  CH_Training_TROPHYS_ShadowHorn );
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_FireTongue] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("jezyk ognia",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FireTongue)),  CH_Training_TROPHYS_FireTongue);
	};
	
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_DrgSnapperHorn] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("smok",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_DrgSnapperHorn)),  CH_Training_TROPHYS_DrgSnapperHorn);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_DragonScale] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Smocze waga ciagnaca",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_DragonScale)),  CH_Training_TROPHYS_DragonScale);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_DragonBlood] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Krew smokowa stozek",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_DragonBlood)),  CH_Training_TROPHYS_DragonBlood);
	};
};
//--------------------------------------------
...
INSTANCE DIA_CH_Misc_PalHeal (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Powiedzenia lekkie i lecznicze";
};                       
