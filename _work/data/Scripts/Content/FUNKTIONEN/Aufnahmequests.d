FUNC VOID Aufnahmequests ()
{
	...
	if (CurrentLevel == NEWWORLD_ZEN)
	{
		...
		if (Mod_VermisstenQuest == 1)
		{
			...
			{
				AI_Output(Mod_573_NONE_Elvrich_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_24_00"); //Gdzie jestes, darling?
			};
			...
			if (Mod_VermisstenCounter == 12)
			{
				...
				AI_Output(Mod_1000_DMR_Kurgan_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_01_01"); //Oto jestem.....
			};
			...
			if (Mod_VermisstenCounter == 17)
			{
				...
				AI_Output(Mod_573_NONE_Elvrich_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_24_02"); //Ale nie jestes.....
			};
			...
			if (Mod_VermisstenCounter == 22)
			{
				...
				AI_Output(Mod_1000_DMR_Kurgan_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_01_03"); //... twoja dziewczyna? Calkiem tak.
			};
			...
			if (Mod_VermisstenCounter == 27)
			{
				...
				AI_Output(Mod_573_NONE_Elvrich_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_24_04"); //Co Pan tutaj robi?
			};
			...
			if (Mod_VermisstenCounter == 32)
			{
				...
				AI_Output(Mod_1000_DMR_Kurgan_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_01_05"); //Po prostu chce, zeby pan to zrobil. (smiertelnicy)
			};
			...
			if (Mod_VermisstenCounter == 42)
			{
				...
				AI_Output(Mod_1000_DMR_Kurgan_NW, NULL, "Info_Mod_Elvrich_Entfuehrung_01_06"); //I wyrzuc z niego pieklo, zanim te szarpniecia cokolwiek zauwaza.
			};
			...
			if (Mod_VermisstenCounter == 42)
			{
				...
				B_LogEntry	(TOPIC_MOD_VERMISSTE, "Rycerz demoniczny porwal Elwicza. To zrobi Vatrase.");
	...
	if (CurrentLevel == OLDMINE_ZEN)
	{
		...
		&& (Npc_GetDistToWP(hero, "OM_CAVE1_47") < 1000)
		{
			if (Mod_WM_KurganAlarm_Counter == 2)
			{
				...
				AI_Output(Mod_7399_DMR_Daemonenritter_OM, NULL, "Info_Mod_DMRGateGuard_Flucht_13_00"); //Wiezien zaginal. Musza byc popedzeni przez wyjscie do Minental.
			};

			if (Mod_WM_KurganAlarm_Counter == 7)
			{
				AI_Output(Mod_1031_DMR_Kurgan_OM, NULL, "Info_Mod_DMRGateGuard_Flucht_01_01"); //Was?! Das hat ja noch gefehlt. Finde diese Nervensäge und bringt ihn zu den "nastepny" nach unten. Du verstehst, was ich meine.
			};
			...
			if (Mod_WM_KurganAlarm_Counter == 12)
			{
				...
				B_LogEntry	(TOPIC_MOD_VERMISSTE, "Uh-huh. Czesc z nich wbiegla przez wyjscie do Minentala. Inni mogliby byc gdzies dalej w dól kopalni.");
