			...
			if (her2.focus_vob)
			{
				if (Hlp_Is_oCMobContainer(her2.focus_vob))
				{
					...
					&& (Mod_Prisma_Array[2] > 0)
					{
						...
						PrintScreen	("Chest's protection spell is broken", -1, -1, FONT_SCREEN, 2);
					};
				}
				else
				{
					...
					if (Hlp_IsValidItem(her_focusItem))
					{
						...
						&& (Mod_Prisma_Array[2] > 0)
						{
							...
							PrintScreen	("Focus's protection spell is broken", -1, -1, FONT_SCREEN, 2);
						};
					};
				};
			};
		...
		if (her3.focus_vob)
		{
			...
			if (Hlp_StrCmp(her_focusMobSoja._zCObject_objectName, "MOBNAME_SOJA") == TRUE)
			{
				if (Hlp_StrCmp(Npc_GetNearestWP(hero), "SOJA_01") && Mod_Soja_01 == 0) {
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount1), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount2), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount3), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount4), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount5), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount6), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount7), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount8), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount9), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount10), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount11), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount12), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount13), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount14), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount15), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount16), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount17), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount18), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount19), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount20), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount21), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount22), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount23), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount24), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount25), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount26), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount27), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount28), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount29), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount30), " So-Ja pods harvested"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					CreateInvItems(hero, ItMi_SojaSchote, sojaAmount30);
					Mod_Soja_030 = 1;
				} else {
					AI_PlayAni(hero, "T_PLUNDER");
					AI_PrintScreen("Nothing to get anymore", -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
				};
			};
		};
	};
			...
			if (her31.focus_vob)
			{
				if (Hlp_Is_oCMobContainer(her31.focus_vob))
				{
					...
					if (Hlp_StrCmp(her_focusMob2._zCObject_objectName, "XARDASOWTRUHE") == TRUE)
					{
						...
						B_LogEntry	(TOPIC_MOD_EROL_FEUERMAGIER, "The chest should now be able to be opened....");
					};
				};
			};
		};
		...
		if (her.focus_vob)
		{
			...
			if (Hlp_IsValidItem (her_focusItem2))
			{
				...
				&& (lastDivePickupTime + 2 < TimeCounter_Real)
				{
					...
					var string str;	str = ConcatStrings (her_focusItem2.name, " kept!");
