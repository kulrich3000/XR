			...
			if (her2.focus_vob)
			{
				if (Hlp_Is_oCMobContainer(her2.focus_vob))
				{
					...
					&& (Mod_Prisma_Array[2] > 0)
					{
						...
						PrintScreen	("Czar ochronny klatki piersiowej jest zepsuty", -1, -1, FONT_SCREEN, 2);
					};
				}
				else
				{
					...
					if (Hlp_IsValidItem(her_focusItem))
					{
						...
						&& (Mod_Prisma_Array[2] > 0)
						{
							...
							PrintScreen	("Zaklecie ochronne Focus jest zlamane", -1, -1, FONT_SCREEN, 2);
						};
					};
				};
			};
		...
		if (her3.focus_vob)
		{
			...
			if (Hlp_StrCmp(her_focusMobSoja._zCObject_objectName, "MOBNAME_SOJA") == TRUE)
			{
				if (Hlp_StrCmp(Npc_GetNearestWP(hero), "SOJA_01") && Mod_Soja_01 == 0) {
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount1), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount2), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount3), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount4), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount5), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount6), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount7), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount8), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount9), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount10), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount11), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount12), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount13), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount14), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount15), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount16), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount17), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount18), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount19), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount20), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount21), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount22), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount23), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount24), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount25), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount26), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount27), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount28), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount29), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					...
					AI_PrintScreen(ConcatStrings(IntToString(sojaAmount30), " Zbierane strakio-Ja"), -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
					CreateInvItems(hero, ItMi_SojaSchote, sojaAmount30);
					Mod_Soja_030 = 1;
				} else {
					AI_PlayAni(hero, "T_PLUNDER");
					AI_PrintScreen("Nic wiecej nie da sie juz osiagnac", -1, YPOS_GoldGiven, FONT_ScreenSmall, 2);
				};
			};
		};
	};
			...
			if (her31.focus_vob)
			{
				if (Hlp_Is_oCMobContainer(her31.focus_vob))
				{
					...
					if (Hlp_StrCmp(her_focusMob2._zCObject_objectName, "XARDASOWTRUHE") == TRUE)
					{
						...
						B_LogEntry	(TOPIC_MOD_EROL_FEUERMAGIER, "Skrzynia powinna byc teraz otwarta.....");
					};
				};
			};
		};
		...
		if (her.focus_vob)
		{
			...
			if (Hlp_IsValidItem (her_focusItem2))
			{
				...
				&& (lastDivePickupTime + 2 < TimeCounter_Real)
				{
					...
					var string str;	str = ConcatStrings (her_focusItem2.name, " Przechowywana!");
