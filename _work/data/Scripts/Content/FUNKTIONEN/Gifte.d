FUNC VOID Gifte ()
{
		...
		if (GGPf_Sumpfgolem_Time == 0)
		{
			...
			|| (GGPf_Sumpfgolem == 40)
			{
				...
				else if (Pflanzengift < 4)
				{
					...
					PrintScreen	("You are immune to the poison of plants.", -1, -1, FONT_SCREEN, 2);
				};

				if (Gewaechsgift < 4)
				{
					PrintScreen	("Your resistance to plant toxins has increased.", -1, -1, FONT_SCREEN, 2);
		...
		if (GGPi_Orkschamane_Time == 0)
		{
			...
			|| (GGPi_Orkschamane == 40)
			{
				...
				else if (Pilzgift < 4)
				{
					...
					PrintScreen	("You're immune to the poison of mushrooms.", -1, -1, FONT_SCREEN, 2);
				};
		...
		if (GTB_Blutfliege_Time == 0)
		{
			...
			|| (GTB_Blutfliege == 30)
			{
				...
				else if (Blutfliegengift < 3)
				{
					...
					PrintScreen	("You're immune to the venom of blood flies.", -1, -1, FONT_SCREEN, 2);
				};

				if (Tiergift < 3)
				{
					PrintScreen	("Your resistance to animal toxins has increased.", -1, -1, FONT_SCREEN, 2);
		...
		if (GTS_Sumpfgasdrohne_Time == 0)
		{
			...
			|| (GTS_Sumpfgasdrohne == 30)
			{
				...
				else if (Sumpfgasdrohnengift < 3)
				{
					...
					PrintScreen	("You're immune to the poison of swamp gas drones.", -1, -1, FONT_SCREEN, 2);
				};
		...
		if (GTM_Minecrawler_Time == 0)
		{
			...
			|| (GTM_Minecrawler == 30)
			{
				...
				else if (Minecrawlergift < 3)
				{
					...
					PrintScreen	("You're immune to the poison of minecrawlers.", -1, -1, FONT_SCREEN, 2);
				};
		...
		if (GTSu_Sumpfhai_Time == 0)
		{
			...
			|| (GTSu_Sumpfhai == 30)
			{
				...
				else if (Sumpfhaigift < 4)
				{
					...
					PrintScreen	("You're immune to the poison of swamp sharks.", -1, -1, FONT_SCREEN, 2);
				};
	...
	if (GGD_Sumpfgasdrohne_Time > 0)
	{
		...
		if (GGD_Sumpfgasdrohne_Time == 0)
		{
			...
			|| (GGD_Sumpfgasdrohne == 40)
			{
				if (Giftdampf < 3)
				{
					PrintScreen	("Your resistance to poisonous vapours has increased.", -1, -1, FONT_SCREEN, 2);
				...
				else if (Giftdampf < 4)
				{
					...
					PrintScreen	("You have the highest resistance to poisonous vapors.", -1, -1, FONT_SCREEN, 2);
				};
	...
	if (BissDerFaeulnis_Time > 0)
	{
		...
		&& (BissDerFaeulnis_Time > 30)
		{
			...
			Print	("You feel the bite of rot poisoning your blood!");
		...
		&& (BissDerFaeulnis_Time > BissDerFaeulnis_Stufe03)
		{
			...
			|| (BissDerFaeulnis == 40)
			{
				...
				if (KBDF == 4)
				{
					PrintScreen	("You have the highest resistance to decay bite.", -1, -1, FONT_SCREEN, 2);
				};
	...
	if (HauchDerPestilenz_Time > 0)
	{
		...
		&& (HauchDerPestilenz_Time > 30)
		{
			...
			Print	("The breath of pestilence penetrates your veins!");
