FUNC VOID GILDENSTORY_SL()
{
	...
	if (CurrentLevel == RELENDEL_ZEN)
	{
		...
		if (Mod_Hofstaat_Alex_Intro == 1)
		{
			if (Mod_Hofstaat_Alex_Intro_Counter == 0)
			{
				...
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_00"); //Zatrzymaj sie!
			};
			...
			if (Mod_Hofstaat_Alex_Intro_Counter == 5)
			{
				...
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_01"); //Hu?
			};
			...
			if (Mod_Hofstaat_Alex_Intro_Counter == 10)
			{
				...
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_02"); //W dól!
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 15)
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_03"); //Co tam robisz?
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 20)
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_04"); //Nie mozesz powiedziec? Kopie!
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 25)
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_05"); //Ty....... kopanie?
			};
			...
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_07"); //I.... Dlaczego kopiesz?
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 40)
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_08"); //Cóz, jestem królewskim grobowcem.
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 45)
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_09"); //Jestes kopaczka otworów?
			};
			...
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_11"); //Wszystko w porzadku, ale czego od mnie oczekujesz?
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 60)
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_12"); //Jak widac, dziura jest tutaj bardzo gleboka.
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 65)
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_13"); //I chcialbys mi pomóc?
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 70)
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_14"); //Nie.
			};
			...
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_16"); //Chcialem tylko pokazac wam moja dziure.
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 85)
			{
				AI_Output(hero, NULL, "Info_Mod_Alex_Hofstaat_Intro_15_17"); //Cóz, w takim przypadku..... Do zobaczenia pózniej.
			};

			if (Mod_Hofstaat_Alex_Intro_Counter == 90)
			{
				AI_Output(Mod_7011_HS_Alex_REL, NULL, "Info_Mod_Alex_Hofstaat_Intro_08_18"); //Do zobaczenia pózniej.
			};
		...
		if (Mod_Hofstaat_Alex_Intro == 3)
		{
			if (Mod_Hofstaat_Typ_Intro_Counter == 2)
			{
				...
				AI_Output(hero, NULL, "Info_Mod_Typ_Hofstaat_Intro_15_00"); //Co Pan tutaj robi?
			};

			if (Mod_Hofstaat_Typ_Intro_Counter == 7)
			{
				AI_Output(Mod_7012_HS_Typ_REL, NULL, "Info_Mod_Typ_Hofstaat_Intro_06_01"); //Stoje dookola i dobrze sie degustuje.
			};

			if (Mod_Hofstaat_Typ_Intro_Counter == 12)
			{
				AI_Output(hero, NULL, "Info_Mod_Typ_Hofstaat_Intro_15_02"); //Ty....... czy zgryzliwe?
			};

			if (Mod_Hofstaat_Typ_Intro_Counter == 17)
			{
				AI_Output(Mod_7012_HS_Typ_REL, NULL, "Info_Mod_Typ_Hofstaat_Intro_06_03"); //Tak..... (krótka pauza) pyszny.
			};

			if (Mod_Hofstaat_Typ_Intro_Counter == 22)
			{
				AI_Output(hero, NULL, "Info_Mod_Typ_Hofstaat_Intro_15_04"); //Dlaczego?
			};

			if (Mod_Hofstaat_Typ_Intro_Counter == 27)
			{
				AI_Output(Mod_7012_HS_Typ_REL, NULL, "Info_Mod_Typ_Hofstaat_Intro_06_05"); //Jestem królewski....
			};
			...
			{
				AI_Output(hero, NULL, "Info_Mod_Typ_Hofstaat_Intro_15_06"); //Cóz za pieklo....?
			};
		...
		&& (Mod_SL_Meer == 0)
		{
			...
			AI_Output(hero, NULL, "Info_Mod_Hero_Meer_15_00"); //Powinienem zatrzymac sie przy obozie bagiennym.

			B_LogEntry	(TOPIC_MOD_SEKTE_ENTSCHEIDUNG, "Powinienem zatrzymac sie przy obozie bagiennym.");
		};
		...
		&& (!Npc_IsInState(Mod_7334_HS_Typ_REL, ZS_Talk))
		{
			...
			if (Mod_SL_PartFluffy_Counter == 15)
			{
				...
				B_LogEntry	(TOPIC_MOD_SL_FLUFFY, "Fluffy jadl karme dla psów. Powinienem rozejrzec sie za nowa karma dla psów.");
			};
		...
		{
			PrintScreen ("Goraca noc pózniejsza", -1, YPOS_LevelUp, FONT_Screen, 2);
	...
	if (CurrentLevel == HALLUZINATION_ZEN)
	{
		...
		&& (!Npc_IsInState(Mod_7330_Meer_HAL, ZS_Talk))
		{
			...
			Spine_OverallSaveSetInt("Hallusz", 1);
	...
	if (CurrentLevel == MINENTAL_ZEN)
	{
		...
		&& (Mod_Caine_Leichengase == 0)
		{
			...
			|| (Npc_GetDistToWP(hero, "SUMPFHAIPROBE_02") < 500)
			{
				...
				{
					Print	("Otrzymana próbka rekina konopnego");

					B_LogEntry	(TOPIC_MOD_SL_LEICHENGASE, "Dostalem próbke rekina bagiennego. Wrócmy teraz do Baal Caine.");
		...
		if (Mod_Leichengase_Kraut == 3)
		{
			...
			{
				B_LogEntry	(TOPIC_MOD_SL_LEICHENGASE, "Teraz powinienem uzyc rolki zaklecia, aby przywolac owce do trolla.");
				...
				if (her.focus_vob)
				{
					if (Hlp_Is_oCMob(her.focus_vob))
					{
						...
						if (Hlp_StrCmp(her_focusMob._zCObject_objectName, "YDRANSGRAB") == TRUE)
						{
							...
							B_LogEntry	(TOPIC_MOD_SL_SCHMIEDEFEUERN, "Bardzo zabawny. Widocznie Baal Ydran juz od dluzszego czasu nie zyje. Musze ponownie porozmawiac z Baalem Namibem.");
						};
					};
				};
			};
		...
		&& (Npc_IsDead(SwampGolem_Sumpfmensch_01)) {
			...
			PrintScreen ("Troche pózniej.....", -1, YPOS_LevelUp, FONT_Screen, 2);
			Wld_PlayEffect("BLACK_SCREEN", hero, hero, 0, 0, 0, TRUE);
		};
	...
	if (Mod_Leichengase_Kraut == 0)
	{
		...
		&& (Npc_HasItems(hero, ItMi_Moleratlubric_MIS) >= 1)
		{
			...
			B_LogEntry	(TOPIC_MOD_SL_LEICHENGASE, "Torebke natarlem tluszczem trzonowym. Teraz powinienem udac sie do wawozu Troll Gorge w dolinie Minental, aby przywiezc ziola do trolli.");
		};
		...
		&& (Npc_HasItems(hero, ItMi_Schafsmagen) == 1)
		{
			...
			B_LogEntry	(TOPIC_MOD_SL_LEICHENGASE, "Mam owczy zoladek pelen ziól. Teraz powinienem udac sie do wawozu Troll Gorge w dolinie Minental, aby przywiezc ziola do trolli.");
		};
	};
};
