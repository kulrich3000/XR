	...
	if (Mod_JG_RaetselWand == 1)
	{
		if (Mod_JG_Raetselstein_Counter > 0)
		{
			if (Mod_JG_Raetselstein_Wert == Mod_JG_Raetselstein)
			{
				...
				{
					B_LogEntry	(TOPIC_MOD_JG_RAETSELWAND, "Zrobilismy to! Teraz w ostatnia komore....");
					...
					B_LogEntry	(TOPIC_MOD_JG_RAETSELWAND, "Raz w porzadku. Ale to nie wydaje sie wystarczajace.....");
				} else if (Mod_JG_Raetselstein_Counter == 3) {
					B_LogEntry	(TOPIC_MOD_JG_RAETSELWAND, "Nadal nie ma racji....");
				};
			}
			else
			{
