...
func void B_SetNpcVisualZombie (var C_NPC slf, var int gender, var string headMesh, var int faceTex, var int bodyTex, var int armorInstance)
{
	slf.aivar[AIV_Gender] = gender;
	...
	{
		// ------ Visual ------ "body_Mesh",		bodyTex		SkinColor	headMesh,	faceTex,	teethTex,	armorInstance	
		Mdl_SetVisualBody (slf,	"zom_body", 	bodyTex,	0,			headMesh, 	faceTex,	0, 			armorInstance);
	};
};
