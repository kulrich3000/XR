...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_Rundschreiben_15_00"); //Mam dla Ciebie newsletter.
...
INSTANCE Info_REL_Buerger_17_FreudenspenderMachtBlind (C_INFO) // E1
{
	...
	permanent	= 1;
	description = "Czy to dawca radosci, która bierzesz?";
};                       
...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_00"); //Czy to dawca radosci, która bierzesz?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_17_01"); //Tak, dlaczego?
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_02"); //Ohhhhhhhh..... Ach, po prostu tak....
	AI_Output(self, hero, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_17_03"); //Co?
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_04"); //Cóz, slysze, ze dawca radosci jest slepy.
...
FUNC VOID Info_Mod_REL_Buerger_17_Pickpocket_DoIt()
{
	...
	else
	{
		...
		Info_AddChoice	(Info_Mod_REL_Buerger_17_Pickpocket, DIALOG_PP_BESCHIMPFEN, Info_Mod_REL_Buerger_17_Pickpocket_Beschimpfen);
		Info_AddChoice	(Info_Mod_REL_Buerger_17_Pickpocket, DIALOG_PP_BESTECHUNG, Info_Mod_REL_Buerger_17_Pickpocket_Bestechung);
		Info_AddChoice	(Info_Mod_REL_Buerger_17_Pickpocket, DIALOG_PP_HERAUSREDEN, Info_Mod_REL_Buerger_17_Pickpocket_Herausreden);
	};
};

FUNC VOID Info_Mod_REL_Buerger_17_Pickpocket_Beschimpfen()
{
...
FUNC VOID Info_Mod_REL_Buerger_17_Pickpocket_Bestechung()
{
...
FUNC VOID Info_Mod_REL_Buerger_17_Pickpocket_Herausreden()
{
