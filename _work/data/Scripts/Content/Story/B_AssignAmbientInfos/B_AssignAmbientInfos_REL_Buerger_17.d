...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_Rundschreiben_15_00"); //I've got a newsletter for you.
...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_00"); //Is that giver of joy you're taking?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_17_01"); //Yeah, why?
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_02"); //Ohhhh... Oh, just so...
	AI_Output(self, hero, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_17_03"); //What?!
	AI_Output(hero, self, "Info_Mod_REL_Buerger_17_FreudenspenderMachtBlind_15_04"); //Well, I hear the giver of joy is blind.
