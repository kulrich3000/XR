...
{	
	AI_Output (hero, self, "DIA_VLK_21_JOIN_15_00"); //Co musze zrobic, aby zostac obywatelem tego miasta?
	AI_Output (self, hero, "DIA_VLK_21_JOIN_21_01"); //Glówni rzemieslnicy w dolnym miescie maja tu duzy wplyw na Khorinis. Powinienes porozmawiac z jednym z nich.
};
...
{	
	AI_Output (hero, self, "DIA_VLK_21_PEOPLE_15_00"); //Kim sa najwazniejsi ludzie w tym miescie?
	AI_Output (self, hero, "DIA_VLK_21_PEOPLE_21_01"); //Pan Andre reprezentuje prawo. Znajdziesz go w baraku.
	AI_Output (self, hero, "DIA_VLK_21_PEOPLE_21_02"); //Ale dopóki nie zlamiesz prawa lub nie chcesz dolaczyc do milicji, nie musisz isc do niego.
};
...
FUNC VOID Info_VLK_21_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_VLK_21_Flugblaetter_21_01"); //Dziekuje, dziekuje. Zobaczmy jak.....

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_VLK_21_Flugblaetter_21_02"); //Ah tak. Moze zatrzymam sie przy Matteo' s.
...
{
	AI_Output(hero, self, "Info_Mod_VLK_21_Rangar_15_00"); //Czy wiedziales, ze Rangar ma romans?
	AI_Output(self, hero, "Info_Mod_VLK_21_Rangar_21_01"); //Naprawde? Z kim?
	AI_Output(hero, self, "Info_Mod_VLK_21_Rangar_15_02"); //Z jedna z owiec Alwin!
	AI_Output(self, hero, "Info_Mod_VLK_21_Rangar_21_03"); //Czy jestes pewien tego? Bede musial od razu isc dalej.
...
{	
	AI_Output (hero, self, "DIA_VLK_21_LOCATION_15_00"); //Jakie sa najciekawsze miejsca w Khorinis?
	AI_Output (self, hero, "DIA_VLK_21_LOCATION_21_01"); //(smiech) Byc moze lepiej zapytac o to mezczyzne. Jesli szukasz rozrywki, powinienes sprawdzic port.
	AI_Output (self, hero, "DIA_VLK_21_LOCATION_21_02"); //Ale jesli chcesz cos kupic, przejdz na rynek przy wschodniej bramie lub w dolnym miescie.
};
