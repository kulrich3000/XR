...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_Rundschreiben_15_00"); //Mam dla Ciebie newsletter.
...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_00"); //Bierzesz radosne dozowniki?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_01"); //Tak.....
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_02"); //Czy nie boisz sie?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_03"); //Z czego?
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_04"); //No cóz, wiesz, ze..... Przyjemny dawca oslepia.
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_05"); //Co? Ten gówno!
...
{	
	AI_Output (hero, self, "DIA_REL_Buerger_19_PEOPLE_15_00"); //Kim sa tutaj wazne osobowosci?
	AI_Output (self, hero, "DIA_REL_Buerger_19_PEOPLE_19_01"); //Prezesem zarzadu jest tu Anselm. Zapewnia równiez prawo i porzadek.
	AI_Output (self, hero, "DIA_REL_Buerger_19_PEOPLE_19_02"); //Poza tym jest Robert, najlepszy kowal w kraju.
};
