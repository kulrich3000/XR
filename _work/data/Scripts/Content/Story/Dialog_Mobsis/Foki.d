...
FUNC VOID B_ActivateFokus ()
{
	...
	if (FokiEingesetzt	==	5)
	{
		...
		B_LogEntry	(TOPIC_MOD_FOKUSSUCHE, "Wlozylem ich wszystkich piec. Ostatnie miejsce zajelo trzesienie ziemi. W pewnym czasie powinienem udac sie do Magicystów Wody.");
	...
	if (hero.guild == GIL_NOV)
	{
		if (FokiEingesetzt == 2)
		{
			...
			B_LogEntry	(TOPIC_MOD_FOKUSSUCHE, "Jak skonczylo sie pieklo? Cos z platformami teleportacyjnymi musialo pójsc nie tak.");
		...
		if (FokiEingesetzt == 4)
		{
			...
			B_LogEntry	(TOPIC_MOD_FOKUSSUCHE, "Jeszcze raz. I tym razem wstydliwa sytuacja.");
