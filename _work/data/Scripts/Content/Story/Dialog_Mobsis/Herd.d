...
INSTANCE PC_Herd_Scavengerdung (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "Mix scavenger grounding in Theklas stew";
};
...
FUNC VOID PC_Herd_Scavengerdung_Info()
{
	...
	B_LogEntry	(TOPIC_MOD_JG_DUNG, "I've mixed the scavenger grounding into Theklas stew. Now I should go back to Grom and let him know.");
...
FUNC VOID PC_Herd_Fleischbraten_Fisch_Alle_Info()
{
	...
	FleischText = ConcatStrings(IntToString(Npc_HasItems(hero, ItFo_Fish)), " fried fish");
...
INSTANCE PC_Herd_Fleischbraten_Fleisch_Alle (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Roast all raw meat";
};
...
FUNC VOID PC_Herd_Fleischbraten_Fleisch_Alle_Info()
{
	...
	FleischText = ConcatStrings(IntToString(Npc_HasItems(hero, ItFo_MuttonRaw)), " piece of raw meat roasted");
...
INSTANCE PC_Herd_PfefferBacon (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Ham pepper: 1x ham + 1x pepper";
};
...
INSTANCE PC_Herd_Stockfisch (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Stockfisch preparation: 1x fried fish";
};
