...
INSTANCE PC_FokusSchrein_Beliar (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Modle sie do Beliara";
};
...
INSTANCE PC_FokusSchrein_Innos (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "Modle sie do Innos.";
};
...
FUNC VOID PC_FokusSchrein_Innos_Info()
{
	...
	B_LogEntry	(TOPIC_MOD_FM_FOKI, "Powinniscie byc przekonani o waszej wierze jako maga ognia. Albo przynajmniej udawac.....");
