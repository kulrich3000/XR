...
INSTANCE PC_Schmelze_Rohstahl (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Ogrzewanie stali surowej";
};
...
INSTANCE PC_Schmelze_Metallblock (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Produkcja bloków metalowych (1x stali surowej)";
};
...
FUNC VOID PC_Schmelze_Metallblock_Info()
{
	...
	Print ("4x metalowy blok wygrany");
};
...
INSTANCE PC_Schmelze_LichKamm (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Grzebien niszczacy";
};
...
FUNC VOID PC_Schmelze_LichKamm_Info()
{
	...
	B_LogEntry	(TOPIC_MOD_NL_DRACHEN, "Grzebien zostal zniszczony, a swiatlo zostalo pozbawione jego niesmiertelnosci. Nawet smokom nie nalezy juz odmawiac dostepu do sfery smierci.");
};
...
INSTANCE PC_Schmelze_MerkwuerdigesDing (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Umieszczenie w ogniu czegos dziwnego";
};
...
FUNC VOID PC_Schmelze_MerkwuerdigesDing_Info()
{
	...
	Print	("10 dziwnych malych rzeczy sie zdobyc!");
};
...
INSTANCE PC_Schmelze_Golemherz (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Stawianie plonacych serc golema bagiennego";
};
...
FUNC VOID PC_Schmelze_Golemherz_Info()
{
	...
	Print	("Pobierz fragmenty serca Golem!");
};
...
FUNC VOID PC_Schmelze_Waffen_RostigesSchwert_G()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_1h_MISC_Sword_Geschaerft)), " Stal surowa otrzymana"));
...
FUNC VOID PC_Schmelze_Waffen_RostigesSchwert()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_1h_MISC_Sword)), " Stal surowa otrzymana"));
...
FUNC VOID PC_Schmelze_Waffen_RostigerZweihaender_G()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_2H_Sword_M_01_Geschaerft)), " Stal surowa otrzymana"));
...
FUNC VOID PC_Schmelze_Waffen_RostigerZweihaender()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_2H_Sword_M_01)), " Stal surowa otrzymana"));
...
FUNC VOID PC_Schmelze_Waffen_RostigeAxt_G()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_1h_MISC_Axe_Geschaerft)), " Stal surowa otrzymana"));
...
FUNC VOID PC_Schmelze_Waffen_RostigeAxt()
{
	...
	Print (ConcatStrings(IntToString(Npc_HasItems(hero, ItMw_1h_MISC_Axe)), " Stal surowa otrzymana"));
