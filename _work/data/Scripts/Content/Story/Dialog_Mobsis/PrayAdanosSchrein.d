...
FUNC VOID PC_PrayAdanosSchrein_Pray_Info()
{
	...
	Info_AddChoice (PC_PrayAdanosSchrein_Pray,"I want to pray and not sacrifice anything.",PC_PrayAdanosSchrein_Pray_NoPay);
			
	if (Npc_HasItems(hero, ItMi_Gold) >= 100)
	{
		Info_AddChoice (PC_PrayAdanosSchrein_Pray,"I want to pray and sacrifice 100 gold.",PC_PrayAdanosSchrein_Pray_100);
	};	
	if (Npc_HasItems(hero, ItMi_Gold) >= 50)
	{
		Info_AddChoice (PC_PrayAdanosSchrein_Pray,"I will pray and sacrifice 50 gold.",PC_PrayAdanosSchrein_Pray_50);
	};
}; 
...
FUNC VOID B_PrayAdanos (var int Goldi, var int EXPi)
{
	...
	&& (AdanosZusatzBonus == 0)
	{
		...
		if (Mod_Schwierigkeit != 4)
		{
			...
			PrintScreen	("Adanos grants you a learning point", -1, 5, FONT_SCREEN, 2);
		}
		else
		{
			...
			PrintScreen	("Adanos gives you more protection", -1, 5, FONT_SCREEN, 2);
		};
	}
	...
	&& (AdanosZusatzBonus == 1)
	{
		...
		PrintScreen	("Adanos grants you 10 Mana", -1, 5, FONT_SCREEN, 2);
	}
	...
	&& (AdanosZusatzBonus == 2)
	{
		...
		PrintScreen	("Adanos grants you an additional 2000 experience points", -1, 5, FONT_SCREEN, 2);
	}
	...
	&& (AdanosZusatzBonus == 3)
	{
		...
		if (Mod_Schwierigkeit != 4)
		{
			...
			PrintScreen	("Adanos grants you 5 learning points", -1, 5, FONT_SCREEN, 2);
		}
		else
		{
	...
	&& (AdanosZusatzBonus == 4)
	{
		...
		PrintScreen	("Adanos grants you 2% bonus on all your combat skills", -1, 5, FONT_SCREEN, 2);
	}
	...
	&& (AdanosZusatzBonus == 5)
	{
		...
		PrintScreen	("Adanos grants you 15 Mana", -1, 5, FONT_SCREEN, 2);
	}
	...
	&& (AdanosZusatzBonus == 6)
	{
		...
		if (Mod_Schwierigkeit != 4)
		{
			...
			PrintScreen	("Adanos grants you 10 learning points", -1, 5, FONT_SCREEN, 2);
		}
		else
		{
	...
	&& (AdanosZusatzBonus == 7)
	{
		...
		PrintScreen	("Adanos grants you an additional 15000 experience points", -1, 5, FONT_SCREEN, 2);
	}
	...
	&& (AdanosZusatzBonus == 8)
	{
		...
		PrintScreen	("Adanos grants you 5% bonus on all your combat skills", -1, 5, FONT_SCREEN, 2);
	};
...
FUNC VOID PC_PrayAdanosSchrein_Reg_Info()
{
	...
	if (Mana_Perk == FALSE)
	{
		if (Mod_Schwierigkeit == 4)
		{
			Info_AddChoice (PC_PrayAdanosSchrein_Reg,"Mana regeneration (7000 Gold)",PC_PrayAdanosSchrein_Reg_Mana);
		}
		else
		{
			Info_AddChoice (PC_PrayAdanosSchrein_Reg,"Mana regeneration (20 LP and 5000 Gold)",PC_PrayAdanosSchrein_Reg_Mana);
		};
	};
}; 
