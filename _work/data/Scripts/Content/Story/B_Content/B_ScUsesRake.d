...
FUNC VOID B_SAATBLUTKULT_S1()
{
	...
	&& (Npc_HasItems(hero, ItAt_ErzdemonTooth) == 1)
	{
		...
		PrintScreen	("Zeby daemonu lukowego zasiewanego", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID USEDUENGER_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		PrintScreen	("Rozlozenie nawozu", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
...
FUNC VOID B_Schatzgraben_01_S1()
{
	...
	&& (Schatz_Greg_01 == FALSE)
	{
		...
		PrintScreen	("Znaleziony tekst", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_02_S1()
{
	...
	&& (Schatz_Greg_02 == FALSE)
	{
		...
		PrintScreen	("Klejnoty Znaleziono kasetke", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_03_S1()
{
	...
	&& (Schatz_Greg_03 == FALSE)
	{
		...
		PrintScreen	("Znaleziona czarna perla", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_04_S1()
{
	...
	&& (Schatz_Greg_04 == FALSE)
	{
		...
		PrintScreen	("Znalezione szable pirackie", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_05_S1()
{
	...
	&& (Schatz_Greg_05 == FALSE)
	{
		...
		PrintScreen	("Znaleziony kamien runowy", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_Deppenhans_S1()
{
	...
	&& (Schatz_Deppenhans == FALSE)
	{
		...
		PrintScreen	("Znaleziono 11 sztuk zlota i 5 sztuk rudy", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Schatzgraben_OrkAmulett_S1()
{
	...
	&& (Schatz_MegaAmulett == FALSE)
	{
		...
		PrintScreen	("Znaleziony amulet", -1, YPOS_XPGained, FONT_ScreenSmall, 2);

		B_LogEntry	(TOPIC_MOD_BDT_ORKS, "Na koniec mam prawy amulet. Powinienem teraz pójsc z tym do dextera.");
...
FUNC VOID B_Schatzgraben_GorNaKosh_S1()
{
	...
	&& (Schatz_GorNaKosh == FALSE)
	{
		...
		PrintScreen	("Gor Na Kosze Znaleziona skórzana torba", -1, YPOS_XPGained, FONT_ScreenSmall, 2);

		B_LogEntry	(TOPIC_MOD_SL_SCHMIEDEFEUERN, "Dostalem portmonetke Gor Na Kosh.");
	};
};
...
FUNC VOID B_Grabraub_01_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziono zardzewialy miecz i srebrny pierscien.", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_02_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Rdzawy miecz i 4 stare monety znaleziono", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_03_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziono zardzewialy miecz i kosc szkieletu.", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_04_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Rdzawy miecz, 2 srebrne pierscienie i 14 zlota znaleziono", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_05_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziono zardzewialy miecz i 2 kosci szkieletu.", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_06_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziony zardzewialy miecz i 121 zlota", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_07_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("3 zardzewiale miecze znalezione", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_08_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Pierscien zlote, pierscien zloto", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_09_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziono zardzewialy miecz, kasete na klejnoty i 16 starych monet.", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_11_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziony zardzewialy miecz i ruda", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_12_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Znaleziono zardzewialy miecz i srebrna plytke.", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_13_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("Rdzawy miecz i figura Inno znalezione", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
...
FUNC VOID B_Grabraub_14_S1()
{
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		PrintScreen	("2 Znaleziono rdzawe miecze i srebrny lancuch", -1, YPOS_XPGained, FONT_ScreenSmall, 2);
	};
};
