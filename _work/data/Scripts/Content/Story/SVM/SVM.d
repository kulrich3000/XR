...
{
	// ------ B_Say_GuildGreetings ---------------------------------------------------------------------------------------
	MILGreetings				= 	"SVM_0_MILGreetings"				;//Za Króla!
	PALGreetings				=	"SVM_0_PALGreetings"				;//Dla Innosów!
	BELGreetings				=	"SVM_0_BELGreetings"				;//Aby uhonorowac Beliara!
	AdanosGreetings				=	"SVM_0_AdanosGreetings"				;//Adanos byc z toba!
	...
	SheepKiller					=	"SVM_0_SheepKiller"					;//Bastard zabija nasze owce!
	SheepKillerMonster			=	"SVM_0_SheepKillerMonster"			;//Damnowy syn suki jedza nasza owce!
	YouMurderer					=	"SVM_0_YouMurderer"					;//Morderca!
	DieStupidBeast				=	"SVM_0_DieStupidBeast"				;//Nie ma tu zadnych stworzen!
	YouDareHitMe				=	"SVM_0_YouDareHitMe"				;//Czekaj, syn suki!
	YouAskedForIt				=	"SVM_0_YouAskedForIt"				;//Prosiles o to!
	ThenIBeatYouOutOfHere		=	"SVM_0_ThenIBeatYouOutOfHere"		;//Wtedy bede musial cie wybic!
	WhatDidYouDoInThere			=	"SVM_0_WhatDidYouDoInThere"			;//Co tam robiles, huh?
	WillYouStopFighting			=	"SVM_0_WillYouStopFighting"			;//Prosze, zatrzymacie to, prosze!
	// ------ B_Say_AttackEND ---------------------------------------------------------------------------------------------
	...
	SheepAttackerDown			=	"SVM_0_SheepAttackerDown"			;//Nie rób tego nigdy wiecej! To sa nasze owce!
	KillMurderer				=	"SVM_0_KillMurderer"				;//Smierc, morderca!
	StupidBeastKilled			=	"SVM_0_StupidBeastKilled"			;//Cóz za glupia cóz!
	NeverHitMeAgain				=	"SVM_0_NeverHitMeAgain"				;//Jeszcze nigdy znowu nie pierdole!
	YouBetterShouldHaveListened	=	"SVM_0_YouBetterShouldHaveListened"	;//Powinienes mnie wysluchac!
	GetUpAndBeGone				=	"SVM_0_GetUpAndBeGone"				;//Teraz wyjmij z niego pieklo!
	NeverEnterRoomAgain			=	"SVM_0_NeverEnterRoomAgain"			;//I ze juz nigdy cie tam juz nie zlapam!
	ThereIsNoFightingHere		=	"SVM_0_ThereIsNoFightingHere"		;//Nie ma tu walki, to prawda? Niech to bedzie dla ciebie lekcja!
	// ------ C_WantToFlee -------------------------------------------------------------------------------------------------
	RunAway						= 	"SVM_0_RunAway"						;//Wyobraz sobie! Wypuscmy sie tutaj!
	// ------ C_WantToCallGuardsToFight --------------------------------------------------------------------------------------
	Alarm						=	"SVM_0_Alarm"						;//ALARM!
	Guards						=	"SVM_0_Guards"						;//WACHE!
	Help						=	"SVM_0_Help"						;//Pomoc!
	// ------ B_AssessMurder -----------------------------------------------------------------------------------------------
	GoodMonsterKill				=	"SVM_0_GoodMonsterKill"				;//Dobrze zrobiona - mniej brudna krowa!
	GoodKill					= 	"SVM_0_GoodKill"					;//(skrzyk) Tak, dokonczyc swinie!
	// ------ B_AssessTalk -----------------------------------------------------------------------------------------------
	NOTNOW						= 	"SVM_0_NOTNOW"						;//Udajcie sie ode mnie!
	// ------ ZS_Attack ----------------------------------------------------------------------------------------------------
	RunCoward					=	"SVM_0_RunCoward"					;//Stoisz nieruchomo, rajd!
	// ------ ZS_ClearRoom -------------------------------------------------------------------------------------------------
	GetOutOfHere				=	"SVM_0_GetOutOfHere"				;//Wyjsc stad!
	WhyAreYouInHere				=	"SVM_0_WhyAreYouInHere"				;//Co Pan tutaj robi? Idzcie!
	YesGoOutOfHere				= 	"SVM_0_YesGoOutOfHere"				;//Tak, wyjdz stad!
	// ------ ZS_ObservePlayer ---------------------------------------------------------------------------------------------
	WhatsThisSupposedToBe		=	"SVM_0_WhatsThisSupposedToBe"		;//Hej! Po co sie chwiejesz?
	YouDisturbedMySlumber		=	"SVM_0_YouDisturbedMySlumber"		;//Co sie dzieje?
	// ------ ZS_RansackBody -----------------------------------------------------------------------------------------------
	...
	// ------ ZS_ReactToWeapon ---------------------------------------------------------------------------------------------
	LookingForTroubleAgain		=	"SVM_0_LookingForTroubleAgain"		;//Jeszcze za malo?
	StopMagic					=	"SVM_0_StopMagic"					;//Idz z magia!
	ISaidStopMagic				=	"SVM_0_ISaidStopMagic"				;//Pozbadz sie magii! Czy slyszysz zle?
	WeaponDown					=	"SVM_0_WeaponDown"					;//Odlozyc pistolet!
	ISaidWeaponDown				=	"SVM_0_ISaidWeaponDown"				;//Czy nie slyszysz dobrze? Powiedzialem, ze odlozylem pistolet!
	WiseMove					=	"SVM_0_WiseMove"					;//Idziesz tam, tam idzcie!
	// ------ ZS_Unconscious ------------------------------------------------------------------------------------------------
	NextTimeYoureInForIt		=	"SVM_0_NextTimeYoureInForIt"		;//Nadal mówimy o.....
	OhMyHead					=	"SVM_0_OhMyHead"					;//(do siebie) Oh, moja czaszka....
	// ------ ZS_WatchFight -------------------------------------------------------------------------------------------------
	TheresAFight				=	"SVM_0_TheresAFight"				;//Wejdzmy do biznesu!
	OhMyGodItsAFight			=	"SVM_0_OhMyGodItsAFight"			;//Oni rozbija czaszki w....
	GoodVictory					=	"SVM_0_GoodVictory"					;//Na to on zasluguje.
	NotBad						= 	"SVM_0_NotBad"						;//(pogniwianie) Nie takie zle....
	OhMyGodHesDown				=	"SVM_0_OhMyGodHesDown"				;//(do siebie) Jaki brutalny facet....
	CheerFriend01				=	"SVM_0_CheerFriend01"				;//Tak, to tak!
	CheerFriend02				=	"SVM_0_CheerFriend02"				;//Chodzcie dalej, odejdzmy!
	CheerFriend03				=	"SVM_0_CheerFriend03"				;//Pozostan na szczycie!
	Ooh01						=	"SVM_0_Ooh01"						;//Nie poddawaj sie niczemu!
	Ooh02						=	"SVM_0_Ooh02"						;//Jestes gonna!
	Ooh03						=	"SVM_0_Ooh03"						;//Nie moge w to uwierzyc!
	// ----------------------------------------------------------------------------------------------------------------------
	WhatWasThat					= "SVM_0_WhatWasThat"					;//Co to bylo?
	// ----------------------------------------------------------------------------------------------------------------------
	GetOutOfMyBed				= "SVM_0_GetOutOfMyBed"					;//Wejsc z lózka!
	Awake						= "SVM_0_Awake"							;//(rzut serca)
	// ----------------------------------------------------------------------------------------------------------------------
	TOUGHGUY_ATTACKLOST			= "SVM_0_TOUGHGUY_ATTACKLOST"			;//To wszystko jest w porzadku, wygrasz. Czego chcesz?
	TOUGHGUY_ATTACKWON			= "SVM_0_TOUGHGUY_ATTACKWON"			;//Czy musze ponownie pokazac ci, kim jest Pan?
	TOUGHGUY_PLAYERATTACK		= "SVM_0_TOUGHGUY_PLAYERATTACK"			;//Chcesz znowu sie ze mna pietrowac lub co?
	// ----------------------------------------------------------------------------------------------------------------------
	GOLD_1000					= "SVM_0_GOLD_1000"						;//Tysiac sztuk zlota.
	GOLD_950					= "SVM_0_GOLD_950"						;//950 sztuk zlota.
	GOLD_900					= "SVM_0_GOLD_900"						;//900 sztuk zlota.
	GOLD_850					= "SVM_0_GOLD_850"						;//850 sztuk zlota.
	GOLD_800					= "SVM_0_GOLD_800"						;//800 sztuk zlota.
	GOLD_750					= "SVM_0_GOLD_750"						;//750 sztuk zlota.
	GOLD_700					= "SVM_0_GOLD_700"						;//700 sztuk zlota.
	GOLD_650					= "SVM_0_GOLD_650"						;//650 sztuk zlota.
	GOLD_600					= "SVM_0_GOLD_600"						;//600 sztuk zlota.
	GOLD_550					= "SVM_0_GOLD_550"						;//550 sztuk zlota.
	GOLD_500					= "SVM_0_GOLD_500"						;//500 sztuk zlota.
	GOLD_450					= "SVM_0_GOLD_450"						;//450 sztuk zlota.
	GOLD_400					= "SVM_0_GOLD_400"						;//400 sztuk zlota.
	GOLD_350					= "SVM_0_GOLD_350"						;//350 sztuk zlota.
	GOLD_300					= "SVM_0_GOLD_300"						;//300 sztuk zlota.
	GOLD_250					= "SVM_0_GOLD_250"						;//250 sztuk zlota.
	GOLD_200					= "SVM_0_GOLD_200"						;//200 sztuk zlota.
	GOLD_150					= "SVM_0_GOLD_150"						;//150 sztuk zlota.
	GOLD_100					= "SVM_0_GOLD_100"						;//100 sztuk zlota.
	GOLD_90						= "SVM_0_GOLD_90"						;//Dziewiecdziesiat sztuk zlota.
	GOLD_80						= "SVM_0_GOLD_80"						;//80 sztuk zlota.
	GOLD_70						= "SVM_0_GOLD_70"						;//70 sztuk zlota.
	GOLD_60						= "SVM_0_GOLD_60"						;//60 sztuk zlota.
	GOLD_50						= "SVM_0_GOLD_50"						;//50 sztuk zlota.
	GOLD_40						= "SVM_0_GOLD_40"						;//40 sztuk zlota.
	GOLD_30						= "SVM_0_GOLD_30"						;//Trzydziesci sztuk zlota.
	GOLD_20						= "SVM_0_GOLD_20"						;//20 sztuk zlota.
	GOLD_10						= "SVM_0_GOLD_10"						;//10 sztuk zlota.
	// -----------------------------------------------------------------------------------------------------------------------
	Smalltalk01					= "SVM_0_Smalltalk01"					;//... Czy naprawde wierzysz, ze....
	Smalltalk02					= "SVM_0_Smalltalk02"					;//... jest wszystko mozliwe.....
	Smalltalk03					= "SVM_0_Smalltalk03"					;//... powinien byl wiedziec lepiej......
	Smalltalk04					= "SVM_0_Smalltalk04"					;//... jakbym nie mial juz dosc problemów.....
	Smalltalk05					= "SVM_0_Smalltalk05"					;//... kto mówi takie cos.....
	Smalltalk06					= "SVM_0_Smalltalk06"					;//... jest jeszcze wiecej klopotów......
	Smalltalk07					= "SVM_0_Smalltalk07"					;//... wiele do powiedzenia.....
	Smalltalk08					= "SVM_0_Smalltalk08"					;//... Nie zrobilbym tego.....
	Smalltalk09					= "SVM_0_Smalltalk09"					;//... To tylko pogloski....
	Smalltalk10					= "SVM_0_Smalltalk10"					;//... musisz tylko uwazac, co mówisz ludziom....
	Smalltalk11					= "SVM_0_Smalltalk11"					;//... Móglbym panstwu to powiedziec wczesniej.....
	Smalltalk12					= "SVM_0_Smalltalk12"					;//... Nikt mnie nie pyta....
	Smalltalk13					= "SVM_0_Smalltalk13"					;//... Mozna zalowac biednego faceta....
	Smalltalk14					= "SVM_0_Smalltalk14"					;//... nie jest to nic nowego....
	Smalltalk15					= "SVM_0_Smalltalk15"					;//... to oczywiste....
	Smalltalk16					= "SVM_0_Smalltalk16"					;//... nie musisz mnie o to pytac......
	Smalltalk17					= "SVM_0_Smalltalk17"					;//... To nie moze trwac wiecznie.....
	Smalltalk18					= "SVM_0_Smalltalk18"					;//... znasz juz moja opinie.....
	Smalltalk19					= "SVM_0_Smalltalk19"					;//... Tak wlasnie powiedzialem.....
	Smalltalk20					= "SVM_0_Smalltalk20"					;//... nic sie nigdy nie zmieni......
	Smalltalk21					= "SVM_0_Smalltalk21"					;//... dlaczego nie dowiedzialem sie o tym do tej pory.....
	Smalltalk22					= "SVM_0_Smalltalk22"					;//... poczekajmy i zobaczmy, co sie dzieje....
	Smalltalk23					= "SVM_0_Smalltalk23"					;//... niektóre problemy rozwiazywane sa samodzielnie......
	Smalltalk24					= "SVM_0_Smalltalk24"					;//... Juz nie slysze....
	//ToughGuy (SLD/MIL/DJG)                                                                                                                        
	Smalltalk25					= "SVM_0_Smalltalk25"					;//... Pijany jak pieklo....
	Smalltalk26					= "SVM_0_Smalltalk26"					;//... Nie mozesz to zrobic ze mna......
	Smalltalk27					= "SVM_0_Smalltalk27"					;//... wszystkie biegly jak króliki, bylem samotny......
	//ProInnos (NOV/KDF/PAL)                                                                                                                        
	Smalltalk28					= "SVM_0_Smalltalk28"					;//... Tak wiec mówi ona w Pismie swietym....[...].
	Smalltalk29					= "SVM_0_Smalltalk29"					;//... Zawsze dzialam w imieniu Innosa....
	Smalltalk30					= "SVM_0_Smalltalk30"					;//... nikt nie moze naruszac boskiego porzadku......
	SmalltalkKhorataAnnaQuest01			= "SVM_0_SmalltalkKhorataAnnaQuest01"; //... On ich wszystkich zabil......
	SmalltalkKhorataAnnaQuest02			= "SVM_0_SmalltalkKhorataAnnaQuest02"; //... po tym, co zrobil przed sedzia, nie pozwole mu wejsc do mojego domu....
	SmalltalkKhorataAnnaQuest03			= "SVM_0_SmalltalkKhorataAnnaQuest03"; //... Nie oplakuje moich synów i córek....
	SmalltalkKhorataAnnaQuest04			= "SVM_0_SmalltalkKhorataAnnaQuest04"; //... Ulrich zawsze wydawal mi sie dziwny....
	SmalltalkKhorataAnnaQuest05			= "SVM_0_SmalltalkKhorataAnnaQuest05"; //... zakladac, ze Ulrich byl równiez czarownica....
	SmalltalkKhorataAnnaQuest06			= "SVM_0_SmalltalkKhorataAnnaQuest06"; //... Nigdy bym nie stanal po stronie sedziego.... Wiecej
	SmalltalkKhorataDichter01			= "SVM_0_SmalltalkKhorataDichter01"; //... Nie mogly to byc wiersze, które byly za nie odpowiedzialne......
	SmalltalkKhorataDichter02			= "SVM_0_SmalltalkKhorataDichter02"; //... zaprzestal teraz pisania.....
	SmalltalkKhorataDichter03			= "SVM_0_SmalltalkKhorataDichter03"; //... nigdy wczesniej nie pomagal mi nigdy wczesniej......
	SmalltalkKhorataDichter04			= "SVM_0_SmalltalkKhorataDichter04"; //... Nie widzialem go od dawna.....
	SmalltalkKhorataDichter05			= "SVM_0_SmalltalkKhorataDichter05"; //... Tak bardzo tesknie za jego historiami....
	SmalltalkKhorataEndres01			= "SVM_0_SmalltalkKhorataEndres01"; //... o mezu Juliany? ...
	SmalltalkKhorataEndres02			= "SVM_0_SmalltalkKhorataEndres02"; //... o Adanos, teraz ludzie sa porwani w Khorata....
	SmalltalkKhorataEndres03			= "SVM_0_SmalltalkKhorataEndres03"; //... Nie wyobrazam sobie, ze jeszcze zyje....
	SmalltalkKhorataEndres04			= "SVM_0_SmalltalkKhorataEndres04"; //... Ale kto nas teraz uzdrawia? ...
	SmalltalkKhorataEndres05			= "SVM_0_SmalltalkKhorataEndres05"; //... Nie moge uwierzyc, ze byl winny....
	SmalltalkKhorataEndres06			= "SVM_0_SmalltalkKhorataEndres06"; //... Nie zrobil nic lepszego niz uzdrowiciel.....
	SmalltalkKhorataEndres07			= "SVM_0_SmalltalkKhorataEndres07"; //... bezimienny czlowiek jest dla mnie bohaterem......
	SmalltalkKhorataFrauenkleider01			= "SVM_0_SmalltalkKhorataFrauenkleider01"; //... Melvin nosi damskie ubrania! ...
	SmalltalkKhorataFrauenkleider02			= "SVM_0_SmalltalkKhorataFrauenkleider02"; //... Czy chce byc traktowany powaznie? ...
	SmalltalkKhorataFrauenkleider03			= "SVM_0_SmalltalkKhorataFrauenkleider03"; //... Melvin ukradl moja bielizne! ...

	SmalltalkKhorataUnruhen01			= "SVM_0_SmalltalkKhorataUnruhen01"; //... Bedziesz mial racje......
	SmalltalkKhorataUnruhen02			= "SVM_0_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_0_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_0_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_0_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_0_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_0_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_0_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_0_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_0_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_0_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...

	SmalltalkKhorataUnruhenTheodorus01		= "SVM_0_SmalltalkKhorataUnruhenTheodorus01"; //... Bardzo zla decyzja....
	SmalltalkKhorataUnruhenTheodorus02		= "SVM_0_SmalltalkKhorataUnruhenTheodorus02"; //... Nie moglo sie to pogorszyc.....
	SmalltalkKhorataUnruhenTheodorus03		= "SVM_0_SmalltalkKhorataUnruhenTheodorus03"; //... Zdejmij glowe z powrotem na.....
	SmalltalkKhorataUnruhenTheodorus04		= "SVM_0_SmalltalkKhorataUnruhenTheodorus04"; //... Opuszczam miasto....

	SmalltalkKhorataUnruhenWendel01			= "SVM_0_SmalltalkKhorataUnruhenWendel01"; //... Ciesze sie, ze walka sie skonczyla....
	SmalltalkKhorataUnruhenWendel02			= "SVM_0_SmalltalkKhorataUnruhenWendel02"; //... Z Wendel wszystko musi zawsze dzialac poprawnie.....
	SmalltalkKhorataUnruhenWendel03			= "SVM_0_SmalltalkKhorataUnruhenWendel03"; //... W koncu osmiele sie wrócic na droge.....
	SmalltalkKhorataUnruhenWendel04			= "SVM_0_SmalltalkKhorataUnruhenWendel04"; //... Buddlerzy uciekli zbyt dobrze! ...

	SmalltalkKhorataUnruhenLukas01			= "SVM_0_SmalltalkKhorataUnruhenLukas01"; //... Dlaczego nie mozemy juz brac dawcy radosci? ...
	SmalltalkKhorataUnruhenLukas02			= "SVM_0_SmalltalkKhorataUnruhenLukas02"; //... Przeciez Lukasz jest lepszy niz Wendel.....
	SmalltalkKhorataUnruhenLukas03			= "SVM_0_SmalltalkKhorataUnruhenLukas03"; //... Oni zabili wszystkich Buddlerów! ...
	SmalltalkKhorataUnruhenLukas04			= "SVM_0_SmalltalkKhorataUnruhenLukas04"; //... Lucas jest po prostu glupi....

	SmalltalkKhorataDiebeGrusel01			= "SVM_0_SmalltalkKhorataDiebeGrusel01"; //... Czy slyszales ten opuszczony dom na skraju miasta? ...
	SmalltalkKhorataDiebeGrusel02			= "SVM_0_SmalltalkKhorataDiebeGrusel02"; //... Tak, mówi sie, ze zdarzyly sie tam straszne rzeczy. ...
	SmalltalkKhorataDiebeGrusel03			= "SVM_0_SmalltalkKhorataDiebeGrusel03"; //... I wciaz czaja sie tam sily zla. ...
	SmalltalkKhorataDiebeGrusel04			= "SVM_0_SmalltalkKhorataDiebeGrusel04"; //... Naprawde chca tam otworzyc restauracje. ...
	SmalltalkKhorataDiebeGrusel05			= "SVM_0_SmalltalkKhorataDiebeGrusel05"; //... Zmeczony zyciem! Wiec nie jestem gonna postawic w nim stope. ...
	SmalltalkKhorataDiebeGrusel06			= "SVM_0_SmalltalkKhorataDiebeGrusel06"; //... I nawet nie jade nigdzie w poblizu budynku. ...

	SmalltalkKhorataDiebeBib01			= "SVM_0_SmalltalkKhorataDiebeBib01"; //... Czy slyszales uczonego....
	SmalltalkKhorataDiebeBib02			= "SVM_0_SmalltalkKhorataDiebeBib02"; //... Tak, podobno ukradl cenne dokumenty z biblioteki......
	SmalltalkKhorataDiebeBib03			= "SVM_0_SmalltalkKhorataDiebeBib03"; //... A jest kilku swiadków, w tym gubernator....
	SmalltalkKhorataDiebeBib04			= "SVM_0_SmalltalkKhorataDiebeBib04"; //... A on bardzo powaznie twierdzi, ze caly czas mieszka w domu....
	SmalltalkKhorataDiebeBib05			= "SVM_0_SmalltalkKhorataDiebeBib05"; //... Oczywiscie nikt go tam nie widzial....
	SmalltalkKhorataDiebeBib06			= "SVM_0_SmalltalkKhorataDiebeBib06"; //... Jak on biegal przez miasto przed kradzieza, ale juz teraz....
	SmalltalkKhorataDiebeBib07			= "SVM_0_SmalltalkKhorataDiebeBib07"; //... Pokryte zgnilymi owocami.....
	SmalltalkKhorataDiebeBib08			= "SVM_0_SmalltalkKhorataDiebeBib08"; //... Musial naprawde stracic umysl....

	SmalltalkKhorataNormal01			= "SVM_0_SmalltalkKhorataNormal01"; //... Od dluzszego czasu nie widzialam wlasciwego spalania czarownic! ...
	SmalltalkKhorataNormal02			= "SVM_0_SmalltalkKhorataNormal02"; //... Bede mial jeszcze jedna....
	SmalltalkKhorataNormal03			= "SVM_0_SmalltalkKhorataNormal03"; //... Nastepna runda na mnie! ...
	SmalltalkKhorataNormal04			= "SVM_0_SmalltalkKhorataNormal04"; //... Jutro to jeszcze jeden dzien - ale on nie bedzie sie lepiej cieszyl.....
	SmalltalkKhorataNormal05			= "SVM_0_SmalltalkKhorataNormal05"; //... Nie pozwolisz czarnoksieznikom zyc....
	SmalltalkKhorataNormal06			= "SVM_0_SmalltalkKhorataNormal06"; //... Grawita zostala odlana.....

	// Khorinis

	SmalltalkRangar01			= "SVM_0_SmalltalkRangar01"; //... teraz nawet milicja ma byc klientem czerwonej latarni....
	SmalltalkRangar02			= "SVM_0_SmalltalkRangar02"; //... Slyszales o owcach Rangar i Alwin? ...

	SmalltalkMatteo01			= "SVM_0_SmalltalkMatteo01"; //... Czy byles juz Matteo? ...
	SmalltalkMatteo02			= "SVM_0_SmalltalkMatteo02"; //... Matte? Czyz nie ozenil sie? ...
	SmalltalkMatteo03			= "SVM_0_SmalltalkMatteo03"; //... wszedzie sa tylko zgnile jablka....
	SmalltalkMatteo04			= "SVM_0_SmalltalkMatteo04"; //... Teraz kupuje od Matteo, gdzie mozna jeszcze dostac swieze owoce....

	SmalltalkKhorinisMario01			= "SVM_0_SmalltalkKhorinisMario01"; //... Paladyny juz sie ubijaja.....
	SmalltalkKhorinisMario02			= "SVM_0_SmalltalkKhorinisMario02"; //... Nie chce, aby ten nieznajomy byl calkowicie niewinny smierci Garonda. ...
	SmalltalkKhorinisMario03			= "SVM_0_SmalltalkKhorinisMario03"; //... Ci dwaj mezczyzni moga byc w miescie i miec klopoty! ...
	SmalltalkKhorinisMario04			= "SVM_0_SmalltalkKhorinisMario04"; //... Milicja nie spelnila swoich obowiazków, to moim zdaniem....

	SmalltalkFellan01			= "SVM_0_SmalltalkFellan01"; //... Moglem zabic Fellana! O godzinie 7:00 rano juz beknie jak szalony. ...
	SmalltalkFellan02			= "SVM_0_SmalltalkFellan02"; //... Tock, tock, tock, tock, tock....

	SmalltalkMikaPflanzen01			= "SVM_0_SmalltalkMikaPflanzen01"; //... Mika oferuje roslinom leczniczym za okazyjna cene! ...
	SmalltalkMikaPflanzen02			= "SVM_0_SmalltalkMikaPflanzen02"; //... Ten nos buraczany zbiera wszystkie rosliny z mojego nosa! ...

	// ----------------------------------------------------------------------------------------------------------------------
	NoLearnNoPoints				= "SVM_0_NoLearnNoPoints"			;//Wróc do domu, gdy masz wiecej doswiadczenia.
	NoLearnOverPersonalMAX		= "SVM_0_NoLearnOverPersonalMAX"	;//Pytasz mnie wiecej niz ja moge Cie nauczyc.
	NoLearnYoureBetter			= "SVM_0_NoLearnYoureBetter"		;//Nie moge juz niczego nauczyc. Juz jestes zbyt dobry.
	YouLearnedSomething			= "SVM_0_YouLearnedSomething"		;//Zobacz, ze dostales sie lepiej....
	// ----------------------------------------------------------------------------------------------------------------------
	UNTERSTADT					= "SVM_0_UNTERSTADT"				;//Teraz jestes w dolnym miescie.
	OBERSTADT					= "SVM_0_OBERSTADT"					;//Teraz jestes w górnym miescie.
	TEMPEL						= "SVM_0_TEMPEL"					;//Teraz jestes w swiatyni.
	MARKT						= "SVM_0_MARKT"						;//Teraz jestes na rynku.
	GALGEN						= "SVM_0_GALGEN"					;//Teraz jestes na szubienicy przed barakami.
	KASERNE						= "SVM_0_KASERNE"					;//To sa baraki.
	HAFEN						= "SVM_0_HAFEN"						;//Jestes tutaj na nabrzezu.
	// -----------------------
	WHERETO						= "SVM_0_WHERETO"					;//Gdzie idziesz?
	// -----------------------
	OBERSTADT_2_UNTERSTADT		= "SVM_0_OBERSTADT_2_UNTERSTADT"	;//Stamtad nalezy przejsc przez brame sródmiejska i wjechac do dolnego miasta.
	UNTERSTADT_2_OBERSTADT		= "SVM_0_UNTERSTADT_2_OBERSTADT"	;//Na poludniowej bramie miasta znajduje sie klatka schodowa prowadzaca do bramy sródmiejskiej. Tu wlasnie zaczyna sie Górne Miasto.
	UNTERSTADT_2_TEMPEL			= "SVM_0_UNTERSTADT_2_TEMPEL"		;//Od kuzni przechodzimy przez przejscie podziemne i wchodzimy na plac swiatyni.
	UNTERSTADT_2_HAFEN			= "SVM_0_UNTERSTADT_2_HAFEN"		;//Z kowalstwa zejdz na Hafenstrasse i dotrzesz do portu.
	TEMPEL_2_UNTERSTADT			= "SVM_0_TEMPEL_2_UNTERSTADT"		;//Z rynku swiatyni znajduje sie przejscie podziemne prowadzace do dolnego miasta.
	TEMPEL_2_MARKT				= "SVM_0_TEMPEL_2_MARKT"			;//Jesli stoisz przed swiatynia, idziesz w lewo i wzdluz muru miasta, to przychodzisz na targ.
	TEMPEL_2_GALGEN				= "SVM_0_TEMPEL_2_GALGEN"			;//Jesli przejdziesz obok pubu po lewej stronie swiatyni, przyjdziesz na plac szubienicy.
	MARKT_2_TEMPEL				= "SVM_0_MARKT_2_TEMPEL"			;//Jesli przejedziesz przez wysoki mur miejski z rynku, dojdziesz do swiatyni.
	MARKT_2_KASERNE				= "SVM_0_MARKT_2_KASERNE"			;//Baraki to ogromny budynek. Wystarczy wejsc po schodach naprzeciwko hotelu.
	MARKT_2_GALGEN				= "SVM_0_MARKT_2_GALGEN"			;//Wystarczy isc po duzych barakach, a przyjdziesz do szubienicy.
	GALGEN_2_TEMPEL				= "SVM_0_GALGEN_2_TEMPEL"			;//Z szubienicy zejdziemy w dól alei i dojdziemy do swiatyni.
	GALGEN_2_MARKT				= "SVM_0_GALGEN_2_MARKT"			;//Wystarczy po prostu przejsc przez duzy barak i przyjsc na targ.
	GALGEN_2_KASERNE			= "SVM_0_GALGEN_2_KASERNE"			;//Baraki to ogromny budynek. Wystarczy wejsc po schodach w góre.
	KASERNE_2_MARKT				= "SVM_0_KASERNE_2_MARKT"			;//Wystarczy zejsc schodami przy glównym wejsciu po lewej stronie i przyjsc na targowisko.
	KASERNE_2_GALGEN			= "SVM_0_KASERNE_2_GALGEN"			;//Wystarczy zejsc schodami w dól przy glównym wejsciu po prawej stronie i przyjdziesz na szubienice.
	HAFEN_2_UNTERSTADT			= "SVM_0_HAFEN_2_UNTERSTADT"		;//Z muru nabrzeza nalezy wejsc w góre Hafenstraße i dotrzec do dolnego miasta.
	// -------------------------------------------------------------------------------------
	Dead						= "SVM_0_Dead"						;//Aaaaaaaaarglas!
	...
	ADDON_WRONGARMOR			= "SVM_0_Addon_WrongArmor";				//To nie jest twoja odziez. Nie rozmawiam z wami.
	ADDON_WRONGARMOR_SLD		= "SVM_0_ADDON_WRONGARMOR_SLD";			//Jak chodzisz? Zalóz cos rozsadnego.
	ADDON_WRONGARMOR_MIL		= "SVM_0_ADDON_WRONGARMOR_MIL";			//Jestes zolnierzem! Odpowiednio ubrac sie.
	ADDON_WRONGARMOR_KDF		= "SVM_0_ADDON_WRONGARMOR_KDF";			//Twoje ubrania nie sa odpowiednie do naszego zamówienia. Zmienic sie.
	ADDON_NOARMOR_BDT			= "SVM_0_ADDON_ADDON_NOARMOR_BDT";		//Nie masz nawet zbroi. Wyjsc stad!

	ADDON_DIEBANDIT				= "SVM_0_ADDON_DIEBANDIT";				//Zgubisz sie, brudny bandyta!
	ADDON_DIRTYPIRATE			= "SVM_0_ADDON_DIRTYPIRATE";			//Pakiet piracki!

	RELMINE01			= "SVM_0_RELMINE01";			//Nie moge juz tego robic!
	RELMINE02			= "SVM_0_RELMINE02";			//Gdyby tylko mialem cos do jedzenia.....
	RELMINE03			= "SVM_0_RELMINE03";			//Dmuchaj po uderzeniu, caly dzien przez caly dzien.....
	RELMINE04			= "SVM_0_RELMINE04";			//To trudne.
	RELMINE05			= "SVM_0_RELMINE05";			//Kiedy przychodzi ulga?
	RELMINE06			= "SVM_0_RELMINE06";			//Najczystsza eksploatacja jest taka!
	RELMINE07			= "SVM_0_RELMINE07";			//Nie wróce jutro, obiecuje, ze nie wróce jutro.... Wiecej
	RELMINE08			= "SVM_0_RELMINE08";			//Taki piekny kamien!
	RELMINE09			= "SVM_0_RELMINE09";			//Moja zona nawet nie wie, jak wygladam....
	RELMINE10			= "SVM_0_RELMINE10";			//Chcialbym teraz dostac tankowiec.....
	RELMINE11			= "SVM_0_RELMINE11";			//Ma to zastapic kolonie karna.
	RELMINE12			= "SVM_0_RELMINE12";			//Skorzystaj z dozowników przyjemnosci, to jest w porzadku.

	NoLearnGold			= "SVM_0_NoLearnGold";			//Wróc, gdy masz wiecej zlota.

	// Witze

	WITZ_01_01			= "SVM_0_WITZ_01_01";			//W glab lasu wchodzi mysliwy.
	WITZ_01_02			= "SVM_0_WITZ_01_02";			//Ork spotyka go z dzika na ramieniu.
	WITZ_01_03			= "SVM_0_WITZ_01_03";			//Kilka kroków dalej spotyka najemnika, który równiez nosi na ramieniu dzika.
	WITZ_01_04			= "SVM_0_WITZ_01_04";			//Kilka metrów dalej widzi goblina.
	WITZ_01_05			= "SVM_0_WITZ_01_05";			//pytanie............................. i co wedlug Ciebie ma goblin?
	WITZ_01_06			= "SVM_0_WITZ_01_06";			//Krwawienie dziasel, poniewaz co trzecia osoba ma krwawiace dziasla.

	WITZ_02_01			= "SVM_0_WITZ_02_01";			//Dwie zombie walcza o swoje zycie.

	WITZ_03_01			= "SVM_0_WITZ_03_01";			//Jaka jest róznica miedzy blotem a pluskiem miesnym?
	WITZ_03_02			= "SVM_0_WITZ_03_02";			//Mieso przynosi 10 doswiadczen.

	WITZ_04_01			= "SVM_0_WITZ_04_01";			//Zlodziej wlamuje sie noca do domu.
	WITZ_04_02			= "SVM_0_WITZ_04_02";			//Kiedy przeslizguje sie po boisku przez czarny salon, slyszy glos:
	WITZ_04_03			= "SVM_0_WITZ_04_03";			//Widze ciebie i widze cie Innos!
	WITZ_04_04			= "SVM_0_WITZ_04_04";			//Przeraza sie na smierc i zapala swiece.
	WITZ_04_05			= "SVM_0_WITZ_04_05";			//Patrzy w góre i widzi papuge siedzaca na slupku w rogu:
	WITZ_04_06			= "SVM_0_WITZ_04_06";			//Wlamywacz czuje ulge:
	WITZ_04_07			= "SVM_0_WITZ_04_07";			//Straszyles mnie piekla. Jakie jest Twoje imie?
	WITZ_04_08			= "SVM_0_WITZ_04_08";			//Bloto!
	WITZ_04_09			= "SVM_0_WITZ_04_09";			//Bloto jest rzadko glupia nazwa papugi!
	WITZ_04_10			= "SVM_0_WITZ_04_10";			//Usmiecha sie ptaka: No cóz, Innos jest równiez rzadko glupia nazwa warg.

	WITZ_05_01			= "SVM_0_WITZ_05_01";			//Zdjac z grobów dwa szkielety i ukrasc konie.
	WITZ_05_02			= "SVM_0_WITZ_05_02";			//Polóz ten nagrobek na jego nagrobku.
	WITZ_05_03			= "SVM_0_WITZ_05_03";			//Drugi z nich pyta:'Dlaczego tak?
	WITZ_05_04			= "SVM_0_WITZ_05_04";			//Czy myslisz, ze jezdze bez papieru?

	WITZ_06_01			= "SVM_0_WITZ_06_01";			//Powstaje podczas burzy w barze Coragon i mówi:
	WITZ_06_02			= "SVM_0_WITZ_06_02";			//Jestem mokry w kosci.

	WITZ_07_01			= "SVM_0_WITZ_07_01";			//Mówi Snappermutter:'Dziecko, dzis jest swieza paladynka.
	WITZ_07_02			= "SVM_0_WITZ_07_02";			//Mówi Snapperkind:'Nienawidze zywnosci konserwowanej.

	WITZ_08_01			= "SVM_0_WITZ_08_01";			//Co to jest czerwona, sliska substancja pomiedzy bokami rekina bagiennego?
	WITZ_08_02			= "SVM_0_WITZ_08_02";			//Powolny nowicjusz.

	WITZ_09_01			= "SVM_0_WITZ_09_01";			//Jaka jest pierwsza rzecz, która przychodzi na mysl, gdy Ork wchodzi do klasztoru Adanos?
	WITZ_09_02			= "SVM_0_WITZ_09_02";			//Lanca lodowa.

	WITZ_10_01			= "SVM_0_WITZ_10_01";			//Sluchaj tego....
	WITZ_10_02			= "SVM_0_WITZ_10_02";			//Tak?
	WITZ_10_03			= "SVM_0_WITZ_10_03";			//Tak wiec....
	WITZ_10_04			= "SVM_0_WITZ_10_04";			//Lisl owce pasterza Pepe sa chore.
	WITZ_10_05			= "SVM_0_WITZ_10_05";			//Martwi sie, pyta pasterza Balthasara:
	WITZ_10_06			= "SVM_0_WITZ_10_06";			//Co dales swojej owcy, kiedy byla tak chora?
	WITZ_10_07			= "SVM_0_WITZ_10_07";			//Dalem wtedy mojej Klarze podwójny mlotek Lou' a, mówi.
	WITZ_10_08			= "SVM_0_WITZ_10_08";			//Nie wczesniej niz to zostalo powiedziane. Kiedy dwa dni pózniej Pepe odwiedza Balthasara, odchodzi:
	WITZ_10_09			= "SVM_0_WITZ_10_09";			//Mój Lisl zmarl. I Balthasar: Moja Klary tez.
	WITZ_10_10			= "SVM_0_WITZ_10_10";			//Tak, tak, heh. Jesli dajesz zwierzetom gorzalke, potrzebuja.

	// Taschendiebstahl

	PICKPOCKET_BESTECHUNG_01	=	"SVM_0_PICKPOCKET_BESTECHUNG_01";	//Wszystko w porzadku, ale zgubic sie teraz!
	PICKPOCKET_HERAUSREDEN_01	=	"SVM_0_PICKPOCKET_HERAUSREDEN_01";	//Zapewne sie pomylilem.....
	PICKPOCKET_HERAUSREDEN_02	=	"SVM_0_PICKPOCKET_HERAUSREDEN_02";	//Byles wyraznie na kieszeni....
};
...
instance SVM_1 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_1_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_1_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_1_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_1_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_1_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_1_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_1_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_1_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_1_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_1_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
INSTANCE SVM_2	(C_SVM)	
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_2_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_2_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_2_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_2_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_2_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_2_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_2_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_2_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_2_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_2_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_3 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_3_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_3_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_3_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_3_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_3_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_3_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_3_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_3_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_3_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_3_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_4 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_4_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_4_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_4_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_4_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_4_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_4_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_4_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_4_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_4_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_4_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_5 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_5_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_5_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_5_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_5_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_5_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_5_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_5_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_5_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_5_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_5_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_6 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_6_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_6_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_6_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_6_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_6_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_6_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_6_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_6_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_6_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_6_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_7 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_7_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_7_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_7_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_7_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_7_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_7_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_7_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_7_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_7_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_7_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_8 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_8_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_8_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_8_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_8_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_8_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_8_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_8_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_8_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_8_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_8_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_9 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_9_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_9_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_9_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_9_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_9_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_9_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_9_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_9_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_9_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_9_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_10 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_10_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_10_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_10_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_10_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_10_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_10_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_10_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_10_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_10_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_10_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_11 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_11_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_11_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_11_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_11_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_11_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_11_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_11_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_11_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_11_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_11_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_12 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_12_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_12_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_12_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_12_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_12_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_12_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_12_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_12_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_12_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_12_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_13 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_13_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_13_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_13_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_13_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_13_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_13_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_13_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_13_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_13_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_13_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_14 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_14_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_14_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_14_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_14_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_14_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_14_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_14_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_14_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_14_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_14_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_16 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_16_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_16_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_16_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_16_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_16_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_16_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_16_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_16_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_16_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_16_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_17 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_17_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_17_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_17_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_17_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_17_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_17_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_17_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_17_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_17_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_17_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_24 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_24_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_24_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_24_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_24_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_24_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_24_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_24_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_24_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_24_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_24_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_26 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_26_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_26_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_26_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_26_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_26_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_26_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_26_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_26_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_26_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_26_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_30 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_30_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_30_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_30_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_30_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_30_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_30_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_30_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_30_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_30_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_30_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_34 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_34_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_34_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_34_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_34_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_34_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_34_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_34_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_34_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_34_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_34_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
...
instance SVM_36 (C_SVM)
{
	...
	SmalltalkKhorataUnruhen02			= "SVM_36_SmalltalkKhorataUnruhen02"; //... Byloby inaczej w przeszlosci......
	SmalltalkKhorataUnruhen03			= "SVM_36_SmalltalkKhorataUnruhen03"; //... Powinnismy przytloczyc ich noca.....
	SmalltalkKhorataUnruhen04			= "SVM_36_SmalltalkKhorataUnruhen04"; //... Na to wlasnie zasluguja....
	SmalltalkKhorataUnruhen05			= "SVM_36_SmalltalkKhorataUnruhen05"; //... Tyrus i Dalton sa martwe! ...
	SmalltalkKhorataUnruhen06			= "SVM_36_SmalltalkKhorataUnruhen06"; //... Co wiec? Co mnie obchodzi? ...
	SmalltalkKhorataUnruhen07			= "SVM_36_SmalltalkKhorataUnruhen07"; //... Trudno mi sie odwazyc wyjsc na ulice......
	SmalltalkKhorataUnruhen08			= "SVM_36_SmalltalkKhorataUnruhen08"; //... To byka.
	SmalltalkKhorataUnruhen09			= "SVM_36_SmalltalkKhorataUnruhen09"; //... Lukasz mial zostac nowym gubernatorem....
	SmalltalkKhorataUnruhen10			= "SVM_36_SmalltalkKhorataUnruhen10"; //... Mysle, ze Wendel bylby lepszy.....
	SmalltalkKhorataUnruhen11			= "SVM_36_SmalltalkKhorataUnruhen11"; //... Nie teodorowy! ...
