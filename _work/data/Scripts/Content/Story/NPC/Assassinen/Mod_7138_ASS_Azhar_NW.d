INSTANCE Mod_7138_ASS_Azhar_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "Azhar"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7138;
};

FUNC VOID Rtn_Start_7138()
{	
	TA_Smalltalk 	(07,20,01,20,"WP_ASSASSINE_38");
	TA_Smalltalk	(01,20,07,20,"WP_ASSASSINE_38");
};

FUNC VOID Rtn_Schlacht_7138()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7138()
{	
