INSTANCE Mod_7134_ASS_Anwaerter_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "aspirant"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7134;
};

FUNC VOID Rtn_Start_7134()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_39");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_39");
};

FUNC VOID Rtn_Schlacht_7134()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7134()
{	
