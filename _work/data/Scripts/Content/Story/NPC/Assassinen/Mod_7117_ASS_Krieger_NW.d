INSTANCE Mod_7117_ASS_Krieger_NW (Npc_Default)
{
	// ------ NSC ------
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7117;
};

FUNC VOID Rtn_Start_7117()
{	
	TA_Guard_Passage 	(07,20,01,20,"WP_ASSASSINE_24");
	TA_Guard_Passage	(01,20,07,20,"WP_ASSASSINE_24");
};

FUNC VOID Rtn_Schlacht_7117()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7117()
{	
