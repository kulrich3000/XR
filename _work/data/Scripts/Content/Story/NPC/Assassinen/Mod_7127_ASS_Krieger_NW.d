INSTANCE Mod_7127_ASS_Krieger_NW (Npc_Default)
{
	// ------ NSC ------
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7127;
};

FUNC VOID Rtn_Start_7127()
{	
	TA_Smalltalk 	(07,20,01,20,"WP_ASSASSINE_30");
	TA_Smalltalk	(01,20,07,20,"WP_ASSASSINE_30");
};

FUNC VOID Rtn_Schlacht_7127()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7127()
{	
