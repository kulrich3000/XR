INSTANCE Mod_7159_ASS_Novize_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "novice"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7159;
};

FUNC VOID Rtn_Start_7159()
{	
	TA_Smalltalk 	(07,20,01,20,"WP_ASSASSINE_68");
	TA_Smalltalk	(01,20,07,20,"WP_ASSASSINE_68");
};

FUNC VOID Rtn_Schlacht_7159()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7159()
{	
