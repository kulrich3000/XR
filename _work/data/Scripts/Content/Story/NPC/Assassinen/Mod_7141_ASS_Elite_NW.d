INSTANCE Mod_7141_ASS_Elite_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "Elita Assassin"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7141;
};

FUNC VOID Rtn_Start_7141()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_43");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_43");
};

FUNC VOID Rtn_Schlacht_7141()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7141()
{	
