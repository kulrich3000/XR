INSTANCE Mod_7142_ASS_Elite_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "Elita Assassin"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7142;
};

FUNC VOID Rtn_Start_7142()
{	
	TA_Smalltalk 	(07,20,01,20,"WP_ASSASSINE_49");
	TA_Smalltalk	(01,20,07,20,"WP_ASSASSINE_49");
};

FUNC VOID Rtn_Schlacht_7142()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7142()
{	
