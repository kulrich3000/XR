INSTANCE Mod_7160_ASS_Novize_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "nowicjusz"; 
	guild 		= GIL_OUT;
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7160;
};

FUNC VOID Rtn_Start_7160()
{	
	TA_Smalltalk 	(07,20,01,20,"WP_ASSASSINE_66");
	TA_Smalltalk	(01,20,07,20,"WP_ASSASSINE_66");
};

FUNC VOID Rtn_Schlacht_7160()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7160()
{	
