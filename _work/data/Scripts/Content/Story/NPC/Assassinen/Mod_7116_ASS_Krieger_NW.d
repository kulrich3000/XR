INSTANCE Mod_7116_ASS_Krieger_NW (Npc_Default)
{
	// ------ NSC ------
	name 		= "Wojownik zabójca"; 
	guild 		= GIL_OUT;
	id 			= 7116;
	voice		= 0;
	flags       = 0;																
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7116;
};

FUNC VOID Rtn_Start_7116()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_24");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_24");
};

FUNC VOID Rtn_Schlacht_7116()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7116()
{	
