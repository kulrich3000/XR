INSTANCE Mod_7166_ASS_Novize_NW (Npc_Default)
{
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_7166;
};

FUNC VOID Rtn_Start_7166()
{	
	TA_Practice_Magic 	(07,20,01,20,"WP_ASSASSINE_69");
	TA_Practice_Magic	(01,20,07,20,"WP_ASSASSINE_69");
};

FUNC VOID Rtn_Schlacht_7166()
{	
	TA_Stand_Guarding 	(07,20,01,20,"WP_ASSASSINE_51");
	TA_Stand_Guarding	(01,20,07,20,"WP_ASSASSINE_51");
};

FUNC VOID Rtn_Tot_7166()
{	
