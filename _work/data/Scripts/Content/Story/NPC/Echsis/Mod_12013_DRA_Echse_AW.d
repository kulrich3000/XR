INSTANCE Mod_12013_DRA_Echse_AW	(C_NPC)
{
	//----- Monster ----
...
//	damage		[DAM_INDEX_MAGIC]	=	0;
	...
	daily_routine	=	Rtn_Start_12013;
};

FUNC VOID Rtn_Start_12013()
{
	TA_Stand_WP_Orc		(08,00,20,00,"BL_DOWN_CENTER_08_B");
	TA_Stand_WP_Orc		(20,00,08,00,"BL_DOWN_CENTER_08_B");
};

FUNC VOID Rtn_FollowWSS_12013()
{
	TA_Follow_Player		(08,00,20,00,"BL_DOWN_CENTER_08_B");
	TA_Follow_Player		(20,00,08,00,"BL_DOWN_CENTER_08_B");
};

FUNC VOID Rtn_Tot_12013()
{
	TA_Stand_WP_ORC		(08,00,20,00,"TOT");
	TA_Stand_WP_ORC		(20,00,08,00,"TOT");
};

FUNC VOID Rtn_Schlacht_12013()
{
