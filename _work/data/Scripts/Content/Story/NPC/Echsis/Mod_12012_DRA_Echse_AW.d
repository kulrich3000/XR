...
//	damage		[DAM_INDEX_MAGIC]	=	0;
	...
	daily_routine	=	Rtn_Start_12012;
};

FUNC VOID Rtn_Start_12012()
{
	TA_Stand_WP_Orc		(08,00,20,00,"BL_DOWN_RING_03");
	TA_Stand_WP_Orc		(20,00,08,00,"BL_DOWN_RING_03");
};

FUNC VOID Rtn_FollowWSS_12012()
{
	TA_Follow_Player		(08,00,20,00,"BL_DOWN_RING_03");
	TA_Follow_Player		(20,00,08,00,"BL_DOWN_RING_03");
};

FUNC VOID Rtn_Tot_12012()
{
	TA_Stand_WP_ORC		(08,00,20,00,"TOT");
	TA_Stand_WP_ORC		(20,00,08,00,"TOT");
};

FUNC VOID Rtn_Schlacht_12012()
{
