instance Mod_1750_KDF_Magier_PAT (Npc_Default)
{
	// ------ NSC ------
	...
	B_SetNpcVisual 		(self, MALE, "Hum_Head_FatBald", Face_N_NormalBart16, BodyTex_N, ITAR_KDF_h);		
	Mdl_SetModelFatness	(self, 1);
	Mdl_ApplyOverlayMds	(self, "Humans_Mage.mds"); // Tired / Militia / Mage / Arrogance / Relaxed

	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_1750;
};

FUNC VOID Rtn_Start_1750 ()
{	
	TA_Stand_Guarding_WP		(08,05,22,05,"WP_PAT_WEG_109");
	TA_Stand_Guarding_WP		(22,05,08,05,"WP_PAT_WEG_109");
};

FUNC VOID Rtn_Kirche_1750 ()
{	
