instance Mod_1753_KDF_Magier_PAT (Npc_Default)
{
	// ------ NSC ------
	...
	B_SetNpcVisual 		(self, MALE, "Hum_Head_FatBald", Face_N_NormalBart22, BodyTex_N, itar_kdf_h);		
	Mdl_SetModelFatness	(self, 1);
	Mdl_ApplyOverlayMds	(self, "Humans_Mage.mds"); // Tired / Militia / Mage / Arrogance / Relaxed

	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_1753;
};

FUNC VOID Rtn_Start_1753 ()
{	
	TA_Stand_Guarding_WP		(08,05,22,05,"WP_PAT_WEG_121");
