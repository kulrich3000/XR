instance Mod_1754_KDF_Magier_PAT (Npc_Default)
{
	...
	B_SetNpcVisual 		(self, MALE, "Hum_Head_Bald", Face_N_Normal06, BodyTex_N, ITAR_kdf_h);		
	Mdl_SetModelFatness	(self, 1);
	Mdl_ApplyOverlayMds	(self, "Humans_Mage.mds"); // Tired / Militia / Mage / Arrogance / Relaxed

	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_1754;
};

FUNC VOID Rtn_Start_1754 ()
{	
	TA_Stand_Guarding_WP		(08,05,22,05,"WP_PAT_WEG_125");
	TA_Stand_Guarding_WP		(22,05,08,05,"WP_PAT_WEG_125");
};

FUNC VOID Rtn_Kirche_1754 ()
{	
