instance Mod_799_BAU_Thekla_NW (Npc_Default)
{
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_799;
};

FUNC VOID Rtn_Start_799 ()
{	
	...
	TA_Cook_Stove		(21,30,22,00,"NW_BIGFARM_KITCHEN_COOK");
    	...
    	TA_Sleep	(22,00,08,00,"NW_BIGFARM_KITCHEN_04");
};

FUNC VOID Rtn_Vorratskammer_799()
{
	TA_RunToWp	(08,00,20,00,"NW_BIGFARM_KITCHEN_04");
	TA_RunToWP	(20,00,08,00,"NW_BIGFARM_KITCHEN_04");
};
