instance Mod_785_BAU_Gunnar_NW (Npc_Default)
{
	...
	// ------ TA anmelden ------
	daily_routine 		= Rtn_Start_785;
};

FUNC VOID Rtn_Start_785 ()
{	
	TA_Smalltalk		(08,00,19,59,"NW_BIGFARM_STABLE_OUT_01");
    TA_Sit_Chair			(19,59,08,00,"NW_BIGFARM_STABLE_06");
};

FUNC VOID Rtn_Dieb_785 ()
{	
	TA_Stand_Guarding		(02,00,23,40,"NW_BIGFARM_STABLE_OUT_01");
    TA_Pick_FP			(23,40,02,00,"NW_BIGFARM_KITCHEN_04");
};

FUNC VOID Rtn_Flucht_785()
{
	TA_RunToWp		(08,00,20,00,"NW_BIGFARM_FELDREUBER4");
	TA_RunToWp		(20,00,08,00,"NW_BIGFARM_FELDREUBER4");
};
