INSTANCE Mod_10005_Orc_HoshPak_OC (Npc_Default)			
{
	//----- Monster -----
	name							=	"Hosh Pak";
	guild							=	GIL_ORC;
	...
	CreateInvItems	(self, ItMi_Focus_Bergfestung, 1);	
...
{
	TA_Stand_WP_Orc		(08,00,20,00,"WP_OCC_01");
	TA_Stand_WP_Orc		(20,00,08,00,"WP_OCC_01");
};

FUNC VOID Rtn_Tot_10005()
{
	TA_Stand_WP_Orc		(08,00,20,00,"GRYD_074");
	TA_Stand_WP_Orc		(20,00,08,00,"GRYD_074");
};
