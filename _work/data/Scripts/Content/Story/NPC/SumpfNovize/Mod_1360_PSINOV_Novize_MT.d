instance Mod_1360_PSINOV_Novize_MT (Npc_Default)
{
	//-------- primary data --------
	name 		=		Name_Novize;
	...
	Mdl_SetVisualBody (self,"hum_body_Naked0",1, 2 ,"Hum_Head_Bald", 6 ,  2, NOV_ARMOR_L);
...
FUNC VOID Rtn_start_1360 ()
{
    ...
    TA_Sit_Chair	(09,05,09,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(10,05,10,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(11,05,11,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(12,05,12,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(13,05,13,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(14,05,14,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(15,05,15,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(16,05,16,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(17,05,17,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(18,05,18,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(19,05,19,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(20,05,20,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(21,05,21,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(22,05,22,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(23,05,23,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(00,05,00,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(01,05,01,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(02,05,02,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(03,05,03,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(04,05,04,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(05,05,05,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(06,05,06,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(07,05,07,10,"PSI_SMITH_01");
    ...
    TA_Sit_Chair	(08,05,08,10,"PSI_SMITH_01");
};

FUNC VOID Rtn_Tot_1360 ()
{
