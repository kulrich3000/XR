...
{
	Erfolg_OpenQuests -= 1;
	PrintScreen		(ConcatStrings("Quest completed: ", topic), -1, YPOS_LOGENTRY+3+LogState_PosY, FONT_ScreenSmall_Green, 4);
...
{
	Erfolg_OpenQuests += 1;
	PrintScreen		(ConcatStrings("New Quest: ", topic), -1, YPOS_LOGENTRY+3+LogState_PosY, FONT_ScreenSmall, 4);
...
{
	Erfolg_OpenQuests -= 1;
	PrintScreen		(ConcatStrings("Quest failed: ", topic), -1, YPOS_LOGENTRY+3+LogState_PosY, FONT_ScreenSmall_Red, 4);
