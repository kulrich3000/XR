...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel, VAR INT aktuelles_Level_Zen)
{
	...
	{
		// ------ Bild einblenden ------
		IntroduceChapter (KapWechsel_1,"The Menace","chapter1.tga","chapter_01.wav", 6000);
	...
	{
		// ------ Bild einblenden ------
		IntroduceChapter (KapWechsel_2,"The Foki","chapter2.tga","chapter_01.wav", 6000);
	...
	{
		// ------ Bild einblenden ------
		IntroduceChapter (KapWechsel_4,"The power of the 3 Gods","chapter4.tga","chapter_01.wav", 6000);
	...
	{
		// ------ Bild einblenden ------
		IntroduceChapter (KapWechsel_6,"The Arena","chapter6.tga","chapter_01.wav", 6000);
