...
func void B_GiveDeathInv (var C_NPC slf)
{
	...
	&& (slf.aivar[AIV_Trefferzone] == 1)
	{
		...
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Tiger_White)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_WolfFur	, 1);	};
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_BlackwolfFur	, 1);	};
	...
	&& (slf.aivar[AIV_Trefferzone] == 0)
	{
		...
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Tiger_White)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_WolfFur_Rein, 1);	};
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_BlackwolfFur_Rein, 1);	};
	...
	&& (slf.aivar[AIV_Trefferzone] == 2)
	{
		...
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Tiger_White)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_WolfFur_Feuer, 1);	};
		if ((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Blackwolf)))			{	CreateInvItems (slf, ItAt_BlackwolfFur_Feuer, 1);	};
