...
FUNC VOID Info_Mod_Milten_IR_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hi_28_01"); //Well, this dark place does credit to the magician Xeres.
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hi_28_02"); //Inno's illuminating fire is what this place has been missing for a long time.
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hi_28_03"); //His blessing will hopefully serve us well when it comes to banishing the demonic brood that nests here.
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hi_28_05"); //Well, it is surely the cold and darkness that brings me closer to Inno.
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hi_28_06"); //Here I notice what I have in him.
};
...
FUNC VOID Info_Mod_Milten_IR_Hebel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_Hebel_28_00"); //Of course it is. Maybe if it's going to get us somewhere...
...
{
	AI_Output(self, hero, "Info_Mod_Milten_IR_Ambient01_28_00"); //Ashes to ashes, and dust to dust. Inno's fire leads the bones of these undead to their right destiny.
...
FUNC VOID Info_Mod_Milten_IR_GehtLos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_GehtLos_28_00"); //Of course I'll go with you. May Inno's fire set fire to the fiends.
...
FUNC VOID Info_Mod_Milten_IR_GehBack_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_GehBack_28_00"); //Well, if you need me, you know where to find me.
...
FUNC VOID Info_Mod_Milten_IR_Kram_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_IR_Kram_28_01"); //Yes, of course. I can teach you to increase your magic power.
	AI_Output(self, hero, "Info_Mod_Milten_IR_Kram_28_02"); //I also have some of the monastery's spell rolls with me, if you want to have a look at them.
};
...
FUNC VOID Info_Mod_Milten_IR_Heiltrank_Info()
{
	...
	{
		Info_AddChoice	(Info_Mod_Milten_IR_Heiltrank, "Potion of Quick Healing", Info_Mod_Milten_IR_Heiltrank_Health_05);
	};
};
