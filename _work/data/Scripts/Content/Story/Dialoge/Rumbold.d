...
{	
	AI_Output (self, other,"DIA_Rumbold_Attack_10_00"); //Get away, thief!
	AI_StopProcessInfos	(self);	
...
{
	AI_Output (self, hero,"Info_Mod_Rumbold_FirstWarn_10_00"); //HALT! You mustn't go to the camp.
...
{
	AI_Output (self, hero,"Info_Mod_Rumbold_SecondWarn_10_00"); //Hey, you hear bad? You can't go in there.
...
func void Info_Mod_Rumbold_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_Rumbold_Attack_10_00"); //You asked for it...
