...
FUNC void Info_Mod_Grimbald_Lernen_Claws()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Grimbald_Lernen_Claws_07_00"); //Animals don't like to give up their claws. You have to place your knife very precisely.
		AI_Output(self, hero, "Info_Mod_Grimbald_Lernen_Claws_07_01"); //Your hands should be slightly crossed. Then you separate the claw with a powerful tug.
		AI_Output(self, hero, "Info_Mod_Grimbald_Lernen_Claws_07_02"); //Merchants are always eager to be paid in claws.
	};
...
FUNC void Info_Mod_Grimbald_Lernen_Fur()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Grimbald_Lernen_Fur_07_00"); //The best way to remove the pelt is by making a deep cut along the hind legs.
		AI_Output(self, hero, "Info_Mod_Grimbald_Lernen_Fur_07_01"); //After that, it should be a cinch to pull off the skin from the front to the back.
	};
