...
{
	AI_Output(self, hero, "Info_Mod_Thorge_TUG_AtDorf_13_00"); //Ah, the village. I'm staying here. From now on, you're on your own.
...
FUNC VOID Info_Mod_Thorge_TUG_Heiltrank_Info()
{
	...
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Essence of Healing", Info_Mod_Thorge_TUG_Heiltrank_Health_04);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Elixir of Healing", Info_Mod_Thorge_TUG_Heiltrank_Health_03);
	};
	if (Npc_HasItems(hero, ItPo_Health_02) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Extract of Healing", Info_Mod_Thorge_TUG_Heiltrank_Health_02);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Essence of Healing", Info_Mod_Thorge_TUG_Heiltrank_Health_01);
	};
	if (Npc_HasItems(hero, ItPo_Health_07) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Drink of light healing", Info_Mod_Thorge_TUG_Heiltrank_Health_07);
	};
	if (Npc_HasItems(hero, ItPo_Health_06) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Light healing potion", Info_Mod_Thorge_TUG_Heiltrank_Health_06);
	};
	if (Npc_HasItems(hero, ItPo_Health_05) >= 1)
	{
		Info_AddChoice	(Info_Mod_Thorge_TUG_Heiltrank, "Potion of Quick Healing", Info_Mod_Thorge_TUG_Heiltrank_Health_05);
	};
};
