...
FUNC VOID Info_Mod_Pepe_Hallo_Info ()
{
	...
	AI_Output (self, hero, "Info_Mod_Pepe_Hallo_02_01"); //Take care of the sheep! And if possible, avoid any trouble.
};
...
{
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_00"); //What are you doing here, what do you want? Are you one of the black shadows too?
	AI_Output(hero, self, "Info_Mod_Pepe_Daemonisch_15_01"); //Now, just calm down. What do you mean, black shadows?
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_02"); //(disturbed) I mean the monsters who packed the mercenaries in the woods at night.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_03"); //They emerged out of nowhere with a kind of... screeching loudly.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_04"); //The mercenaries pulled out their weapons and tried to assault them.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_05"); //But they were all seized and penetrated by them.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_06"); //They shouted, screamed and threw themselves to the ground.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_07"); //One of them even pierced himself with his own gun.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_08"); //l-- I could not move and remained completely motionless while sitting by the fire, watching the terrible spectacle helplessly.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_09"); //Even when everyone was lying on the floor and nobody was moving, I was paralyzed.... for many hours.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_10"); //But then suddenly they all started twitching and groaning.
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_11"); //Nothing could stop me any more and I panicked and took flight. And I've been hiding here ever since.
	...
	AI_Output(self, hero, "Info_Mod_Pepe_Daemonisch_02_14"); //(slightly calmer) Yes... Yes, yes, I will.
...
FUNC VOID Info_Mod_Pepe_Unheil_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Pepe_Unheil_02_01"); //Yes, indeed. This pack of black wolves makes my head spin. The mercenaries had already searched for them in the forest, but couldn't find anything.
	AI_Output(self, hero, "Info_Mod_Pepe_Unheil_02_02"); //And the health problems of my sheep.
	AI_Output(self, hero, "Info_Mod_Pepe_Unheil_02_03"); //Something always seems to startle them when they graze on the edge of the forest at the bend to the hunter Grom.
	AI_Output(self, hero, "Info_Mod_Pepe_Unheil_02_04"); //I could not see anything yet, but once I had the impression that I heard a soft groaning from the rocks above them.
	AI_Output(self, hero, "Info_Mod_Pepe_Unheil_02_05"); //Hmm, otherwise it seemed to me as if I had seen figures go into the forest a few times in the evening. Very creepy.
};
...
{
	AI_Output(self, hero, "Info_Mod_Pepe_Hexen_02_00"); //These dreadful beasts have killed my entire herd, and I should have been killed by a hair's breadth.
	AI_Output(self, hero, "Info_Mod_Pepe_Hexen_02_01"); //How am I supposed to explain that to Onar? Where is Innos' blessing when you need it?!
};
