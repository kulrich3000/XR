...
FUNC VOID Info_Mod_Valentine_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_Hi_12_01"); //Jestem Walentynem, siostra Valentino.
};
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_Kapitel2_12_00"); //Co Pan tutaj robi?
...
FUNC VOID Info_Mod_Valentine_WoValentino_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_12_01"); //Czy nie chcesz jedynego Kanthara?
...
FUNC VOID Info_Mod_Valentine_WoValentino_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_E_12_01"); //ocalic Valentino? Czy? Samotny?
...
FUNC VOID Info_Mod_Valentine_WoValentino_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_B_12_01"); //W swoim zadaniu Canthar opisal czlowieka, którego opis odnosi sie do Ciebie.
...
FUNC VOID Info_Mod_Valentine_WoValentino_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_A_12_01"); //Czego ode mnie chcesz?
...
FUNC VOID Info_Mod_Valentine_WoValentino_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_D_12_01"); //Aha.... Wszystko dobrze, czego chcesz?
...
FUNC VOID Info_Mod_Valentine_WoValentino_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_C_12_01"); //Co robisz? Wróc na pewno.
...
FUNC VOID Info_Mod_Valentine_WoValentino_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_G_12_01"); //(srebrny) Na wysokosci latarni morskiej firmy Jack. Zycze powodzenia.
...
FUNC VOID Info_Mod_Valentine_WoValentino_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_F_12_01"); //Canthar chce dostac na ciebie rece, a ty chcesz biec do niego sam?
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_F_12_02"); //Nie, nie wolno sie ujawniac jego hejmerom. Pójde z Toba.
...
FUNC VOID Info_Mod_Valentine_WoValentino_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_I_12_01"); //(srebrny) Wszystkie prawa. Na wysokosci latarni morskiej Jacka. Zycze powodzenia.
...
FUNC VOID Info_Mod_Valentine_WoValentino_H()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_WoValentino_H_12_01"); //Mam juz plan...... Podazam za mna, zabiore cie do obozu uprowadzajacych.
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_FirstStop_12_00"); //Pierwsze dwa z tych gangów przestepczych juz istnieja.
	AI_Output(self, hero, "Info_Mod_Valentine_FirstStop_12_01"); //Wydaje mi sie, ze jestem nowicjuszem, nie wygladaja jak powazni przeciwnicy.
	AI_Output(self, hero, "Info_Mod_Valentine_FirstStop_12_02"); //Mysle, ze mozna je latwo wyjac. Po prostu upewnij sie, ze nie dzwonia do kopii zapasowej.
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_FirstStop_Fertig_12_00"); //To dobrze! Ale trudna czesc jeszcze nie nadeszla. Sledz mnie!
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_SecondStop_12_00"); //(który caly czas sie pogarsza) Psst! Sa tam wlasnie.
	AI_Output(self, hero, "Info_Mod_Valentine_SecondStop_12_01"); //Teraz do mojego planu: Stoisz tutaj i chodzcie do obozu i szpieguje strazników.
	AI_Output(self, hero, "Info_Mod_Valentine_SecondStop_12_02"); //Moze mozna je w jakis sposób oddzielic lub przemknac obok nich.
	AI_Output(hero, self, "Info_Mod_Valentine_SecondStop_15_03"); //Dlaczego nie powinienem tego robic?
	AI_Output(self, hero, "Info_Mod_Valentine_SecondStop_12_04"); //Bo oni szukaja Ciebie, a nie mnie. Gdy jestem odkryta, nadal moge robic niewinne rzeczy.
	AI_Output(self, hero, "Info_Mod_Valentine_SecondStop_12_05"); //Ale mysle, ze najlepiej by bylo, gdybys mi powiedzial, co mam zrobic. To moje pierwsze tego typu przedsiewziecie!
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_Spy01_Fertig_12_00"); //Trzech mezczyzn stoi wokól namiotu, a w namiocie pojawiaja sie trzy cienie; Jednym z nich bedzie Valentino.
	AI_Output(self, hero, "Info_Mod_Valentine_Spy01_Fertig_12_01"); //Co mam teraz zrobic?
...
FUNC VOID Info_Mod_Valentine_Spy02_Fertig_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Spy02_Fertig_12_00"); //Jeden z strazników zatrzymuje sie zawsze na miejscu i nadal pije piwo.
	};
	if (!Npc_IsDead(Mod_7030_OUT_Entfuehrer_NW))
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Spy02_Fertig_12_01"); //Jeden z nich wydaje sie miec slaby pecherz, co godzine opuszcza obóz, aby sie odciazyc.
	};
	if (!Npc_IsDead(Mod_7031_OUT_Entfuehrer_NW))
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Spy02_Fertig_12_02"); //Jeden z nich patroluje przez obóz, ale nie wyglada na bardzo silny.
	};
};
...
FUNC VOID Info_Mod_Valentine_Kill01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Valentine_Kill01_12_01"); //Co dokladnie powinienem wymieszac?
	AI_Output(self, hero, "Info_Mod_Valentine_Kill01_12_02"); //Jesli masz dziesiec niebieskich piosenek, zasypia z przedawkowania.
	AI_Output(self, hero, "Info_Mod_Valentine_Kill01_12_03"); //Jesli masz porcje trucizny, on odetrze sie co najmniej na dlugi czas.
	AI_Output(self, hero, "Info_Mod_Valentine_Kill01_12_04"); //Jestem pewien, ze mógl umrzec z trzech czesci trucizny.
...
FUNC VOID Info_Mod_Valentine_Kill01_Fertig_Info()
{
	...
	|| (Npc_HasItems(self, ItPo_Mischgift) >= 1)
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Kill01_Fertig_12_00"); //Nigdy wiecej nie powinien wstac.
	...
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Kill01_Fertig_12_01"); //Nie wróci tak szybko.
	...
	{
		AI_Output(self, hero, "Info_Mod_Valentine_Kill01_Fertig_12_02"); //Najpierw wezmie troche drzemki.
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_Kill02_Fertig_12_00"); //Nie wstanie tak szybko. Mniej sie martwic.
};
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_Kill03_Fertig_12_00"); //Dobrze wykonane. Co dalej?
};
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_AllKills_Fertig_12_00"); //Dobrze! Nie spodziewalem sie, ze pójdziemy tak daleko.
	AI_Output(self, hero, "Info_Mod_Valentine_AllKills_Fertig_12_01"); //Teraz musimy tylko zabic dwóch przestepców w namiocie, nie szkodzac Valentino.
...
{
	AI_Output(self, hero, "Info_Mod_Valentine_ValentinoFrei_12_00"); //Nie sadzilem, zeby bylo tak latwo.
	AI_Output(hero, self, "Info_Mod_Valentine_ValentinoFrei_15_01"); //Nie bylo to tez latwe.
	AI_Output(self, hero, "Info_Mod_Valentine_ValentinoFrei_12_02"); //Jednakze. Uwazam to za niezwykle ekscytujace.
