INSTANCE Info_Mod_Morgahard_NW_Hi (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "Czy móglbys cos dla nas zorganizowac?";
};
...
{
	AI_Output(hero, self, "Info_Mod_Morgahard_NW_Hi_15_00"); //Czy móglbys cos dla nas zorganizowac?
	AI_Output(self, hero, "Info_Mod_Morgahard_NW_Hi_31_01"); //Tak, w porcie dostalem magazyn. Chodz, moge ci pokazac.
...
{
	AI_Output(self, hero, "Info_Mod_Morgahard_NW_AtLagerhaus_31_00"); //Whistler wyslal tutaj swoich ludzi.
	AI_Output(hero, self, "Info_Mod_Morgahard_NW_AtLagerhaus_15_01"); //A co mam teraz zrobic?
	AI_Output(self, hero, "Info_Mod_Morgahard_NW_AtLagerhaus_31_02"); //Zapytaj Whistlera, ze biegnie cala rzecz.
