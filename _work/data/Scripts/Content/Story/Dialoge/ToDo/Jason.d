...
{
	AI_Output(hero, self, "Info_Mod_Jason_Aabid_15_00"); //I came for Aabid...
	AI_Output(self, hero, "Info_Mod_Jason_Aabid_06_01"); //Psssssssssssst!
	AI_Output(hero, self, "Info_Mod_Jason_Aabid_15_02"); //What...?
	AI_Output(self, hero, "Info_Mod_Jason_Aabid_06_03"); //Here it is and now get out of here!

	B_GiveInvItems	(self, hero, ItMi_HerbPaket, 1);

	AI_Output(hero, self, "Info_Mod_Jason_Aabid_15_04"); //Um... Okay.

	B_LogEntry	(TOPIC_MOD_ASS_AABID_PAKET, "Jason was very funny and gave me his package without many words. What's the point?");
