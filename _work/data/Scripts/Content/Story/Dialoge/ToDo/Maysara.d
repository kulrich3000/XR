INSTANCE Info_Mod_Maysara_Hi (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "Witaj. Gdzie moge cos tutaj kupic?";
};
...
{
	AI_Output(hero, self, "Info_Mod_Maysara_Hi_15_00"); //Witaj. Gdzie moge cos tutaj kupic?
	AI_Output(self, hero, "Info_Mod_Maysara_Hi_06_01"); //Oczywiscie ze mna. Tylko najlepsza bron. Moglabym tez cie szkolic.
	AI_Output(hero, self, "Info_Mod_Maysara_Hi_15_02"); //Szkolenia bylyby dobre.
	AI_Output(self, hero, "Info_Mod_Maysara_Hi_06_03"); //Co chcesz praktykowac?
};
...
{
	AI_Output(hero, self, "Info_Mod_Maysara_Lernen_15_00"); //Chce sie uczyc.
...
FUNC VOID Info_Mod_Maysara_Pickpocket_DoIt()
{
	...
	else
	{
		...
		Info_AddChoice	(Info_Mod_Maysara_Pickpocket, DIALOG_PP_BESCHIMPFEN, Info_Mod_Maysara_Pickpocket_Beschimpfen);
		Info_AddChoice	(Info_Mod_Maysara_Pickpocket, DIALOG_PP_BESTECHUNG, Info_Mod_Maysara_Pickpocket_Bestechung);
		Info_AddChoice	(Info_Mod_Maysara_Pickpocket, DIALOG_PP_HERAUSREDEN, Info_Mod_Maysara_Pickpocket_Herausreden);
	};
};

FUNC VOID Info_Mod_Maysara_Pickpocket_Beschimpfen()
{
...
FUNC VOID Info_Mod_Maysara_Pickpocket_Bestechung()
{
...
FUNC VOID Info_Mod_Maysara_Pickpocket_Herausreden()
{
