...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_43_00"); //What? How did you get in here?
...
FUNC VOID Info_Mod_Petunia_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_B_43_01"); //Damn, somebody fucked up that part! But thanks for the tip.
...
FUNC VOID Info_Mod_Petunia_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_A_43_01"); //I'm asking the questions here. I don't think you can afford to be rude, boy.
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_E_43_00"); //Now get out of my way, I'm busy.
...
FUNC VOID Info_Mod_Petunia_Hi_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_D_43_01"); //Settle your doom! And then I'll have tea. I love tea.
...
FUNC VOID Info_Mod_Petunia_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_C_43_01"); //My name doesn't matter, but I think my actions distinguish me.
...
FUNC VOID Info_Mod_Petunia_Hi_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_G_43_01"); //Almost. But that doesn't matter, then you just get out of the way. (giggles)
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_43_00"); //The whole trap. The potion, the subsequent vision and the deposited petal. Simply everything!
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_J_15_01"); //Thanks for the information, I have to go.
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_43_02"); //You don't think I'm just gonna let you go now? You know my plan, don't you?
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_J_15_03"); //That's what I thought...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_43_04"); //That's funny, boy. Men, blow out his lights. (giggles)
...
FUNC VOID Info_Mod_Petunia_Hi_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_F_43_01"); //Oh, yeah? (laughs hysterically) Nobody can stop me now! It's all set!
...
FUNC VOID Info_Mod_Petunia_Hi_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_I_43_01"); //Get him, get him!
...
FUNC VOID Info_Mod_Petunia_Hi_H()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_H_43_01"); //I don't want to talk. Besides, it doesn't work any more, it's too late.
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_H_15_02"); //What's too late?
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_H_43_03"); //It's all set!
...
FUNC VOID Info_Mod_Petunia_Pruefung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_43_01"); //You're not as weak as you look.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_15_02"); //I think it's time you explained to me what's going on here.
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_43_03"); //You know the plan. What else do you want to know?
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_43_00"); //The transforming mages have destroyed my life!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_43_01"); //I was one of them, but I was never treated as a full member. Probably because I'm a woman. Pah!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_43_02"); //Sooner or later I started working against them. It's that simple.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_C_15_03"); //What have they done to you?
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_43_04"); //With the smallest offenses, they have already imposed the highest punishments on me. So unfair!
...
FUNC VOID Info_Mod_Petunia_Pruefung_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_B_43_01"); //My name is Petunia.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_B_15_02"); //Maybe a little more?
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_B_43_03"); //Suit yourself. The whole story.
...
FUNC VOID Info_Mod_Petunia_Pruefung_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_A_43_01"); //Why? I can tell you that!
...
FUNC VOID Info_Mod_Petunia_Pruefung_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_E_43_01"); //Finally someone who understands me!
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_H_43_00"); //What do you think you're doing? I'll pour my heart out to you, and you'll let it trickle away in this miserable soil!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_H_43_01"); //What have I done to you?
...
FUNC VOID Info_Mod_Petunia_Pruefung_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_D_43_01"); //Yeah. I accidentally roasted a herd of sheep or skinned wolves when I was cold. That's gotta be in there!
...
FUNC VOID Info_Mod_Petunia_Pruefung_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_F_43_01"); //Thank you so much, I'll never forget it!
...
FUNC VOID Info_Mod_Petunia_Pruefung_J()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_J_43_01"); //Oh, come on. You straightened it all up, didn't you? You really can't blame me for that.
...
FUNC VOID Info_Mod_Petunia_Pruefung_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_I_43_01"); //What am I supposed to do? You ruined everything. You know the plan.
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_I_43_02"); //Go and do whatever you need to do now.
...
FUNC VOID Info_Mod_Petunia_Pruefung_L()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_L_43_01"); //Do that.
...
FUNC VOID Info_Mod_Petunia_Pruefung_K()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_K_43_01"); //If you think this is right....
