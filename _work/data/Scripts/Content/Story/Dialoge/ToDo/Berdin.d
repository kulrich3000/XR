...
FUNC VOID Info_Mod_Berdin_Jagdtalente_Info()
{
	...
	||(PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_FireTongue] == FALSE))
	{
		...
		if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Claws] == FALSE)
		{ 
			Info_AddChoice	(Info_Mod_Berdin_Jagdtalente, B_BuildLearnString ("chop claws",B_GetLearnCostTalent (hero,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Claws)),  Info_Mod_Berdin_Jagdtalente_Claws);
		};
		if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_FireTongue] == FALSE)
		{ 
			Info_AddChoice	(Info_Mod_Berdin_Jagdtalente, B_BuildLearnString ("Fire Tongue", B_GetLearnCostTalent (hero, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FireTongue)),  Info_Mod_Berdin_Jagdtalente_FireTongue);
		};
	}
	else
	{
...
FUNC VOID Info_Mod_Berdin_Jagdtalente_Claws()
{
	...
	{
		AI_Output			(self, hero, "Info_Mod_Berdin_Jagdtalente_Claws_07_00"); //Animals don't like to give up their claws. You have to place your knife very precisely.
		AI_Output			(self, hero, "Info_Mod_Berdin_Jagdtalente_Claws_07_01"); //Your hands should be slightly crossed. Then you separate the claw with a powerful tug.
		AI_Output			(self, hero, "Info_Mod_Berdin_Jagdtalente_Claws_07_02"); //Merchants are always eager to be paid in claws.
	};
