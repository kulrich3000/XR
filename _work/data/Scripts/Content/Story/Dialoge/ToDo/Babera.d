...
{
	AI_Output(hero, self, "Info_Mod_Babera_Unheil_15_00"); //Witaj piekne dziecko.
	AI_Output(self, hero, "Info_Mod_Babera_Unheil_43_01"); //W moim domu nie mam platków lukrecji. Szczególnie teraz.
	AI_Output(self, hero, "Info_Mod_Babera_Unheil_43_02"); //Ahh, te cholera bóle z powrotem znacznie sie pogorszyly. Móglbym wzniesc sciany.....

	B_LogEntry	(TOPIC_MOD_ADANOS_UNHEIL, "Babera cierpi od jakiegos czasu na ciezkie bóle pleców.");
