...
FUNC VOID Info_Mod_Seraphia_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Seraphia_Hi_43_01"); //What do you want from me? Go away, leave me alone.
};
...
FUNC VOID Info_Mod_Seraphia_Lagermusik_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Seraphia_Lagermusik_43_01"); //Why not? Thorus is just showing me his cold shoulder, this uptight guy, so I've got nothing to do.
	AI_Output(self, hero, "Info_Mod_Seraphia_Lagermusik_43_02"); //And a little music is a welcome change.
