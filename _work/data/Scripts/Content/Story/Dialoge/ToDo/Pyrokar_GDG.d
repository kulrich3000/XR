...
{
	AI_Output(hero, self, "Info_Mod_Pyrokar_GDG_Lernen_15_00"); //Teach me something.
...
FUNC VOID Info_Mod_Pyrokar_GDG_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Pyrokar_GDG_Lernen_BACK_05_01"); //Your magic skills are so good now, I can't teach you anything.
	};
	Info_ClearChoices	(Info_Mod_Pyrokar_GDG_Lernen);
};
