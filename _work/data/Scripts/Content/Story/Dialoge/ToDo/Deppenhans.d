...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_00"); //Hej, czy mozesz dac mi reke? Mam klopoty z klatka piersiowa.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_01"); //Nie moge uzyskac oszczednosci zyciowych.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_02"); //Klopot z zamkiem?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_03"); //Nah, potrzebuje kolejnej na pokrywie.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_04"); //Jak?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_05"); //No cóz, ponownie skacze i ugryza jak szalone.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_06"); //Tym razem bylo to naprawde wspaniale, wiec nie moge jej karcic na wlasna reke.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_07"); //Jaki to nonsens?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_08"); //Tak, masz racje, to nonsens, co ona robi znowu.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_09"); //Nie moze jednak zachowywac sie jak drzewo. Przechodzimy przez pole i przewracamy wszystko do góry nogami.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_10"); //W pewnym momencie wzialem siekiere i podjalem ja na klatke piersiowa.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_11"); //Ale zachowanie nie jest jeszcze lepsze.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_13"); //Tak, to dziwne, dobre.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_14"); //Jesli pomozesz mi ja uspokoic, dam ci troche oszczednosci.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_01_15"); //Jestem gonna wejsc do srodka i sprawdzic ja.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe2_01_00"); //Tam, spojrzec. Od dawna nie byla tak paskudna.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe2_01_01"); //Prosze, tesknic za jednym, nie zapomni o tym tak szybko.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_01_00"); //Wspaniale, to zrobiles.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_01_01"); //I tutaj, jak obiecalem, czesc moich oszczednosci.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_01_02"); //Tu zajmiemy polowe. Wykonales naprawde dobra prace i naprawde zarobiles.

	B_GiveInvItems	(self, hero, ItPl_Beet, 6);

	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe3_15_03"); //Och, wspaniale, rzepy.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_01_04"); //Tak, ciesze sie, ze podoba ci sie.
...
FUNC VOID Info_Mod_Deppenhans_Kaninchenplage_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_01"); //Tak, smieszne, puszyste, puszyste, puszyste króliczki na calym miejscu. To dziwne, ze od tego czasu stopniowo znikaja moje warzywa. Musi byc tu gdzies zlodziejem....
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_03"); //Nah, po prostu tak sie pojawiaja.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_05"); //Skorzystajcie? Hej, dostalem cos dla Ciebie.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Kaninchenplage_15_06"); //Chetni) Tak! Wskazówki?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_07"); //Nah, mialem swietny pomysl, zeby zrobic za duzy grzebien na drewnianym stylu. O tym wlasnie dowiedzialem sie.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_09"); //Ale mozna równiez zapytac tego czarnego goscia, który zawsze chodzi po nim, robiac zabawne swiatlo reka.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_01_10"); //Zwlaszcza, ze pojawia sie wtedy duzo królików...... On równiez musial to widziec.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_NovizeWeg_01_00"); //Hej, moje warzywa przestaly znikac.
	AI_Output(self, hero, "Info_Mod_Deppenhans_NovizeWeg_01_01"); //Cokolwiek zrobiles, wez te dynie jako podziekowanie.
...
FUNC VOID Info_Mod_Deppenhans_WoherBaum_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_WoherBaum_01_01"); //Sadzilem ja obok pola..... z sadzonkami od wilgotnego bagna.
	AI_Output(self, hero, "Info_Mod_Deppenhans_WoherBaum_01_02"); //Ale najwyrazniej byly one zle wychowane, sposób, w jaki sie zachowywal. Widziales go sam.
};
...
FUNC VOID Info_Mod_Deppenhans_Landarbeit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_01"); //To cudownie piekne. Wiem, jak to dziala.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_02"); //Nasiona i bulwy wpadaja do gleby na polu, a nastepnie rosna.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_03"); //Mój szef, Erhard, robi to wszystko zle.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_04"); //Na scianie domu, posród wszystkich belek siana i beczek zasypal smiesznie zólte i niebieskie lsniace klody.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_05"); //Myslalem, ze nic przyzwoitego z nich nie wyrosnie.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_01_06"); //Ale sa tez dziwni ludzie.
};
