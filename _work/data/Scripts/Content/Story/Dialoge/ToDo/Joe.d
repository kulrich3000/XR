...
FUNC VOID Info_Mod_Joe_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Joe_Hi_07_01"); //I'm Joe.
};
...
FUNC VOID Info_Mod_Joe_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Joe_Flugblaetter_07_01"); //Oh, thank you. Thank you. Let's see....

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Joe_Flugblaetter_07_02"); //Ah yes. Maybe I'll stop by Matteo's.
...
FUNC VOID Info_Mod_Joe_Diego_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Joe_Diego_07_01"); //All right, I'll be on my way right away.
...
{
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_00"); //Greetings. What's the news from out there?
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_01"); //I heard that there was some misfortune on the pasture plateau....
	...
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_03"); //I felt the anxiety and concern in our ranks.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_04"); //How I would like to do my part in this, too... but as a simple novice such tasks are unfortunately not yet open to me.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_05"); //And the test that was imposed on me for a quick admission to the Water Warriors paralyzes me with fear that I might fail.
	AI_Output(hero, self, "Info_Mod_Joe_Wassersnapper_15_06"); //What's this about?
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_07"); //Oh, my job is to guide the snappers of the water safely to Relendel.
	...
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_09"); //No, that's not the point. They are in themselves peaceful animals that would attack me all the less since I serve their Creator.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_10"); //Every 10 years at this time these holy creatures appear on the lake between excavation site and black troll.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_11"); //They stay there for some time, give the place its blessing aura and then set off on their way to the lake in Relendel.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_12"); //And I was given the task of escorting them safely in part.
	AI_Output(hero, self, "Info_Mod_Joe_Wassersnapper_15_13"); //And what's the problem with that?
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_14"); //Now, after this test was imposed on me, rumours came to my ears that poachers are to hang around here.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_15"); //This is confirmed by sightings of wild animals shot by the rangers, and a trader in the city is said to have recently acquired skins of rare and hard-to-hunt animals.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_16"); //Now I'm worried that something might happen to the snapper on the way and I won't be able to protect them.
	...
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_18"); //Really?! That would do me an invaluable service.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper_07_19"); //Now I can calmly go to the lake and wait for you there. Thank you very much.
...
{
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper2_07_00"); //Ahh, there you are.
	AI_Output(hero, self, "Info_Mod_Joe_Wassersnapper2_15_01"); //What's it look like?
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper2_07_02"); //Everything's been quiet so far. Maybe everything will work out without complications after all.
...
FUNC VOID Info_Mod_Joe_Wassersnapper3_Info()
{
	...
	&& (Npc_IsDead(Wassersnapper_Joe_03)) {
		AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper3_07_00"); //What wrong-doers. Now everything is lost.
	...
	|| (Npc_IsDead(Wassersnapper_Joe_02))
	|| (Npc_IsDead(Wassersnapper_Joe_03)) {
		AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper3_07_02"); //What wrong-doers. Only thanks to your support, worse things have been averted.
		...
		AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper3_07_04"); //What wrong-doers. Thanks to your support, we were able to save all the snappers.
...
{
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_00"); //Here we are. We actually did it. Without your help, it would never have been possible. I don't know how to thank you.
	...
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_03"); //l-- it seems to me that the snappers have given us part of their aura.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_04"); //I feel how the knowledge and the magical power within me have grown.
	AI_Output(hero, self, "Info_Mod_Joe_Wassersnapper4_15_05"); //They've disappeared.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_06"); //Yes, to another place to which they bless Adano.... until ten years from now, she'll be heading back here.
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_07"); //And this is mainly thanks to you. Well, here's my thanks to you.
	...
	AI_Output(self, hero, "Info_Mod_Joe_Wassersnapper4_07_08"); //I hope you can use it, even if it does not reflect the true value of your service, of course.
