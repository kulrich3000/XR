...
{
	AI_Output(hero, self, "Info_Mod_HofstaatHaendler02_Hi_15_00"); //Czy to jest Twoje miejsce?
	AI_Output(self, hero, "Info_Mod_HofstaatHaendler02_Hi_01_01"); //Tak.
	AI_Output(hero, self, "Info_Mod_HofstaatHaendler02_Hi_15_02"); //Daj mi ja.
	...
	{
		AI_Output(self, hero, "Info_Mod_HofstaatHaendler02_Hi_01_04"); //Nie, raczej nie.
	};
};
