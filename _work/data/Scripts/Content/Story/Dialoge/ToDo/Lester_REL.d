...
FUNC VOID Info_Mod_Lester_REL_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_01"); //Have you ever been high on that truck before? I'm telling you, this is an experience you won't soon forget.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_02"); //I think I'm gonna go right back and forth again.
	AI_Output(hero, self, "Info_Mod_Lester_REL_Hi_15_03"); //Fine and well, but why are you here?
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_04"); //Have you ever heard of Khorata?
	AI_Output(hero, self, "Info_Mod_Lester_REL_Hi_15_05"); //Not really.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_06"); //From all I've heard, the city is close to paradise.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_07"); //Anyone who wants to is allowed in and can lead his or her comfortable life.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_08"); //The city council is made up of a single man who only makes sure that the chaos does not get out of hand.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_09"); //In the nearby farmhouse, something is gained that is called a giver of joy and is said to be much more effective than bogweed.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Hi_41_10"); //I can hardly imagine that, but trying it doesn't hurt.
};
...
FUNC VOID Info_Mod_Lester_REL_VonWem_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_VonWem_41_01"); //I picked it up on the marketplace in Khorinis. I think Baltram told me about it.
	AI_Output(self, hero, "Info_Mod_Lester_REL_VonWem_41_02"); //However, the level of awareness of Khorata is surprisingly low.
	AI_Output(self, hero, "Info_Mod_Lester_REL_VonWem_41_03"); //No one seems to have the need to brag about the benefits. That's fine by me.
};
...
FUNC VOID Info_Mod_Lester_REL_Zusammen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_Zusammen_41_01"); //Another time. I really want to do some trips with this truck first...
};
...
FUNC VOID Info_Mod_Lester_REL_Gefallen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_Gefallen_41_01"); //The giver of joy really kills you. (laughs) Fucking good stuff. But Khorata...
	AI_Output(self, hero, "Info_Mod_Lester_REL_Gefallen_41_02"); //I had thought to find a free city, but Khorata is ruled by resentment and arbitrariness.
	AI_Output(self, hero, "Info_Mod_Lester_REL_Gefallen_41_03"); //The greatest problem in every community is and remains the human being.
};
...
FUNC VOID Info_Mod_Lester_REL_FindeOrt_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_41_01"); //What exactly do you not find?
...
FUNC VOID Info_Mod_Lester_REL_FindeOrt_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_D_41_01"); //(laughs) Usually you're looking for a way to avoid him.
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_D_41_02"); //But I have heard from a trader of the court that a troll is supposed to make the passport there unsafe.
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_D_41_03"); //Do you need my help?
...
FUNC VOID Info_Mod_Lester_REL_FindeOrt_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_C_41_01"); //No problem, the mine is signposted from the city. Want me to go with you?
...
FUNC VOID Info_Mod_Lester_REL_FindeOrt_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_B_41_01"); //The farmer Erhard has often complained that there are bandits near his farm.
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_B_41_02"); //They shouldn't be too difficult to find. Shall we go looking together?
...
FUNC VOID Info_Mod_Lester_REL_FindeOrt_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_A_41_01"); //Yeah, I've heard a lot about Vincent, too.
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_A_41_02"); //He is said to have pitched his tent somewhere west of the big lake in Relendel.
	AI_Output(self, hero, "Info_Mod_Lester_REL_FindeOrt_A_41_03"); //If you want, we can take a look together.
...
{
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtTroll_41_00"); //Well, if that's not a chunk. Are you sure you want to chop it down?
	AI_Output(hero, self, "Info_Mod_Lester_REL_AtTroll_15_01"); //What else have we come all this way for?
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtTroll_41_02"); //All right, then. Two of us, we grab him.
...
{
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtTroll2_41_00"); //That's a wrap.
...
{
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtMine_41_00"); //This is the mine entrance. Have fun in there.
...
{
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtMelvin_41_00"); //There I see a camp with several tents. Those should be the bandits you're looking for.
...
{
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtVincent_41_00"); //Here's the big lake I was talking about. On the opposite side, you should find Vincent.
	AI_Output(self, hero, "Info_Mod_Lester_REL_AtVincent_41_01"); //I'm going back to town now. The running is too much for me.
