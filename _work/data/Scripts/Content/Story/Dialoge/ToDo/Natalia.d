...
FUNC VOID Info_Mod_Natalia_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Natalia_Hi_43_01"); //Jestem Natalia, jedna z pokojówek Cor Cadara.
};
...
FUNC VOID Info_Mod_Natalia_Woher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Natalia_Woher_43_01"); //Zabilem czlowieka, który caly czas mnie nasladuje.
	AI_Output(self, hero, "Info_Mod_Natalia_Woher_43_02"); //Potem zostalem wyslany tutaj do obozu bagiennego i sluzylem Y' Berionowi, a teraz sluze Cor Cadarorowi.
};
