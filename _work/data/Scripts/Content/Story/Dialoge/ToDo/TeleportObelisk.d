...
INSTANCE Info_Mod_TeleportObelisk_ToPatherion (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "od Khorinis do Patherion";
};
...
INSTANCE Info_Mod_TeleportObelisk_FromPatherion (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do klasztoru w Khorinis";
};
...
INSTANCE Info_Mod_TeleportObelisk_OWDemonTower (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do starej wiezy demonów";
};
...
INSTANCE Info_Mod_TeleportObelisk_Oldcamp (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do starego magazynu";
};
...
INSTANCE Info_Mod_TeleportObelisk_Farm (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do wielkiego rolnika";
};
...
INSTANCE Info_Mod_TeleportObelisk_Newcamp (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do nowego magazynu";
};
...
INSTANCE Info_Mod_TeleportObelisk_PassNW (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do przeleczy w Khorinis";
};
...
INSTANCE Info_Mod_TeleportObelisk_RELPass (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do przepustki w Relendel";
};
...
INSTANCE Info_Mod_TeleportObelisk_Sonnenkreis (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do kola slonecznego";
};
...
INSTANCE Info_Mod_TeleportObelisk_Psicamp (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do obozu bagiennego";
};
...
INSTANCE Info_Mod_TeleportObelisk_Beliarfestung (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do twierdzy Beliar";
};
...
INSTANCE Info_Mod_TeleportObelisk_Bergfestung (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do twierdzy górskiej";
};
...
INSTANCE Info_Mod_TeleportObelisk_Seaport (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do miasta portowego";
};
...
INSTANCE Info_Mod_TeleportObelisk_Klosterruine (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "do ruiny klasztoru";
};
