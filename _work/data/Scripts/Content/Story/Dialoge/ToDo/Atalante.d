...
{
	AI_Output(self, hero, "Info_Mod_Atalante_Hi_12_00"); //Rozerwam cie!
	AI_Output(hero, self, "Info_Mod_Atalante_Hi_15_01"); //Relaks, nie chce Ci krzywdzic.
	AI_Output(self, hero, "Info_Mod_Atalante_Hi_12_02"); //(grunty grozace)
};
...
FUNC VOID Info_Mod_Atalante_Bosper_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Atalante_Bosper_12_01"); //Nie chce o tym slyszec! Wyslij go tutaj, a ja zajme sie nim.
	AI_Output(hero, self, "Info_Mod_Atalante_Bosper_15_02"); //On chce ci przebaczyc.
	AI_Output(self, hero, "Info_Mod_Atalante_Bosper_12_03"); //Wybaczcie mi! Na kolanach bedzie czolgal sie i blagal o przebaczenie!
	AI_Output(hero, self, "Info_Mod_Atalante_Bosper_15_04"); //Co Bosper zrobil dla Ciebie?
	AI_Output(self, hero, "Info_Mod_Atalante_Bosper_12_05"); //Przestan dzwonic do tej nazwy! Przynosil mi tylko cierpienie.
	AI_Output(hero, self, "Info_Mod_Atalante_Bosper_15_06"); //Czy nie sadzisz, ze mozesz o tym porozmawiac?
	AI_Output(self, hero, "Info_Mod_Atalante_Bosper_12_07"); //Nie, nie musze juz mówic. Wszystko, czego nie lubie, zostanie zabite i zjedzone.
	AI_Output(self, hero, "Info_Mod_Atalante_Bosper_12_08"); //I nie lubie ciebie, woski czlowiek. Szukasz rzeczy, które nie sa Twoim biznesem!
