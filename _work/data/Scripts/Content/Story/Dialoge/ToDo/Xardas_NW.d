...
FUNC VOID Info_Mod_Xardas_NW_Daemonisch_Info()
{
	...
	else
	{
		if (news) {
			...
			AI_Output(hero, self, "Info_Mod_Xardas_NW_Daemonisch_15_51"); //Na razie nic.
			AI_Output(self, hero, "Info_Mod_Xardas_NW_Daemonisch_14_52"); //Nastepnie wróc na swoja droge.
		};
	};
};
...
FUNC VOID Info_Mod_Xardas_NW_Daemonisch2_Info()
{
	...
	B_LogEntry	(TOPIC_MOD_DAEMONISCH, "Xardas chce, abym pokonal dreczycieli duszy i szukal dalszych wskazówek. Wszakze Urnol ciagle tu wisi. Dal mi wskazówke, ze dreczyciele duszy unikaja swiatla. To pomoze.");
