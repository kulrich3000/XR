...
FUNC VOID Info_Mod_Xardas_NW_Daemonisch_Info()
{
	...
	{
		AI_Output(hero, self, "Info_Mod_Xardas_NW_Daemonisch_15_23"); //I encountered even black shadows in the night that attacked me.
	...
	|| (Mod_HQ_SPGesehen == TRUE)
	{
		...
		|| (Npc_KnowsInfo(hero, Info_Mod_Opolos_Daemonisch))
		{
			...
			AI_Output(hero, self, "Info_Mod_Xardas_NW_Daemonisch_15_34"); //Soll ich jetzt etwa zu jedem hinrennen und ihn zu einem Schluck Klosterwein oder "Healing of Possession" überreden?
		...
		else
		{
			...
			AI_Output(self, hero, "Info_Mod_Xardas_NW_Daemonisch_14_48"); //It's imperative that you try to find out more about restaurants and settlements in the area.
	...
	else
	{
		if (news) {
			...
			AI_Output(hero, self, "Info_Mod_Xardas_NW_Daemonisch_15_51"); //Nothing yet.
			AI_Output(self, hero, "Info_Mod_Xardas_NW_Daemonisch_14_52"); //Then get back on your way.
		};
	};
};
...
FUNC VOID Info_Mod_Xardas_NW_Daemonisch2_Info()
{
	...
	B_LogEntry	(TOPIC_MOD_DAEMONISCH, "Xardas wants me to defeat the soul tormentors and look for more clues. After all, Urnol is still hanging around here somewhere. He gave me the hint that the soul tormentors were avoiding the light. That'll help.");
...
func void Info_Mod_Xardas_PETZMASTER_PayLater()
{
	...
	AI_Output (self, hero, "Info_Mod_Xardas_PETZMASTER_PayLater_14_01"); //Then see to it that you acquire the gold as quickly as possible
	AI_Output (self, hero, "Info_Mod_Xardas_PETZMASTER_PayLater_14_02"); //And I'm warning you: if you add to your guilt, things will get worse for you.
