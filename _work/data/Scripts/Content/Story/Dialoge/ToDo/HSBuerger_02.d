...
{
	AI_Output(hero, self, "Info_Mod_HSBuerger_02_Orakel_15_00"); //Szukam Oracle.
	AI_Output(self, hero, "Info_Mod_HSBuerger_02_Orakel_06_01"); //Oracle? Nie ma takiej rzeczy. Powinienes zapytac królewskiego wyrocznia, gdzie mozna go znalezc, to jest calkiem madre.
	AI_Output(hero, self, "Info_Mod_HSBuerger_02_Orakel_15_02"); //A gdzie jest królewski wyrocznia?
	AI_Output(self, hero, "Info_Mod_HSBuerger_02_Orakel_06_03"); //Bedziesz musial umówic sie na wizyte u króla.
};
...
INSTANCE Info_Mod_HSBuerger_02_Teleport (C_INFO)
{
	...
	permanent	= 1;
	important	= 0;
	description	= "Szukam krótkiej drogi przez bagno, znasz ja?";
};
...
{
	AI_Output(hero, self, "Info_Mod_HSBuerger_02_Teleport_15_00"); //Szukam krótkiej drogi przez bagno, znasz ja?
	AI_Output(self, hero, "Info_Mod_HSBuerger_02_Teleport_06_01"); //Zostaw mnie sam na sam z psycho!
};
