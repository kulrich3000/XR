...
{
	AI_Output			(other, self, "DIA_Mil_332_Stadtwache_PERM_15_00"); //Jaki jest wynik?
	AI_Output			(self, other, "DIA_Mil_332_Stadtwache_PERM_04_01"); //Nadal jezdzic! Jestem na dyzurze!
	AI_StopProcessInfos (self);
};
