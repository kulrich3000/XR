...
FUNC VOID Info_Mod_Diana_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Diana_Hi_43_01"); //I hope so, but I'm starting to worry.
	AI_Output(hero, self, "Info_Mod_Diana_Hi_15_02"); //You miss someone?
	AI_Output(self, hero, "Info_Mod_Diana_Hi_43_03"); //Our daughter left for mushroom picking this morning, but she hasn't returned yet.
	AI_Output(self, hero, "Info_Mod_Diana_Hi_43_04"); //Not that she's not old enough to take care of herself, but it doesn't leave me alone not to hear from her.
	AI_Output(self, hero, "Info_Mod_Diana_Hi_43_05"); //If you run into her, please let her know that she could slowly make her way back.
	AI_Output(self, hero, "Info_Mod_Diana_Hi_43_06"); //You can recognize them by their idiosyncratic red cap.
...
FUNC VOID Info_Mod_Diana_Eintopf_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Diana_Eintopf_43_01"); //Look at the well-fed boys in the yard! They're literally tearing the meatbug ragout out of my hands.
	AI_Output(self, hero, "Info_Mod_Diana_Eintopf_43_02"); //My secret is little pieces of melon.
