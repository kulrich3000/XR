...
{
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_00"); //I have to see the secretary.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_01"); //You're wrong about me, I'm the Minister of Equilibrium.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_02"); //I know, but the hunter told me you could help me get to the secretary of drugs.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_03"); //I guess he's right. But only if you can tell me the code word.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_04"); //Let me guess.... Bananarama?
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_05"); //Right. Come on, let's go.
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_00"); //So, man, you just need to calm down.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_01"); //Okay.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_02"); //Just feel the wind flow through you and become one with you.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_03"); //All right, all right.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_04"); //You have to be firm like the stone and yet flexible like the reed, you know?
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_05"); //More or less.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_06"); //That's good news. Then take your target into your eyes and...
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_07"); //Go over the rope?
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_08"); //TO THE SKY DOES NOT WANT TO BULL! You'll break your neck.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_09"); //Here's the key to the ladder. The door is at the foot of the other hill.

	B_GiveInvItems	(self, hero, ItKe_HSDM, 1);

	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_10"); //What?! Then why did we go up here again?!
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_11"); //I like it up here.
