...
{
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_00"); //Musze zobaczyc sekretarza.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_01"); //Nie macie sie co do mnie, jestem ministrem równowagi.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_02"); //Wiem, ale mysliwy powiedzial mi, ze mozesz pomóc mi dostac sie do sekretarza narkotyków.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_03"); //Mysle, ze ma racje. Ale tylko wtedy, gdy mozesz mi podac kod.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Hi_15_04"); //Pozwólcie mi sie zgadnac..... Bananarama?
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Hi_01_05"); //Prawo. Chodzcie dalej, odejdzmy.
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_00"); //Wiec czlowiek, trzeba tylko sie uspokoic.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_01"); //Okay.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_02"); //Wystarczy poczuc, jak wiatr przeplywa przez ciebie i stac sie jednym z toba.
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_03"); //Wszystkie sluszne, wszystkie sluszne.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_04"); //Musisz byc twardy jak kamien i jednoczesnie elastyczny jak trzcina, wiesz?
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_05"); //Wiecej lub mniej.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_06"); //To dobra wiadomosc. Nastepnie wez cel do oczu i....
	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_07"); //Przejdz przez line?
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_08"); //NA NIEBO NIEBO NIE CHCE BYKU! Zerwiesz szyje.
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_09"); //Oto klucz do drabiny. Drzwi znajduja sie u podnóza drugiego wzniesienia.

	B_GiveInvItems	(self, hero, ItKe_HSDM, 1);

	AI_Output(hero, self, "Info_Mod_HofstaatGGMinister_Drogenminister_15_10"); //Co? Wiec dlaczego weszlismy tu ponownie?
	AI_Output(self, hero, "Info_Mod_HofstaatGGMinister_Drogenminister_01_11"); //Lubie to tutaj.
