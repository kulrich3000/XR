...
FUNC VOID Info_Mod_HSBuerger_01_Orakel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HSBuerger_01_Orakel_09_01"); //Oracle? Nie ma takiej rzeczy. Powinienes zapytac królewskiego wyrocznia, gdzie mozna go znalezc, to jest calkiem madre.
	AI_Output(hero, self, "Info_Mod_HSBuerger_01_Orakel_15_02"); //A gdzie jest królewski wyrocznia?
	AI_Output(self, hero, "Info_Mod_HSBuerger_01_Orakel_09_03"); //Bedziesz musial umówic sie na wizyte u króla.
};
...
{
	AI_Output(hero, self, "Info_Mod_HSBuerger_01_Teleport_15_00"); //Szukam krótkiej drogi przez bagno, znasz ja?
