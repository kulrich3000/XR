...
{
	AI_Output(hero, self, "Info_Mod_Thorge_KommMit_15_00"); //Come with me.
	AI_Output(self, hero, "Info_Mod_Thorge_KommMit_13_01"); //All right, all right.
...
FUNC VOID Info_Mod_Thorge_Pickpocket_DoIt()
{
	...
	else
	{
		...
		Info_AddChoice	(Info_Mod_Thorge_Pickpocket, DIALOG_PP_BESCHIMPFEN, Info_Mod_Thorge_Pickpocket_Beschimpfen);
		Info_AddChoice	(Info_Mod_Thorge_Pickpocket, DIALOG_PP_BESTECHUNG, Info_Mod_Thorge_Pickpocket_Bestechung);
		Info_AddChoice	(Info_Mod_Thorge_Pickpocket, DIALOG_PP_HERAUSREDEN, Info_Mod_Thorge_Pickpocket_Herausreden);
	};
};

FUNC VOID Info_Mod_Thorge_Pickpocket_Beschimpfen()
{
...
FUNC VOID Info_Mod_Thorge_Pickpocket_Bestechung()
{
...
FUNC VOID Info_Mod_Thorge_Pickpocket_Herausreden()
{
