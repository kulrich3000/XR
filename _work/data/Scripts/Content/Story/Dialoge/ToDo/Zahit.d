...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Kill_07_00"); //You shouldn't have come here!
...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_00"); //What are you doing here? Did Amir bring you here?
	AI_Output(hero, self, "Info_Mod_Zahit_Amir_15_01"); //Yeah, he did.
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_02"); //What's he imagining?
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_03"); //Just because he's in town doesn't mean that he can ignore our rules and drag strangers here.
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_05"); //Aha, you helped Amir. So my friend, what did you have to do? Kill meat bugs?
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_07"); //You as a weakling have such talents? That speaks for you, I must say.
	AI_Output(hero, self, "Info_Mod_Zahit_Amir_15_08"); //What about now, can I join you?
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_09"); //Don't be in a hurry, my friend. You did convince Amir, but to become an Assassin at all, you have to do a lot of things.
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_10"); //There's a long way to go, my boy.
};
...
FUNC VOID Info_Mod_Zahit_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_01"); //Well, in order to become an assassin, it takes a very important thing.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_02"); //Which is?
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_03"); //Trust.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_04"); //Uh-huh. What next?
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_05"); //In order to become a member of the camp, you first have to earn the trust of the lower Assassin members, the so-called crooks.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_06"); //Your neighborhood is behind this door.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_07"); //Behind it comes the quarter of the warriors and after that the magician and the High Council.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_08"); //In order to be able to enter the last two quarters at all, you have to be a crook.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_09"); //If you really embrace this path, which will be very difficult, then you have the possibility to join the magicians or the warriors.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_10"); //But first you will have to undergo difficult tests.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_11"); //That sounds very motivating.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_12"); //(strength) Be glad that you get the chance to join us at all.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_13"); //Few outsiders have received this honor so far, so keep your naughty mouth shut.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_14"); //If you meet the magicians or warriors like that, they will teach you manners.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_15"); //I'll keep it in mind.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_16"); //Good. So you can enter the first quarter now.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_17"); //Talk to the people and complete their tasks to be accepted.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_18"); //When you've convinced everyone, you'll get a chance to talk to the magicians and warriors.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_19"); //The leader is Chief Crown Shakir. Talk to him for more information.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_20"); //Thank you, I will.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_21"); //And don't make any trouble for us to understand each other!
...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Assassinengold_07_00"); //Here you are at last. Everybody's waiting for you. Go for it.
	AI_Output(hero, self, "Info_Mod_Zahit_Assassinengold_15_01"); //A little respect for a magician, lad!
	AI_Output(self, hero, "Info_Mod_Zahit_Assassinengold_07_02"); //Sorry about that. Not long ago, you were nothing.
...
FUNC VOID Info_Mod_Zahit_PosWechsel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_PosWechsel_07_01"); //Replaced Amir as an observer.
	AI_Output(hero, self, "Info_Mod_Zahit_PosWechsel_15_02"); //And what's so important?
	AI_Output(self, hero, "Info_Mod_Zahit_PosWechsel_07_03"); //You must go to Mustafa immediately. Seems important.
...
FUNC VOID Info_Mod_Zahit_Gefunden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_01"); //What do you mean?
	AI_Output(hero, self, "Info_Mod_Zahit_Gefunden_15_02"); //I don't think nobody has ever explored this cave before.
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_03"); //This has rarely happened so far and those who came here could not tell anyone else.
	AI_Output(hero, self, "Info_Mod_Zahit_Gefunden_15_04"); //So you killed her?
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_05"); //Yeah, we don't want to move the paladins and militia here.
...
FUNC VOID Info_Mod_Zahit_Hergekommen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_01"); //As we all know, there is total chaos on the mainland.
	AI_Output(hero, self, "Info_Mod_Zahit_Hergekommen_15_02"); //Yeah, I heard about that, too.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_03"); //We couldn't stand it there any more. Therefore, our wise leaders decided to escape this madness.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_04"); //By means of a powerful teleport spell, the mages of ours have managed to telepolize us all to Khorinis.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_05"); //We searched for a hiding place and found this cave here unused.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_06"); //We decided to stay here and since then this is our camp.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_07"); //But we want to try to expand our influence in the near future.
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_09"); //Don't mention it.
};
