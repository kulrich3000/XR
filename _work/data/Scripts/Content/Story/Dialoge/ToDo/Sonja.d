...
FUNC VOID Info_Mod_Sonja_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sonja_Hi_43_01"); //Well, what does it look like? Is there any way I can get you...? to satisfy you?
};
...
FUNC VOID Info_Mod_Sonja_News_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_01"); //In the arms of an emotional woman, every silent man becomes a talkative boy.
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_02"); //from Matteo's marriage to Constantino's secret tastes.
	AI_Output(hero, self, "Info_Mod_Sonja_News_15_03"); //And what do you hear from your customers?
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_04"); //I hear a lot of uncertainty and despair about the fall of the barrier.
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_05"); //Some of my clients fear that the "wild and rude barbarians" from the colony are coming up against their possessions.
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_06"); //On the other hand, many complain about the strict control by the paladins.
	AI_Output(self, hero, "Info_Mod_Sonja_News_43_07"); //But most of them just squawk in my ear how good I would be. (laughs)
};
...
FUNC VOID Info_Mod_Sonja_Sex_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sonja_Sex_43_01"); //I'm yours all night for 100 gold pieces, sweetie. A whole exciting night.
...
{
	AI_Output(self, hero, "Info_Mod_Sonja_SexLos_43_00"); //Relax, sweetie.
...
{
	AI_Output(self, hero, "Info_Mod_Sonja_Bartok_43_00"); //Hey you! I saw you get beat up by Bartok. Maybe I can help you.
	AI_Output(hero, self, "Info_Mod_Sonja_Bartok_15_01"); //How will you help me?
	AI_Output(self, hero, "Info_Mod_Sonja_Bartok_43_02"); //Well, I could go to Bartok's and spend some time with him and make sure he listens to you.
	AI_Output(hero, self, "Info_Mod_Sonja_Bartok_15_03"); //And what am I supposed to do about it?
	AI_Output(self, hero, "Info_Mod_Sonja_Bartok_43_04"); //Nothing yet, but I'll get back to you.
...
{
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_43_00"); //Remember your little promise, sweetheart?
	AI_Output(hero, self, "Info_Mod_Sonja_Freier_15_01"); //I owe you another favor.
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_43_02"); //Now is the time for me to come back to that.
...
FUNC VOID Info_Mod_Sonja_Freier_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_B_43_01"); //I was hoping I could count on you.
...
FUNC VOID Info_Mod_Sonja_Freier_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_01"); //One of my most frequent clients hasn't shown up in a while.
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_02"); //I haven't heard anything about anything happening to him, so there must be other reasons why he's not visiting me anymore.
	AI_Output(hero, self, "Info_Mod_Sonja_Freier_A_15_03"); //Who is this suitor?
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_04"); //I can't tell you that. Professional secrecy.
	AI_Output(hero, self, "Info_Mod_Sonja_Freier_A_15_05"); //Then why don't you see him yourself?
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_06"); //Because he lives in the upper district, silly. I don't have access there.

	if (Mil_305_Torwache.aivar[AIV_Passgate] == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_07"); //But you're such an aspiring young man, I'm sure you'll have a chance soon.
	};
	...
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_09"); //I can still tell you that this is not one of the paladins or militiamen. The selection shouldn't be too big any more.
	AI_Output(self, hero, "Info_Mod_Sonja_Freier_A_43_10"); //If you found him, ask him to stop by my house again.
