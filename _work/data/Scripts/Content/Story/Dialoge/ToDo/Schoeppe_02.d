...
{
	AI_Output(hero, self, "Info_Mod_Schoeppe_02_Hi_15_00"); //How are you doing?
	AI_Output(self, hero, "Info_Mod_Schoeppe_02_Hi_06_01"); //It's a bit boring right now. I'd like to torture someone again.
	AI_Output(self, hero, "Info_Mod_Schoeppe_02_Hi_06_02"); //They all ate something, and only with torture can you get it out of them!
};
...
FUNC VOID Info_Mod_Schoeppe_02_Pickpocket_DoIt()
{
	...
	else
	{
		...
		Info_AddChoice	(Info_Mod_Schoeppe_02_Pickpocket, DIALOG_PP_BESCHIMPFEN, Info_Mod_Schoeppe_02_Pickpocket_Beschimpfen);
		Info_AddChoice	(Info_Mod_Schoeppe_02_Pickpocket, DIALOG_PP_BESTECHUNG, Info_Mod_Schoeppe_02_Pickpocket_Bestechung);
		Info_AddChoice	(Info_Mod_Schoeppe_02_Pickpocket, DIALOG_PP_HERAUSREDEN, Info_Mod_Schoeppe_02_Pickpocket_Herausreden);
	};
};

FUNC VOID Info_Mod_Schoeppe_02_Pickpocket_Beschimpfen()
{
...
FUNC VOID Info_Mod_Schoeppe_02_Pickpocket_Bestechung()
{
...
FUNC VOID Info_Mod_Schoeppe_02_Pickpocket_Herausreden()
{
