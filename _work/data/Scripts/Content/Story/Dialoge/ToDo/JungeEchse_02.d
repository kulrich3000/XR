INSTANCE Info_Mod_JungeEchse_02_ZettelZeigen (C_INFO)
{
	npc		= Mod_12013_DRA_Echse_AW;
	nr		= 1;
	condition	= Info_Mod_JungeEchse_02_ZettelZeigen_Condition;
...
FUNC VOID Info_Mod_JungeEchse_02_ZettelZeigen_Info()
{
	B_UseFakescroll ();
...
INSTANCE Info_Mod_JungeEchse_02_EXIT (C_INFO)
{
	npc		= Mod_12013_DRA_Echse_AW;
	nr		= 1;
	condition	= Info_Mod_JungeEchse_02_EXIT_Condition;
	information	= Info_Mod_JungeEchse_02_EXIT_Info;
	permanent	= 1;
	important	= 0;
	description	= DIALOG_ENDE;
};

FUNC INT Info_Mod_JungeEchse_02_EXIT_Condition()
{
	return 1;
};

FUNC VOID Info_Mod_JungeEchse_02_EXIT_Info()
{
	AI_StopProcessInfos	(self);
};
