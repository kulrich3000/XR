...
FUNC VOID Info_Mod_Nadja_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Nadja_Hi_43_00"); //Nadia.
};
...
INSTANCE Info_Mod_Nadja_LuteroHochzeit (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "Lutero promised to marry you?";
};
...
{
	AI_Output(hero, self, "Info_Mod_Nadja_LuteroHochzeit_15_00"); //Lutero promised to marry you?
	AI_Output(self, hero, "Info_Mod_Nadja_LuteroHochzeit_43_01"); //Don't worry about that. I've got dozens of offers in my life.
	AI_Output(self, hero, "Info_Mod_Nadja_LuteroHochzeit_43_02"); //There are situations where men throw all their rational thinking overboard.
	AI_Output(self, hero, "Info_Mod_Nadja_LuteroHochzeit_43_03"); //I'd be unhappy if I took all her promises at face value.
};
