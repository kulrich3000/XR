...
FUNC INT Info_Mod_Trimedron_Hi_Condition()
{
	if (Mod_GDG_RitualTafel02 == 1) {
		...
		if (!Trimedron_Attacking) {
			B_LogEntry(TOPIC_MOD_URIZIEL, "I discovered the spirit Trimedron, but he attacked me immediately. I wonder if I can find a way to appease him. Maybe there's an incantation formula...");
