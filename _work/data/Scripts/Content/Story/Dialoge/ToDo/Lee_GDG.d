...
{
	AI_Output(self, hero, "Info_Mod_Lee_GDG_Hi_04_00"); //Thofeistos gave me this for you.

	B_GiveInvItems	(self, hero, ItAr_DJG_H, 1);

	AI_Output(self, hero, "Info_Mod_Lee_GDG_Hi_04_01"); //Let's hope the armour keeps its promise.
};
