...
{
	AI_Output(self, hero, "Info_Mod_Dschinn_MineBesetzt_10_00"); //This mine is already occupied.
};
...
{
	AI_Output(self, hero, "Info_Mod_Dschinn_VM_Hi_10_00"); //An abandoned ore mine. My master will be delighted.
