...
{
	AI_Output(hero, self, "Info_Mod_Pyrokar_GDG_Lernen_15_00"); //Naucz mnie czegos.
...
FUNC VOID Info_Mod_Pyrokar_GDG_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Pyrokar_GDG_Lernen_BACK_05_01"); //Twoje magiczne umiejetnosci sa teraz tak dobre, ze nie moge cie niczego nauczyc.
	};
	Info_ClearChoices	(Info_Mod_Pyrokar_GDG_Lernen);
};
