...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_InHaus_14_00"); //That's what I call a comfortable home, isn't it?
	AI_Output(hero, self, "Info_Mod_Ramirez_REL_InHaus_15_01"); //Looks okay.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_InHaus_14_02"); //That's what I mean. Hmm, what's missing is the right food.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_InHaus_14_03"); //I hope that Attila will soon return from his exploration... I can hear him coming down the stairs.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_14_00"); //Well done. I'm sure that should make sense of that.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_14_01"); //(to the hero) How about you go there and try to take a full sack with you from the camp.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_14_02"); //Make sure the guards don't catch you doing it.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_14_03"); //Maybe you'll have to hide in the camp until they're finally gone by night.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_14_04"); //You'll think of something.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_14_00"); //What's this? I smell ham, cheese, bread...
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_14_01"); //Ahh, very nice, you were in the camp, I see.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_14_02"); //And I was afraid I'd have to go to the market to buy something.

	B_GiveInvItems	(hero, self, ItMi_Fresssack, 1);

	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_14_03"); //Let me see... at least for the next four weeks. Good work.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_14_04"); //Here's some gold... and some food out of the bag.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie_14_00"); //Ahh, there you are. So we're good to go. Follow me. Follow me.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie2_14_00"); //You're much too late. It's not worth it to start now.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie2_14_01"); //We have to postpone it until tomorrow.... you asshole.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie3_14_00"); //All right, then. What comes now is for the sole purpose of the mission.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie3_14_01"); //As soon as I get him interested, you should be able to grab that dress.
...
FUNC VOID Info_Mod_Ramirez_REL_Glorie4_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie4_14_00"); //Here you are at last. While you were in bed with your ass, we broke through the wall and uncovered a tunnel.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie4_14_01"); //Great, we're through. Good job, guys. Looks like it's really moving on.
	};
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie5_14_00"); //All right... the three pounds of gold in my pockets are enough for now.
