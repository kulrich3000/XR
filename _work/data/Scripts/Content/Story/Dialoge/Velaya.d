...
FUNC VOID Info_Mod_Velaya_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_Hi_17_01"); //Wreszcie z tego miejsca? Nic lepszego niz to.
...
FUNC VOID Info_Mod_Velaya_AusLager_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_AusLager_17_00"); //Szczesliwy) W koncu uciec z tego zakletego obozu, yohoohoo, yohoo! Teraz opusc te doline.
...
FUNC VOID Info_Mod_Velaya_AusLager_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_AusLager_B_17_01"); //W porzadku, idzmy. Badzcie blisko mnie.
...
FUNC VOID Info_Mod_Velaya_AusLager_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_AusLager_A_17_01"); //Co? Absolutnie nie.
...
{
	AI_Output(self, hero, "Info_Mod_Velaya_Umgehauen_17_00"); //Zloczyn sie....
...
FUNC VOID Info_Mod_Velaya_Unterwegs_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_Unterwegs_B_17_01"); //Nigdy nigdy!
...
{
	AI_Output(self, hero, "Info_Mod_Velaya_AtPass_17_00"); //Stad moge to zrobic samodzielnie. Jak moge wam podziekowac? Ale czekam, moge o czyms pomyslec.
	AI_Output(self, hero, "Info_Mod_Velaya_AtPass_17_01"); //Poniewaz ktos opróznil wszystkie kasetony w domu arcybaronów, skarby i bogactwa zostaly zlozone w róznych tajnych miejscach w domu.
	AI_Output(self, hero, "Info_Mod_Velaya_AtPass_17_02"); //Jeden z nich, jak kiedys zauwazylem, znajduje sie w kominku pokoju Bartholos. Pod prochami znajduje sie mala kryjówka. Powinnas byc w stanie ja znalezc.
	AI_Output(self, hero, "Info_Mod_Velaya_AtPass_17_03"); //Nie wpadaj jednak w pulapke. I zadbaj o siebie.
