...
FUNC VOID Info_Mod_Malcom_DI_Heiltrank_Info()
{
	...
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Istota uzdrawiania", Info_Mod_Malcom_DI_Heiltrank_Health_04);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Eliksir uzdrawiania", Info_Mod_Malcom_DI_Heiltrank_Health_03);
	};
	if (Npc_HasItems(hero, ItPo_Health_02) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Ekstrakt z ekstraktu leczniczego", Info_Mod_Malcom_DI_Heiltrank_Health_02);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Istota uzdrawiania", Info_Mod_Malcom_DI_Heiltrank_Health_01);
	};
	if (Npc_HasItems(hero, ItPo_Health_07) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Napój lekkiego leczenia", Info_Mod_Malcom_DI_Heiltrank_Health_07);
	};
	if (Npc_HasItems(hero, ItPo_Health_06) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Lekki eliksir leczniczy", Info_Mod_Malcom_DI_Heiltrank_Health_06);
	};
	if (Npc_HasItems(hero, ItPo_Health_05) >= 1)
	{
		Info_AddChoice	(Info_Mod_Malcom_DI_Heiltrank, "Napoje szybko lecznicze", Info_Mod_Malcom_DI_Heiltrank_Health_05);
	};
};
