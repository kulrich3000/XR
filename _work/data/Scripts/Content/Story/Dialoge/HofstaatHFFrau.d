...
FUNC VOID Info_Mod_HFFrau_Heiraten_01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_01_16_01"); //No.
};
...
INSTANCE Info_Mod_HFFrau_Heiraten_02 (C_INFO)
{
	...
	permanent	= 0;
	important	= 0;
	description	= "You're the wife of the dog food?";
};
...
{
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_15_00"); //You're the wife of the dog food?
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_16_01"); //Yes...
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_16_02"); //... which means it was me.
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_15_03"); //I'm terribly sorry for your loss. You want a little joy to comfort you.
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_16_04"); //Yes... gerne.
	...
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_02_16_06"); //Heiraten? Yes... aber ich heirate nur noch jemanden der seinen eigenen Grund besitzt ... Tust du das?
};
...
{
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_03_15_00"); //I have a house.
	AI_Output(self, hero, "Info_Mod_HFFrau_Heiraten_03_16_01"); //Great, then let's get married!
