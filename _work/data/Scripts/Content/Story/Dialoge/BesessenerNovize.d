...
FUNC VOID Info_Mod_BesessenerNovize_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_BesessenerNovize_Hi_01_01"); //Jestes spózniony, maluch. Zabije wszystkich slugi Beliarsa i wykonam wspaniala przysluge!
	AI_Output(hero, self, "Info_Mod_BesessenerNovize_Hi_15_02"); //Przycinajmy sie do poscigu!

	AI_DrawWeapon	(hero);

	AI_Output(self, hero, "Info_Mod_BesessenerNovize_Hi_01_03"); //Dopasuj sie do siebie.
