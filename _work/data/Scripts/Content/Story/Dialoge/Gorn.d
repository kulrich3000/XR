...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_00"); //I don't believe it.... you?! No monster or arch-demon can kill you....
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_01"); //Nice to see you, too.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_02"); //Man... some memories come alive. What we have experienced together.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_03"); //It's like it was only yesterday that we kicked the guards out of our mine with an ass kick.
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_04"); //Or together they killed the fat troll in the monastery fortress.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_05"); //Sure, how could I forget that fat bitch? And again you're in the right place at the right time.
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_06"); //Why?
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_07"); //Well, I was just about to take the cursed fortress up there. There should be lots of treasures to fetch, but also full of undead bastards.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_08"); //Hard work, I thought to myself. Until you came. It was supposed to be a walk with you.
};
...
FUNC VOID Info_Mod_Gorn_GotoCastlemine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_GotoCastlemine_03_01"); //I expected nothing less from you. Let's show these bastards.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_00"); //So that's it, then. A few gold coins have come together, but not quite as much as I had hoped for.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_01"); //And the mine seems to be buried too. In any case, there is nothing more to get here.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_02"); //But it was still a lot of fun to be on the road with you again.... and reason enough to meet the other guys to discuss some things.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_03"); //Can you do me a favor?
	AI_Output(hero, self, "Info_Mod_Gorn_AtCastlemine_15_04"); //Sure, what's it about?
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_05"); //Tell Diego, Milten and Lester that we'll meet at the Dead Harpie tavern.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_06"); //Since you've become one of us, you can come too.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_07"); //And if you ever need help, you can come to us, then we will try to help you.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_00"); //Hey, looking for adventure again?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_02"); //Oh, Pepe went into the woods with some mercenaries to hunt wolves and then went crazy and left.
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_03"); //Lares can tell you more about it. Anyway, the boys from the woods have been eating for three since then.
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_04"); //Thekla hardly ever follows the cooking and is already mad.
	AI_Output(hero, self, "Info_Mod_Gorn_Daemonisch_15_05"); //Then there's always a reason for conversation. Well, see you soon.
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_06"); //Take care, now.
...
FUNC VOID Info_Mod_Gorn_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_02"); //A trip to an island? Man, you're always good for a surprise...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_03"); //Well, the Orcfighter Cord would certainly be there.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_04"); //He trains like a madman all day long and would certainly not miss the chance of such an adventure.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_05"); //And then there's Bennet, because it wouldn't be bad to have a blacksmith on board if you need some sharp blades.
...
FUNC VOID Info_Mod_Gorn_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath2_03_01"); //You say it. On an adventurous trip like this, I won't say no...
	AI_Output(hero, self, "Info_Mod_Gorn_Irdorath2_15_02"); //Then I'm happy to welcome you aboard.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath2_03_03"); //I'll be on my way to the harbour right away.
...
FUNC VOID Info_Mod_Gorn_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath3_03_01"); //Too bad. I'll go back then. You know where to find me if there's ever gonna be a seat left.
...
FUNC VOID Info_Mod_Gorn_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath4_03_01"); //Very well, I'll be back at the harbour.
...
FUNC VOID Info_Mod_Gorn_Treffen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_00"); //It's nice of you all to come. I thought it was time for another meeting. How have you been?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_02"); //I'm comfortable with the Fire Magicians. However, there are not many ways to escape the walls of the monastery, so I am not well informed about everything that is going on outside.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_04"); //(laughs) Since when do you try to be a prophet, Diego?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_06"); //What awaits us?
	AI_Output(hero, self, "Info_Mod_Gorn_Treffen_15_07"); //It's still in the dark. But it will show up soon enough.

	TRIA_Next(Gorn);
	
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_08"); //Let it come! I can't imagine anything we're not up to.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_11"); //Admit it, you're in the middle of it again.
	AI_Output(hero, self, "Info_Mod_Gorn_Treffen_15_12"); //It looks like it. I think I have more enemies than I intended.

	TRIA_Next(Gorn);
	
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_13"); //You know, I hope you don't have to go through this alone. You can count on us if we all die.

	TRIA_Next(Milten);
	
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_14"); //You shouldn't have put it so drastically.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_17"); //And the axe ready.

	TRIA_Next(Milten);
	
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_18"); //And the magic fresh in your memory.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_22"); //Aye.

	TRIA_Next(Milten);
	
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_28_23"); //Sure. Gladly. And if our danger is open, I'd like to know. The monastery is not the first place in the world to know what's going on.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_00"); //Oh, man, those horrible monsters on the plateau, we'd rather not dare.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_01"); //The undead on Sekobs may not be without them, but they can still be created.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_02"); //Lares hesitates but something else, waits for the right moment to attack....
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_00"); //Hey, the undead at Sekob's court have scattered. Now we could beat them up.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_01"); //If you go along with it, our clout should be enough.
...
FUNC VOID Info_Mod_Gorn_Hexen_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_B_03_01"); //Hmm, too bad I didn't think you'd want to miss this.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_B_03_02"); //Then we'll just have to wait a little longer before we get reinforcements.
...
FUNC VOID Info_Mod_Gorn_Hexen_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_A_03_01"); //Very well, I didn't expect anything else from you. Well, here we go.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_A_03_02"); //We'll gather at the crossroads. Just like old times.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_02_03_00"); //Come on, let's kick this undead man's butt.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_03_00"); //Well, we showed them. It was a pleasure to have fought at your side again.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_BalrogGigantTot_03_00"); //Hey, I hear the monsters and giants on the plateau are gone... and somehow I think you were involved.
	AI_Output(self, hero, "Info_Mod_Gorn_BalrogGigantTot_03_01"); //Great performance. I would have liked to be at the party when you spanked those monsters.
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_00"); //Man, oh, man. In the Minental, one believes to have defied all the challenges that exist in the world and then these giant lizards are on the doorstep.
	AI_Output(hero, self, "Info_Mod_Gorn_Drachen_15_01"); //Well, without new challenges everything would be monotonous and pointless.
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_02"); //As always imperturbable before any great task. Yeah, I guess you're right.
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_03"); //And I'm also sure that there will be another chance to have an adventure together. Take care of yourself.
...
FUNC VOID Info_Mod_Gorn_Knucker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_01"); //Oh, you're a good talker. Me and Cord were ordered to keep watch on the edge of the forest since some sheep died and two peasants disappeared.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_03"); //Yes, if wolves are able to suck the sheep's blood to the last drop, they are.
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_04"); //Just like the peasants who went into the woods at night like in a trance and disappeared....
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_06"); //You mean, go to the woods and see? I don't know about that. At least I'd have to leave my post for that...
	AI_Output(hero, self, "Info_Mod_Gorn_Knucker_15_07"); //Come on, because of the five minutes we spend exploring the forest....
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_08"); //And if any of the demonic creatures that hang around here these days attack during this? No, it really doesn't work that way.
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_09"); //Hmm, but I'll be relieved next night. Then we can get started and make the forest insecure.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_11"); //What you can count on.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_WaldSpaziergang_03_00"); //Oh, there you are. Shall we go then?
	AI_Output(hero, self, "Info_Mod_Gorn_WaldSpaziergang_15_01"); //Yeah, let's not waste any more time.
	AI_Output(self, hero, "Info_Mod_Gorn_WaldSpaziergang_03_02"); //All right, follow me.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_NichtsLosImWald_03_00"); //Well, there wasn't much going on here, except for the few creatures.
	AI_Output(self, hero, "Info_Mod_Gorn_NichtsLosImWald_03_01"); //We should stop by the crypt sometime.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_VorKrypta_03_00"); //My ass, do you see all these undead in the cemetery of the crypt? Maybe they have something to do with the disappearance of the peasants.
	AI_Output(self, hero, "Info_Mod_Gorn_VorKrypta_03_01"); //Come on, let's get' em.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hel_03_00"); //Where the hell did she go?
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_00"); //(except for breath) Boah, she might have been a hard beast. Even Thekla is gentle as a lamb against them.
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_01"); //Well, I won't be laughing at the martial arts of women that fast.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_03"); //And now I can finally pursue other things than standing idly in front of the chapel all day long. Hey, I owe you one.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_05"); //Well, see you next time. Take care of yourself.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_00"); //I see you're still using two-handed people with both hands, mate.
	AI_Output(hero, self, "Info_Mod_Gorn_ZweihandAlsEinhand_15_01"); //Yeah. What's wrong with that?
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_02"); //It's impossible for a regular warrior, but guys as strong as you and I can lead two-handed men like one-handed men.
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_03"); //If you feel like it, I'll show you how to do it.
};
...
FUNC VOID Info_Mod_Gorn_ZweihandAlsEinhand2_Info()
{
	...
	&& (hero.lp >= 5))
	{
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_01"); //The most important thing is that the feeling of one-handed and two-handed people is different.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_02"); //The weapon's center of gravity is further away from your body in two-handed mode.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_03"); //That's why you should be careful not to stretch your arm completely, because then the weight of the weapon will be too much.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_04"); //Wave your arm slightly and you shouldn't have any problems.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_05"); //What are you waiting for? I want to see you practice!
	...
	{
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_06"); //Come back when you're ready.
	};
};
...
FUNC VOID Info_Mod_Gorn_Standfest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Standfest_03_01"); //There is a way. Do you have some time?
};
...
FUNC VOID Info_Mod_Gorn_Standfest2_Info()
{
	...
	&& (hero.lp >= 5))
	{
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_01"); //In the end, only the right mixture of strength and skill counts.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_02"); //When you see that one of the opponents is getting ready for a powerful blow, you prepare yourself.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_03"); //Just before he catches you, you make yourself small and move your body's centre of gravity towards the ground.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_04"); //If you then put all your power against the blow, it will still be painful, but you don't sail several meters through the air.
		AI_Output(hero, self, "Info_Mod_Gorn_Standfest2_15_05"); //I think I get it. Thanks.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_06"); //You're welcome.
	...
	{
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_07"); //Come back when you're ready.
	};
};
...
FUNC VOID Info_Mod_Gorn_Hilfe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_03_01"); //With what?
...
FUNC VOID Info_Mod_Gorn_Hilfe_Kristall()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_01"); //Hmm, let me think. I can't think of much in a hurry either.... but wait a minute.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_02"); //I heard Lee talk about a paladin he knew from before. The fat Lothar in the upper quarter is said to be quite a swallow.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_03"); //He likes to inflate himself, but doesn't take it so close to discipline....
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_04"); //He might tell you something.
...
FUNC VOID Info_Mod_Gorn_Hilfe_MinecrawlerSekret()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_01"); //Lester once told me that in the eggs of the minecrawler is a stronger secretion than in the tongs.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_02"); //I had two minecrawler eggs from the free mine when we freed them together from the guardsmen, but I gave them to Milten.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_03"); //I couldn't handle the eggs, but I'm sure he could use them as a magician. Go see him and ask him, maybe he still has it.
...
FUNC VOID Info_Mod_Gorn_Hilfe_Alvares()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Alvares_03_01"); //A mercenary candidate.... hmm, there won't be a qualified fighter on the farms.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Alvares_03_02"); //Most likely those who have already been arrested by the city guards for their actions.
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_EXIT_03_00"); //May you never find your master!
