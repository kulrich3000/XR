...
{
	AI_Output(self, hero, "Info_Mod_Malfama_AtHome_16_00"); //Tak, dotknal jej niemoralnie i grozil nam zlo, jesli mu powiedzielismy.
	AI_Output(self, hero, "Info_Mod_Malfama_AtHome_16_01"); //To zle, my nie mozemy nic z nim zrobic. Jesli tylko ktos móglby nam pomóc....
	AI_Output(hero, self, "Info_Mod_Malfama_AtHome_15_02"); //Moze móglbym stanac u waszego boku.
	AI_Output(self, hero, "Info_Mod_Malfama_AtHome_16_03"); //Naprawde? Och, dziekuje bardzo. Nigdy wczesniej nie spotkalismy takiego czlowieka.
...
FUNC VOID Info_Mod_Malfama_Traenenkristall_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Malfama_Traenenkristall_16_00"); //(do Serry) Co zrobiles/as? Tak, oczywiscie krysztal. Chce, zebyscie wszyscy zalowali tego smierci!
