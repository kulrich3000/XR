...
{
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_00"); //Huh? Am I dreaming? Who are you people?
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_01"); //We're pirates. We got a message in a bottle.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_02"); //You found my message? Thank heaven!
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_03"); //By the way, they call me Brunhild. Friends call me Bruni.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_04"); //Pleased to meet you. How did you get here?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_05"); //It's a long story.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_06"); //Tell me about it.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_07"); //I sailed away with my father and brother. We were going to Khorinis.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_08"); //It is said that there are no orcs there who devastate the court yard and kill anything that doesn't look like an orc.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_09"); //My mother was killed by them.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_10"); //Where'd you get that old wives' tale?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_11"); //That's what they say on the mainland.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_12"); //What a joke! And where are your people?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_13"); //Dead. My brother didn't survive the shipwreck and my father built us this tent here.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_14"); //Then he was beaten to death by creepy limping creatures who lived among us in the caves.
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_16"); //You killed them all?
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Hi_15_17"); //We are pirates and we fear neither death nor Beliar!
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Hi_21_18"); //Can you give me a lift? I won't survive long here, even without the hinkers.
...
FUNC VOID Info_Mod_Brunhild_DI_Gestaendnis_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_01"); //Better than in my wretched tent anyway! You want some soup?
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_02"); //Later, maybe. I come from Samuel....
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_03"); //You were talking about me?
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_04"); //We did. You haven't been honest with me.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_05"); //Forgive me, I was afraid I had to stay on this island.
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_07"); //We didn't emigrate, we fled.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_08"); //My mother didn't drown, she was burned as a witch at the stake.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_09"); //And I was also suspected of witchcraft.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_10"); //Was she a witch? Are you a witch?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_11"); //No. My father used to be a magician of the Earth.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_12"); //When he met my mother and wanted to marry her, he had to leave the order.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_13"); //Order of the Earth? Never heard of him.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_14"); //This order prays to Adanos like the water magicians. Is not as well-known as the other orders and their magic is also somewhat different.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_15"); //Father has now taught Mother and me some of this magic.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_16"); //So no witchcraft?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_17"); //No. Good, positive magic, like others. My knowledge corresponds approximately to the first circle of magic.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Gestaendnis_15_18"); //Which means?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Gestaendnis_21_19"); //I could uproot trees, create crevasses, cause avalanches of rubble, move rocks. Things like that.
...
FUNC VOID Info_Mod_Brunhild_DI_Amulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Amulett_21_01"); //Oh! A locket.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Amulett_15_02"); //Medallion?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Amulett_21_03"); //Yeah. Something similar to an amulet, but more precious and rare.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Amulett_15_04"); //And what's that all about?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Amulett_21_05"); //I don't really know. It could be a banner, but I'm not sure.
	AI_Output(hero, self, "Info_Mod_Brunhild_DI_Amulett_15_06"); //A banner?
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Amulett_21_07"); //Yeah. An object with which one can pronounce or revoke bans.
...
FUNC VOID Info_Mod_Brunhild_DI_Erdmagie_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Erdmagie_21_01"); //Even if it's not an entire mountain.
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Erdmagie_21_04"); //That's got something. Where's the treasure?
...
FUNC VOID Info_Mod_Brunhild_DI_Erdmagie2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Erdmagie2_21_01"); //Uh-huh. And you mean this wall? Should work.

	AI_PlayAni	(self, "T_MAGRUN_2_TRFSHOOT");

	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Erdmagie2_21_02"); //Hm. I can't make it. Strange... there's some kind of obstacle. Not a real... Strong magic.
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Erdmagie2_21_03"); //Maybe this Jones who's with your captain can help. My knowledge of spells is too low.
...
FUNC VOID Info_Mod_Brunhild_DI_Ende_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brunhild_DI_Ende_21_01"); //Too bad your closeness has something soothing about it.
