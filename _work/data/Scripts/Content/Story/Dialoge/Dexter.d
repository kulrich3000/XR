...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_00"); //What the hell are you doing here?
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_02"); //Okay, you have our password.

		if (Gardist_Dabei == TRUE)
		{
			AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_03"); //But I have heard that you are already part of the Old Camp.
		}
		else
		{
			AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_04"); //But I have heard that you are already part of many other camps.
		};

		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_05"); //You can't become a real bandit anymore. The danger of you passing on information from us is too great for me.
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_06"); //You are free to enter our camp and deal with the boys.
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_07"); //Don't make any trouble, okay?

		B_SetTopicStatus	(TOPIC_MOD_AUFNAHME_BANDITEN, LOG_FAILED);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_08"); //It seems that you have already convinced a few of us, or else you wouldn't have come in here alive.
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_09_09"); //So if you want, you can become one of us now.
...
FUNC VOID Info_Mod_Dexter_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Aufnahme_09_01"); //Here's your armour. You can make yourself useful in the camp now.
...
FUNC VOID Info_Mod_Dexter_WhatToDo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_01"); //They are very diverse and varied.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_02"); //Of course, we plan and carry out robberies first and foremost and look elsewhere, where there is something to get with a bit of skill.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_03"); //Only a few days ago we stalked a small group of hostile orcs on their way to the Orc City in the southwest.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_04"); //A quite valuable artifact fell into our hands. But I'll deal with that some other time.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_05"); //In any case, without buyers and receivers to whom we could resell our captured goods, we would lack a central source of income.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_06"); //We have contacts and customers all over Khorinis. We therefore also act as traders, messengers, and occasionally even take on orders that are too hot for others.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_09_07"); //Once you have proven yourself in the camp, some good fish will fall for you. You'll enjoy life as a bandit.
};
...
FUNC VOID Info_Mod_Dexter_Job_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Job_09_01"); //Not for the time being. Maybe come back in a few days.
...
FUNC VOID Info_Mod_Dexter_TimeOver_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_00"); //You have already served our camp well and shown yourself to be a skillful and worthy bandit.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_01"); //So I have a very important task for you.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_02"); //So far you haven't done anything really big for our camp.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_03"); //But since you know the old camp of former times well and nobody knows about your affiliation to us, you can finally do something important for us.
	};

	AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_04"); //What's this about?
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_05"); //I told you a few days ago in our conversation that we had captured an important artifact from the orcs.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_06"); //Well, this item was a magical amulet.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_07"); //From a book about lost treasures from the old days we learned that this piece of jewellery belonged to a series of powerful objects, which were once supposed to have been created by divine instruction in the smelting furnaces of Nordmars, long before the foundation of the clans.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_08"); //We entered into negotiations with the transforming magicians, who showed great interest in the amulet.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_09"); //They even gave us some valuable spell rolls on the spot to seal the deal.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_10"); //Now Quentin was to bring the amulet to them yesterday, after Oschust had given him a fresh shine. He's actually a capable man and one of our best fighters.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_11"); //On the way he stopped in the old camp to watch some arena fights. He drank one or the other sip and got into an argument with a foreign fighter.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_12"); //Well, to get to the point, they outbid each other with their bets to be able to send the other on the arena floor and this idiot Quentin offered the amulet at last.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_13"); //The fight didn't last long, Quentin sank into the dust after a few strokes of his opponent and the amulet was loose.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_14"); //This is a heavy blow to our entire camp, because some of the spell rolls given to us by the magicians were used up on a reconnaissance mission.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_15"); //This is not an easy way to reverse business and the reputation of our reliability is at stake.

	if (Kapitel >= 4)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_16"); //And that the old camp is now in the hands of the orcs doesn't make it any easier.
	};

	AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_17"); //And I'm supposed to retrieve the amulet?
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_18"); //That's right, you get the point.
	...
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_20"); //We found out that the fighter is called Sabitsch and is an old friend of Thorus from the days before the colony.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_21"); //He has been on the road a lot and is said to have won victories in numerous arenas of the well-known world.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_22"); //After he heard about the fall of the barrier and the reign of his old friend Thorus over the camp, he must have come here as a knight of fortune to take some of the treasures of this valley.

	if (Kapitel < 4)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_23"); //So a lot of dexterity is required for your task, because he is not only a notorious fighter, but also a good friend of Thorus and we don't want to mess it up with the old camp.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_24"); //Try to find out as much about him as possible, talk to the people who often deal with him - not Thorus, of course.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_25"); //And then do everything you can to get back into possession of the amulet... leave as little trace as possible if it should happen in a way that could lead to conflicts with the Old Camp.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_26"); //Well, didn't go as well for him as he hoped.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_27"); //Although he was an excellent fighter, he probably didn't stand a chance against the 200 orcs sitting there now.
		AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_28"); //Acha, what am I supposed to do?
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_29"); //Go in, find the arena, ransack the body, retrieve the amulet and bring it to us.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_30"); //However, perhaps in a less conspicuous form.

		B_Say	(hero, self, "$WASMEINSTDU");

		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_09_31"); //Talk to Quentin. He's got something for you.
...
FUNC VOID Info_Mod_Dexter_AmulettBack_Info()
{
	...
	if (Kapitel < 4)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_01"); //Very good. Very good. You've done a great service to our camp.
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_02"); //Use this as a reward.
		...
		{
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_03"); //Well, you were caught stealing the amulet, but that's self-defeating and the main thing is that we have the amulet.
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_04"); //You've earned yourself a reward.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_05"); //Erstaunlich! Dir ist es wirklich gelungen. Damit hast du unserem Lager einen großen Dienst erwiesen. Use this as a reward.
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_09_06"); //Anyway, I'm gonna give quentin a second chance. He will bring the amulet to the magicians and complete the trade.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_00"); //Fucking hell.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_01"); //What has happened?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_02"); //When Quentin handed over the amulet to the magician Albert, he examined the piece for a few minutes.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_03"); //Then he suddenly threw the Quentin to her feet, was upset, spoke of deception and fraud.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_04"); //He could still feel the rest of the magical aura of the real amulet, but this is clearly a fake.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_05"); //How is that possible?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_06"); //Well, I'm not completely stupid either. I went over everything again and came to the only conclusion that this filthy Oschust must be behind it.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_07"); //When we gave him the amulet to polish up, he must have made an exact copy in the same night, which he then handed over to us the next day.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_08"); //He must have hidden the original somewhere. I can't just go to him now and cut him into pieces. We still need him.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_09"); //What remains to be done?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_10"); //Das überlasse ich dir. Kümmere du dich um Oschust. Bringe ihn mit etwas "diplomacy" dazu, dir Auskunft über den Standort des Amulettes zu geben.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_11"); //But he should still be able to pursue his counterfeiting trade afterwards. You understand?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_09_12"); //Good. Report back to me afterwards.
...
FUNC VOID Info_Mod_Dexter_FakeAmulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_FakeAmulett_09_01"); //I'm carrying it with me. Here, you can have it because you took it from the old camp.

	B_GiveInvItems	(self, hero, ItAm_MegaAmulett, 1);

	AI_Output(self, hero, "Info_Mod_Dexter_FakeAmulett_09_02"); //It's no longer of any value to us.
};
...
FUNC VOID Info_Mod_Dexter_OschustAmulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_01"); //Very good. Very good. How cooperative was Oschust?
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_03"); //Yes?
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_04"); //The cave is full of orcs and warg now.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_05"); //What, the orcs again?! So close to stock... that's not good.
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_06"); //And what do we do about the amulet?
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_07"); //We don't have enough clout for a frontal attack... and a nightly robbery would fail because of the watchful dogs.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_08"); //I also need my men here to protect the camp, as often as orcs are currently roaming around....
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_09"); //Does that mean I'm on my own again?
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_10"); //Well... not necessarily. You could try hiring some Orchunters in the New Camp.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_11"); //It doesn't come cheap. Here's some gold.

	B_GiveInvItems	(self, hero, ItMi_Gold, 500);

	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_12"); //Maybe you can also find a lunatic who plays the decoy and pulls the orcs out of the cave.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_09_13"); //Well, I'm sure you'll find a way. Good luck to you!
...
FUNC VOID Info_Mod_Dexter_OschustTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustTot_09_01"); //What...?! You did a great job of it. Well... since you were so smart: have fun searching!
...
FUNC VOID Info_Mod_Dexter_Amulett2Gefunden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Amulett2Gefunden_09_01"); //Excellent. Now go directly to the transformation mage Albert and give it to him.
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_09_01"); //Very good. Very good. Did he give you the rest of the agreed-upon price?
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_09_00"); //Be that as it may, after all the trouble over the last few days, we have to make up for it. Here, have a drink.

	CreateInvItems	(hero, ItFo_Addon_Grog, 1);

	B_UseItem	(hero, ItFo_Addon_Grog);

	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_09_01"); //Real good sailor grog, which our boys once took from a merchant on Khorinis.
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_09_02"); //In addition, there are exquisite ham and crispy roasted meat. Tonight there's going to be no excuse. (laughs)
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_B_09_01"); //Damn, I almost feared that. Well, thanks for your efforts anyway.
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_A_09_01"); //Excellent. As a reward for your services around the camp you may keep the boar spell roll and 200 gold.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_00"); //What happened, where are the other bandits?
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_02"); //How is that possible? I thought he was dead....
	...
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_05"); //Damn, this is a disaster. I have to think.... So, there is no time to lose, because our weakened camp can be attacked at any time.
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_06"); //Hurry up to the old mountain fortress. There you will find orcs with whom we have dealings.
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_07"); //Turn to Ur Shak. Maybe we can learn more from him.
	...
	|| (Npc_KnowsInfo(hero, Info_Mod_Oschust_BadOne_Plan))
	{
		...
		AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_09_10"); //Hmm, in this case you can also turn to the Transformation Mages immediately. Talk to Albert, but hurry up.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_00"); //That was at the very last moment, but you did it.
	...
	if (Mod_Survivors >= 6)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_01"); //Excellent, I see you were able to save most of them.
		...
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_03"); //Great achievement. Here's 500 gold coins.

		B_GiveInvItems	(self, hero, ItMi_Gold, 500);

		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_04"); //This has to be celebrated. But not today.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_05"); //A battle like today's even wipes out the strongest bandit.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_06"); //Ohh, I see some of them didn't make it.
		AI_Output(hero, self, "Info_Mod_Dexter_AngriffVorbei_15_07"); //The orcs have inflicted a great burden on us and some have died.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_08"); //Very unfortunate, many good men. But in the fight against hordes of orcs, losses are to be expected.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_09"); //But where are the other bandits? You couldn't save any of them?
		AI_Output(hero, self, "Info_Mod_Dexter_AngriffVorbei_15_10"); //There were just too many orcs attacking us.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_09_11"); //This is a disaster! Fucking orcs! How can we go on with our warehouse....
...
{
	AI_Output(self, hero, "B_Dexter_SayNewArmor_09_00"); //This old bandit armor may not look like the best, but it is perfect for longer raids even in difficult terrain... and you travel a lot.
	AI_Output(self, hero, "B_Dexter_SayNewArmor_09_01"); //It is made of resistant material and densely woven so that it can withstand all external influences in equal measure.
	AI_Output(self, hero, "B_Dexter_SayNewArmor_09_02"); //Have fun with it!
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_09_00"); //(lightly ironic) Ahh, our savior. Come here and have a drink.

	if (Mod_Import_Dexter == LOG_SUCCESS)
	|| (Mod_Import_Dexter == -1)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_09_01"); //By the way, it took me a while, but I recognized you.
		AI_Output(hero, self, "Info_Mod_Dexter_PartyNachRettung_15_02"); //Then you know that back then,
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_09_03"); //Yeah, like you got me the recipe for that potion from Crazy Kalom back then. I got something here. Have a sip...
	...
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_09_04"); //I found something nice for you.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Wolkenwelt_09_00"); //There you are again. While you were on the road in the land of dreams, I've been digging up something nice for you.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Alissandro_09_00"); //What's going on here?
	AI_Output(hero, self, "Info_Mod_Dexter_Alissandro_15_01"); //The guard won't let me in without a password.
	AI_Output(self, hero, "Info_Mod_Dexter_Alissandro_09_02"); //I know you, you can come in. Let's go to the camp, where we can talk better.
...
FUNC VOID Info_Mod_Dexter_Botschaft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Botschaft_09_01"); //Well, what happened to the actual ambassador?
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Botschaft_09_03"); //Bartholos people wanted to take us on their side and were here a few days ago.
...
FUNC VOID Info_Mod_Dexter_Plan_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_09_01"); //Under certain circumstances, however, is quite risky.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_02"); //And what is it?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_09_03"); //We don't stand a chance against all the guardsmen together, we have to kill them all at once.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_04"); //And how are we supposed to do that?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_09_05"); //Mach einfach das, was ich sage. Als erstes lockst du einen Gardisten zu mir. Ich belege ihn mit einer "Sleep" Spruchrolle.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_06"); //How am I gonna lure him?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_09_07"); //All guards guard the entrance, so it's hard to lure you away. However, one is something inside the camp and looks for the right thing. Attack him and lure him to me.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Gardist_09_00"); //So, nun müssen wir warten, bis seine Kollegen nachschauen, was mit ihm passiert ist. In der Zeit brauchen wir eine "Fire Rain" Spruchrolle. Ich habe für Notfälle eine in meiner Truhe.
	AI_Output(self, hero, "Info_Mod_Dexter_Gardist_09_01"); //My chest is in the cave. I'll stay here in time and wait for the guards. When I give the signal, you ignite the part of speech.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Jetzt_09_00"); //Now, I'm hiding in the cave for so long.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Feuerregen_09_00"); //We won! We'll join Alissandro. Go to him and tell him about it.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Eroberung_05_09_00"); //Then we penetrate...
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Eroberung_07_09_00"); //... and kicking Bartholo's ass and his people in the ass.
};
...
{
	AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_00"); //Did you come to pay your fine?

	if (B_GetTotalPetzCounter(self) > Dexter_LastPetzCounter)
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_01"); //I was wondering if you'd even dare come here!
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_02"); //Apparently, it's not the latest accusations!

		if (Dexter_Schulden < 1000)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_03"); //I warned you! The fine you have to pay now is higher!
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_04"); //You let me down so badly!
		};
	}
	else if (B_GetGreatestPetzCrime(self) < Dexter_LastPetzCrime)
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_05"); //Some new things have come up.
		
		if (Dexter_LastPetzCrime == CRIME_MURDER)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_06"); //Suddenly, there's no one left to accuse you of murder.
		};
		
		if (Dexter_LastPetzCrime == CRIME_THEFT)
		|| ( (Dexter_LastPetzCrime > CRIME_THEFT) && (B_GetGreatestPetzCrime(self) < CRIME_THEFT) )
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_07"); //No one remembers seeing you at a theft.
		};
		
		if (Dexter_LastPetzCrime == CRIME_ATTACK)
		|| ( (Dexter_LastPetzCrime > CRIME_ATTACK) && (B_GetGreatestPetzCrime(self) < CRIME_ATTACK) )
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_08"); //There's no more witnesses to the fact that you've ever been in a fight.
		};
		
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_09"); //Apparently all the charges against you have vanished.
		};
		
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_10"); //I don't know what happened, but I warn you: don't play games with me.
				
		// ------- Schulden erlassen oder trotzdem zahlen ------
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_11"); //Anyway, I've decided to waive your debt.
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_12"); //Make sure you don't get in trouble again.
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_13"); //One thing is clear: you still have to pay your penalty in full.
			B_Say_Gold (self, hero, Dexter_Schulden);
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_09_14"); //So, what is it?
		};
	};
...
FUNC VOID Info_Mod_Dexter_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_01"); //I'm glad you came to me before things got worse for you.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_02"); //Murder is a grave offence!
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_03"); //Not to mention the other things you've done.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_06"); //I have no interest in putting you on the gallows.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_07"); //But it won't be easy to make people gracious again.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_08"); //You could show your repentance by paying a fine - of course the penalty must be appropriate.
	};
		
	if (B_GetGreatestPetzCrime(self) == CRIME_THEFT) 
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_09"); //Good of you to come! You're accused of stealing! There are witnesses!

		if ((PETZCOUNTER_City_Attack + PETZCOUNTER_City_Sheepkiller) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_10"); //I don't even want to talk about the other things I've heard.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_11"); //I will not tolerate such behaviour here!
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_12"); //You'll have to pay a fine to make up for your crime!
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_13"); //If you fight with the militia or anything, it's one thing...
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_14"); //But if you attack our people, I'll have to hold you accountable.

		if (PETZCOUNTER_City_Sheepkiller > 0)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_15"); //And I don't think it had to be the case with the sheep.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_16"); //If I let you get away with this, everybody's gonna do what they want.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_17"); //So you'll pay an appropriate fine - and the whole thing will be forgotten.
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_18"); //I've heard that you've been messing with our sheep.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_19"); //You do realize I can't let this go through.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_09_20"); //You'll have to pay compensation!
...
func void Info_Mod_Dexter_PETZMASTER_PayNow()
{
	...
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayNow_09_01"); //Good! I will see to it that each one of us learns about it - so your reputation would be reasonably restored.
...
func void Info_Mod_Dexter_PETZMASTER_PayLater()
{
	...
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayLater_09_01"); //Then see that you get the gold as soon as possible.
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayLater_09_02"); //And I'm warning you, if you owe yourself anything, it's going to get worse for you.
