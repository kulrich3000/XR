...
FUNC VOID Info_Mod_Hubert_Landvermessung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_Landvermessung_28_02"); //H... hm. Bring me a new pest. In my sober condition no clear thoughts can not grasp yet.
	AI_Output(hero, self, "Info_Mod_Hubert_Landvermessung_15_03"); //Woher bekomme ich das "buzz"?
	AI_Output(self, hero, "Info_Mod_Hubert_Landvermessung_28_04"); //Always straight ahead and then to the right. No, I'd better go to the chick where Fusl's, uh, sold out. Should be standing around the market place. (growls)
...
FUNC VOID Info_Mod_Hubert_LandvermessungAlk_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_28_01"); //Oh, good!

	CreateInvItems	(self, ItFo_Booze, 1);

	B_UseItem	(self, ItFo_Booze);

	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_28_02"); //Things are better now. Jesus Christ! I've got some inner dips... interstitial thought about your question.
	...
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_28_06"); //Siebn Stobbelfelder! Kho-ra-ra-ra-ta is as big as siebn Stobbelfelder next to each other.
	AI_Output(hero, self, "Info_Mod_Hubert_LandvermessungAlk_15_07"); //Gorgeous....
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_28_08"); //Isn't it?
...
FUNC VOID Info_Mod_Hubert_CityGuide01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_28_01"); //(drunk) Whoo? Until new here?
	AI_Output(hero, self, "Info_Mod_Hubert_CityGuide01_15_02"); //You guessed it.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_28_03"); //Well, that can't be done... Wait a minute, have to sort my legs. (groans)
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_28_04"); //Always nice and pretty friendly with the stranger, huh?
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_28_05"); //Just run after me and tell me when I'm so fast.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide02_28_00"); //This is our town hall. That's where our Oberfurzi lives. Well, hello sagn.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide03_28_00"); //I'll get anything to drink here. And if you want to kick your ass, you might know Hans.... n... Learning to learn.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide04_28_00"); //In the street they all go penn.... n. Nothing where you have to go.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_28_00"); //Inside are the gown furrows, as I call them.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_28_01"); //(laughs exaggerated) The ham the only real pot inside town.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_28_02"); //Well, fine assholes do.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_28_00"); //Hopefully never had to go in, because there's the judge. It's creepy of me, the guy.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_28_01"); //This completes the tour. I'm gonna go to the inn, get some new stuff.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_28_02"); //You can come with me if you want to.
...
FUNC VOID Info_Mod_Hubert_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_Freudenspender_28_01"); //Nah, nah, nah, my Zeuchz is enough for me...
};
