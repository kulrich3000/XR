...
FUNC VOID Info_Mod_Hubert_Landvermessung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_Landvermessung_06_02"); //H... hm. Przynies mi nowe szkodniki. W moim stonowanym stanie, zadne jasne mysli nie moga jeszcze uchwycic.
	AI_Output(hero, self, "Info_Mod_Hubert_Landvermessung_15_03"); //Woher bekomme ich das "buczenie"?
	AI_Output(self, hero, "Info_Mod_Hubert_Landvermessung_06_04"); //Zawsze prosto przed siebie, a nastepnie w prawo. Nie, lepiej pójde do kurczaka, gdzie Fusl, uh, wyprzedal sie. Powinien byc otoczony rynkiem. (rowery)
...
FUNC VOID Info_Mod_Hubert_LandvermessungAlk_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_06_01"); //Och, dobrze!

	CreateInvItems	(self, ItFo_Booze, 1);

	B_UseItem	(self, ItFo_Booze);

	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_06_02"); //Teraz sytuacja jest lepsza. Jezu Chryste! Mam jakies wewnetrzne dipy.... sródmiazszowy zastanawiales sie nad swoim pytaniem.
	...
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_06_06"); //Siebn Stobbelfelder! Kho-ra-ra-ra-ra-ra-ta jest tak samo duza jak siebn Stobbelfelder obok siebie.
	AI_Output(hero, self, "Info_Mod_Hubert_LandvermessungAlk_15_07"); //Wspanialy....
	AI_Output(self, hero, "Info_Mod_Hubert_LandvermessungAlk_06_08"); //Czyz nie?
...
FUNC VOID Info_Mod_Hubert_CityGuide01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_06_01"); //Kto? A do czasu, az tu nowe?
	AI_Output(hero, self, "Info_Mod_Hubert_CityGuide01_15_02"); //Domyslales sie tego.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_06_03"); //Cóz, nie da sie tego zrobic..... Odczekaj minute, posortuj moje nogi. (grozy)
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_06_04"); //Zawsze milo i ladnie z nieznajomym, huh?
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide01_06_05"); //Po prostu biegaj za mna i mów mi, kiedy jestem tak szybki.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide02_06_00"); //To jest nasz ratusz. Tam wlasnie mieszka nasz Oberfurzi. No cóz, hello sagn.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide03_06_00"); //Tutaj mam cos do picia. A jesli chcesz kopnac tylek, mozesz znac Hansa..... n... Umiejetnosc uczenia sie.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide04_06_00"); //Na ulicy wszyscy oni ida olówkiem..... n. Nie ma dokad isc.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_06_00"); //Wewnatrz sa bruzdy sukni, jak je nazywam.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_06_01"); //Szynka jest jedynym prawdziwym doniczka w miescie.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide05_06_02"); //Dobrze, delikatne nasadki.
...
{
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_06_00"); //Miejmy nadzieje, ze nigdy nie musielismy wejsc, bo jest sedzia. To mnie, facet, to pelza.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_06_01"); //To zakonczy trase. Jestem gonna ide do karczmy, dostaje nowe rzeczy.
	AI_Output(self, hero, "Info_Mod_Hubert_CityGuide06_06_02"); //Mozesz przyjsc do mnie, jesli chcesz.
...
FUNC VOID Info_Mod_Hubert_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hubert_Freudenspender_06_01"); //Nah, nah, nah, nah, nah, mój Zeuchz wystarczy mi....
};
