...
FUNC VOID Info_Mod_Friedel_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Hi_01_00"); //I'm Friedel, teaching the young men how to fight.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(hero, self, "Info_Mod_Friedel_Hi_15_01"); //Can you teach me something?
		AI_Output(self, hero, "Info_Mod_Friedel_Hi_01_02"); //As long as you are inexperienced, I will be able to show you one or two tricks.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_01"); //Nice! This would give us a third participant.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_02"); //The other two will be my apprentice students taking their final exams in rat hunting.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_03"); //Can we take off then?
	AI_Output(hero, self, "Info_Mod_Friedel_Wettstreit_15_04"); //I'd like to know the rules.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_05"); //That can be arranged!
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_06"); //There's always rats all over the lake.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_07"); //Participants start at the same time and must kill all the rats around the lake.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_08"); //Whoever is most successful wins and receives a cash prize.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_01_09"); //When you're ready, we can begin.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_A_01_01"); //Then don't waste any time!
...
FUNC VOID Info_Mod_Friedel_Wettstreit2_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_01_00"); //All due respect, even I would have had a hard time with you.
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_01_01"); //You shall be rewarded for this.
	...
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_01_02"); //Today was not enough.

		if (Mod_REL_Wettstreit_Verloren == 0)
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_01_03"); //But since we have so many rats this year, we can still have a competition tomorrow. Maybe that will make you more successful.
...
{
	AI_Output(self, hero, "Info_Mod_Friedel_Buerger_01_00"); //A new one in our ranks. Here's your starting capital.
	...
	if (Mod_Verhandlungsgeschick > 0)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_01_02"); //You got that right. But this has to do it!
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_01_03"); //I don't want that to be enough for the rest of your life! Go to work!
		};
	};
};
...
FUNC VOID Info_Mod_Friedel_Unruhen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Unruhen_01_01"); //All right, even if it's not right.
...
FUNC VOID Info_Mod_Friedel_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Freudenspender_01_01"); //Are you kidding me? No, I don't want to!
};
...
FUNC VOID Info_Mod_Friedel_Lernen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Lernen_01_01"); //What do you want to learn?
