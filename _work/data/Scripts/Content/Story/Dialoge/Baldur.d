...
FUNC VOID Info_Mod_Baldur_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_08_01"); //Jestem Baldur, mysliwy w sluzbie druidom i straznikom.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_02"); //Niebezpieczenstwo? Druidy? Co.....?
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_08_03"); //Rangers sa równiez mysliwymi, ale sa oni czesciowo zaangazowani w walke.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_04"); //A i Druidowie?
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_08_05"); //To sa liderzy Rangersów. A takze wszystkich mysliwych.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_08_06"); //Madrzy mezczyzni, którzy znaja swoja droge wokól medycyny i magii.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_08_07"); //Nie poluja i rzadko walcza, kochaja przyrode i modla sie do Adanosa.
...
FUNC VOID Info_Mod_Baldur_CyrcoMine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_08_01"); //To wlasnie mam na mysli! To jest gromada, która mamy!
	AI_Output(hero, self, "Info_Mod_Baldur_CyrcoMine_15_02"); //Udales sie na kolejna runde? Dostalem kolejna misje.
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_08_03"); //Nie, pozwólcie mu odejsc. Urazilem ramie. Lepsze nie.
};
...
FUNC VOID Info_Mod_Baldur_Felle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_08_01"); //Jest ich stos. Pomóz sobie.
	AI_Output(hero, self, "Info_Mod_Baldur_Felle_15_02"); //Bede mial 10 sztuk.
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_08_03"); //Przejdz do przodu. Nie musze jej wciagac.
...
FUNC VOID Info_Mod_Baldur_AlterMann_Info()
{
	if (Mod_BDT_AlterWaldMann == 0)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_00"); //Ach, masz na mysli starego czlowieka z lasu. Tak, wiem o nim cos.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_01"); //Mówi sie, ze ma ona stulecia i ma chronic zwierzeta w lesie wokól Khoraty.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_02"); //Mówi sie, ze jest slepy, ale jednoczesnie ma magiczny talent.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_03"); //To wszystko, o czym moge teraz pomyslec. Moze ktos inny wie wiecej.
	...
	else if (Mod_BDT_AlterWaldMann == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_04"); //Stary czlowiek z lasu? Tak, slyszalem, ze byl kiedys sluga Adano.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_05"); //Nie wiadomo, czy byl on takim straznikiem jak my, magikiem wody, czy przemieniajacym magiem.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_06"); //Jego magiczne zdolnosci, a takze silne przywiazanie do swiata zwierzat i roslin sa dowodem na to, ze ma wszystko.
	...
	else if (Mod_BDT_AlterWaldMann == 2)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_07"); //Cóz, nie moge ci wiele powiedziec o nim.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_08"); //Problem polega równiez na tym, ze nie rozmawia z nikim, nawet z nami, nawet jesli dazymy do podobnych celów.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_09"); //Sam z zwierzetami lasu bawi sie sam.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_10"); //No cóz, gdybym byl dzikiem, jestem pewien, ze móglbym powiedziec ci wiecej o nim.
	...
	else if (Mod_BDT_AlterWaldMann == 3)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_11"); //Stary czlowiek z lasu? Cóz, ma byc scisle zwiazany z fauna i flora.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_12"); //Mówi sie, ze prowadzi on spakowywanie zwierzat takich jak knury czy wilki, aby chronic las przed intruzami.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_13"); //Nawet mówi sie, ze czesto wystepuje w ksztalcie zielonego wilka.
	...
	else if (Mod_BDT_AlterWaldMann == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_14"); //Interesuja Cie opowiesci o starym czlowieku z lasu?
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_15"); //Cóz, nie wiem wiele o tej mistycznej dziwnej kuli.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_16"); //Podobno zamieszkuje glównie w ciemnym lesie, ale równiez w poblizu zbiorników wodnych, takich jak jeziora.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_08_17"); //Rzadko zdarza sie, ze ktos go widzial.....
