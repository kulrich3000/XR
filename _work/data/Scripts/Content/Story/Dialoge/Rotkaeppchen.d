...
FUNC VOID Info_Mod_Rotkaeppchen_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_01"); //Zaczynam sie martwic.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_02"); //Od jakiegos czasu czuje sie nawiedzony przez duzego wilka. On jest tam z powrotem, kierujac sie do spalonego magazynu.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_03"); //Nie osmiele sie chodzic obok niego, wiec biegam coraz glebiej w glab lasu.
...
FUNC VOID Info_Mod_Rotkaeppchen_Grossmutter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Grossmutter_19_01"); //Tak, dlaczego pytasz? Chce ja odwiedzic juz wkrótce, ona jest tak sama.
};
...
FUNC VOID Info_Mod_Rotkaeppchen_WolfTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_01"); //Odjechales go?
	AI_Output(hero, self, "Info_Mod_Rotkaeppchen_WolfTot_15_02"); //Mozna to nazwac.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_03"); //Wtedy wreszcie moge wrócic do domu!
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_04"); //Dzieki temu dostaniesz polowe zebranych przeze mnie grzybów!
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_05"); //Zobacz, jakie wspaniale okazy znalazlem!
