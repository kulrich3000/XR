...
{
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_00"); //(Przypomniales) UZYTKOWNIK! Odczekac minute..... Teraz zawdziecza mi pan kilka odpowiedzi!
	...
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_02"); //Widze fakty przed mna - ale jak to fuck!
	AI_Output(hero, self, "Info_Mod_Milten_Hi_15_03"); //Xardas.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_04"); //(smiech) Wszystko w porzadku, potem wiem. Zdecydowanie dobrze jest wiedziec, ze jestes tutaj.
	...
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_06"); //Tak, ale wymagalo to wielu przekonujacych dzialan. No cóz, nie mialem zwolenników, nie mialem przyzwoitych szkolen. Ale robiac magie, bije ich wszystkich tutaj, szybko to zrozumieli.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_07"); //Wiec moglem sie od razu uratowac nowicjuszowi szate.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_28_08"); //I ty? Jakie sa Twoje plany?
...
FUNC VOID Info_Mod_Milten_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Hi_B_28_01"); //Gratuluje, potem przyszedles do klasztoru! Oczywiscie docenilabym to, gdybyscie do nas dolaczyli.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_B_28_02"); //A co z twoimi umiejetnosciami?
	AI_Output(hero, self, "Info_Mod_Milten_Hi_B_15_03"); //Zle. Wszystko musze uczyc sie od zera.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_B_28_04"); //Och, drodzy, nie ma sposobu, abyscie mogli przejsc nowicjat. Ale nie martw sie, to juz minie.
...
FUNC VOID Info_Mod_Milten_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Hi_A_28_01"); //Nic dziwnego o tym, co przezyles. Poswiec troche czasu.
	AI_Output(self, hero, "Info_Mod_Milten_Hi_A_28_02"); //Moze poczujesz sie nawet jak dolaczyc do klasztoru na koncu. Bylbym szczesliwy.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_00"); //Witam, mam nadzieje, ze nie przeszkadzalo mi ci to.....
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch_15_01"); //Nie, nie, dopiero konczyli.
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_02"); //Wyglada na to, ze znów jest duzo tajnosci w grze, tak samo jak wyodrebniles sie od innych..... No cóz, zreszta jestem z Lester.
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch_15_03"); //Wczoraj? Co sie z nim dzieje?
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_04"); //Chce, abym ci powiedzial, ze modyfikuje niektóre z glównych ról.
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_05"); //Moga pomóc Ci znalezc bron bogów.
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch_15_06"); //Dobrze, dziekuje. Zatrzymam sie na jego miejscu.
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_07"); //Tak, zrób to. Bede jednak opiekowal sie tym incydentem wraz z póznym nowicjuszem.
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch_15_08"); //Smierc nowicjusza!
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_09"); //Dyrian, dzis rano nagle zmarl. Babo widzial, ze tak sie stalo.
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch_28_10"); //Musial wziac biednego czlowieka dosc duzo z nim, jak on ledwie zyskal slowo z niego od tego czasu.
...
FUNC VOID Info_Mod_Milten_Daemonisch2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch2_28_01"); //Tak, o co to chodzi?
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch2_15_02"); //Na czym polega wino klasztorne?
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch2_28_03"); //Hmm, nie wiem, czy powinienem ci to powiedziec. Wiedza ta jest wlasciwie przeznaczona tylko dla strazaków.
	AI_Output(hero, self, "Info_Mod_Milten_Daemonisch2_15_04"); //Moze sie to okazac wazne.
	AI_Output(self, hero, "Info_Mod_Milten_Daemonisch2_28_05"); //Wszystkie sluszne, wszystkie sluszne. Wiec wziac piec butelek zwyklego wina, isc z nim do swiatyni Innos, poswiecic go i rozprowadzic eliksir do uzdrowienia obsesji z nim. To równiez o to chodzi.
...
FUNC VOID Info_Mod_Milten_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath_28_02"); //Hmm, posród magów strazy pozarnej klasztoru kazdy ma przypisane mu zadania.
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath_28_03"); //Nie bedzie latwo znalezc kogos, kto nie chce zostac pominiety......
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath_28_04"); //Wsród paladynów, najprawdopodobniej bedziesz mógl liczyc na Tengrona jako swojego towarzysza, który juz wykazal sumiennosc w zagrozeniu dreczyciela duszy i jest przeznaczony do uwolnienia dla misji?
...
FUNC VOID Info_Mod_Milten_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath2_28_01"); //Nie jestem zwiazany z klasztorem. Jak pytaja mnie Panstwo, z przyjemnoscia towarzyszyc Panstwu w tej przygodzie.
	AI_Output(hero, self, "Info_Mod_Milten_Irdorath2_15_02"); //Wtedy witam pana na pokladzie. Zobacze cie w porcie.
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath2_28_03"); //Doskonaly. Do zobaczenia pózniej.
...
FUNC VOID Info_Mod_Milten_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath3_28_01"); //Zbyt zle. Wróce wtedy. Wiesz, gdzie mnie znalezc, jesli kiedykolwiek zostanie jakies miejsce.
...
FUNC VOID Info_Mod_Milten_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Irdorath4_28_01"); //Bardzo dobrze, wróce do portu.
...
FUNC VOID Info_Mod_Milten_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_28_01"); //Hmmmmm.....
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_28_02"); //Jest cos, z czym mozesz mi pomóc. Jest to jednak dosc niebezpieczne.
...
FUNC VOID Info_Mod_Milten_Aufgabe_Wie()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Wie_28_01"); //Nauczyciel Neoras poprosil mnie, abym zaparzyl eliksir.
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Wie_28_02"); //Potrzebujesz jednak bardzo rzadkiej rosliny i nie jest latwo ja dostac.
...
FUNC VOID Info_Mod_Milten_Aufgabe_Pflanze()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Pflanze_28_01"); //Roslina ta nosi nazwe Sonnenaloe i rosnie tylko w poblizu Black Troll.
	AI_Output(hero, self, "Info_Mod_Milten_Aufgabe_Pflanze_15_02"); //CZARNY TROLL?
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Pflanze_28_03"); //Tak, dlatego jeszcze nie moglem skonczyc eliksiru. Samotnie nie jest mozliwe, aby magik taki jak ja zabil trolle.
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Pflanze_28_04"); //Móglbym Ci pomóc z moja magia, a nastepnie mozesz zlapac rosline.
	AI_Output(hero, self, "Info_Mod_Milten_Aufgabe_Pflanze_15_05"); //A gdzie jest ten troll?
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Pflanze_28_06"); //Mieszka w jaskini na pólnoc od wyspy. Moge uratowac nam troche podróz, teleportujac nas z klasztoru.
	AI_Output(self, hero, "Info_Mod_Milten_Aufgabe_Pflanze_28_07"); //Musimy przejsc reszte drogi. Prosze pozwolic mi wiedziec, kiedy sie zaczyna.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_Teleport_Da_28_00"); //Stamtad musimy isc, podazac za mna.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_Station_28_00"); //Jesli zejdziesz z tej sciezki, przyjedziesz do miejsca wykopaliska Magika Wody. Ale mozna przyjrzec sie im pózniej.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_AnSee_28_00"); //Prawie tam jestesmy. Po drugiej stronie tego jeziora znajduje sie jaskinia.
	AI_Output(hero, self, "Info_Mod_Milten_AnSee_15_01"); //Poruszajmy sie dalej.
	AI_Output(self, hero, "Info_Mod_Milten_AnSee_28_02"); //Dobrze, podazaj za mna.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_BeiTroll_28_00"); //Oto jestesmy. Mam dla Ciebie eliksir, który sprawi, ze bedziesz szybszy.
	AI_Output(self, hero, "Info_Mod_Milten_BeiTroll_28_01"); //Jedyne co musisz zrobic, to dostac rosline i przyjsc do mnie. Teleportuje nas z powrotem do klasztoru.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_Fertig_28_00"); //Wrócmy tu wreszcie.
	AI_Output(hero, self, "Info_Mod_Milten_Fertig_15_01"); //Jest to Sonnenaloe.

	B_GiveInvItems	(hero, self, ItPl_Sagitta_Herb_MIS, 1);

	AI_Output(self, hero, "Info_Mod_Milten_Fertig_28_02"); //Dzieki. Teraz moge skonczyc eliksir Mistrza Neorasa.
	AI_Output(self, hero, "Info_Mod_Milten_Fertig_28_03"); //Najlepiej dac mu eliksir, a nastepnie mozna go przekonac. Wróce jutro i bede gotowy.
...
FUNC VOID Info_Mod_Milten_HabTrank_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_HabTrank_28_01"); //Tak, wlasnie skonczylem.
	AI_Output(self, hero, "Info_Mod_Milten_HabTrank_28_02"); //Tutaj jest, Panie Panu.

	B_GiveInvItems	(self, hero, NeorasTrankVonMilten, 1);

	AI_Output(self, hero, "Info_Mod_Milten_HabTrank_28_03"); //Zabierz go do Neorasa, bedzie o Tobie przekonany.
...
FUNC VOID Info_Mod_Milten_MardukAufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_MardukAufgabe_28_01"); //Cóz, z pewnoscia zrobil pan na nim mile wrazenie.
	AI_Output(self, hero, "Info_Mod_Milten_MardukAufgabe_28_02"); //Powinien byc tak samo swiadomy, jak ja, ze nigdy nie bedziesz w stanie zrobic tego samemu, bez pomocy maga?
	AI_Output(hero, self, "Info_Mod_Milten_MardukAufgabe_15_03"); //Dlatego prosze Cie.
	AI_Output(self, hero, "Info_Mod_Milten_MardukAufgabe_28_04"); //Dobrze, pomoze ci w tym.... Ale jest to miedzy nami, wszyscy sluszne?
	AI_Output(self, hero, "Info_Mod_Milten_MardukAufgabe_28_05"); //Potrzebuje kamienia z run, pecha i zaklec w kuli ognia.
...
FUNC VOID Info_Mod_Milten_HabZutatenRune_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_HabZutatenRune_28_01"); //Zobaczmy teraz. Najpierw kamien runowy.
	AI_Output(hero, self, "Info_Mod_Milten_HabZutatenRune_15_02"); //Tutaj jest, Panie Panu.

	B_GiveInvItems	(hero, self, ItMi_RuneBlank, 1);

	AI_Output(self, hero, "Info_Mod_Milten_HabZutatenRune_28_03"); //Nieszczescie, wiec.
	AI_Output(hero, self, "Info_Mod_Milten_HabZutatenRune_15_04"); //Idzcie, prosze.

	B_GiveInvItems	(hero, self, ItMi_Pitch, 1);

	AI_Output(self, hero, "Info_Mod_Milten_HabZutatenRune_28_05"); //A rola strazaka.
	...
	AI_Output(self, hero, "Info_Mod_Milten_HabZutatenRune_28_07"); //Dobrze, to wszystko. Wróc jutro i runa powinna byc gotowa.
...
FUNC VOID Info_Mod_Milten_RuneFertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_RuneFertig_28_01"); //Tutaj jest.

	B_GiveInvItems	(self, hero, ItRu_InstantFireball, 1);

	AI_Output(hero, self, "Info_Mod_Milten_RuneFertig_15_02"); //Dziekuje bardzo.
	AI_Output(self, hero, "Info_Mod_Milten_RuneFertig_28_03"); //Ale jak juz powiedzialem, jest to miedzy nami. Jestem zbyt ciekawy, ze widze twarz Marduka, kiedy przynosisz mu rune.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_MardukRune_28_00"); //Reakcja Marduka przekroczyla moje oczekiwania.
	AI_Output(hero, self, "Info_Mod_Milten_MardukRune_15_01"); //Mil?
	AI_Output(self, hero, "Info_Mod_Milten_MardukRune_28_02"); //Powiedzialem ci, ze nie brakuje mi tego. Bylo to troche jak dawne czasy, kiedy Saturas nazywal czerwony, jesli sie rozumie......
	AI_Output(hero, self, "Info_Mod_Milten_MardukRune_15_03"); //Hmm..... gniewny mag Czy zwalowanie rudy?
	AI_Output(self, hero, "Info_Mod_Milten_MardukRune_28_04"); //Dokladnie.
	AI_Output(hero, self, "Info_Mod_Milten_MardukRune_15_05"); //I ciesze sie z waszego powrotu.
	AI_Output(self, hero, "Info_Mod_Milten_MardukRune_28_06"); //Za kazdym razem jeszcze raz. Jestem pewien, ze to nie byla nasza ostatnia sztuczka. Do tego czasu.
...
FUNC VOID Info_Mod_Milten_Treffen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Treffen_28_01"); //Dobrze, od razu bede w drodze.
...
FUNC VOID Info_Mod_Milten_HaveYouCrawlerEggs_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_HaveYouCrawlerEggs_28_01"); //Gorn przywiózl mnie wtedy z otwartej kopalni. Ladne próbki.
	AI_Output(self, hero, "Info_Mod_Milten_HaveYouCrawlerEggs_28_02"); //Nie wiedzialem, ze w wolnej kopalni jest królowa.
...
FUNC VOID Info_Mod_Milten_MinecrawlerEi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_MinecrawlerEi_28_01"); //Uzylem jednego, ale mozesz miec drugiego.
...
{
	AI_Output(self, hero, "Info_Mod_Milten_Drachen_28_00"); //Hej, moge miec cos dla Ciebie.
	AI_Output(self, hero, "Info_Mod_Milten_Drachen_28_01"); //Po zaatakowaniu tych jaszczurów, badalem je w starozytnych pismach.
	AI_Output(self, hero, "Info_Mod_Milten_Drachen_28_02"); //Ten zlowieszczy przepis natknalem sie na starozytna, mocno zwietrzala ksiazke.
	AI_Output(self, hero, "Info_Mod_Milten_Drachen_28_03"); //Moze mozna cos z tym zrobic.
...
FUNC VOID Info_Mod_Milten_Leichengase_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Milten_Leichengase_28_01"); //Oczywiscie, o co chodzi?
	AI_Output(hero, self, "Info_Mod_Milten_Leichengase_15_02"); //Musze dostac trolle aby tam zjesc ta torbe ziól.
	AI_Output(self, hero, "Info_Mod_Milten_Leichengase_28_03"); //Co? No cóz, masz powody.
	AI_Output(hero, self, "Info_Mod_Milten_Leichengase_15_04"); //Czy mozesz mi pomóc, czy nie?
	AI_Output(self, hero, "Info_Mod_Milten_Leichengase_28_05"); //Mam pomysl.
	AI_Output(self, hero, "Info_Mod_Milten_Leichengase_28_06"); //Udaj sie do Hyglasa, jest on odpowiedzialny za zaklecie, które toczy sie tutaj w klasztorze. Popros go o pomoc.
	
	if (hero.guild != GIL_VLK) {
		AI_Output(self, hero, "Info_Mod_Milten_Leichengase_28_07"); //Oto klucz do biblioteki.
