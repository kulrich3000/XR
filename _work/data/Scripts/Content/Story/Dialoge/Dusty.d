...
{
	AI_Output(self, hero, "Info_Mod_Dusty_Hi_14_00"); //You here? They said you were buried in the temple of sleepers--
	AI_Output(hero, self, "Info_Mod_Dusty_Hi_15_01"); //A long, unpleasant story. But why are you here?
	AI_Output(self, hero, "Info_Mod_Dusty_Hi_14_02"); //I was supposed to go over to the mainland, family and stuff. (laughs tortured)
	AI_Output(self, hero, "Info_Mod_Dusty_Hi_14_03"); //The only problem is that there is currently no ship in the harbor that will be leaving the port in the near future.
	AI_Output(self, hero, "Info_Mod_Dusty_Hi_14_04"); //And because the paladins are causing a lot of stress even in the harbour district, I'm out again and get hunted.
};
...
FUNC VOID Info_Mod_Dusty_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_Lehrer_14_01"); //I can definitely show you the basics. You helped me in the colony, didn't you?
...
FUNC VOID Info_Mod_Dusty_Infos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_Infos_14_01"); //Yeah, I saw some. It was two small groups.
	AI_Output(hero, self, "Info_Mod_Dusty_Infos_15_02"); //Where can I find her?
	AI_Output(self, hero, "Info_Mod_Dusty_Infos_14_03"); //You know something? I've been on withdrawal for days. My brain doesn't work that fast, if you know what I mean.
	AI_Output(hero, self, "Info_Mod_Dusty_Infos_15_04"); //You need another dose of swampweed?
	AI_Output(self, hero, "Info_Mod_Dusty_Infos_14_05"); //(wholish) Oh, yes! If you bring me a good stem, I'll get my thoughts straightened out.
...
FUNC VOID Info_Mod_Dusty_Kippe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_Kippe_14_01"); //Ah, very nice. My eyes are clear again.
	AI_Output(hero, self, "Info_Mod_Dusty_Kippe_15_02"); //Then tell me where I can find the fanatics.
	AI_Output(self, hero, "Info_Mod_Dusty_Kippe_14_03"); //One group has settled at the lighthouse. That's the bigger group. When you go there, you have to be very careful.
	AI_Output(self, hero, "Info_Mod_Dusty_Kippe_14_04"); //The other group is in a cave in the forest south of town. You should stop by there first.
	AI_Output(self, hero, "Info_Mod_Dusty_Kippe_14_05"); //You better let the lighthouse stay before you find out more.
...
FUNC VOID Info_Mod_Dusty_Crawlersekret_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_Crawlersekret_14_01"); //I've heard from the other hunters that minecrawlers have been spotted in the north.
	AI_Output(self, hero, "Info_Mod_Dusty_Crawlersekret_14_02"); //If you're lucky, there's also a queen there whose eggs you can steal to win the secret from.
};
...
FUNC VOID Info_Mod_Dusty_OtherHunters_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_OtherHunters_14_01"); //Bei der Taverne "The Dead Harpy" nordöstlich von hier ist ein großes Lager, an dem ich vorbeigekommen bin. Ob es noch andere Treffpunkte gibt, weiß ich nicht.
...
FUNC VOID Info_Mod_Dusty_Bruderschaft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_Bruderschaft_14_01"); //I don't know, there wasn't much of a sense of departure or anything. Most of them have built up a new life in the camp and do not want to leave.
	AI_Output(self, hero, "Info_Mod_Dusty_Bruderschaft_14_02"); //That the sleeper was an arch-demon had to digest some of course, but I don't know if they were looking for a replacement or just smoking swamp herbs.
};
...
FUNC VOID Info_Mod_Dusty_BosperFelle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dusty_BosperFelle_14_01"); //I've shot a few wolves, even though they're damn dangerous.
	AI_Output(self, hero, "Info_Mod_Dusty_BosperFelle_14_02"); //But I didn't skin them all. Wait a minute.... I'd have two undamaged skins. Interested?
	...
	AI_Output(self, hero, "Info_Mod_Dusty_BosperFelle_14_04"); //You removed the barrier. That's all you need to do for me.
};
...
FUNC VOID Info_Mod_Dusty_Lernen_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_14_01"); //Depends on what you want to know.
		...
		{ 
			Info_AddChoice	(Info_Mod_Dusty_Lernen, B_BuildLearnString ("Teeth torn",B_GetLearnCostTalent (hero,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Teeth)), Info_Mod_Dusty_Lernen_Teeth);
		};
		if (PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_Claws] == FALSE)
		{ 
			Info_AddChoice	(Info_Mod_Dusty_Lernen, B_BuildLearnString ("Chipping claws",B_GetLearnCostTalent (hero,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Claws)), Info_Mod_Dusty_Lernen_Claws);
		};
		...
		{ 
			Info_AddChoice	(Info_Mod_Dusty_Lernen, B_BuildLearnString ("skin",B_GetLearnCostTalent (hero,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Fur)), Info_Mod_Dusty_Lernen_Fur);
		};
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_14_02"); //I can't teach you any more than you already know. Sorry about that.
	};
};
...
FUNC void Info_Mod_Dusty_Lernen_Claws()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Claws_14_00"); //Animals don't like to give their claws away. You have to hit the exact spot where you're going with your knife.
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Claws_14_01"); //The posture of your hand should be slightly entangled. With a strong jolt you cut off the claw.
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Claws_14_02"); //Claws are always a sought-after means of payment for a trader.
	};
...
FUNC void Info_Mod_Dusty_Lernen_Teeth()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Teeth_14_00"); //The easiest thing you can extract from animals is their teeth. You're driving your knife around the dentures in his mouth.
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Teeth_14_01"); //Then you skillfully separate it from the animal's skull with a jerk.
	};
...
FUNC void Info_Mod_Dusty_Lernen_Fur()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Fur_14_00"); //The best way to remove fur is to make a deep cut on the animal's hind legs.
		AI_Output(self, hero, "Info_Mod_Dusty_Lernen_Fur_14_01"); //Then you can always pull the fur from the front to the back very easily.
	};
