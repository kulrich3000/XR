...
FUNC VOID Info_Mod_Mario_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hi_08_01"); //I rush down one beer at a time. It actually helps against frustration.
	AI_Output(hero, self, "Info_Mod_Mario_Hi_15_02"); //What frustration?
	AI_Output(self, hero, "Info_Mod_Mario_Hi_08_03"); //They call me the eternal militia. For years I have been trying to become a paladin, but at the top of the chain of command I have no friends, but rather enemies.
	AI_Output(self, hero, "Info_Mod_Mario_Hi_08_04"); //That's why I'm just sent from one task to the next.
	AI_Output(self, hero, "Info_Mod_Mario_Hi_08_05"); //Twenty-two I've done so far. Some make it without an entrance exam.
	AI_Output(self, hero, "Info_Mod_Mario_Hi_08_06"); //And now they've given me a task I can't solve.
};
...
FUNC VOID Info_Mod_Mario_WarumFeinde_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_WarumFeinde_08_01"); //I never made a secret of being gay.
	AI_Output(self, hero, "Info_Mod_Mario_WarumFeinde_08_02"); //That's where the charity of the paladins ends. The nicest just look at me funny.
	AI_Output(self, hero, "Info_Mod_Mario_WarumFeinde_08_03"); //"A gay paladin? Innos himself must stop it!"
};
...
FUNC VOID Info_Mod_Mario_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Aufgabe_08_01"); //There's supposed to be two snappers in the big forest outside the city.
	AI_Output(self, hero, "Info_Mod_Mario_Aufgabe_08_02"); //Instead of sending out a squad to take care of the critters, I'm getting all that dirt.
	AI_Output(self, hero, "Info_Mod_Mario_Aufgabe_08_03"); //Would probably fit the colonel well in the stuff if I was snapper-fed there.
};
...
FUNC VOID Info_Mod_Mario_Hilfe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe_08_01"); //You, a weak convict?
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe_15_02"); //Snappers are one of my specialties.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe_08_03"); //It's worth a try. Even your company won't let me sink further in the eyes of the others.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe_08_04"); //Shall we leave immediately? I know the way.
...
FUNC VOID Info_Mod_Mario_Hilfe2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe2_08_01"); //Follow me. Follow me.
...
{
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe3_08_00"); //That was barely a success. Anyway, thank you for your support.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe3_08_01"); //I'll let Garond know I passed this exam, too.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe3_08_02"); //And then I continue to see what awaits me next....
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe3_15_03"); //Let me know if you need my help again.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe3_08_04"); //It's not unlikely. But thanks for the offer.
...
FUNC VOID Info_Mod_Mario_Hilfe4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_08_01"); //Here's the deal. You have again given me a new challenge, and this time I am really at a loss.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe4_15_02"); //What's this about?
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_08_03"); //It's about a veritable horde of well-equipped goblins who have repeatedly provided skirmishes in recent weeks. Next to you criminals.
...
FUNC VOID Info_Mod_Mario_Hilfe4_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_B_08_01"); //I didn't even ask for it.
...
FUNC VOID Info_Mod_Mario_Hilfe4_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_A_08_01"); //Hardly. We need at least one more fighter. A trained ranger.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe4_A_15_02"); //I could ask Diego. He's got nothing to do right now. And he's good too.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_A_08_03"); //Diego? Isn't that a former inmate, too?
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe4_A_15_04"); //Yeah. Is that a problem for you?
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe4_A_08_05"); //(sighs) No, I'm glad somebody's on my side at all. Ask him quietly and bring him here.
...
FUNC VOID Info_Mod_Mario_Hilfe5_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe5_08_01"); //All clear. You're not that far away.
...
{
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe6_08_00"); //A hard piece of work. Share your reward with Diego.

	B_GiveInvItems	(self, hero, ItMi_Gold, 300);

	AI_Output(self, hero, "Info_Mod_Mario_Hilfe6_08_01"); //I'm really curious to see if Garond can think of another more difficult test.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe6_08_02"); //But even if his imagination is not so good, I'm afraid he will succeed.
...
FUNC VOID Info_Mod_Mario_Hilfe6_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe6_B_08_01"); //Too bad, but I can't force you.
...
FUNC VOID Info_Mod_Mario_Hilfe6_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe6_A_08_01"); //Thank you, thank you.
...
FUNC VOID Info_Mod_Mario_Hilfe7_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_08_01"); //I can be admitted now.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe7_15_02"); //Congratulations! Aren't you happy at all?
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_08_03"); //In the last few days, doubts have caught up with me as to whether it would really be right for me to become Paladin.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_08_04"); //I know now that I would hardly make friends among them. On the other hand, it's been my wish since I was a little boy.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_08_05"); //What do you think?
...
FUNC VOID Info_Mod_Mario_Hilfe7_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_B_08_01"); //That's exactly what I was thinking.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_B_08_02"); //Who knows what rules this club would come up with to keep harassing me!
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_B_08_03"); //I get along fine with the other militia men. I shouldn't take any chances.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_B_08_04"); //Thanks for your advice and your help. Without you, Coragon's beer would probably have been my best friend...
...
FUNC VOID Info_Mod_Mario_Hilfe7_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_A_08_01"); //I think you're right. It would look like I'm losing all my guts at the last minute.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_A_08_02"); //All right, I'll check in with Garond later.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe7_A_08_03"); //And you, thank you so much for your active support. Without you, Coragon's beer would probably have been my best friend...
...
{
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_08_00"); //You have to help me again, please!
...
FUNC VOID Info_Mod_Mario_Hilfe8_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_01"); //Some time ago I was doing guard duty in prison.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_02"); //That's where I met someone like me. I fell in love with him.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe8_A_15_03"); //Let me guess. You want to free the prisoner.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_04"); //He told me he landed there because of his inclinations. Because his neighbors tried to get rid of him. He's not a criminal.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_05"); //We intend to leave Khorinis. This is a place of oppression.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_06"); //We're going to look for a better home.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_07"); //From the prison to the city gates, however, there are some guards of the militia, who would certainly not let us go so easily.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe8_A_15_08"); //And what is my job?
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_09"); //While I go to prison, you take care of the two gatekeepers at the marketplace. Just lure her somewhere.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_10"); //Send Olav away too, he's on his way from the barracks to the city gate.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_11"); //I'll take care of the militiamen in prison myself.
	AI_Output(hero, self, "Info_Mod_Mario_Hilfe8_A_15_12"); //All right, I'll get started.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe8_A_08_13"); //I'm leaving now. Please don't fail!
...
{
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe9_08_00"); //I'm in your debt. But I have a little compensation for you.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe9_08_01"); //We would have used those speed potions if you hadn't helped us.
	AI_Output(self, hero, "Info_Mod_Mario_Hilfe9_08_02"); //Now we have no use for them.

	B_GiveInvItems	(self, hero, ItPo_Speed, 2);

	AI_Output(self, hero, "Info_Mod_Mario_Hilfe9_08_03"); //Now we have to leave. I wish you all the best.
