...
{
	AI_Output(self, hero, "Info_Mod_August_Hi_13_00"); //Zatrzymaj sie! Nie znam twarzy.
	AI_Output(self, hero, "Info_Mod_August_Hi_13_01"); //Das bedeutet, ich hab dir die Regeln der Stadt noch nicht vorgelesen - oder du hast dich von 'nem Schattenläufer "tylny" lassen. (lacht merkwürdig)
	AI_Output(self, hero, "Info_Mod_August_Hi_13_02"); //Nadal nie moge zapamietac glupiego tekstu, wiec musze spogladac na papier w srodku, jesli nie przeszkadza mi to.

	B_UseFakeScroll ();

	AI_Output(self, hero, "Info_Mod_August_Hi_13_03"); //Cztery przykazania dla obcych.
	AI_Output(self, hero, "Info_Mod_August_Hi_13_04"); //Po pierwsze, zabronione jest wykorzystywanie darczynców radosci w obrebie murów miejskich.
	AI_Output(self, hero, "Info_Mod_August_Hi_13_05"); //Haha, przynajmniej dotyczy tylko obcych.

	B_UseFakeScroll ();

	AI_Output(self, hero, "Info_Mod_August_Hi_13_06"); //Po drugie, trzem udomowionym szczurom straznika miejskiego nalezy sie hold.
	AI_Output(self, hero, "Info_Mod_August_Hi_13_07"); //Tak przy okazji, oni zmarli.

	B_UseFakeScroll ();

	AI_Output(self, hero, "Info_Mod_August_Hi_13_08"); //Po trzecie, zakazane jest uzycie sily.

	B_UseFakeScroll ();

	AI_Output(self, hero, "Info_Mod_August_Hi_13_09"); //Po czwarte: Hold Beliara i praktykowanie okrucienstw w jego imieniu moze zostac ukarane przez ogien smiercia.
	...
	|| (Mod_Gottstatus == 4)
	{
		AI_Output(self, hero, "Info_Mod_August_Hi_13_10"); //Ach, tak, to moze byc dla ciebie szczególnie interesujace.
	};

	AI_Output(self, hero, "Info_Mod_August_Hi_13_11"); //To wszystko. Jakies pytania?

	AI_PlayAni	(self, "T_HUNGER");

	AI_Output(self, hero, "Info_Mod_August_Hi_13_12"); //(mumbuly) Móglbym uzyc innego ugryzienia....
...
FUNC VOID Info_Mod_August_Essenholen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Essenholen_13_01"); //Och, tak! Bylabym naprawde glodna specjalnosci gospody, solonej jagnieciny.
	AI_Output(self, hero, "Info_Mod_August_Essenholen_13_02"); //Dwa racje, a ja oczywiscie oddam ci pieniadze.
...
FUNC VOID Info_Mod_August_EssenGeholt_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_EssenGeholt_13_01"); //Dziekuje! Wez to pod uwage!
...
FUNC VOID Info_Mod_August_EssenGeholt_A()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_August_EssenGeholt_A_13_01"); //Masz racje, zaslugujesz na wiecej.
	...
	{
		AI_Output(self, hero, "Info_Mod_August_EssenGeholt_A_13_02"); //Jestes oszukiwany!
	};
...
FUNC VOID Info_Mod_August_Plagenquest_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_August_Plagenquest_13_00"); //Mam nadzieje, ze damn to Teodorus wkrótce cos dowie sie.
	...
	{
		AI_Output(self, hero, "Info_Mod_August_Plagenquest_13_01"); //Damn to, mam nadzieje, ze Wendel wkrótce sie dowie.
	...
	{
		AI_Output(self, hero, "Info_Mod_August_Plagenquest_13_02"); //Damn, mam nadzieje, ze lucas wkrótce cos sie dowie.
	...
	AI_Output(self, hero, "Info_Mod_August_Plagenquest_13_03"); //Wszystkie pieprzace sie istoty...... Przypomina mi o najgorszej podrózy, jaka kiedykolwiek odbylem.
};
...
FUNC VOID Info_Mod_August_Zurechtfinden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Zurechtfinden_13_01"); //Nie jest to takie trudne. Po prostu jedz prosto przed siebie glówna droga i dotrzesz na rynek.
	AI_Output(self, hero, "Info_Mod_August_Zurechtfinden_13_02"); //Po lewej stronie znajduje sie droga prowadzaca prosto do siedziby sadu.
	AI_Output(self, hero, "Info_Mod_August_Zurechtfinden_13_03"); //A potem skrecamy w lewo i trafiamy do gospody. To na razie powinno wystarczyc.
	AI_Output(self, hero, "Info_Mod_August_Zurechtfinden_13_04"); //Jesli chcesz byc prowadzony, zapytaj Huberta, czesto czai sie wokól bramy.
};
...
FUNC VOID Info_Mod_August_KhorataOrganisation_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_KhorataOrganisation_13_01"); //Nie potrafie dokladnie ci to wytlumaczyc.
	AI_Output(self, hero, "Info_Mod_August_KhorataOrganisation_13_02"); //Nasz gubernator Anselm dba o wszystkie przepisy i nowe prawa, sedzia i jego dwaj synowie prowadza sad, a my pilnujemy, aby wszystko pozostalo spokojne.
	AI_Output(self, hero, "Info_Mod_August_KhorataOrganisation_13_03"); //Khorata dobrze zarabia na handlu przysmakami i tym, co kupuja kupcy!
	AI_Output(self, hero, "Info_Mod_August_KhorataOrganisation_13_04"); //Przeciagnij duzo rzeczy do miasta, widze to tutaj.
};
...
FUNC VOID Info_Mod_August_Buerger_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Buerger_13_01"); //To prawda. A co z nimi?
	AI_Output(hero, self, "Info_Mod_August_Buerger_15_02"); //Czy znasz ich nazwiska?
	AI_Output(self, hero, "Info_Mod_August_Buerger_13_03"); //Oczywiscie. Kiedy zyli, kazdego dnia musielismy im oddawac hold przez straznika.
	AI_Output(self, hero, "Info_Mod_August_Buerger_13_04"); //Oleg, Pinky i Fievel. Haha, naprawde chore imiona szczurów, huh?
	AI_Output(hero, self, "Info_Mod_August_Buerger_15_05"); //To prawda. Dziekuje za informacje.
	AI_Output(self, hero, "Info_Mod_August_Buerger_13_06"); //Nic do podziekowania.
};
...
{
	AI_Output(self, hero, "Info_Mod_August_Buerger2_13_00"); //Cóz, dostales obywatelstwo? Gratuluje, jestes dobrym czlowiekiem.
};
...
{
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_00"); //Nie jest to dobry czas, boje sie.
	AI_Output(hero, self, "Info_Mod_August_Unruhen_15_01"); //Co sie dzieje?
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_02"); //Wszystko to gówno. Zaczelo sie od Buddlera w naszej kopalni, który domagal sie wiekszych plac i lepszych warunków pracy.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_03"); //Ale Anselm nie pozwolil nikomu z nim porozmawiac.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_04"); //W rezultacie górnicy odmówili kontynuowania pracy, a oni opanowali i zwiazali swojego przelozonego Frazera.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_05"); //Anselm wyslal firmy Tyrus i Dalton, aby przywrócily kopaczom do pracy.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_06"); //Wyobraz sobie! Tylko Tyrus i Dalton, dwie glowice.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_07"); //Oczywiscie spór sie nasilil, a potem zaczely grac pickaxy.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_08"); //Jeszcze nie odwazylismy sie zabrac dwóch cial przed kopalnie.
	AI_Output(hero, self, "Info_Mod_August_Unruhen_15_09"); //Brzmi to jak ogromny problem.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_10"); //Jesli tylko to bylo wszystko! Anselm odszedl i nie mamy juz gubernatora!
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_11"); //I bez fuksujacego przywódcy nikt nie chce sie martwic negocjacjami z buddystami.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_12"); //Czy nie bylbys w nastroju do pracy?
	AI_Output(hero, self, "Info_Mod_August_Unruhen_15_13"); //Przykro mi, ale to nie jest mój pomysl na przyszlosc.
	AI_Output(self, hero, "Info_Mod_August_Unruhen_13_14"); //Czy móglbys przynajmniej zajac sie nastepca Anselma?
...
FUNC VOID Info_Mod_August_Unruhen2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Unruhen2_13_01"); //Moim zdaniem sa trzy odpowiednie kandydatury: Lukasz, Wendel i Theodorus.
	AI_Output(self, hero, "Info_Mod_August_Unruhen2_13_02"); //Porozmawiaj z nimi i spróbuj ich przekonac.
	AI_Output(self, hero, "Info_Mod_August_Unruhen2_13_03"); //Kiedy juz je wszystkie uslyszysz, zastanów sie i zglos sie do mnie.
	AI_Output(self, hero, "Info_Mod_August_Unruhen2_13_04"); //Ufamy Panstwu.
...
FUNC VOID Info_Mod_August_Unruhen3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_13_01"); //Wyrzuc go na zewnatrz.
...
FUNC VOID Info_Mod_August_Unruhen3_C()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_C_13_01"); //Tak, dobre lucasy to naprawia.
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_C_13_02"); //Idz do niego i powiedz mu dobra wiadomosc, upewnie sie, ze cale miasto wie o tym.
...
FUNC VOID Info_Mod_August_Unruhen3_B()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_B_13_01"); //Miejmy wiec nadzieje, ze Wendel ma dosc gryzie.
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_B_13_02"); //Powiedz mu te wiadomosc, o niej poinformuje w miescie.
...
FUNC VOID Info_Mod_August_Unruhen3_A()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_A_13_01"); //A... niezwykly wybór. Dobrze, wiesz, co mówisz.
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_A_13_02"); //Przekaze ja pozostalej czesci spoleczenstwa.
	AI_Output(self, hero, "Info_Mod_August_Unruhen3_A_13_03"); //Powinienes wprowadzic teodora do miasta i pokazac mu swoje nowe mieszkanie.
...
FUNC VOID Info_Mod_August_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Freudenspender_13_01"); //... nie musisz jesc dokladnie w miescie. Przywiazac do niego.
};
...
{
	AI_Output(self, hero, "Info_Mod_August_Penner_13_00"); //Spójrz, spójrz! Nowa twarz.... Nie. Widzialem cie juz wczesniej.
	...
	if (Npc_KnowsInfo(hero, Info_Mod_August_EssenGeholt))
	{
		...
		AI_Output(self, hero, "Info_Mod_August_Penner_13_03"); //To prawda! Jagniecina dojrzewajaca. Na duzy apetyt. Czy ty - czy ty
		AI_Output(hero, self, "Info_Mod_August_Penner_15_04"); //Rozumiem. Jeszcze jedna porcja....
		AI_Output(self, hero, "Info_Mod_August_Penner_13_05"); //Dokladnie! I chleb pita z piekarza, jesli sie podoba, i ciemne piwo z browaru.
		AI_Output(self, hero, "Info_Mod_August_Penner_13_06"); //Jagniecina rzeznika jest prawie lepsza od jagnieciny Piotra. To wszystko trzy kluby.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_August_Penner_13_07"); //Czy moglabys mnie laski?
		AI_Output(hero, self, "Info_Mod_August_Penner_15_08"); //Oczywiscie, co sie dzieje?
		AI_Output(self, hero, "Info_Mod_August_Penner_13_09"); //Czy móglbys odebrac mi od Piotra lub rzeznika porcje solonej jagnieciny, plaskodan z piekarza i ciemne piwo z browaru?
	};

	AI_Output(hero, self, "Info_Mod_August_Penner_15_10"); //Alkohol w czasie pracy? Jesli powiem to gubernatorowi....
	AI_Output(self, hero, "Info_Mod_August_Penner_13_11"); //Nie mówisz mi. Bo wtedy dostalibyscie to, co mam dac....
	AI_Output(hero, self, "Info_Mod_August_Penner_15_12"); //Lubie to? Co masz na mysli?
	AI_Output(self, hero, "Info_Mod_August_Penner_13_13"); //Najpierw zgryz.
...
FUNC VOID Info_Mod_August_Penner2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_01"); //Daj mi ja. W miedzyczasie jestem naprawde glodny.
	AI_Output(hero, self, "Info_Mod_August_Penner2_15_02"); //Co mi chciales dac?
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_03"); //No cóz, pewnego dnia bylem na sluzbie na straznicy przy przepustce.
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_04"); //Podbiegnawszy pod góre stoku, natykam sie na to. Gwarantuje, ze czesc jest wartosciowa.
	AI_Output(hero, self, "Info_Mod_August_Penner2_15_05"); //Pozwole sobie to zobaczyc.
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_06"); //Tutaj.
	...
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_08"); //Nah. Poszukiwalem od dawna, ale nic nie znalazlem.
	...
	AI_Output(self, hero, "Info_Mod_August_Penner2_13_11"); //Oczywiscie tutaj. I na pewno znajdziecie inny kawalek.
