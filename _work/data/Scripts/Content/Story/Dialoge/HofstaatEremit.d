...
FUNC VOID Info_Mod_HofstaatEremit_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_01"); //Depends on it.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_02"); //On what?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_03"); //Which hermits you mean.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_04"); //The royal one, of course.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_05"); //Yes, I am him.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_06"); //The magician sent me.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_07"); //Which one?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_08"); //The royal one.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_09"); //Oh, well. And what does he want?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_10"); //He said something about a mushroom delivery.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_11"); //What mushroom loo.... (interrupted)
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_12"); //The royal goddamned one!
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_13"); //Oh, well. Then take this royal bag full of royal mushroom spores and bring it to the magician!

	B_GiveInvItems	(self, hero, ItMi_FreudenspenderSporen, 1);

	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_14"); //Which one?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_08_15"); //The royal, of course!
