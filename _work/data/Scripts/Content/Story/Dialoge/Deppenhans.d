...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_00"); //Hey, can you give me a hand? I'm having trouble with my chest.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_01"); //I can't get my life savings.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_02"); //Trouble with the castle?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_03"); //Nah, she needs another one on the lid.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_04"); //How?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_05"); //Well, she jumps and bites like crazy again.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_06"); //This time it was really great, so I can't chastise her on my own.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe_15_07"); //What kind of nonsense is that?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_08"); //Yeah, you're right, it's nonsense what she does again.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_09"); //Couldn't behave like a tree, though. Ran through the field and turned everything upside down.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_10"); //At some point I took my axe and made it the chest.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_11"); //But behavior's still no better.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_13"); //Yeah, it's weird, the good one.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_14"); //If you help me calm her down, I'll give you some of my savings.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe_31_15"); //I'm gonna go inside and check on her.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe2_31_00"); //There, look. She hasn't been that nasty in a long time.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe2_31_01"); //Please, miss one thing, she won't forget it so quickly.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_31_00"); //Great, you did it.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_31_01"); //And here, as promised, part of my savings.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_31_02"); //Here, take half. You did a really good job and you really earned it.

	B_GiveInvItems	(self, hero, ItPl_Beet, 6);

	AI_Output(hero, self, "Info_Mod_Deppenhans_Truhe3_15_03"); //Ohh, great, turnips.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Truhe3_31_04"); //Yeah, I'm glad you like them.
...
FUNC VOID Info_Mod_Deppenhans_Kaninchenplage_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_01"); //Yeah, funny, fluffy, fluffy bunnies all over the place. It's strange that my vegetables have been disappearing bit by bit ever since. Must be a thief around here somewhere....
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_03"); //Nah, they just show up like that.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Kaninchenplage_15_04"); //All right, so I can comb the area for clues.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_05"); //Comb?! Hey, I got something for you.
	AI_Output(hero, self, "Info_Mod_Deppenhans_Kaninchenplage_15_06"); //(eagerly) Yes?! Hints?
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_07"); //Nah, I had the great idea to make an oversized comb on a wooden style. That's where I found out.
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_09"); //But you can also ask this black dressed guy who always walks around here making funny lights with his hand.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Kaninchenplage_31_10"); //Especially then a lot of rabbits appear.... He must have seen it too.
...
{
	AI_Output(self, hero, "Info_Mod_Deppenhans_NovizeWeg_31_00"); //Hey, my vegetables stopped disappearing.
	AI_Output(self, hero, "Info_Mod_Deppenhans_NovizeWeg_31_01"); //Whatever you did, take those pumpkins as a thank you.
...
FUNC VOID Info_Mod_Deppenhans_WoherBaum_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_WoherBaum_31_01"); //I planted it next to my field.... with seedlings from the damn moor.
	AI_Output(self, hero, "Info_Mod_Deppenhans_WoherBaum_31_02"); //But apparently they were brought up badly, the way he behaved. You saw it yourself.
};
...
FUNC VOID Info_Mod_Deppenhans_Landarbeit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_01"); //It's wonderfully beautiful. I know how it works.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_02"); //The seeds and tubers come into the soil on the field and then they grow.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_03"); //My boss, the Erhard, he's doing it all wrong.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_04"); //He buried funny yellow and blue shiny chunks on the wall of his house, among all the hay bales and barrels.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_05"); //I thought that nothing decent would grow out of them.
	AI_Output(self, hero, "Info_Mod_Deppenhans_Landarbeit_31_06"); //But there are strange people.
};
