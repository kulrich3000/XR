...
{
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_00"); //To juz minelo!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_01"); //Odszedl, czyz nie?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_02"); //Nie, to AWAJ! Calkowicie WAY!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_03"); //I.... Kiedy wróci?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_04"); //Powiedzialbym, ze...... w ciagu okolo czterech miesiecy.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_05"); //Co?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_06"); //Tak, rodzaj hibernacji. Gdy tylko zaczyna sie czas wielkiego swietowania, budzi sie.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_07"); //Jak dlugo trwa jego zycie?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_08"); //Okolo osmiu miesiecy.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_09"); //No cóz, nigdy nie przeszkadza. Potrzebuje alkoholu.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_10"); //Czego potrzebujesz?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_12"); //Ach, masz na mysli pijaka!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_13"); //Co?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_14"); //Pijac! To wlasnie to, co sie pijalo.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_15"); //Jak twoim zdaniem otrzymal imie?
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_16"); //A jak ja dostac?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_17"); //Dlaczego go nie pytasz?
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_18"); //Ale on juz go nie ma.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_19"); //Ktos inny? Wlasnie tutaj. Jestes -- --

	AI_TurnToNpc	(self, Mod_7272_HS_Trunkenbold_REL);

	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_20"); //Pijany, czy dalbys panu pic?
...
{
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_00"); //Ach, musisz byc nowa królewska dziewczyna na wszystko!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_01"); //Czy kilka dni temu nie byles królewskim grobowcem?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_02"); //Co oczywiscie sadzisz?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_03"); //...
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_04"); //Nie rób tak przygnebiajacej twarzy! Praca dla Ciebie! Idz do pustelnika królewskiego!

	B_Say	(hero, self, "$WOFINDEICHIHN");

	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_06"); //Znalezienie tego bedzie twoim pierwszym królewskim zadaniem.
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_07"); //Co?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_08"); //Mój umysl nie pamieta, gdzie mieszka. Ale jestem pewien, ze widzialem go ostatnio!
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_09"); //Wystarczy isc do miejsc, w których ostatnio bylem!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_10"); //A gdzie byles ostatnio?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_11"); //Gdybym to wiedzial, nie potrzebowalbym twojej pomocy w znalezieniu go! Teraz idzcie!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_12"); //I.... co mam z nim zrobic?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_13"); //Z kim?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_14"); //W domu pustelnika.
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_15"); //Masz wiesci o miejscu pobytu pustelnika?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_16"); //Nie.
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_17"); //Ah.... Czy móglbys go znalezc i poprosic go o zwykla porcje grzybów?
...
FUNC VOID Info_Mod_Alex_GeheimnisFreudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_GeheimnisFreudenspender_01_01"); //W kazdym razie! Nie znasz jeszcze tej tajemnicy!
};
...
FUNC VOID Info_Mod_Alex_Pilzsporen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_Pilzsporen_01_01"); //Znalazles pustelnika? Cudowny. Zabierz te ostrogi do sekretarza królewskiego narkotyków!

	B_Say	(hero, self, "$WOFINDEICHIHN");

	AI_Output(self, hero, "Info_Mod_Alex_Pilzsporen_01_03"); //Szukaj królewskiego mysliwego w poblizu obozu. On wskaze ci droge!
...
FUNC VOID Info_Mod_Alex_Transportsystem_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_Transportsystem_01_01"); //I przychodzisz do mnie?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Transportsystem_01_03"); //Oh, tak...... Moja magia. Wszystko dobrze, twoje zyczenie jest twoje! Spotkaj mnie u bram zamku za dwa dni!
...
{
	AI_Output(self, hero, "Info_Mod_Alex_TeleporterFertig_01_00"); //Ach, tam jestescie. Wystarczy przyjechac do mnie, przyjedzcie z mna!
...
{
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_00"); //Tutaj mój system transportowy.
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_01"); //A... Otwór?
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_02"); //W pewnym sensie.... Tak, ale to równiez teleporter.
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_03"); //Tutaj wchodzisz, opadasz i wychodzisz z bagna. Czyz nie jest to tak wielkie?
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_04"); //W ciagu dwóch dni wykopales dziure do bagna?
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_05"); //Tak.
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_06"); //Mialem cos z czyms wiecej..... Czary czeka na....
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_07"); //.... Tak wiec.... Mam na mysli......
...
{
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_00"); //Oh, powitanie. Cóz, czy jestem pod wrazeniem mojej dziury?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_02"); //Hej, dostales to prawo. Jestem zajety jako kopaczka.
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_03"); //Nie ma nikogo i nic, co wykopuje sie szybciej niz ja.... z wyjatkiem
	AI_Output(hero, self, "Info_Mod_Alex_Lochgraben_15_04"); //Poza czym?
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_05"); //Z wyjatkiem gasienic. Gasienice sa niesamowite jesli chodzi o kopanie.
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_06"); //Taki gasienica moglaby tam wykopac dziure, w ziemi po drugiej stronie góry Fluffy' ego, w nocy, która bylaby tak gleboka, ze nie widzielibysmy ziemi!
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_07"); //Ale na szczescie nie ma tu gasienic.... Tylko ja.
...
{
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_00"); //Ach, dobry poranek. Chcesz ponownie podziwiac moje sztuki pogrzebowe, czyz nie?
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_01"); //Mysle, ze chcesz samemu wykopac dziure. Ach, jest juz jeden.
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_02"); //Pozwole sobie przyjrzec sie temu. Wykopales lyzka, czy nie?

	AI_GotoWP	(self, "REL_HS_007");

	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_03"); //Otwór jest ledwie pusty..... tylko..... gram.... po prostu maal..... TO JEST NAJGLEBSZA DZIURA, JAKA KIEDYKOLWIEK WIDZIALEM!
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_04"); //Jak to zrobiles, zielonoswiadczylas zieleni? Musi to byc sztuczka.

	AI_GotoWP	(self, "REL_HS_008");
	AI_GotoWP	(self, "REL_HS_007");

	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_05"); //.... .... Aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaahhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh.....
