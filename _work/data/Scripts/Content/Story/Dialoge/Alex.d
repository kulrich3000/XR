...
{
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_00"); //It's gone!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_01"); //He's gone, isn't he?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_02"); //No, he's AWAY! Completely WAY!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_03"); //And... when will he be back?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_04"); //I would say.... in about four months.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_05"); //What?!
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_06"); //Yeah, it kind of hibernates. As soon as the time of great celebration begins, he wakes up.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_07"); //How long has he been gone?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_08"); //About eight months.
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_09"); //Well, never mind. I need alcohol.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_10"); //You need what?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_12"); //Oh, you mean drunk!
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_13"); //What?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_14"); //Drunk! That's the stuff that got the drunk away.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_15"); //How do you think he got his name?
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_16"); //And how do I get it?
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_17"); //Why don't you ask him?
	AI_Output(hero, self, "Info_Mod_Alex_Trunkenbold_15_18"); //But he's gone.
	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_19"); //Gone? He's right here. You're a--

	AI_TurnToNpc	(self, Mod_7272_HS_Trunkenbold_REL);

	AI_Output(self, hero, "Info_Mod_Alex_Trunkenbold_01_20"); //Drunkard, would you give the gentleman a drink?
...
{
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_00"); //Ahh, you must be the new royal girl for everything!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_01"); //Weren't you the royal tomb a few days ago?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_02"); //Of course, what do you think?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_03"); //...
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_04"); //Don't make such a despondent face! There's work for you! Go to the royal hermit!

	B_Say	(hero, self, "$WOFINDEICHIHN");

	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_06"); //Finding out that will be your first royal task.
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_07"); //What?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_08"); //My mind will not remember where he lives. But I'm sure I've seen him recently!
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_09"); //Just go to the places I've been lately!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_10"); //And where have you been lately?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_11"); //If I knew that, I wouldn't need your help finding him! Now go!
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_12"); //And... what am I supposed to do with him?
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_13"); //With whom?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_14"); //At the hermit's house.
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_15"); //You have news of the hermit's whereabouts?
	AI_Output(hero, self, "Info_Mod_Alex_Magier_15_16"); //No.
	AI_Output(self, hero, "Info_Mod_Alex_Magier_01_17"); //Ah... Could you please find him and ask him for the usual delivery mushrooms?
...
FUNC VOID Info_Mod_Alex_GeheimnisFreudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_GeheimnisFreudenspender_01_01"); //Away! You are not yet ready to know this secret!
};
...
FUNC VOID Info_Mod_Alex_Pilzsporen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_Pilzsporen_01_01"); //You found the hermit? Wonderful. Take these spurs to the king's secretary of drugs!

	B_Say	(hero, self, "$WOFINDEICHIHN");

	AI_Output(self, hero, "Info_Mod_Alex_Pilzsporen_01_03"); //Search for the royal hunter in the vicinity of the camp. He will show you the way!
...
FUNC VOID Info_Mod_Alex_Transportsystem_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alex_Transportsystem_01_01"); //And you come to me?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Transportsystem_01_03"); //Oh, yes.... My magic. All right, your wish is yours! Meet me at the gates of the castle in two days!
...
{
	AI_Output(self, hero, "Info_Mod_Alex_TeleporterFertig_01_00"); //Ah, there you are. Just come with me, just come with me!
...
{
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_00"); //Here, my transport system.
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_01"); //A... Hole?
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_02"); //In a sense... Yes, but it's also a teleporter.
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_03"); //You step in here, fall and get out of the swamp. Isn't that great?
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_04"); //You dug a hole from here to the swamp in two days?
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_05"); //Yeah.
	AI_Output(hero, self, "Info_Mod_Alex_AtLoch_15_06"); //I had something with more.... Magic awaits...
	AI_Output(self, hero, "Info_Mod_Alex_AtLoch_01_07"); //Well... So... I mean....
...
{
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_00"); //Oh, hello. Well, are you impressed with my hole?
	...
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_02"); //Hey, you got that right. I'm busy as a digger.
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_03"); //There's no one and nothing that digs faster than me... except.
	AI_Output(hero, self, "Info_Mod_Alex_Lochgraben_15_04"); //Except what?
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_05"); //Except for a crawler. Crawlers are incredible when it comes to digging.
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_06"); //Such a crawler could dig a hole over there, in the ground on the other side of Fluffy's mountain, within a night, that would be so deep that you wouldn't see the ground!
	AI_Output(self, hero, "Info_Mod_Alex_Lochgraben_01_07"); //But luckily there are no crawlers here... just me.
...
{
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_00"); //Ah, good morning. You want to admire my funeral arts again, don't you?
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_01"); //I guess you want to dig a hole yourself. Oh, there's one already.
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_02"); //Let me take a look at that. You dug with a spoon, didn't you?

	AI_GotoWP	(self, "REL_HS_007");

	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_03"); //The hole is barely empty.... just... gram... just maal.... THIS IS THE DEEPEST HOLE I' VE EVER SEEN!!!!
	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_04"); //How did you do that, you greenhorn? There must be a trick to it.

	AI_GotoWP	(self, "REL_HS_008");
	AI_GotoWP	(self, "REL_HS_007");

	AI_Output(self, hero, "Info_Mod_Alex_LochGegraben_01_05"); //That... That... Aaaaaaaaaaaaaaaaaaaaaaaahhhhhhh...
