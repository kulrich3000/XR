...
FUNC VOID Info_Mod_Bloodwyn_EBR_Belagerung_Info()
{
	...
	if (Npc_HasItems(hero, ItRu_TeleportSeaport) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportSeaport, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportMonastery) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportMonastery, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportPatBack) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportPatBack, 1);
	...
	if (Npc_HasItems(hero, ItRu_Teleport_Pat) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_Teleport_Pat, 1);
	...
	if (Npc_HasItems(hero, ItRu_Teleport_Pat_01) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_Teleport_Pat_01, 1);
	...
	if (Npc_HasItems(hero, ItRu_Teleport_Pat_02) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_Teleport_Pat_02, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportFarm) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportFarm, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportXardas) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportXardas, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportPassNW) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportPassNW, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportPassOW) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportPassOW, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportOC) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportOC, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportOWDemonTower) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportOWDemonTower, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportTaverne) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportTaverne, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportDemonTower) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportDemonTower, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportPsicamp) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportPsicamp, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportOldcamp) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportOldcamp, 1);
	...
	if (Npc_HasItems(hero, ItRu_TeleportNewcamp) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_TeleportNewcamp, 1);
	...
	if (Npc_HasItems(hero, ItRu_Teleport_3) == 1)
	{
		...
		Mob_CreateItems	("TELEPORTAZE PROWADZA KLATKE PIERSIOWA", ItRu_Teleport_3, 1);
	...
	{
		AI_Output(self, hero, "Info_Mod_Bloodwyn_EBR_Belagerung_04_13"); //Widze, ze macie teleportrunki. Wydaje mi sie, ze nie przeszkadza ci, jesli zabiore ja ze mna.
	};
