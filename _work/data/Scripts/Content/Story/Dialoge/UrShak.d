...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Hi_18_00"); //Obcy sa przeze mnie witani.
	AI_Output(hero, self, "Info_Mod_UrShak_Hi_15_01"); //Ur-Shak, to ja.
	AI_Output(self, hero, "Info_Mod_UrShak_Hi_18_02"); //Badz przyjacielem. Uratowales mnie przed wojownikami z Orcstadtu. Wciaz jestem wam bardzo wdzieczny.
};
...
FUNC VOID Info_Mod_UrShak_WasHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_WasHier_18_01"); //Po tym jak przyjaciel zniszczyl Krushaka, Ur Shak uderzyl w Tarrok. Wspólnie postanowilismy znalezc nowego Klan.
	AI_Output(self, hero, "Info_Mod_UrShak_WasHier_18_02"); //Jako obóz zabralismy w skaly stara twierdze. Tutaj chronimy sie przed zlymi orkami.
};
...
FUNC VOID Info_Mod_UrShak_Foki_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_01"); //Tutaj na podium spowiedziano sie, ale pewnego wieczoru juz nie bylo.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_02"); //Kiedy Focus zniknal, Ur Shak udal sie do przyjaciela Xardasa. Wyjasnil, ze istnieje piec punktów ostrosci.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_03"); //On Ur Shak daje mape, gdzie narysowal wszystkie lokalizacje Fokusse. W rezultacie Ur Shak wyslal Tarrok, aby szukac ostrosci na kamieniach.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_04"); //Jednak nawet ta uwaga juz sie nie skupia. Xardas podejrzewa, ze orki ukradzione skupiaja sie na wskrzeszeniu Krushaka.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_05"); //Nie moze sie to jednak zdarzyc. Przyjaciól musi odnalezc pozostale ogniska i przyniesc te z Orków.
	AI_Output(hero, self, "Info_Mod_UrShak_Foki_15_06"); //Tak czy owak szukam ostrosci.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_07"); //Przyjaciel szuka równiez ostrosci? Wtedy Ur Shak pomoze przyjacielowi najlepiej jak potrafi.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_08"); //Ranad wiele o tym wie. Czasami jeszcze czasami oglada obozy orkowe.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_18_09"); //Obecnie znajduje sie on na szczycie fortecy. Idz do niego i porozmawiaj z nim. Prawdopodobnie ma wiele informacji dla przyjaciela.
...
FUNC VOID Info_Mod_UrShak_Mitmachen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Mitmachen_18_01"); //To nie nazywa sie Krushak jego plecy?
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Mitmachen_18_03"); //Badz dobry.
};
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_18_00"); //Witaj, przyjaciela. Ranad Ur Shak doniósl, ze orki zlapaly ludzi z obozu w Bergen.
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_18_01"); //Ponadto, chcesz rozpoczac atak na zapasy i naklonic magów do zdobycia amuletu.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_18_03"); //Bedzie to jego trudne zadanie. Dobrze strzezeni orkami sa w Orkstadcie w podziemnej jaskini.
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_18_04"); //Ur Shak wie, ze jestes jego mocnym wojownikiem. Ale to nie wystarczy, aby uwolnic przyjaciól.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_18_06"); //Ur Shak lubi pomagac przyjaciolom i zyczyc sukcesów w trudnych zadaniach.
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Xeres_18_00"); //Ciesze sie, ze przychodza przyjaciele. Ur Shak ma zle wiesci. Orki z miasta maja nowych przywódców. Wyglada jak czlowiek, ale nie calkiem zywy.
	AI_Output(self, hero, "Info_Mod_UrShak_Xeres_18_01"); //Orki chca zrobic swoja armie. Przyjaciel musi zapobiegac.
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Karte_18_00"); //Zobacz Ur Shak, zla karte przyjaciela. Ur Shak zrobi calosc.

	Npc_RemoveInvItems	(hero, ItWrWorldmap, 1);
	CreateInvItems	(hero, ItWrWorldmap_Orc, 1);

	AI_Output(self, hero, "Info_Mod_UrShak_Karte_18_01"); //Teraz mapujemy wszystko.
};
...
FUNC VOID Info_Mod_UrShak_Biftek_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_01"); //Tak. Ale kazdy ork moze przyzwyczaic sie do ziól i grzybów, po prostu nie chce.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_03"); //(myslal) Ur Shak da spadl na stary przepis, aby zastapic mieso. Orki nazywaja go To-Fu.
	AI_Output(hero, self, "Info_Mod_UrShak_Biftek_15_04"); //Co to oznacza?
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_05"); //Nie znaczy nic, to nazwa.
	AI_Output(hero, self, "Info_Mod_UrShak_Biftek_15_06"); //A jak przygotowac to do Fu?
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_07"); //Ur Shak musi spojrzec w nuty. (sees)
	
	AI_PlayAni(self, "r_Roam1");
	
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_08"); //Tam ma nawet recepte zrozumiala dla ludzi.
	
	B_GiveInvItems(self, hero, ItWr_TofuRezept, 1);
	
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_09"); //Czlowiek musi szukac taksówek i zbierac ich straki. W strakach znajduje male ziarna fasoli. Ur Shak nie wie, czy i tu rosna rosliny So-Ja, ale w okolicach Orków zdecydowanie tak.
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_10"); //W stojaku na receptury, aby wykonac To-Fu, nalezy nacisnac przycisk So-Ja. Ale czlowiek moze równiez uzywac stolu alchemicznego.
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_18_11"); //Po zakonczeniu, Biftek mówi, ze mieso dla niego miec, a on nie zauwazy zadnej róznicy.
...
FUNC VOID Info_Mod_UrShak_Biftek2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek2_18_01"); //Zaskoczy nas Ur Shak. Oczekuje wiekszych problemów.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek2_18_03"); //Badz wdzieczny za ludzka pomoc!
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_PolochTretor_18_00"); //Ur Shak sluchac Tretor i Poloch teraz najlepszych przyjaciól, a czlowiek ma palce w grze.
	AI_Output(hero, self, "Info_Mod_UrShak_PolochTretor_15_01"); //Tak, kosztem kilku siniaków.
	AI_Output(self, hero, "Info_Mod_UrShak_PolochTretor_18_02"); //Czlowiek bierze to, co Ur Shak znajduje w twierdzy górskiej. Orki nie moga jej uzyc.
