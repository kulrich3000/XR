...
FUNC VOID Info_Mod_Liselotte_TRADE1_Info()
{
	...
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_01"); //Hey, you want to hit on me here?
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_02"); //Oh, uh.....
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_03"); //Don't say anything wrong!
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_04"); //l--
 	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_05"); //... Don't even think it!
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_06"); //SORRY!
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_07"); //Suppose - but STRAIGHT!
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_08"); //Um...
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_09"); //What the fuck do you want?
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_10"); //I wanted to ask you... you as a merchant...
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_11"); //Talk to me reasonably!
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_12"); //O. K. You, uh, as a dealer, you sell merchandise...
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_13"); //Yeah, that's right.
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_14"); //Would you mind if I took a look at your merchandise?
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_15"); //I can't offer you anything because I lost my package on the way to town.
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_19"); //It must be lying around somewhere near the city gate, but I couldn't find it.
	AI_Output (hero, self, "Info_Mod_Liselotte_Trade1_15_16"); //If I find it, I'll send it to you.
	AI_Output (self, hero, "Info_Mod_Liselotte_Trade1_16_17"); //Thank you, you're a darling!
...
FUNC VOID Info_Mod_Liselotte_Warenpaket_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Liselotte_Warenpaket_16_01"); //Yes, thank you.
	AI_Output(hero, self, "Info_Mod_Liselotte_Warenpaket_15_02"); //Um, do I get a reward now?
	AI_Output(self, hero, "Info_Mod_Liselotte_Warenpaket_16_03"); //OK. I'll give you 50 gold.

	B_GiveInvItems	(self, hero, ItMi_Gold, 50);

	AI_Output(self, hero, "Info_Mod_Liselotte_Warenpaket_16_04"); //Besides, you can trade with me now.
...
FUNC VOID Info_Mod_Liselotte_Blutkelch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Liselotte_Blutkelch_16_01"); //Ah, the flatterer. What can I get you?
	AI_Output(hero, self, "Info_Mod_Liselotte_Blutkelch_15_02"); //I'm looking for a cup. A cup of blood.
	AI_Output(self, hero, "Info_Mod_Liselotte_Blutkelch_16_03"); //I don't have a cup. Especially no bloody one.
	AI_Output(hero, self, "Info_Mod_Liselotte_Blutkelch_15_04"); //Could have been. Thanks. By the way, what are you doing after hours?
	AI_Output(self, hero, "Info_Mod_Liselotte_Blutkelch_16_05"); //Going to bed. Well, what else?
