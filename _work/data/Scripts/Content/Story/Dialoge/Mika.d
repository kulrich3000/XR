...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_13_00"); //Hey, I've seen you around here before. You must be new in town.
	AI_Output(hero, self, "Info_Mod_Mika_Hi_15_01"); //That's possible.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_13_02"); //I'm giving you the advice to take good care of yourself when you leave town.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_13_03"); //Recently there has been an increasing number of reports of rather uncanny events.
...
FUNC VOID Info_Mod_Mika_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Hi_B_13_01"); //Well, it's rumored that dark powers are at odds with each other. People disappear, others suddenly fall seriously ill.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_B_13_02"); //And some have even reported that the dead rise up from their graves and, as undead, cause their dreadful mischief.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_E_13_00"); //Okay, whatever you say. Don't come running when undead or other sinister creatures are after you.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_13_00"); //And only some time ago I saw an uncanny, sinister figure coming from the valley basin in front of the city.
	AI_Output(hero, self, "Info_Mod_Mika_Hi_D_15_01"); //A dark figure? Where did she go?
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_13_02"); //Continue up the path. Either in the direction of Akil's Hof, which is located to the left of the path, or straight ahead in the direction of Taverne.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_13_03"); //I wasn't very happy, that fellow.
...
FUNC VOID Info_Mod_Mika_Yasin_Info()
{
	...
	if (!Npc_KnowsInfo(hero, Info_Mod_Urnol_WerBistDu))
	{
		...
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_13_03"); //Are they going into town? Tell me.
		...
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_13_05"); //You must be insane, but good, good luck!
	}
	else
	{
		AI_Output(hero, self, "Info_Mod_Mika_Yasin_15_06"); //I caught the pilgrim you told me about. And even more.
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_13_07"); //Tell me about it.
	...
	AI_Output(self, hero, "Info_Mod_Mika_Yasin_13_10"); //I want to check it out, what am I here for? You got my back?
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Yasin2_13_00"); //There's no one here. The birds must have flown out.
	AI_Output(hero, self, "Info_Mod_Mika_Yasin2_15_01"); //Not quite. There's one left here.
	AI_Output(self, hero, "Info_Mod_Mika_Yasin2_13_02"); //Where? Where?
...
FUNC VOID Info_Mod_Mika_Banditen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_13_01"); //For days now, the militia have been chasing after a small group of bandits who constantly attack the traders.
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_13_02"); //Before we get hold of them, they always disappear in the woods near Akil Hof.
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_13_03"); //There's no way we're going in there. It's full of animals.
	AI_Output(hero, self, "Info_Mod_Mika_Banditen_15_04"); //What would you give me if I killed those bandits!
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_13_05"); //Well, 100 gold pieces would be in it for you. Does that mean you're killing those guys?
	AI_Output(hero, self, "Info_Mod_Mika_Banditen_15_06"); //Yes, that's what it means!
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_13_07"); //You must be insane, but good, good luck!
...
FUNC VOID Info_Mod_Mika_BanditenTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_BanditenTot_13_01"); //I didn't think you'd be able to do this on your own, kiddo. Here's the gold you promised me!
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_13_00"); //You better get to town fast.
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_13_01"); //There are demons floating around out here at the moment, leaving no one alive to cross their path.
	AI_Output(hero, self, "Info_Mod_Mika_Randolph_15_02"); //Demons? Where do these come from?
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_13_03"); //I don't know, they're all over the woods near the city. And in the vicinity of Lobart's yard there is an obscure figure.
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_13_04"); //Anyway, I have to be careful now and I don't have time to talk anymore.
};
...
{
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_13_00"); //That's good news. The demons seem to have disappeared again.
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_13_01"); //I suppose they must have realized they're no match for us.
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_13_02"); //So you can go back to town with peace of mind.
...
FUNC VOID Info_Mod_Mika_Dokumente_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Dokumente_13_01"); //Correct.
	AI_Output(hero, self, "Info_Mod_Mika_Dokumente_15_02"); //And they're still in your possession?
	AI_Output(self, hero, "Info_Mod_Mika_Dokumente_13_03"); //Right.
...
FUNC VOID Info_Mod_Mika_Dokumente_C()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Mika_Dokumente_C_13_01"); //Oh, take it already, I can't do anything with it.
	...
	{
		AI_Output(self, hero, "Info_Mod_Mika_Dokumente_C_13_02"); //200 gold or no notes.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_00"); //Hold on a second.
	AI_Output(hero, self, "Info_Mod_Mika_VinoBrennerei_15_01"); //What is it?
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_02"); //You travel a lot out there. Have you seen Vino anywhere?
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_03"); //Lobart is very worried because he left the farm two days ago and hasn't come back yet.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_04"); //And I can't help but recall that he passed the city gate here.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_05"); //However, I don't know where he went afterwards.
	AI_Output(hero, self, "Info_Mod_Mika_VinoBrennerei_15_06"); //No, I haven't seen him lately either.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_07"); //No one at Lobart's farm wants to know where he went.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_08"); //He's been on the field all day with the other farmhands.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_09"); //Somebody must have heard something.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_13_10"); //And I'm allowed to stand up here and ask any questions.
...
FUNC VOID Info_Mod_Mika_AndreVermaechtnis_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_AndreVermaechtnis_13_02"); //I.... uhm... Shit, let's get outta here.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_AndreVermaechtnis2_13_00"); //Shit, we're trapped. Fight for your life, or we'll end up like Yasin.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_13_00"); //Hey, hold it right there!
	AI_Output(hero, self, "Info_Mod_Mika_Pflanzensammler_15_01"); //What's going on?
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_13_02"); //The herbalists complained that you were constantly picking up all the medicinal plants in the area and keeping them to yourself.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_13_03"); //The existing ones would hardly be sufficient to cover the demand.
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_13_05"); //You give me 50 medicinal plants, and I'll pay you almost as good as one of the merchants.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_13_06"); //You ain't gonna get no more trouble for this.
...
FUNC VOID Info_Mod_Mika_Pflanzensammler_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_13_01"); //I regret your decision.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_13_02"); //She's forcing me to denounce my help in case you're attacked outside the city gates.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_13_03"); //And now: go.
...
FUNC VOID Info_Mod_Mika_Pflanzensammler_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_A_13_01"); //A wise decision. Have a nice day.
