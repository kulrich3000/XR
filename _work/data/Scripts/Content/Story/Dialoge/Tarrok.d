...
FUNC VOID Info_Mod_Tarrok_Lernen_Info()
{
	...
	{ 
		Info_AddChoice	(Info_Mod_Tarrok_Lernen, B_BuildLearnString ("Horn of the Shadow Runner", B_GetLearnCostTalent (hero, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_ShadowHorn)), Info_Mod_Tarrok_Lernen_ShadowHorn);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_FireTongue] == FALSE)
	{ 
		Info_AddChoice	(Info_Mod_Tarrok_Lernen, B_BuildLearnString ("tongue of fire", B_GetLearnCostTalent (hero, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FireTongue)), Info_Mod_Tarrok_Lernen_FireTongue);
	};
};
