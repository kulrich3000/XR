...
{
	AI_Output(self, hero, "Info_Mod_Bodo_MT_Hi_36_00"); //Oczekiwalem Ciebie. Nie mozesz mnie minac, przysiegam.
	...
	{
		B_LogEntry	(TOPIC_MOD_AL_FLUCHT, "Bodo zaatakowal mnie w Minentalu.");
	};
};
