...
FUNC VOID	Change_FH_Visual()
{
	...
	if  (FH_SkinTexture < 0)
		{
			FH_SkinTexture = 0;
			PrintScreen	("MINUS twarze nie istnieja!!!!!!!!!" , -1, -1, "FONT_OLD_10_WHITE.TGA", 2);		
		};
	...
	PrintScreen	("Tekstura SkinTexture:" 		, -1, 10, "FONT_OLD_10_WHITE.TGA", 4 );
	
	printText = IntToString	(FH_SkinTexture);
	PrintScreen	(printText		, -1, 12, "FONT_OLD_10_WHITE.TGA", 2 );
	
	
	PrintScreen	("Siatka na glowe:"		, -1, 20, "FONT_OLD_10_WHITE.TGA", 2 );
...
INSTANCE DIA_FH_NextFace (C_INFO)
{
	...
	permanent		= 1;
	description		= "Nastepna przyszlosc";
};                       
...
INSTANCE DIA_FH_NextFace10 (C_INFO)
{
	...
	permanent		= 1;
	description		= "Nastepny krok Face 10";
};                       
...
INSTANCE DIA_FH_PreviousFace10 (C_INFO)
{
	...
	permanent		= 1;
	description		= "Poprzedni krok Face 10 ";
};                       
...
INSTANCE DIA_FH_WomanFace (C_INFO)
{
	...
	permanent		= 1;
	description		= "Goto kobieta twarze";
};                       
...
INSTANCE DIA_FH_Choose_HeadMesh (C_INFO)
{
	...
	permanent		= 1;
	description		= "Wybierz siatke strzalkowa.";
};                       
...
{	
	...
	Info_AddChoice		(DIA_FH_Choose_HeadMesh, "grzbiet" 				, DIA_FH_Choose_HeadMesh_7);
