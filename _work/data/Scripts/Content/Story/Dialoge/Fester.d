...
FUNC VOID Info_Mod_Fester_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_05_01"); //Hej, jestes nowy w obozie. Chcesz szybko podnosic sie do góry i robic z nami róznice.
	AI_Output(hero, self, "Info_Mod_Fester_Hi_15_02"); //Jasne, dlaczego nie.
	AI_Output(self, hero, "Info_Mod_Fester_Hi_05_03"); //Bardzo dobry. Wtedy po prostu musialbys towarzyszyc mi i dwóm innym chlopcom na polowaniu, zabic troche Molerata i Scavengera, wcale nie ciezko. Co mówisz?
...
FUNC VOID Info_Mod_Fester_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_B_05_01"); //Wiec tak, ale o tym zadecyduje pierwszy, który jawi sie, gdy w obozie nie ma nic do jedzenia. Ose, tse, tse, tse, taki dobry dla niczego.
...
FUNC VOID Info_Mod_Fester_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_A_05_01"); //Fantastyczne. Engardo i Nodrak mieli juz zaczac biegac i czekac na nas przed obozem. Idzmy tu idzmy.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_VorLager_05_00"); //Chodzcie dalej, odejdzmy.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_00"); //Ahh, tutaj jest dobre miejsce.
	AI_Output(hero, self, "Info_Mod_Fester_AtSmallCave_15_01"); //Huh, czy bedziemy tu czekac?
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_02"); //Uh, tak, tak, cos takiego.

	CreateInvItems	(self, ItMi_Joint, 1);

	B_UseItem	(self, ItMi_Joint);

	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_03"); //Ahh, piekny.
	AI_Output(hero, self, "Info_Mod_Fester_AtSmallCave_15_04"); //A co jest teraz....?
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_05"); //Och, polowanie. Cóz, widzisz tam te dobrze odzywione padlinozercy i Moleraty? Poluj na nich i przyprowadz mnie po dziesiec padlinozerców i dziesiec Moleratkeulen kazdy. Jakies pytania?
...
FUNC VOID Info_Mod_Fester_HabFleisch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_HabFleisch_05_01"); //Pranie? Oh, mieso. Dobrze zrobione, dzieciak.
	AI_Output(self, hero, "Info_Mod_Fester_HabFleisch_05_02"); //Teraz idziemy nieco dalej, zeby polowac w jaskini cos innego.
...
FUNC VOID Info_Mod_Fester_AtGreatCave_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_AtGreatCave_05_01"); //Czy powiedzialem strzal? Chodzilo mi o to.
	AI_Output(self, hero, "Info_Mod_Fester_AtGreatCave_05_02"); //Uh, ale tylko minuta. W jaskini osiedlily sie olbrzymie orki. Wejdz do srodka i zadbaj o nia.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_GobbosTot_05_00"); //Bardzo dobrze, teraz mozemy teraz zrobic troche strzebli.... uh, cwiczymy alchemie. Czekaj minute, az sie skonczy.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_PotionReady_05_00"); //Tam mozna wrócic. Idz dalej, podazamy za Toba.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_BackAtCamp_05_00"); //Hej, zrobiles naprawde dobra robote.... na debiutant. Czy Lee i Sylvio poinformuja Cie, ze zrobiles to dosc dobrze.
	AI_Output(self, hero, "Info_Mod_Fester_BackAtCamp_05_01"); //Oto troche chwastów i rudy za Twoja nagrode.
...
FUNC VOID Info_Mod_Fester_KesselProblem_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_01"); //Co....? Kim jestes i czego chcesz?
	AI_Output(hero, self, "Info_Mod_Fester_KesselProblem_15_02"); //Pytanie brzmi: co mi Pan powie, co mi powie.... o malych firmach.
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_03"); //Co....? Damn to! Hej, czlowiek, nie daj mi zadnych klopotów.
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_04"); //Po prostu sprzedalem kilka rzeczy na rude.
	AI_Output(hero, self, "Info_Mod_Fester_KesselProblem_15_05"); //Pary rzeczy?
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_06"); //No tak, cóz, brudny. Czlowiek, co to jest wielki problem?
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_07"); //Zaslugiwalem na wiekszosc z innymi rzeczami, na przyklad na futro biegacza cieni.
	...
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_09"); //Hej, przyjdz dalej. Nie mówcie o tym, co bagniste.
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_10"); //Jesli trzymasz usta zamkniete, nie bedziesz tego zalowal.
...
FUNC VOID Info_Mod_Fester_KesselProblem2_Info()
{
	if (Mod_NL_TalkesselProblem == 5)
	{
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_00"); //Phew, dziekuje ci tak wiele za to, ze nie mówie Lee o ziolach.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_01"); //Ledwo ucieklam czarnym okiem.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_02"); //Cóz, teraz musze byc nieco bardziej ostrozny. Stad..... Tutaj wez ziolo.
		...
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_03"); //I.... er er..... kolejny maly przepis.

		B_GiveInvItems	(self, hero, ItWr_Weisenchronik, 1);

		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_04"); //Preferowane przed snem..... wtedy masz super zrelaksowana noc, a nastepnego ranka rano bedziesz w dobrej formie.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_05"); //Zabawa z tym. Ale nie przesadzajcie, huh?
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_06"); //Wspaniale, dzieki Tobie moge pracowac przez kilka tygodni od rana do nocy.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_07"); //Czy naprawde wykonywales swietna prace..... Syn suki!
	};
};
