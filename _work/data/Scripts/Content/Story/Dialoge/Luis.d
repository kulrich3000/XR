...
FUNC VOID Info_Mod_Luis_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_01"); //To byloby obciazeniem dla kazdego mysliwego!
	AI_Output(hero, self, "Info_Mod_Luis_Hi_15_02"); //Ale mozesz to zmienic. Dlaczego nie wyjezdzasz z miasta i nie polujesz troche?
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_03"); //Masz na mysli jak kilkunastu innych mysliwych?
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_04"); //Rywalizacja przed miastem jest nie do zniesienia i nie mozna dostac zbyt wiele za zwykla siersc.
	AI_Output(hero, self, "Info_Mod_Luis_Hi_15_05"); //Strefa lodowa jest dosc duza, musi byc cos do zdobycia?
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_06"); //Mój przyjaciel Randi powiedzial przed wyjsciem cos podobnego i od tego czasu nie slyszalem od niego.
	AI_Output(hero, self, "Info_Mod_Luis_Hi_15_07"); //Czego on potrzebowal?
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_08"); //Chcial wykorzystac stara wieze nad jeziorem jako obóz na noc.
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_09"); //Wlasciwie nie jest to zly pomysl, ale kto wie, co sie tam osiedlil po tych latach.
	...
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_12"); //Jesli równiez tam chcesz umrzec, prosze!
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_13"); //Najpierw jednak powinienes sie zglosic Keithowi. Randi chcial go przekonac do swojego pomyslu.
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_14"); //Byc moze masz szczescie i oni jeszcze nie odeszli.
	AI_Output(self, hero, "Info_Mod_Luis_Hi_06_15"); //Tutaj masz mape, z nia nalezy dostac sie do jego domku w lesie, szczescie.
...
FUNC VOID Info_Mod_Luis_Vigonza_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_01"); //Obawialem sie tego, ale mialem nadzieje, ze sie myle.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_02"); //Teraz, gdy mam pewnosc jego smierci, jeszcze bardziej martwie sie o Pilara.
	AI_Output(hero, self, "Info_Mod_Luis_Vigonza_15_03"); //Teraz, kiedy to mówisz, gdzie on jest?
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_04"); //Niedawno uciekl, powiedzial, ze nie moze juz go tu zniesc.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_05"); //Chcial zobaczyc swojego brata, mieszka w poblizu cmentarza w Goblinie, niedaleko rozpadajacej sie wiezy strazniczej.
	...
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_07"); //Dotyczy to równiez zwyklych goblinów, ale kilka lat temu byl wsród nich równiez wezwany demon.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_08"); //Najwyrazniej uczyl innych, jak budowac cmentarz.
	AI_Output(hero, self, "Info_Mod_Luis_Vigonza_15_09"); //Nie brzmi to dla mnie bardzo dobrze.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_10"); //Nie panicznie, dawno temu pokonalismy goblinów w bitwie pod jednym z wiezyczek strazniczych.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_11"); //Kiedy goblinowie próbowali go zabrac, prawie zabilismy caly klan. I nieliczni, którzy przezyli, chcieli po prostu pochowac swoich zmarlych.
	AI_Output(hero, self, "Info_Mod_Luis_Vigonza_15_12"); //A i demon czarujacy?
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_13"); //On tez umarl. Ma nawet najwiekszy nagrobek na cmentarzu.
	AI_Output(self, hero, "Info_Mod_Luis_Vigonza_06_14"); //Jesli chcesz, pokaze ci cmentarz. Ja i tak ide do Pilara, i to jest w drodze.
...
{
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof_06_00"); //Cóz, tutaj jestesmy. Dzis dzieje sie tu niewiele.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof_06_01"); //Przyjedzcie ze mna, pokaze wam urocza grób demonów.
...
{
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof2_06_00"); //Tutaj jest tutaj. Dziwne jest, jak sprytny goblin moze przeniesc msze goblinowa na cos w rodzaju budowy tego cmentarza.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof2_06_01"); //Co to bylo....? Slyszales to tez?
...
{
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof3_06_00"); //Damn, po prostu mnie przerazali. Naprawde ich nie slyszalem.
	AI_Output(hero, self, "Info_Mod_Luis_AtFriedhof3_15_01"); //Moze nie podobalo im sie to tak bardzo, ze bylismy na ich cmentarzu.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof3_06_02"); //Oh, a jesli tak, to i jesli tak. Tutaj i tak sa tylko trupy.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof3_06_03"); //Lepiej dbac o swoje pola rzepy niz przez caly dzien.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof3_06_04"); //Przejdzmy teraz do kabiny brata Pilara.
...
{
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof4_06_00"); //Pozwólcie mi sie domyslic, ze po prostu spózniamy sie, czyz nie?
	...
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof4_06_02"); //.... co moze oznaczac, ze mimo wszystko nie umrze.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof4_06_03"); //Powinnismy spojrzec na kruszaca sie wieze. Moze jest moze wskazówka, gdzie mieszka.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof4_06_04"); //Bede mial tutaj strazników, którzy zajma stanowiska, na wypadek gdyby czesc z nich wyszla z ziemi.
...
{
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof5_06_00"); //Miejmy nadzieje, ze byl tylko jeden z nich.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof5_06_01"); //Gdyby wszystkie byly tak silne, mielibysmy problem.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof5_06_02"); //Mysle, ze gobliny maja dosc na dzien dzisiejszy. Wracam teraz do tawerny.
	AI_Output(self, hero, "Info_Mod_Luis_AtFriedhof5_06_03"); //Ach, tak, tak, chce, zebys równiez wstapil do niego z Thysem. Mysle, ze chcialby panu podziekowac.
