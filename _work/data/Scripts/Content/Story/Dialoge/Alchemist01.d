...
{
	AI_Output(self, hero, "Info_Mod_Alchemist01_Hi_06_00"); //Hey, I've never seen you around here before, brother. Did you just come in from outside?
	AI_Output(hero, self, "Info_Mod_Alchemist01_Hi_15_01"); //Yeah, that's me.
	AI_Output(self, hero, "Info_Mod_Alchemist01_Hi_06_02"); //Do you have any herbs around?
	AI_Output(self, hero, "Info_Mod_Alchemist01_Hi_06_03"); //Because of the siege there is a lack of everything here and it is above all the potions that give us strength to resist the enemy's attacks at this difficult time.
	AI_Output(self, hero, "Info_Mod_Alchemist01_Hi_06_04"); //But we're running out of ingredients for them.
	AI_Output(self, hero, "Info_Mod_Alchemist01_Hi_06_05"); //So if you could get me a handful of different herbs - let's say a dozen of them each - we would at least be free from this worry for the next few weeks.
...
{
	AI_Output(self, hero, "Info_Mod_Alchemist01_MangelQuest_Fertig_06_00"); //At Innos, you must have spent hours collecting all the herbs. This means that the lack of ingredients is no longer necessary.
	AI_Output(self, hero, "Info_Mod_Alchemist01_MangelQuest_Fertig_06_01"); //Here, these potions will certainly be useful for your future travels.

	B_ShowGivenThings	("Elixir of life, 2 anti-poisons and potion of recovery preserved");

	AI_Output(self, hero, "Info_Mod_Alchemist01_MangelQuest_Fertig_06_02"); //Innos keep you safe.
...
FUNC VOID Info_Mod_Alchemist01_Fake_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alchemist01_Fake_06_01"); //A magician was just here. He said he was going to the practice rooms.
