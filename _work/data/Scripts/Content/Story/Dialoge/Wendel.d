...
FUNC VOID Info_Mod_Wendel_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_01_00"); //Spirala. Odpowiadam za zaopatrzenie w wode tutaj w Khorata.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_01_01"); //Jak widac, dystrybucja wody nie jest tak prosta, ale z pomoca pomp i zamków, naziemnych i podziemnych.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_01_02"); //W tym celu mozemy zagwarantowac optymalna podaz ludnosci.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_01_03"); //Tak skomplikowany system wymaga oczywiscie ciaglego monitorowania i naprawy.
};
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_01_00"); //Och, nie! Mamy powazny problem!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_15_01"); //Co sie dzieje?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_01_02"); //Chcialbym to równiez wiedziec! Cyrkulacja wody zostaje przerwana.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_01_03"); //Wydaje sie, ze cos zatyka rury.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_15_04"); //Co mozna z tym zrobic?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_01_05"); //Albo zdejmiemy wszystkie rury i sprawdzimy je.... lub smarujemy go od wewnatrz smarem, majac nadzieje, ze korek sam rozpusci sie.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_01_06"); //Czy bedziecie smarowac?
...
FUNC VOID Info_Mod_Wendel_Endres_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_01_01"); //To jest kolejne pytanie. Mysle, ze jedyna rzecza, która pomaga tylko troll tluszczu, to jest bardzo tluste. Bardzo rzadkie.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_01_02"); //Ale masz szczescie widziec tu trolle w Relendel.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_01_03"); //Po prostu umiescic go w dól i wziac tyle jego tluszczu z niego, jak mozesz niesc!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_A_15_04"); //To wszystko, co masz?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_01_05"); //Teraz spiesz sie, zanim natkniemy sie na waskie gardla!
...
FUNC VOID Info_Mod_Wendel_Endres02_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres02_01_01"); //Bardzo dobrze! A teraz wlewala sie do aborcji w Domu Strazaka.
...
FUNC VOID Info_Mod_Wendel_Endres02_Optional_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres02_Optional_01_01"); //Znajduje sie przy tej samej ulicy, co karczma i browar. W porzadku, idzmy!
};
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_01_00"); //Jezu Chryste! .... To Endres!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres03_15_01"); //Kto?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_01_02"); //Endres, budowniczy! Zaginiony czlowiek Juliany. Zablokowal rury. (chokesy)
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_01_03"); //(pauza) I.... Ach, przez Adanosa, zostal zamordowany!
...
FUNC VOID Info_Mod_Wendel_Endres04_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_01"); //Byl troche dziwaczny..... Mozna powiedziec, ze wspanialy.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_02"); //Stworzyl w miescie tajemnicze rzezby i pomógl zaplanowac instalacje wodociagowa.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_03"); //Bez niego bylibysmy znacznie bardziej zacofani.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres04_15_04"); //Kto chcialby go zabic?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_05"); //Skad powinienem wiedziec? On musial miec zazdrosc, ale to wszystko, co wiem. Nigdy go nie znalem dobrze.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres04_15_06"); //Wtedy bede pytal dalej.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_07"); //Opowiedz Julianie o incydencie. Nie czuje sie dobrze.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_08"); //Ah.... w odniesieniu do wodociagów: wszystko znowu dziala..... jak praca w zegarku....
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_01_09"); //Dziekujemy za pomoc.
...
FUNC VOID Info_Mod_Wendel_Endres05_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres05_01_01"); //Dlaczego tak jest?
	AI_Output(hero, self, "Info_Mod_Wendel_Endres05_15_02"); //Prosze odpowiedziec na pytania.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres05_01_03"); //Wszystkie prawa.
};
...
FUNC VOID Info_Mod_Wendel_Endres06_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres06_01_01"); //Um.... z moim asystentem, instalatorem.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres06_01_02"); //Jak zawsze od rano rano.
...
FUNC VOID Info_Mod_Wendel_Endres07_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres07_01_01"); //Nie potrafie powiedziec, czy nawet lepiej sie znaja. Z pewnoscia nie byli dobrymi przyjaciólmi.
...
FUNC VOID Info_Mod_Wendel_Endres08_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres08_01_01"); //Zwiazek miedzy Juliana i Endresem wydawal sie troche napiety.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres08_01_02"); //Byl geniuszem, co nie zawsze jest latwe dla partnera.
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_01_01"); //Kto dal ci list?
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_B_01_01"); //Zbyt zle. Wtedy nie moge odpowiedziec.
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_A_01_01"); //Jestes nosicielem najlepszej nowiny z mojego zycia! Wez to za podziekowania!
...
FUNC VOID Info_Mod_Wendel_Unruhen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen_01_01"); //Jestem bardzo zaszczycony. Nie jestem jednak pewny, ze jestem jednym z nich.
};
...
FUNC VOID Info_Mod_Wendel_Unruhen2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen2_01_01"); //Jest bardzo niepewna. Nie wolno nam robic niczego wiecej, co mogloby jeszcze bardziej sprowokowac górników, ale powinnismy natychmiast wznowic rozmowy na temat porozumienia.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen2_01_02"); //Nalezy zapobiegac kolejnym zgonom!
...
FUNC VOID Info_Mod_Wendel_Unruhen3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen3_01_01"); //Nie o to chodzi. Obie strony popelnily bledy.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen3_01_02"); //Naszym celem musi byc zintegrowanie górników z naszym spoleczenstwem w taki sposób, aby wszyscy bylismy zadowoleni.
};
...
FUNC VOID Info_Mod_Wendel_Unruhen4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_01"); //Nie wiem, czy powinienem byc z tego zadowolony.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_02"); //Bedziesz mial racje.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_03"); //Z Twoja pomoca. Zacznijmy od razu. Jest wiele do zrobienia.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_04"); //Gdzie zaczniemy?
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_05"); //Oczywiscie z górnikami. Konflikt musi zakonczyc sie bez rozlewu krwi.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_06"); //Wlasciwie byloby to sprawa sadowa. Ale miedzy wami a mna nie mysle zbyt wiele o sedziego i magistratze.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_07"); //Zrozumiale.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_08"); //Mysle, ze powinnismy zebrac przedstawicieli mieszczan i jednego z kopaczy;
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_09"); //w dwóch z nich omówiono by mozliwe rozwiazania, nadzorowane przez bezstronnego outsidera - Ciebie.
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_11"); //Teraz, gdy jestem glowa Khoraty, przypuszczam, ze zabieram glos w imieniu obywateli.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_12"); //Jesli chodzi o kopaczki, proponuje znalezc wsród nich ochotnika.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_01_13"); //Spotkam sie z Toba w ratuszu.
...
FUNC VOID Info_Mod_Wendel_Unruhen8_B()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_01_01"); //Przykro mi, ze musze wam to powiedziec, ale pod tym bezstronnym nie wyobrazam sobie tego, co nam tu pokazales.
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_01_02"); //Nie jestem zadowolony z wyniku dyskusji i sugeruje, ze spróbuje ponownie spróbowac pózniej.

		Mod_REL_WendelS = 17;
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_01_03"); //Tak, mam tego swiadomosc. Bedziemy cos z tym zrobic.
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_01_04"); //Byc moze moglibysmy odlozyc na jakis czas w przyszlosci rekompensate, aby uporzadkowac budzet. Czy to wszystko byloby sluszne?
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen9_01_00"); //Wydaje sie, ze rozwiazalismy najpowazniejsze problemy. Mam nadzieje, ze teraz wszystko bedzie przebiegalo sprawnie.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen9_01_01"); //Dziekujemy za pomoc.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_01"); //Tak, wyslalismy juz przez miasto kilka mlotków mysliwych.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_02"); //Ale nawet mlotkami nie udalo sie powstrzymac szkodników.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_03"); //Bez wzgledu na to, jak czesto ich bijesz, wracaja oni do nas i w towarzystwie wielu swoich rodaków.
	B_Say	(hero, self, "$PLAGENQUEST02");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_05"); //W rzeczywistosci, obecnie badam kroniki miasta i spotkalem sie z czyms.....
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_06"); //Minie jednak troche czasu, zanim przejde do pelnej analizy tekstu.
	B_Say	(hero, self, "$PLAGENQUEST03");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_08"); //Tak, mozesz spróbowac szczescia jako mlotkowiec na dworze, w którym obecnie jest wiele brudnych stworzen.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_01_09"); //Moze odniesiesz wiekszy sukces.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_00"); //Ach, dobrze, zeby cie zobaczyc, odkrylem cos waznego.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_01"); //Choroba, która obecnie dotyka miasto, istniala juz wiele stuleci temu - niedlugo po jego powstaniu.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_02"); //Aby zabezpieczyc blogoslawienstwo bogów dla miasta i jego otoczenia, w holdzie bogom uczyniono wówczas poswiecenia zwierzat.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_03"); //Kazdy mial obowiazek poswiecic pewna liczbe zwierzat.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_04"); //Jednak jeden z ich ojców zalozycieli byl tak skapy, ze zamiast owcy czy molate poswiecil owady.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_05"); //Bogowie byli tak wsciekli, ze przenosili ludzkie pragnienie bogatej populacji zwierzat na owady srodowiska.

	B_Say	(hero, self, "$PLAGENQUEST04");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_07"); //No cóz, z klubem chemicznym.

	B_Say	(hero, self, "$PLAGENQUEST05");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_09"); //Tak, przez dlugi czas bylo sie zupelnie bezradnym i wydawalo sie, ze trzeba sie bylo porzucic miasto.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_10"); //Ale wtedy sprawiedliwy i szanowany obywatel Chemos zostal wysypany snem.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_11"); //Otrzymal on instrukcje jak zbudowac bron, która moglaby wypedzic zaraze.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_12"); //Dlatego wlasnie nasz zwyczaj z mlotkami miejskimi musi przyjsc do walki z owadami.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_13"); //Mloty i kluby nie róznily sie wówczas zasadniczo.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_14"); //Nasze prawo w tym zakresie siega nieco pózniej, kiedy to mlotki nadano im charakterystyczny ksztalt, a kluby zostaly zastapione z powodów praktycznych.

	B_Say	(hero, self, "$PLAGENQUEST06");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_16"); //Nie, juz nie boje sie. A produkcja takiej broni nie jest nieskomplikowana. Znalazlem te instrukcje.....

	B_Say	(hero, self, "$PLAGENQUEST07");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_18"); //Oto jej kopia.
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_21"); //Czy to prawda? Bedzie pan nam wszystkim przysluzyl sie swietnie.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_22"); //Jak tylko bedziesz miec wszystko razem, wróc tutaj i oddaj materialy do naszego kowala.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_01_23"); //A gdzies w miescie znajdziemy klub. Dziekuje, dziekuje.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_03_01_00"); //Slysze, ze dostales klub. Teraz nadszedl czas, aby wypedzic szkodniki z miasta.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_03_01_01"); //Wiele zwierzat zebralo sie na targowisku. Wez klub chemiczny i zniszcz go.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_04_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_01"); //To wspanialy i pierwszy krok na drodze do ostatecznego wygnania zla.
	B_Say	(hero, self, "$PLAGENQUEST11");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_03"); //Tak, niestety dowiedzielismy sie, ze nowe pasozyty nadal pochodza z okolicznych lasów.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_04"); //Gdzies tam, gdzie musi byc korzen zla...... zlowieszczy olbrzymi blad, o którym mówily zródla.
	B_Say	(hero, self, "$PLAGENQUEST12");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_06"); //Jest cos, a raczej ktos, kto moze Ci w tym pomóc.
	B_Say	(hero, self, "$PLAGENQUEST13");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_08"); //Obywatel naszego miasta. Jego imie jest aksonem i nosi krew chemiczna, jak dowiedzialem sie kilka godzin temu.
	B_Say	(hero, self, "$PLAGENQUEST14");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_10"); //Cóz, z jednej strony rodowody daja jasne wskazówki, a z drugiej..... no cóz.....
	B_Say	(hero, self, "$PLAGENQUEST15");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_12"); //... Znalezlismy z nim klub chemiczny. Caly czas wisiala w salonie jego domu.
	B_Say	(hero, self, "$PLAGENQUEST16");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_01_14"); //W kazdym razie, powinien byc w stanie pomóc Ci wyczuc chrzaszcze, odkryc i zniszczyc olbrzymi blad. On juz czeka na Ciebie poza miastem.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_05_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_05_01_01"); //To wspaniale. Uczyniles nasze miasto sluzba o nieocenionej wartosci i rozwiales zlo.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_05_01_02"); //Wez to zloto i mlotek miejski jako podziekowania. Niech wam towarzyszy blogoslawienstwo bogów.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_00"); //Dobry poranek, zolnierz. Czy tez powinienem wezwac Pana kapitana?
	B_Say	(hero, self, "$HEROBOTQUEST01");
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_02"); //Plan Pana Andre' a zadzialal, ale nie bylo sposobu na wyprowadzenie wyjscia do wielkiego pieca, wiec on nasycil cie, wlozyl kostium i zwabil robota do wielkiego pieca.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_03"); //Znalezlismy obok Ciebie zapieczetowana koperte. W nim Andre wyjasnil cala sprawe i mianowal cie swoim nastepca.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_04"); //Ale tutaj.... mozesz sam przeczytac szczególy.

	B_GiveInvItems	(self, hero, ItWr_AndreAbschied, 1);

	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_05"); //A ja powinienem wam dac ten klucz. Prawdopodobnie do pudelka w pokoju kapitana.

	B_GiveInvItems	(self, hero, ItKe_Andre, 1);

	B_Say	(hero, self, "$HEROBOTQUEST02");
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_06"); //Dokladnie. Brakowalo Ci nabozenstwa, spales przez 32 godziny snu. Stary konik wydaje sie byc w bardzo dobrej formie.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_07"); //Jesli chcesz sie pozegnac, Andre jest teraz na cmentarzu. Przynajmniej jego prochy. Ale odpocznij najpierw, nie ucieknie od ciebie.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_01_08"); //O tak, zanim zapomne: operator wielkiego pieca poprosil cie o to, sprawdz go.
...
FUNC VOID Info_Mod_Wendel_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Freudenspender_01_01"); //Co to jest?
	AI_Output(hero, self, "Info_Mod_Wendel_Freudenspender_15_02"); //Droga do duchowosci.
	AI_Output(self, hero, "Info_Mod_Wendel_Freudenspender_01_03"); //(smiech) Wypróbuj staruszki.
};
