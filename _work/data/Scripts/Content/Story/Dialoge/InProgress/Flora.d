...
{
	AI_Output(self, hero, "Info_Mod_Flora_Hi_21_00"); //Yes?
};
...
FUNC VOID Info_Mod_Flora_Port_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_01"); //What's the point? Did I do something wrong?
	AI_Output(hero, self, "Info_Mod_Flora_Port_15_02"); //You're on a killer's hit list. It has to do with Johannes Port.
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_03"); //Seriously, what happened? Is he all right?
	AI_Output(hero, self, "Info_Mod_Flora_Port_15_04"); //How to take it. He's not in pain anymore.
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_05"); //(languagelessly) Oh.... such as.... what? He's dead? No! ... But why are you coming to me?
	AI_Output(hero, self, "Info_Mod_Flora_Port_15_06"); //To warn you and ask what motive the killer might have had.
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_07"); //Hmm... Surely John had his secrets... but there was one thing he didn't even want to tell me, his cousin.
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_08"); //In his last letter he only hinted at what he had found out, but that it could be life-threatening, I hadn't expected....
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_09"); //Oh, wait! I remember a name, a person Johannes warned me about.
	AI_Output(hero, self, "Info_Mod_Flora_Port_15_10"); //What's the person's name?
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_11"); //Brahim did it. Johannes didn't know him, but he thought he had dark connections.... I wonder what that means.
	AI_Output(hero, self, "Info_Mod_Flora_Port_15_12"); //I'll figure it out.
	AI_Output(self, hero, "Info_Mod_Flora_Port_21_13"); //Good. Thanks for your warning, I'll be careful. Good luck to you!
...
{
	AI_Output(self, hero, "Info_Mod_Flora_Dachratte_21_00"); //Oh, you look like a trained climber.
	AI_Output(self, hero, "Info_Mod_Flora_Dachratte_21_01"); //Please help me get this horrible beast off my roof!
...
FUNC VOID Info_Mod_Flora_Dachratte_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Flora_Dachratte_A_21_01"); //A rat! Hopefully her whole family hasn't settled in the attic yet!
	AI_Output(hero, self, "Info_Mod_Flora_Dachratte_A_15_02"); //How do I get to the roof?
	AI_Output(self, hero, "Info_Mod_Flora_Dachratte_A_21_03"); //You have to find a way up somewhere. That's why I'm asking you!
...
FUNC VOID Info_Mod_Flora_Dachratte2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Flora_Dachratte2_21_01"); //Oh, there are still helpful people out there. Thank you very much!
