...
{
	AI_Output(self, hero, "Info_Mod_Trador_Hi_03_00"); //Jestes, nie liczylem na ciebie, ale ciesze sie, ze jestes tutaj.
...
FUNC VOID Info_Mod_Trador_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_B_03_01"); //Czy nie sadzisz, ze najpierw powinienes mi cos powiedziec o sobie?
...
FUNC VOID Info_Mod_Trador_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_A_03_00"); //Jestem Tradorem, wysokim czlonkiem kregu magów transformacji.
	AI_Output(self, hero, "Info_Mod_Trador_Hi_A_03_01"); //Slyszalem juz o twoim przyjezdzie, wiec ruszylem w droge.
...
FUNC VOID Info_Mod_Trador_Hi_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_D_03_01"); //Co zrobilem dla Ciebie? Nie badz tak uparty.
...
FUNC VOID Info_Mod_Trador_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_C_03_01"); //Nie obchodzi mnie to, kim jestes, ale co tu robisz.
...
FUNC VOID Info_Mod_Trador_Hi_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_E_03_01"); //Poczekac! Co Pan tutaj robi?
...
FUNC VOID Info_Mod_Trador_Hi_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_G_03_01"); //Czy widze rosliny?
...
FUNC VOID Info_Mod_Trador_Hi_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_F_03_01"); //Mozesz mi ufac. Jestem przeciez magikiem transformujacym.
...
FUNC VOID Info_Mod_Trador_Hi_J()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_J_03_01"); //Czy zawsze sadzisz ludzi po ich wygladzie? Chodzcie, przyjdzcie.
...
FUNC VOID Info_Mod_Trador_Hi_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_I_03_01"); //Blagam cie, mozesz szukac nowych roslin dla Genn.
	AI_Output(self, hero, "Info_Mod_Trador_Hi_I_03_02"); //Moge wam ofiarowac te ziola, wygladaja dokladnie jak trujace, ale sa calkowicie nieszkodliwe. Mozesz dac to Gennowi.
	AI_Output(hero, self, "Info_Mod_Trador_Hi_I_15_03"); //Co sie z tego wydostaje?
	AI_Output(self, hero, "Info_Mod_Trador_Hi_I_03_04"); //Czy mozemy powiedziec - 200 zlotych monet?
...
FUNC VOID Info_Mod_Trador_Hi_T()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_T_03_01"); //Nie do konca bylem szczesliwy, ze sie zlapal. Ale zrozumialem, ze masz z tym cos wspólnego. Zbyt duzo szarpales.
	...
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_T_03_02"); //Po wypuszczeniu go, przyszedl do mnie. To bylo bardzo lekkomyslne.
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_T_03_03"); //Ale prawdopodobnie nigdy nie wiesz, dlaczego Fa ma umrzec. Adieu!
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Hi_R_03_00"); //Dziekuje, oszukujesz! Nigdy wiecej nie zobaczysz roslin! (smiertelnicy)

	if (Mod_VMG_FaiceGifty_Gift == 13)
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_R_03_01"); //Oto, co otrzymasz za to, aby Furt przewrócic!
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_R_03_02"); //Furt mialem racje, jestes naprawde lekkomyslny!
	};
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Hi_S_03_00"); //Jezdzisz do mnie szalony!

	if (Mod_VMG_FaiceGifty_Gift == 13)
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_S_03_01"); //Ale oczekiwalem, ze bedziecie wytrwali po skazaniu Furta.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Trador_Hi_S_03_02"); //Ale Furt juz powiedzial mi, ze byc moze jestes wytrwaly.
	};
...
FUNC VOID Info_Mod_Trador_Hi_K()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_K_03_01"); //500 - Moja ostatnia oferta.
...
FUNC VOID Info_Mod_Trador_Hi_M()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_M_03_01"); //1000. I juz wiecej monet!
...
FUNC VOID Info_Mod_Trador_Hi_O()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_O_03_01"); //Dlaczego? Czy cos dla Ciebie zrobilem? Musze to zrobic za wazne.... poznac.
...
FUNC VOID Info_Mod_Trador_Hi_P()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Hi_P_03_01"); //O.... Habits of the other members, yes.
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Teleport_03_00"); //Co pan tutaj? Masz byc gdzies indziej!
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Teleport_C_03_00"); //(smiech) Nie ma szansy. Jestem tylko gonna przywolac kilka golemów i ustawic je na ciebie. Moge wówczas spokojnie uciekac.
	AI_Output(hero, self, "Info_Mod_Trador_Teleport_C_15_01"); //Nie jestem gonna, zeby to bylo az tak daleko.
	AI_Output(self, hero, "Info_Mod_Trador_Teleport_C_03_02"); //Co ty z tym robisz, huh?
...
FUNC VOID Info_Mod_Trador_Teleport_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Trador_Teleport_A_03_01"); //Uszkodzilem portal tak, ze wyladowales w tej samotnej dolinie z dwoma ubogimi ludzmi, którzy starali sie udaremnic nasze plany.
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Buff_03_00"); //Co.....? Co próbujesz zrobic?
...
{
	AI_Output(self, hero, "Info_Mod_Trador_Setta_03_00"); //arghhhhhhh.....
	AI_Output(hero, self, "Info_Mod_Trador_Setta_15_01"); //Teraz dostaniesz pelen guzik na ustach!
	AI_Output(self, hero, "Info_Mod_Trador_Setta_03_02"); //Nie poddam sie bez walki!
