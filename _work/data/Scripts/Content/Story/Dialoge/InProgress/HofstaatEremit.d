...
FUNC VOID Info_Mod_HofstaatEremit_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_01"); //Zalezy od niego.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_02"); //Co na czym?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_03"); //Który pustelnik oznacza.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_04"); //Oczywiscie królewski.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_05"); //Tak, jestem nim.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_06"); //Czarodziej wyslal mnie.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_07"); //Który z nich?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_08"); //Królewski.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_09"); //Ach, cóz. I czego chce?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_10"); //Powiedzial cos na temat doreczenia grzybów.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_11"); //.... Co to grzyb? (zaklócone)
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_12"); //Królewski goddamned jeden królewski!
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_13"); //Ach, cóz. Nastepnie wez te królewska torbe pelna królewskich zarodników grzybów i przyprowadz do maga!

	B_GiveInvItems	(self, hero, ItMi_FreudenspenderSporen, 1);

	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_14"); //Który z nich?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_15"); //Oczywiscie królewski!
