...
FUNC VOID Info_Mod_Pendler_01_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_01"); //We are the fools who were ordered by Anselm to transport the proceeds of our mine into town.
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_02"); //But we're still lucky.
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_03"); //I don't want to trade with the poor bastards who are now allowed to work in the mine.
};
...
FUNC VOID Info_Mod_Pendler_01_WoMine_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_01"); //Why don't you just come with me, we're on our way over there right now.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_02"); //We're on our way into town right now, so you have to go the other way.
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_03"); //You'd have to find enough signposts to lead you there.
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_04"); //Otherwise, wait until we get back there, then you can come with us.
	};
};
