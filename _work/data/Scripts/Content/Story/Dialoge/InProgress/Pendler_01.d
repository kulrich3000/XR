...
FUNC VOID Info_Mod_Pendler_01_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_01"); //Jestesmy glupcami, którym Anselm nakazal przetransportowac wplywy naszej kopalni do miasta.
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_02"); //Ale nadal mamy szczescie.
	AI_Output(self, hero, "Info_Mod_Pendler_01_Hi_03_03"); //Nie chce handlowac z biednymi draniemi, którym teraz wolno pracowac w kopalni.
};
...
FUNC VOID Info_Mod_Pendler_01_WoMine_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_01"); //Dlaczego nie tylko nie przychodzisz ze mna, ale jestesmy tam wlasnie teraz.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_02"); //Jestesmy w drodze do miasta juz teraz, wiec musisz isc inna droga.
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_03"); //Musisz znalezc wystarczajaco duzo drogowskazów, aby zaprowadzic Cie tam.
		AI_Output(self, hero, "Info_Mod_Pendler_01_WoMine_03_04"); //W przeciwnym razie, poczekaj, az tam wrócimy, wtedy mozna przyjsc z nami.
	};
};
