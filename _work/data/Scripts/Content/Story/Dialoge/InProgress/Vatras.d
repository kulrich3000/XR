...
FUNC VOID Info_Mod_Vatras_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hi_16_01"); //Jestem magikiem wody Vatry.
};
...
{
	AI_Output(self, hero, "Info_Mod_Vatras_Daemonisch_16_00"); //Co Pan (i) zglasza? Musimy natychmiast zaostrzyc srodki bezpieczenstwa.....
...
FUNC VOID Info_Mod_Vatras_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_02"); //I myslales o mnie?
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_03"); //Widzialam, jakie zlo moze przyjac to zagrozenie, poniewaz niemal zniszczylo ono miasto.
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_04"); //Jesli zaproponowano mi mozliwosc, to nie tylko moja wola towarzyszenia wam tam, ale nawet mój obowiazek ratowania calego Khorinisa.
};
...
FUNC VOID Info_Mod_Vatras_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath2_16_01"); //Nastepnie udam sie teraz do portu i czekam na poczatek naszej podrózy.
...
FUNC VOID Info_Mod_Vatras_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath3_16_01"); //Zbyt zle. Wróce wtedy. Wiesz, gdzie mnie znalezc, jesli kiedykolwiek zostanie jakies miejsce.
...
FUNC VOID Info_Mod_Vatras_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath4_16_01"); //Bardzo dobrze, wróce do portu.
...
FUNC VOID Info_Mod_Vatras_Novize_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_01"); //Zanim staniecie sie jednym z nas, musicie nam pomóc przez jakis czas.
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_02"); //Jesli wykonasz dla nas duza prace, zabiore Cie do pracy. Tam bedziesz wykonywal zadania dla mnie i innych magów wody.
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_03"); //Kiedy bedziecie nam sluzyc przez jakis czas, zabierzemy Was w krag wody.
...
FUNC VOID Info_Mod_Vatras_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_16_01"); //W dzisiejszych czasach brakuje coraz wiecej ludzi. Dowiedz sie gdzie sie znajduja.
...
FUNC VOID Info_Mod_Vatras_Aufgabe_Wo()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_Wo_16_01"); //Idz do portu i porozmawiaj z jednym z naszych czlonków. Nazywa sie Diego.
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_Wo_16_02"); //Powiedz mu, ze cie poslalem, a on ci powie wszystko, co wie.
...
FUNC VOID Info_Mod_Vatras_ErsteInfos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_01"); //Sprawozdania.
	AI_Output(hero, self, "Info_Mod_Vatras_ErsteInfos_15_02"); //Liste te znalazlem w poblizu domu Freda.
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_03"); //Pozwole sobie to zobaczyc.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_05"); //Bardzo dobry. Wyglada jak Elvrich jest jej kolejna ofiara.
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_06"); //Porozmawiaj z nim i ogonuj go.
...
FUNC VOID Info_Mod_Vatras_Fertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_01"); //Kim to jest?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_03"); //Naprawde? Co daje ci taka pewnosc?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_05"); //A jak to bylo uprowadzenie?
	AI_Output(hero, self, "Info_Mod_Vatras_Fertig_15_06"); //.... Wojownik demoniczny wyszedl znikad i zniknal podobnie jak Elvrich.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_07"); //Hmm, no cóz, ze wszystko brzmi bardzo mylaco.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_08"); //I wiele pozostaje ukrytych w ciemnosci nocy.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_09"); //Nie wiemy na pewno, dopóki nie znajdziesz porywaczy.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_10"); //Zostales skierowany. Wejdz w droge i spróbuj dowiedziec sie wiecej od wojowników demonów.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_11"); //Ich obóz znajdziesz gdzies w Minental w górach.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_12"); //Slyszalem tez, ze powinni posiadac kopalnie. Byc moze jest to równiez wazna wskazówka....
...
FUNC VOID Info_Mod_Vatras_RealInfos_Info()
{
	...
	if (Mod_WM_ElvrichImSumpf == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_02"); //Co, gdzie jest teraz? Nadal w niewoli?
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_06"); //Hmm..... To, o czym jestem informowany, nie jest istotne dla miasta bezpieczenstwa.
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_07"); //Jak najszybciej podejmiemy niezbedne kroki, aby polozyc kres tej zlej dzialalnosci.....
	...
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_09"); //W Adanos (krótkie przerwy)? Mialem nadzieje, ze wciaz sa wsród zyjacych....
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_10"); //No cóz, przynajmniej teraz jest jasnosc co do ich losu i mozemy zrobic wszystko, co jest konieczne, aby polozyc kres temu zgielkowi w murach miasta?

		B_GivePlayerXP	(400);
	};

	AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_11"); //Tak czy inaczej, wykonales swoja prace bardziej niz dobrze i udowodniles mi, ze bedziesz godnym bratem w naszej wspólnocie.
	AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_12"); //Nic nie stoi ci na przeszkodzie, aby dolaczyc do naszych szeregów.

	if (Mod_Gilde == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_13"); //Mozesz do nas dolaczyc juz teraz.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_14"); //Niestety, wybrales juz inna droge.
	};
...
FUNC VOID Info_Mod_vatras_Aufnahme_Info()
{
	...
	if (hero.level >= 5)
	{
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_01"); //Jestes gotów dolaczyc do nas.
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_02"); //Ale gdy tylko nosisz jedna z naszych pancerzy, nie ma juz odwrotu.
		...
		if (Mod_HatPlayerNeutraleKlamotten())
		{
			...
			|| (Mod_Gottstatus <= 4)
			{
				AI_Output(self, hero, "Info_Mod_Vatras_Aufnahme_16_05"); //Powinienes jednak zrobic jeszcze kilka rzeczy na korzysc Adanosa.
			}
			else
			{
		...
		{
			AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_04"); //Najpierw powinienes zdobyc neutralna zbroje.
		};
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_03"); //Lepiej zdobyc wiecej doswiadczenia.
	};
};
...
FUNC VOID Info_Mod_vatras_Aufnahme_Nein()
{
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Nein_16_01"); //Cokolwiek mówisz.
...
FUNC VOID Info_Mod_vatras_Aufnahme_Ja()
{
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_01"); //Dobre. Oto Twoja szata.
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_03"); //Nowicjusze maja u nas paleczke. Oto Twoje.

	B_GiveInvItems	(self, hero, ItMw_RangerStaff_Addon, 1);

	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_04"); //Jesli potrzebujesz lepszej broni, musisz ja kupic na rynku.
	AI_Output(self, hero, "Info_Mod_Vatras_Aufnahme_Ja_16_05"); //Ta runa powinna pomóc ci bezpiecznie przeciwstawic sie niebezpieczenstwom, które moga czaic sie w drodze do moich braci.
...
FUNC VOID Info_Mod_Vatras_AkilsHof_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_01"); //Powiedz mi wiec, co cie do mnie przyprowadzi.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_04"); //Co Pan mówi? Brak zla? W takim przypadku moje mozliwosci nie wystarcza.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_05"); //Prawdopodobnie jest to raczej obsesja niz zwykla choroba, a moja sztuka zawodzi.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_06"); //Dobrze by bylo spieszyc sie z powrotem do klasztoru magików strazy pozarnej, aby tam recytowac zapytanie.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_07"); //Ten prosty eliksir powinien pomóc cierpiacemu Ehnimowi.

	B_GiveInvItems	(self, hero, ItPo_Health_01, 1);

	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_08"); //Przejdz teraz, wiesz co robic.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_01"); //Tak, czuje, ze wydaje mi sie Pan byc pod czara zlego zaklecia. Co sie stalo?
	AI_Output(hero, self, "Info_Mod_Vatras_Hexenfluch_15_02"); //Kobieta w tawernie Orlana rzucila na mnie zdradliwa magie.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_03"); //Co? Kobieta? To brzmi dla mnie tak samo...... czarownicy.

	AI_TurnAway	(self, hero);

	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_04"); //Tutaj na Khorinis....

	AI_TurnToNpc	(self, hero);

	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_05"); //Co dokladnie sie stalo?
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_C_16_01"); //Co? Tak, dzialales naprawde niegodnie. Nieco spokojniejszy) Ale mysle, ze to dobrze, ze mówisz mi prawde.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_C_16_02"); //Mam nadzieje, ze wyciagneliscie wnioski z tego bledu. Przejdzcie teraz do klasztoru Pyrokar, poniewaz nie moge wam pomóc w tej sprawie.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_B()
{
	...
	if (Mod_AttraktiveFrau == 2)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_01"); //Czyz to prawda? Moze to wynikac z tego, ze czarownice sa zdolne do takiej pracy. Nie widze jednak, by bylo to prawda.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_02"); //Jesli angazujesz sie w niemoralne prostytutki demoniczne - i z wlasnej wolnej woli - przynajmniej wyznaj to.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_03"); //A gdy idziesz do klasztoru do Pyrokar, który moze Ci pomóc w odpowiedzi na twoja prosbe, powinienes uwaznie pomyslec o swoim zachowaniu.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_04"); //Teraz wyjdz z oczu.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_05"); //Hmm, widze w waszych oczach, ze mówicie prawde.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_06"); //Faktycznie odpowiada to charakterowi czarownic, aby móc oddzialywac na ich ofiary.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_07"); //Niestety, nie jestem w stanie pomóc w tej sprawie. Najlepiej udac sie bezposrednio do Klasztoru Pyrokar.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_A_16_01"); //Nie widze jak mówisz mi prawde.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_A_16_02"); //Jesli angazujesz sie w niemoralne prostytutki demoniczne, przynajmniej wyznaj to.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_E_16_01"); //Naprawde mam nadzieje, ze dla waszego dobra nauczycie sie Panstwo uczyc na wlasnych bledach.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_E_16_02"); //Teraz udaj sie do klasztoru Pyrokar. Znajdziesz u niego pomoc.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_D()
{
	...
	if (Mod_AttraktiveFrau == 2)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_01"); //Tak, naprawde? Jestem gleboko smutny i gniewny, ze znowu klamia panstwo na mnie tak bezwstydnie.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_02"); //Teraz wyjdz mi z oczu, brudny klamca.

		B_GivePlayerXP	(-100);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_03"); //Hmm, wyczuwam przynajmniej prawde w waszych slowach. No cóz, zrobilbys dobrze, gdybys od razu byl szczery.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_04"); //Przejdz do klasztoru Pyrokar. On moze Ci pomóc w rozwiazaniu problemu.
	};
...
FUNC VOID Info_Mod_Vatras_NovizenTrank_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_NovizenTrank_16_01"); //Lek dla nowicjuszy pozaru? Jakie cierpienia trzeba wyleczyc?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_NovizenTrank_16_04"); //Ah, czarna goraczka. Wez ten eliksir, powinien pomóc.
...
FUNC VOID Info_Mod_Vatras_TempelDicht_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_01"); //Mów, synu.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_05"); //To naprawde straszna wiadomosc. Chcialbym podac klucz, ale niestety jakis czas temu zostal on skradziony.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_06"); //Co? Kto ukradl klucz?
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_07"); //Byl czlonkiem zlowieszczego kultu krwi. Kult krwi jest grupa nikczemnych istot, które wyczarowuja zaburzenia równowagi.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_08"); //Gdzie zlodziej moze uciec?
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_09"); //W poblizu tawerny Orlanu znajduje sie jaskinia. Jesli dobrze pamietam, jest jedna z kryjówek kultów krwi. Spróbuj szczescia tam.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_10"); //Dziekujemy za koncówke.
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_11"); //Jeszcze jedno! Kult krwi ma nieznane zdolnosci i moce, które przerazaja nawet nas. Nalezy zachowac ostroznosc.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_12"); //Bede, to zrobie. Wyjezdzam teraz.
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_13"); //Obys wrócil bezpiecznie!
...
FUNC VOID Info_Mod_Vatras_TempelDicht2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht2_16_01"); //Bardzo dobry, syn. Jest pan niezwyklym wojownikiem.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht2_15_02"); //Ide teraz do Riordiana i ratuje pozostalych.
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht2_16_03"); //Zrób to, ale spiesz sie. Czas nie jest naszym sojusznikiem.
...
FUNC VOID Info_Mod_Vatras_Kristall_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Kristall_16_01"); //Cenny przedmiot. Postaram sie, aby zajal nalezne mu miejsce.
	AI_Output(self, hero, "Info_Mod_Vatras_Kristall_16_02"); //Ten akt umozliwia dolaczenie do nas.
...
FUNC VOID Info_Mod_Vatras_Sweetwater_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Sweetwater_16_01"); //Calkiem tak. Otrzymalem wiadomosc, ze Saturas potrzebuje Twojej pomocy.
	AI_Output(self, hero, "Info_Mod_Vatras_Sweetwater_16_02"); //Minelo troche czasu. Lepiej sie spieszyc.
...
FUNC VOID Info_Mod_Vatras_Zeremoniendolch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_01"); //Tyle tylko, ze zapisy takiej relikwii znaleziono w Jharkendarzu. Znasz Jharkendara?
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_02"); //Tak, otworzylem portal.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_03"); //Nastepnie porozmawiaj z Merdarionem. Jestem pewien, ze moze ci powiedziec wiecej.
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_04"); //Dziekuje, magikowi.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_05"); //Trzymac przez sekunde. Jesli pójdziesz tam, mozesz zabrac ze soba kilka rzeczy.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_06"); //Zazwyczaj robi to Cavalon, ale nie byl tu od dawna.
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_07"); //Jest w swiatyni portalu i stoi tam nogi w brzuchu.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_08"); //Potem powiedz mu, zeby sie tu pojawil. Mam wiecej do transportu.
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_09"); //To wlasnie robie. Co powinienem zabrac ze soba?
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_10"); //Tutaj. Przekazujesz te torbe magikowi Cronosowi.
...
FUNC VOID Info_Mod_Vatras_BosperLehrling_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_01"); //Tkaniny nie sa moja specjalnoscia.
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_02"); //Moge podac wam role odwrotu, który nastepnie trzeba miec alchemika rozbitego na jego czesci skladowe.
...
FUNC VOID Info_Mod_Vatras_Kreis1_Info ()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis1_16_01"); //Pierwsze kolo pozwala na uzycie utworzonych przez Ciebie run.
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis1_16_02"); //Mozesz teraz nauczyc sie formul zaklec, aby tworzyc wlasne runy.
...
FUNC VOID Info_Mod_Vatras_Kreis2_Info ()
{
	...
	if (Kapitel >= 2)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis2_16_01"); //Wejdz do drugiego kola i naucz sie rzucac jeszcze mocniejsze czary.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis2_16_02"); //Nadszedl jeszcze czas.
	};
};	
///////////////////////////////////////////////////////////////////////
//	Info TECH_CIRCLE_03
...
FUNC VOID Info_Mod_Vatras_Kreis3_Info ()
{
	...
	if (Kapitel >= 3)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis3_16_01"); //Tak, nadszedl czas. Wprowadz trzecie kolo magii. Czekaja na Ciebie nowe zaklecia.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis3_16_02"); //Nie nadszedl jeszcze czas, aby nauczyc sie trzeciego kola.
	};
};		
...
FUNC VOID Info_Mod_Vatras_Kreis4_Info ()
{
	...
	if (Kapitel >= 4)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis4_16_01"); //Dobre. Wszystkie znaki sa wypelnione. Teraz wejdz w czwarte kolo, abys mial moc nowych zaklec.
	...
	{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis4_16_02"); //Jeszcze nie.
	};
};
...
FUNC VOID Info_Mod_Vatras_Kreis5_Info()
{
	...
	if (Kapitel >= 5)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis5_16_01"); //Nastepnie dolacz do piatego kola magii. Teraz opanujesz mocniejsze czary niz kiedykolwiek wczesniej.
	...
	{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis5_16_02"); //Nadszedl jeszcze czas.
	};
};
...
FUNC VOID Info_Mod_Vatras_Kreis6_Info()
{
	...
	if (Kapitel >= 6)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_01"); //Wiele czasu minelo od czasu, kiedy zawarles przymierze z Innosem. Wiele sie wydarzylo i nie znajdujemy pokoju.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_02"); //Jestes Wybranym Adanosem ". W ten sposób bedziesz potrzebowal calej sily, aby przetrwac swoje walki.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_03"); //Poswiecam pana teraz, prosze pania wybrac. Wprowadzasz szóste kolo.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_04"); //Jesli chcesz, mozesz teraz nauczyc sie zaklec ostatniego kola od Nefariusa.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_05"); //To jeszcze nie czas. Jesli poszedles troche dalej po drodze Beliar cie pokaze, a ja cie poucze.
	};
};
...
FUNC VOID Info_Mod_Vatras_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Lehrer_16_01"); //Z pewnoscia moge panu w tym pomóc.
...
FUNC VOID Info_Mod_Vatras_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Lernen_BACK_16_01"); //Twoje magiczne umiejetnosci sa teraz tak dobre, ze nie moge cie niczego nauczyc.
	};
	Info_ClearChoices	(Info_Mod_Vatras_Lernen);
};
...
FUNC VOID Info_Mod_Vatras_Ruestung_Info()
{
	...
	&& (Mod_Gilde < 10)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_16_02"); //Slyszalem, ze podobno w poblizu jeziora na pólnocny zachód od miejsca wykopaliska mieszka paczka lapanek wodnych. Z ich skóra z pewnoscia moge poprawic swoja nowicjuszowa szate wodna troche.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_16_03"); //Slysze, ze w drodze na miejsce wykopu znajduje sie lyzwiarka wodna. Z jego futrem z pewnoscia móglbym troche poprawic wasza wodna magiczna szate.
...
FUNC VOID Info_Mod_Vatras_Ruestung_WNOV_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_01"); //Wszystko jasne.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_02"); //Musisz miec nowa próbke wody lub nie bede w stanie naprawic jej dla Ciebie.
	}
	else if (Npc_HasItems(hero, ItAt_Wassersnapperhaut) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_03"); //Nie moge poprawic zbroi, jesli nie masz skóry na szpicke.
	};
...
FUNC VOID Info_Mod_Vatras_Ruestung_KDW_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_KDW_S_16_01"); //Wszystko jasne.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_RIT_S_16_02"); //Musisz miec czarodziejska szate wodna lub nie bede w stanie ja dla ciebie naprawic.
	}
	else if (Npc_HasItems(hero, ItAt_WaterShadowFur) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_RIT_S_16_03"); //Jesli nie masz plaszcza odbijajacego, nie moge poprawic pancerza.
	};
