...
{
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Hi_16_00"); //Witaj znajomego. Krok blizej!
	AI_Output(hero, self, "Info_Mod_Raritaetenhaendler_Hi_15_01"); //Przyjacielu? Czy znamy sie nawzajem?
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Hi_16_02"); //Jeszcze nie. Nazywam sie Finder. Zajmuje sie rzadkoscia.
	AI_Output(hero, self, "Info_Mod_Raritaetenhaendler_Hi_15_03"); //Rzadkosci. To rzadkie rzeczy.
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Hi_16_04"); //Dokladnie. Rzadkie, dziwne, a nawet wyjatkowe rzeczy.
...
FUNC VOID Info_Mod_Raritaetenhaendler_Rune_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune_16_01"); //Bylbym szczesliwy. Mozesz go miec za 500 sztuk.
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune_16_04"); //Czy nie masz zamiaru? Jest to absolutna rzadkosc. Nie mniej niz 400.
};
...
FUNC VOID Info_Mod_Raritaetenhaendler_Rune01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune01_16_01"); //Jest to popyt i podaz. Tutaj. Dobrze sie bawic.
...
FUNC VOID Info_Mod_Raritaetenhaendler_Rune02_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune02_16_01"); //Oh. Pól runy.
	AI_Output(hero, self, "Info_Mod_Raritaetenhaendler_Rune02_15_02"); //Dokladnie. Oni sa tam gdzies.
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune02_16_03"); //A zatem wszystko w porzadku. Zejde do 250.
...
FUNC VOID Info_Mod_Raritaetenhaendler_Rune03_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune03_16_01"); //Wtedy nie mozemy robic interesów. Przepraszam za to.
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune03_16_03"); //Ladunek. Tutaj runa.
...
FUNC VOID Info_Mod_Raritaetenhaendler_Rune04_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune04_16_01"); //Tak myslisz. Prawie wszyscy pytaja mnie co sie dzieje z runem.
	AI_Output(hero, self, "Info_Mod_Raritaetenhaendler_Rune04_15_02"); //I oczywiscie mówisz:"Nie wiem". Tutaj. 200 zlota.

	B_GiveInvItems	(hero, self, ItMi_Gold, 200);

	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune04_16_03"); //Moje ostatnie slowo. 250. Ja równiez musze zyc. I zona i siedmioro dzieci....
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_Rune04_16_05"); //Jestes przestepca. Tutaj. runa.
...
FUNC VOID Info_Mod_Raritaetenhaendler_BrokenRune_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_BrokenRune_16_01"); //Co? Ponownie? Czego chcesz?
	AI_Output(hero, self, "Info_Mod_Raritaetenhaendler_BrokenRune_15_02"); //Jestem z Daniela. Sprzedal ci postac adanosowa.
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_BrokenRune_16_03"); //To moze byc prawda. Mila praca. Wykonany w calosci w akwamarynie.
	...
	AI_Output(self, hero, "Info_Mod_Raritaetenhaendler_BrokenRune_16_05"); //Oczywiscie. 500 zlota....
