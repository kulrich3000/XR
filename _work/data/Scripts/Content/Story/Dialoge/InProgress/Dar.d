...
{
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_00"); //Hey, what are you doing here?! Or will you bring me the merchandise from the bandits?
	AI_Output(hero, self, "Info_Mod_Dar_Miguel_15_01"); //Um, yeah, I should.
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_02"); //Come on, bring the potion.

	B_GiveInvItems	(hero, self, ItPo_MiguelForDar, 1);

	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_03"); //Well, then, I suppose...
	...
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_05"); //Buaahh, really cool stuff, dig in hard. With something like that, I want to be the libest dn gaaanzn Tlg...
