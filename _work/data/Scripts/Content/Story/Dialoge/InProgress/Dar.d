...
{
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_00"); //Hej, co tu robisz? A moze przynosisz mi towar od bandytów?
	AI_Output(hero, self, "Info_Mod_Dar_Miguel_15_01"); //Um, tak, powinienem.
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_02"); //Przynies eliksir, dodaj eliksir.

	B_GiveInvItems	(hero, self, ItPo_MiguelForDar, 1);

	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_03"); //Cóz, wiec przypuszczam, ze to....
	...
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_28_05"); //Buaahh, naprawde chlodne rzeczy, ciezko sie wykopuje. Z czyms takim chce byc najwolniejsza gaaanzn Tlg....
