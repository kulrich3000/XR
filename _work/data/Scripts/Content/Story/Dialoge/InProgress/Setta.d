...
{
	AI_Output(self, hero, "Info_Mod_Setta_Hi_19_00"); //Hey!

	B_Say (hero, self, "$WHOAREYOU");

	AI_Output(self, hero, "Info_Mod_Setta_Hi_19_01"); //My name is Setta. I've been living here for a few years, I live here.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_15_02"); //How did you get here?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_19_03"); //I don't remember exactly. Where are you from, where are you from?
...
FUNC VOID Info_Mod_Setta_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_01"); //As a matter of fact, I have. If I recall correctly, that's where I come from, too. Is the...? Barrier still there?
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_02"); //No, she's gone. And I wasn't completely uninvolved.
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_03"); //Wow, a real hero. In my humble cabin. What can I do for you, can I do?
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_04"); //How do I get out of here?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_05"); //I can't tell you, I can't, because I don't know myself. Otherwise I probably wouldn't be here.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_06"); //Don't you have any ideas?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_07"); //Hm, now that you're saying it. Why don't you ask the old Buff? He lives in a tent down the way, he lives.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_08"); //Thanks for the information.
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_09"); //You're welcome, hihi.
...
FUNC VOID Info_Mod_Setta_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_Hi_A_19_01"); //Oh, like a bird? I love birds, I love birds. But I can screw myself alone, I can. I'm not as shaky as I look.
