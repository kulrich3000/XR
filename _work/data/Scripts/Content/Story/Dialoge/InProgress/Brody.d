...
{
	AI_Output(self, hero, "Info_Mod_Brody_Hi_03_00"); //Hey, water. Water, please.
...
FUNC VOID Info_Mod_Brody_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_Hi_B_03_00"); //It's not working. I won't be doing it much longer anyway. (laughs dryly and breathes out his life)
...
FUNC VOID Info_Mod_Brody_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_Hi_A_03_01"); //Ahhhhh! Thanks, buddy.
...
FUNC VOID Info_Mod_Brody_WhoAreYou_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_01"); //I'm a desert pirate.

	AI_DrawWeapon	(hero);

	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_02"); //No, no, no, I'm not gonna hurt you. I'm too weak for that.

	AI_RemoveWeapon	(hero);

	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_03"); //I was a member of a whole group. Our camp was back there, across from the temple.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_04"); //Our favorite thing we did was to annoy the pirates.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_05"); //We stole food and stuff from them, destroyed boats, spat in front of Greg's hut and peed in her grog.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_06"); //One night, I was awakened by a scream.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_07"); //These swamp rats of pirates had discovered our camp and murdered us one by one!
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_08"); //I was the only one who escaped without equipment, without boozing. And I've been frying here ever since.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_09"); //I can't get out of the canyon. The mountains are too high and the exit I know of is constantly guarded.
...
FUNC VOID Info_Mod_Brody_AndererWeg_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_AndererWeg_03_01"); //Really? Where?
...
{
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_00"); //friend I don't know how to thank you.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_01"); //But you're lucky enough that I wasn't strong enough when you found me.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_02"); //Then the conversation would have taken a completely different turn, believe me.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_03"); //So long, and be happy when you don't hear from me anymore!
...
{
	AI_Output(self, hero, "Info_Mod_Brody_FalscherWeg_03_00"); //friend That's the pirate camp. You're going to turn me over to them.
	AI_Output(self, hero, "Info_Mod_Brody_FalscherWeg_03_01"); //Either you show me another way or you'll get in a lot of trouble.
...
{
	AI_Output(self, hero, "Info_Mod_Brody_PechGehabt_03_00"); //I warned you.
...
FUNC VOID Info_Mod_Brody_Heiltrank_Info()
{
	...
	{
		Info_AddChoice	(Info_Mod_Brody_Heiltrank, "Potion of Quick Healing", Info_Mod_Brody_Heiltrank_Health_05);
	};
};
