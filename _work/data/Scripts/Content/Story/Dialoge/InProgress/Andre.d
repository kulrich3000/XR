...
{
	AI_Output(self, hero, "Info_Mod_Andre_Argez_40_00"); //To juz wystarczy, mój przyjaciel. Przyjezdzacie ze mna do koszar, a my mamy o czym porozmawiac.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_00"); //Tam tam. Nowe w miescie i w klopotach.
	AI_Output(hero, self, "Info_Mod_Andre_Argez2_15_01"); //To nie moja wina.
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_02"); //Wiem. Garond jest czyms..... nadgorliwy w nowym zadaniu. Ale on sie do tego przyzwyczai.
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_03"); //Tylko - jesli masz jakies watpliwosci, jest to niewlasciwy adres. Zauwazylem, ze miales kogos zabrac do miasta. Czy to prawda?
	AI_Output(hero, self, "Info_Mod_Andre_Argez2_15_04"); //Tak.
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_05"); //Czy popelnil w miescie jakakolwiek zbrodnie, dlatego mógl zostac wygnany?
	AI_Output(hero, self, "Info_Mod_Andre_Argez2_15_06"); //Z tego, co wiem, nie mial zadnych szans.
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_07"); //A zatem wszystko w porzadku. Sugeruje poprowadzic przyjaciela przez druga brame miasta przy rynku. Upewnie sie, ze nie zatrzymacie sie panstwo.
	AI_Output(self, hero, "Info_Mod_Andre_Argez2_40_08"); //Ale nie pokazuj sie w Garond' s. Prawdopodobnie.... niecierpliwie reagowac.
...
FUNC VOID Info_Mod_Andre_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Hi_40_01"); //Jestem Panem Andrem, dowódca milicji i zastepca przywódcy paladynów.
	AI_Output(self, hero, "Info_Mod_Andre_Hi_40_02"); //Co moge dla Ciebie zrobic?
...
FUNC VOID Info_Mod_Andre_Alvares_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Alvares_40_01"); //Walczyl z jedna z naszych milicji. Ale bedzie siedzial przez kilka nastepnych dni.
};
...
FUNC VOID Info_Mod_Andre_AlvaresSchneller_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_01"); //Mozesz zaplacic jego grzywne.
	AI_Output(hero, self, "Info_Mod_Andre_AlvaresSchneller_15_02"); //Ile to kosztuje?
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_03"); //Po swoich wykroczeniach? Nie bedzie tani. Ubij 500 zlotych monet.
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_04"); //Poza tym do naszego miasta trzeba przywiezc jeszcze jednego zbrodnie.

	if (Mod_AlvaresAndre_Taeter == 1)
	{
		AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_07"); //Jesli dobrze pamietam, to juz to zrobiles.
	};

	AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_05"); //Albo pokonac bandytów, którzy maja swój obóz gdzies w poblizu gospodarstwa Akila w lesie i przyniesc mi swoja bron.
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresSchneller_40_06"); //Czesto rabuja podrózujacych dealerów.
...
FUNC VOID Info_Mod_Andre_AlvaresBanditen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresBanditen_40_01"); //Bardzo dobry. A ich bron?
	AI_Output(hero, self, "Info_Mod_Andre_AlvaresBanditen_15_02"); //Oto one.

	B_GiveInvItems	(hero, self, ItMw_Banditenschwert_Andre, 3);

	AI_Output(self, hero, "Info_Mod_Andre_AlvaresBanditen_40_03"); //Doskonaly. Dzieki temu otoczenie miasta jest znacznie bezpieczniejsze.
...
FUNC VOID Info_Mod_Andre_AlvaresGeld_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_AlvaresGeld_40_01"); //No cóz, mozesz go zabrac razem z toba.
...
FUNC VOID Info_Mod_Andre_Miliz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Miliz_40_01"); //Zapisujemy tylko to, co najlepsze. Dzis organizujemy turniej, a zwyciezca zostanie przyjety przez milicje.
	AI_Output(self, hero, "Info_Mod_Andre_Miliz_40_02"); //Masz szczescie, ze jest tam miejsce na jeszcze jedno.
...
FUNC VOID Info_Mod_Andre_Kristall_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kristall_40_01"); //Gdzie dostaniesz krysztal?
	AI_Output(hero, self, "Info_Mod_Andre_Kristall_15_02"); //Zdjalem zlodziej.
	AI_Output(self, hero, "Info_Mod_Andre_Kristall_40_03"); //Bardzo dobry. Jesli chcesz, mozesz teraz dolaczyc do milicji.
...
FUNC VOID Info_Mod_Andre_TurnierSinbad_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_TurnierSinbad_40_01"); //To prawda. Jeden fotel jest nadal dostepny, jesli chcesz wziac udzial.
...
FUNC VOID Info_Mod_Andre_Regeln_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Regeln_40_01"); //Czary i walki na odleglosc nie sa dozwolone w turnieju, poniewaz nie wolno Ci zabijac.
};
...
FUNC VOID Info_Mod_Andre_Turnier1_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Turnier1_40_01"); //Nazwisko: Do smierci. Powinien byc tu w kazdej chwili.
...
FUNC VOID Info_Mod_Andre_Turnier2_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier2_40_01"); //Bity go pan. Teraz jestes w kolejnej rundzie.
		AI_Output(self, hero, "Info_Mod_Andre_Turnier2_40_02"); //Nastepnym przeciwnikiem jest Alrik.
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier2_40_03"); //Straciles. Teraz jestes juz poza turniejem.
		...
		{
			AI_Output(self, hero, "Info_Mod_Andre_Turnier2_40_05"); //Jesli naprawde chcesz dolaczyc do milicji, idz na hipoteze. Znajdziesz go w baraku kuzni.
		...
		{
			AI_Output(self, hero, "Info_Mod_Andre_Turnier2_40_06"); //Straciles do chlopa. Nie mozemy uzyc kogos takiego jak Ty w milicji.
...
FUNC VOID Info_Mod_Andre_Turnier3_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier3_40_01"); //Gratuluje, bijecie go. Teraz pozostalo ci tylko jedna walka.
		AI_Output(self, hero, "Info_Mod_Andre_Turnier3_40_06"); //Nastepnym przeciwnikiem jest Gidan. Powodzenia!
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier3_40_02"); //Straciles. Teraz jestes juz poza turniejem.
		...
		{
			AI_Output(self, hero, "Info_Mod_Andre_Turnier3_40_04"); //Jesli naprawde chcesz dolaczyc do milicji, idz na hipoteze. Znajdziesz go w baraku kuzni.
		...
		{
			AI_Output(self, hero, "Info_Mod_Andre_Turnier3_40_05"); //Straciles i przegapiles szanse dolaczenia do milicji.
...
FUNC VOID Info_Mod_Andre_Turnier4_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_01"); //Gratuluje, bijecie go. Zarobiles sobie miejsce w milicji.
		...
		else
		{
			...
			AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_07"); //Jestes niesamowitym facetem. Szkoda, ze moglabym cie uzyc.

			if (Npc_KnowsInfo(hero, Info_Mod_Sinbad_Hi))
			{
				AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_08"); //Ale wezmiesz ten dokument.
	...
	{
		AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_02"); //Straciles. Teraz jestes juz poza turniejem.
		...
		if (Assassinen_Dabei == 0)
		{
			...
			{
				AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_04"); //Jesli naprawde chcesz dolaczyc do milicji, idz na hipoteze. Znajdziesz go w baraku kuzni.
			...
			{
				AI_Output(self, hero, "Info_Mod_Andre_Turnier4_40_05"); //Straciles i przegapiles szanse dolaczenia do milicji.
...
FUNC VOID Info_Mod_Andre_Aufnahme_Info()
{
	...
	&& (Diebe_Dabei == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_01"); //Jestescie gotowi dolaczyc do milicji.
		AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_02"); //Ale gdy tylko nosisz zbroje naszych zolnierzy, nie ma juz odwrotu.
		
		if (Mod_HatPlayerNeutraleKlamotten())
		{
			if (Mod_Gottstatus <= 8)
			{
				AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_05"); //Nalezy jednak najpierw zrobic kilka rzeczy na korzysc Innosa.
			}
			else
			{
		...
		{
			AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_04"); //Najpierw powinienes zdobyc neutralna zbroje.
		};
	}
	else if (Diebe_Dabei == TRUE)
	{
		AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_06"); //Slysze, ze masz sie zatrzymac z zlobieniem w doku. Nie mozemy miec takiej osoby w milicji.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_40_03"); //Lepiej zdobyc wiecej doswiadczenia.
	};
};
...
FUNC VOID Info_Mod_Andre_Aufnahme_Nein()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_Nein_40_01"); //Cokolwiek mówisz.
...
FUNC VOID Info_Mod_Andre_Aufnahme_Ja()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_Ja_40_01"); //Dobre. Oto Twoja zbroja.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_Ja_40_02"); //Obserwuj tam, gdzie dajesz sie widziec, najemnicy i wyznawcy Beliaranu nie zawahaja sie cie zabic.
	AI_Output(hero, self, "Info_Mod_Andre_Aufnahme_Ja_15_03"); //A co z pistoletem?
	AI_Output(self, hero, "Info_Mod_Andre_Aufnahme_Ja_40_04"); //Milicja ma z nami miecze. Idz na targowisko, sprzedadza troche.
...
FUNC VOID Info_Mod_Andre_Sinbad01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad01_40_01"); //Oczywiscie tak jest. Zwyciezyles w konkursie.
	AI_Output(hero, self, "Info_Mod_Andre_Sinbad01_15_02"); //Dokladnie. Teraz chcialbym miec cos w rodzaju czynu.
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad01_40_03"); //Nie dalem ci ich.
	AI_Output(hero, self, "Info_Mod_Andre_Sinbad01_15_04"); //Nie.
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad01_40_05"); //Oczywiscie masz do tego prawo. Tutaj jestes.
...
FUNC VOID Info_Mod_Andre_Sinbad02_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad02_40_01"); //Zgubiles juz sie. Gidan jest zwyciezca turnieju. On jednak ucieka.
	AI_Output(hero, self, "Info_Mod_Andre_Sinbad02_15_02"); //Co to oznacza?
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad02_40_03"); //Mówi sie, ze byl pijany, a nastepnie chwycil za cien biegacza w dolinie przy wschodniej bramie. Zreszta nie pojawil sie.
	AI_Output(hero, self, "Info_Mod_Andre_Sinbad02_15_04"); //Wtedy miejsce jest ponownie wolne?
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad02_40_05"); //Zasadniczo tak. W prawo, idziesz na dól i widzisz, co sie dzieje.
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad02_40_06"); //Jesli Gidan jest martwy, masz Bieguna Cienia jako przeciwnika. Jesli go pokonasz, mozesz zachowac trofeum.
...
FUNC VOID Info_Mod_Andre_Sinbad03_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Sinbad03_40_01"); //Czysta praca. Mozesz ja zachowac. A jesli chcesz do nas dolaczyc.....
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_00"); //Dobrze, ze jestes tutaj, jest wiele do zrobienia!
	AI_Output(hero, self, "Info_Mod_Andre_Auftrag_15_01"); //Ach, tak? Co masz na mysli?
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_02"); //Po pierwsze, z górnego miasta zniknal naukowiec, prawdopodobnie porwany.
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_03"); //Z drugiej strony, stare fanatyczne kultowe blystki zdaja sie cos planowac. Co gorsza, ostatni karawana w drodze do klasztoru zostala zaatakowana przez dziwne golemy.
	AI_Output(hero, self, "Info_Mod_Andre_Auftrag_15_04"); //Oby, dosc duzo na raz.
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_05"); //Tak, dlatego nie pracujesz sam.
	AI_Output(hero, self, "Info_Mod_Andre_Auftrag_15_06"); //Was meinst du mit "nie sam"?
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_07"); //Gidan bedzie nadzorowal przyczepy kempingowe.
	AI_Output(hero, self, "Info_Mod_Andre_Auftrag_15_08"); //Wszystko w porzadku.... Wtedy zatroszcze sie o sekte i wynalazce.
	AI_Output(self, hero, "Info_Mod_Andre_Auftrag_40_09"); //No cóz, daj mi znac, czy cos znajdziesz.
...
FUNC VOID Info_Mod_Andre_WoErfinder_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_WoErfinder_40_01"); //Rozejrzyj sie po jego domu. Przejdz do górnej czesci dzielnicy i przez szose w kierunku kupca Salandril.
	AI_Output(self, hero, "Info_Mod_Andre_WoErfinder_40_02"); //Tam po lewej stronie dom nalezy do wynalazcy.
...
FUNC VOID Info_Mod_Andre_WoFanatiker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_WoFanatiker_40_01"); //Dlaczego nie idziesz do obozu bagiennego w Minental? Albo u twojego przyjaciela, o którym Gidan mi opowiedzial, ze Lester.
...
FUNC VOID Info_Mod_Andre_Erfahrung_Erfinder_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_Erfinder_40_01"); //Wszystkie sluszne, zglosic.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_Erfinder_40_05"); //To sa wazne informacje.
...
FUNC VOID Info_Mod_Andre_Erfahrung_Fanatiker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_Fanatiker_40_01"); //Wszystkie sluszne, zglosic.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_Fanatiker_40_05"); //Hm, musimy byc ostrozni....
...
FUNC VOID Info_Mod_Andre_Erfahrung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_40_01"); //No cóz, to nie brzmi dobrze. Gidan jeszcze nie wrócil, co oznacza, ze musimy czekac az wróci do domu, zanim dowiemy sie wiecej.
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_40_02"); //Pójdziesz do Minental tak dlugo, jak chcesz. Tam mielismy kopalnie w okolicy orksu kolo wiezy. Ale ostatnio zostala zaatakowana. Musisz ja uwolnic!
	AI_Output(hero, self, "Info_Mod_Andre_Erfahrung_15_03"); //Kto ukradl kopalnie?
	AI_Output(self, hero, "Info_Mod_Andre_Erfahrung_40_04"); //Wedlug naszych raportów, przez bandytów. Prawdopodobnie chcac zarobic fortune, magiczna ruda jest dzis dosc zmudna i kosztowna.
...
FUNC VOID Info_Mod_Andre_Banditen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Banditen_40_01"); //Damn to! Musza miec palce we wszystkim.
...
FUNC VOID Info_Mod_Andre_GidanBack_Info()
{
	...
	if (Kapitel < 3)
	{
		AI_Output(self, hero, "Info_Mod_Andre_GidanBack_40_01"); //Nie, jeszcze nie. Wróc do domu pózniej.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Andre_GidanBack_40_02"); //Tak, ale on odszedl znowu!
		...
		AI_Output(self, hero, "Info_Mod_Andre_GidanBack_40_06"); //Tak. Konfigurujemy ja tak, aby monitorowac karawany z klasztoru do miasta. Tuz przed wejsciem do nas dotarl poslannik, który powiedzial, ze zostalismy zaatakowani.
		AI_Output(hero, self, "Info_Mod_Andre_GidanBack_15_07"); //Gdzie znajduje sie ten magazyn?
		AI_Output(self, hero, "Info_Mod_Andre_GidanBack_40_08"); //Pod mostem w drodze do tawerny.
...
FUNC VOID Info_Mod_Andre_FIFinished_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_FIFinished_40_01"); //Co dostales? Mialo to byc odwrotnie.
	...
	AI_Output(self, hero, "Info_Mod_Andre_FIFinished_40_06"); //Tak bylo.... Cóz, w kazdym razie zarobiles sobie nagrode.
	AI_Output(self, hero, "Info_Mod_Andre_FIFinished_40_07"); //Niniejszym oswiadczam, ze jestes rycerzem. Oto Twoja zbroja.
	...
	AI_Output(self, hero, "Info_Mod_Andre_FIFinished_40_08"); //W tej chwili wszystko jest spokojne, jesli jest jeszcze cos do zrobienia, dowiesz sie tutaj.
...
FUNC VOID Info_Mod_Andre_RLMord_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_RLMord_40_02"); //Dobrze, ze to Ty! Pekniecie piekla w doku. Zginela milicja Jason!
...
FUNC VOID Info_Mod_Andre_RLMord_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_RLMord_C_40_01"); //Na czerwonej latarni.
	AI_Output(hero, self, "Info_Mod_Andre_RLMord_C_15_02"); //Byl w domu publicznym? Biznes?
	AI_Output(self, hero, "Info_Mod_Andre_RLMord_C_40_03"); //Nie sadze. Byl nagi.....
...
FUNC VOID Info_Mod_Andre_RLMord_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_RLMord_B_40_01"); //Gdybysmy wiedzieli, ze wisi ten syn suki!
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Giselle_40_00"); //Dobra praca, zolnierz. Masz go nie tylko w miesniach, ale takze w glowie! Jason zostanie pochowany na cmentarzu, oddamy mu szacunek.
	AI_Output(self, hero, "Info_Mod_Andre_Giselle_40_01"); //Oto Twoja wyplata. Mam nadzieje, ze teraz zmierzamy ku ciszy.....

	B_GiveInvItems	(self, hero, ItMi_Gold, 2000);

	AI_Output(hero, self, "Info_Mod_Andre_Giselle_15_02"); //Was ist mit der "Ciemna cyfra"?
	AI_Output(self, hero, "Info_Mod_Andre_Giselle_40_03"); //Szukamy dla niej tajnosci. Ostatnia rzecza, której potrzebujemy, jest masowa panika.
	AI_Output(hero, self, "Info_Mod_Andre_Giselle_15_04"); //Czy cos jeszcze znalazles?
	AI_Output(self, hero, "Info_Mod_Andre_Giselle_40_05"); //Nie, jeszcze nie.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Bernd_40_00"); //Ciesze sie, ze wlasnie przyszliscie. Wlasnie otrzymalem raport o przemocy domowej.
	AI_Output(self, hero, "Info_Mod_Andre_Bernd_40_01"); //Bernd, pijak z dzielnicy portowej, po raz kolejny wypil pijanego o pragnieniu i zostawia swój grobat zaraz na zonie, prosze idz tam i "spokojny" go.
...
FUNC VOID Info_Mod_Andre_Jana_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Jana_40_01"); //Lubie to? To bylo szybkie.
	AI_Output(hero, self, "Info_Mod_Andre_Jana_15_02"); //Tak, a takze trwale. On nie zyje.
	AI_Output(self, hero, "Info_Mod_Andre_Jana_40_03"); //Damn to, nie mozna zabic kazdego pijaka, który uciekl tylko dlatego, ze chcesz uratowac sie od papierkowej roboty!
	AI_Output(hero, self, "Info_Mod_Andre_Jana_15_04"); //Ich war‘s nicht, sondern ein "ciemny facet w milicji pancernej".
	AI_Output(self, hero, "Info_Mod_Andre_Jana_40_05"); //Nie masz na mysli?
	AI_Output(hero, self, "Info_Mod_Andre_Jana_15_06"); //Tak, tak. Mamy do czynienia z seryjnym zabójca w pancerzu Jasona.
	AI_Output(self, hero, "Info_Mod_Andre_Jana_40_07"); //Wtedy chyba bedziemy musieli pójsc na jaw....
	AI_Output(self, hero, "Info_Mod_Andre_Jana_40_08"); //Przygotuje tu wszystko, prosze w miedzyczasie udac sie na targowisko, jest dziwak, chyba stary guru z obozu kultowego, który ostrzega ludzi przed koncem swiata i jest dosc dyskretny. Wyprowadzic go z miasta.
...
FUNC VOID Info_Mod_Andre_HeroBot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_01"); //Wiesz? Kto?
	AI_Output(hero, self, "Info_Mod_Andre_HeroBot_15_02"); //Robot bojowy Kolam.
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_03"); //Co? Co sprawia, ze myslisz o tym?
	AI_Output(hero, self, "Info_Mod_Andre_HeroBot_15_04"); //Widzialam go. Na targowisko wybil szalonego faceta.
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_05"); //Przypuszczam, ze nie musze sie martwic o to, jak to jeszcze moze dzialac, ani dlaczego jest on jak dotad tylko kluc przestepcami, poniewaz to zrobiles...... Oto prawda?
	...
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_07"); //Dlaczego wiec stoisz tutaj?
	...
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_09"); //"Zagrozenie, które nalezy uznac za przestepstwo kryminalne" ... das kommt mir merkwürdig bekannt vor. Hat der Roboter sonst noch was gesagt?
	...
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_11"); //Wszystko wydaje sie tak znajome. Skad to wiem? Czy robot powiedzial cos wiecej?
	AI_Output(hero, self, "Info_Mod_Andre_HeroBot_15_12"); //Nie wiem o tym.
	AI_Output(self, hero, "Info_Mod_Andre_HeroBot_40_13"); //To nowe zadanie dla Ciebie. Dowiedz sie, co jeszcze. Próbuje powstrzymac masowa panike! I spieszyc sie, czy pan?
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_00"); //Najwyzszy czas, zebys przyszedl, cos wycieklo, pieklo peka tu luzno.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_01"); //Nakladalismy godzine powszednia, ale to nie robi na nas wrazenia.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_02"); //Musimy natychmiast rozwiazac ten problem! Mam nadzieje, ze wiecie jak.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_04"); //(setzt in den Satz des Helden ein) "... ich modelowy efekt nie pozwala na praktykowanie nieuczciwych praktyk". Natürlich! Das sind alles Grundregeln der Milizenschule.
	AI_Output(hero, self, "Info_Mod_Andre_Kerze_15_05"); //Szkola milicyjna?
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_06"); //Brakowalo Ci go, bo wygrales turniej, pamietaj? Kolam musial zaprogramowac robota nieprawidlowo.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_07"); //Nie tylko nagral twój styl walki, ale pewnie przyjales na nim jakas maksyme milicji. A teraz rozbija zbrodnie i niesprawiedliwosc.
	AI_Output(hero, self, "Info_Mod_Andre_Kerze_15_08"); //Dlaczego wiec mielibysmy cos z tym zrobic?
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_09"); //Zobacz, co robi! Robot porusza sie po trupach.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_10"); //A jesli nie wymyslimy sposobu na szybkie doprowadzenie tego do skutku, kazdy zrobi to, poniewaz ulice beda wybrukowane bezzyciowymi cialami przestepców!
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_11"); //Musimy go zniszczyc, wspólnie wezwac wszystkie milicje, bedziemy go atakowac otwarcie.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_15"); //Wtedy bedziemy musieli go po prostu zlapac w pulapke. Najpierw znajdujemy sie, a nastepnie niszczymy.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_16"); //Poczekaj chwile.... Mam tu gdzies jakies stare profile, które nam sie przydadza.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_17"); //Oni pochodza z dawnej sprawy. Zadany zawsze pojawial sie w kolorowym kostiumie z kolnierzem szachowym. Wykorzystajmy to teraz.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_18"); //Doloze wszelkich staran, aby kazdy straznik dostal jeden. Chce, zebyscie je pokazywali.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_19"); //W miedzyczasie powiesz heraldowi na targowisku, aby ostrzec ludzi przed niebezpiecznymi szalenczymi spacerami po kolorowych kostiumach z kolnierzykami szachownicowymi, a wczoraj wieczorem klujac ich w czterech zolnierzach milicji podczas snu.
	AI_Output(hero, self, "Info_Mod_Andre_Kerze_15_20"); //Ale to tylko poglebi panike.
	AI_Output(self, hero, "Info_Mod_Andre_Kerze_40_21"); //Prosze pozwolic mi sie tym martwic. Chodz, spiesz sie.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_00"); //Bardzo dobry. Podjalem wszystkie przygotowania. Wez to tutaj.

	B_GiveInvItems	(self, hero, ItPo_Speed_Andre, 1);

	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_01"); //I to wlasnie musisz nosic.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_03"); //Mamy tylko jedna szanse polowac na ten robot, musimy go stopic.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_04"); //W tym celu musimy go wabic do wielkiego pieca w Khoracie, jedynego miejsca, które jest na tyle gorace, ze moze stopic magiczna rude i z którego nie moze sie teleportowac.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_05"); //Sciany sa równiez wykonane z magicznej rudy, nie ma magii. Bedziesz wabikiem.
	AI_Output(hero, self, "Info_Mod_Andre_Herold_15_06"); //Chcesz, abym poszedl do wielkiego pieca? Mialem raczej plan, zeby nie palic.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_07"); //Prosze pozwolic mi sie tym martwic. Teraz naniesc kostium i napic sie eliksiru.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_08"); //Nastepnie biegna Panstwo do Khoraty i bezposrednio do wielkiego pieca. W miedzyczasie bede tam teleportowal i przygotowywal wszystko.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_09"); //Piec zostanie wylaczony po wejsciu, a ja przygotuje dla Ciebie wyjscie.
	AI_Output(self, hero, "Info_Mod_Andre_Herold_40_10"); //Idz dalej, biegnij po miescie z kostiumem, az robot cie zlapie, przyjedzie po tobie. Do zobaczenia w Khorata.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_00"); //Co cie do mnie sprowadza?
	AI_Output(hero, self, "Info_Mod_Andre_Ramirez_15_01"); //Zlapalem zlodziej próbujacy ukrasc niewinnego mieszkanca tego miasta.
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_02"); //Dziekuje Innosowi, jest jeszcze sprawiedliwosc. Odczekaj minute, to Ramirez, lider gangu zlodziei.
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_03"); //Jak móglbys go zlapac?
	AI_Output(hero, self, "Info_Mod_Andre_Ramirez_15_04"); //Kiedy on wlasnie sie przewrócil, moglem go z tylu obezwladnic.
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_05"); //Widze ogien Innosa w twoim sercu, przekonales mnie.
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_06"); //Moglibysmy uzyc takiego faceta jak ty. To juz drugie zdarzenie. Druga osoba nazywa sie Attila i jest morderca.
	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_07"); //Jesli bedziemy nadal tak postepowac, obywatele wkrótce beda mogli spac spokojnie.

	if (Mod_Gilde < 1)
	|| (Mod_Gilde > 3)
	{
		AI_Output(hero, self, "Info_Mod_Andre_Ramirez_15_08"); //Czy jestem teraz czlonkiem milicji?
		AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_09"); //Mozesz zrobic wyjatek, ale nie chwalic sie tym, bo oboje bedziemy miec problemy.
		AI_Output(hero, self, "Info_Mod_Andre_Ramirez_15_10"); //Widze.
		AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_11"); //Dobrze, oto twoja zbroja.

		CreateInvItems	(self, ItAr_Mil_L, 1);
		B_GiveInvItems	(self, hero, ItAr_Mil_L, 1);
	};

	AI_Output(self, hero, "Info_Mod_Andre_Ramirez_40_12"); //Oto Twoja laska dla Ramirez.
...
FUNC VOID Info_Mod_Andre_Keller_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Keller_40_01"); //Jestes na czasie. Jeden z dealerów opowiedzial mi o dziwnych rzeczach w moim spiworze.
	AI_Output(self, hero, "Info_Mod_Andre_Keller_40_02"); //W nocy z piwnicy wychodzi kilka dziwnych stworzen.
	AI_Output(self, hero, "Info_Mod_Andre_Keller_40_03"); //Udac sie na dno.
...
FUNC VOID Info_Mod_Andre_Hanna_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Hanna_40_01"); //A co znalazles?
	AI_Output(hero, self, "Info_Mod_Andre_Hanna_15_02"); //W ciemnej dziurze byly tylko szczury, nic wiecej.
	AI_Output(self, hero, "Info_Mod_Andre_Hanna_40_03"); //Prawdopodobnie wlasnie tam kupiec marzyl.
	AI_Output(hero, self, "Info_Mod_Andre_Hanna_15_04"); //Z pewnoscia to zrobil.
	AI_Output(self, hero, "Info_Mod_Andre_Hanna_40_05"); //Wszystko w porzadku, oto twoje wynagrodzenie.

	B_GiveInvItems	(self, hero, ItMi_Gold, 200);

	AI_Output(self, hero, "Info_Mod_Andre_Hanna_40_06"); //Pózniej wróc do domu, na razie wszystko jest cicho.
...
FUNC VOID Info_Mod_Andre_NewsMilizDead_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_NewsMilizDead_40_01"); //Poniewaz nie moglo byc inaczej, tesknimy za dwiema milicjami, które nie byly tu od jakiegos czasu.
	AI_Output(hero, self, "Info_Mod_Andre_NewsMilizDead_15_02"); //Co o tym chodzi?
	AI_Output(self, hero, "Info_Mod_Andre_NewsMilizDead_40_03"); //Mortis, nasz kowal, powiedzial nam, ze prawdopodobnie Meldor próbuje zamknac jakis biznes chwastów.
	AI_Output(hero, self, "Info_Mod_Andre_NewsMilizDead_15_04"); //Czy nie moge sie tym zajac?
	AI_Output(self, hero, "Info_Mod_Andre_NewsMilizDead_40_05"); //Wyglada na to, ze jestes tutaj jedynym. W porzadku, oczy pozostana otwarte dla pozostalych dwóch.
...
FUNC VOID Info_Mod_Andre_Meldor_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Meldor_40_01"); //Jak ostatni raz. Mortis równiez staje sie coraz bardziej nierzetelny.
	AI_Output(self, hero, "Info_Mod_Andre_Meldor_40_02"); //Jaka jest twoja zaplata za pieklo?

	CreateInvItems	(self, ItMi_Gold, 200);
	B_GiveInvItems	(self, hero, ItMi_Gold, 200);

	AI_Output(hero, self, "Info_Mod_Andre_Meldor_15_03"); //Czy moge znalezc cichsze miejsce, moze strzezyc wiezniów?
	AI_Output(self, hero, "Info_Mod_Andre_Meldor_40_04"); //Dlaczego nie, wykonales wiele pracy.
	AI_Output(self, hero, "Info_Mod_Andre_Meldor_40_05"); //Mówie straznikowi, jutro bedziesz mógl pilnowac wiezniów.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_RamirezAttilaFlucht_40_00"); //Gdzie byles/as? Gdzie sa zlodzieje? Gdzie jest cale zloto z mojej klatki piersiowej?
	AI_Output(hero, self, "Info_Mod_Andre_RamirezAttilaFlucht_15_01"); //l--
	AI_Output(self, hero, "Info_Mod_Andre_RamirezAttilaFlucht_40_02"); //Jestes tak niewiarygodny jak pozostale dwie osoby, które jeszcze nie przyszly. Czekam na dobre wyjasnienie.
	...
	AI_Output(self, hero, "Info_Mod_Andre_RamirezAttilaFlucht_40_05"); //Jak to wszystko moglo sie zdarzyc?
	...
	AI_Output(self, hero, "Info_Mod_Andre_RamirezAttilaFlucht_40_07"); //Z hipoteka? Pomógl im pomóc?
	AI_Output(hero, self, "Info_Mod_Andre_RamirezAttilaFlucht_15_08"); //Moze warto przyjrzec sie blizej jego kuzni.
	AI_Output(self, hero, "Info_Mod_Andre_RamirezAttilaFlucht_40_09"); //I jestem gonna porzadku to teraz. Wróc jutro.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_MortisBadGuy_40_00"); //Masz racje, Mortis mial bagazowa torebke na kapuste ukryta w klatce piersiowej. Prawdopodobnie postawil nas wszystkich na niewlasciwym torze.
	AI_Output(self, hero, "Info_Mod_Andre_MortisBadGuy_40_01"); //Bedziemy najwiekszym posmiewiskiem w miescie. Dwóch zbrodniarzy ucieklo przed nami, jeden z naszych wlasnych ludzi nas zdradzil, a cale zloto milicji zniknelo.
	AI_Output(hero, self, "Info_Mod_Andre_MortisBadGuy_15_02"); //Nie ma nic, co mozesz z tym zrobic.
	AI_Output(self, hero, "Info_Mod_Andre_MortisBadGuy_40_03"); //Co zamierzasz teraz zrobic? Nigdy nie zabiore Cie z powrotem do wiezienia jako straznika.
	...
	|| (Mod_Gilde > 3)
	{
		...
		AI_Output(self, hero, "Info_Mod_Andre_MortisBadGuy_40_05"); //Czy jestes o tym naprawde pewien?
		AI_Output(hero, self, "Info_Mod_Andre_MortisBadGuy_15_06"); //Zrobilem juz swój umysl.
		AI_Output(self, hero, "Info_Mod_Andre_MortisBadGuy_40_07"); //Cóz, nigdy nie zapomnij, ze jestes mile widziany, jesli chcesz zaczac.
...
FUNC VOID Info_Mod_Andre_Rangar_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Rangar_40_01"); //Co do kogo?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Rangar_40_05"); //Natychmiast to sprawdze. Dziekuje za powiadomienie mnie.
	AI_Output(self, hero, "Info_Mod_Andre_Rangar_40_06"); //Oto mala nagroda.
...
FUNC VOID Info_Mod_Andre_Ole_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Ole_40_01"); //Wszystko w porzadku, zobaczmy.

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Andre_Ole_40_02"); //Tell Ole, dopóki nie moze mi zagwarantowac rudy, nie dostaje zadnych paladynów jako dodatkowych mezczyzn.
	AI_Output(self, hero, "Info_Mod_Andre_Ole_40_03"); //Powinien przyniesc mi co najmniej piecdziesiat kawalków rudy, jako dowód na to, ze znowu wydobywa rude, wtedy mozemy mówic o dodatkowych ludziach.
	AI_Output(self, hero, "Info_Mod_Andre_Ole_40_04"); //Idz i powiedz mu to.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Knast_40_00"); //Zostales zgloszony jako zbrodni przez szanowanego obywatela. Co masz do powiedzenia na temat tego oskarzenia?
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Knast_Ok_40_00"); //Sprawdze to. Dziekuje za odpowiedzi.
...
FUNC VOID Info_Mod_Andre_Knast_C ()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Knast_C_40_01"); //Nietrudno jest uzyskac potwierdzenie, ze jestes z kolonii karnej, a czlonkowie Starego Obozu nadal sa jedynie powaznymi biznesmenami, wiec jestes weryfikowalnym czlonkiem organizacji przestepczej.
...
FUNC VOID Info_Mod_Andre_Knast_B ()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Knast_B_40_01"); //Czy posiadasz jakies dowody na to, czy tez zarzuty te sa przenoszone droga powietrzna?
...
FUNC VOID Info_Mod_Andre_Knast_A ()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Knast_A_40_01"); //Czy posiadasz jakies dowody na to, czy tez zarzuty te sa przenoszone droga powietrzna?
...
FUNC VOID Info_Mod_Andre_Knast_AB_C ()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Knast_AB_C_40_01"); //Czy moze pan to udowodnic?
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Knast2_40_00"); //Sprawdzilismy wasze wypowiedzi i wydaja sie one poprawne. Przepraszam za spowodowane przez nas niedogodnosci.
	AI_Output(self, hero, "Info_Mod_Andre_Knast2_40_01"); //Pan Hagen przyjmie cie i chcialbym zauwazyc, ze obywatel Bodo opuscil miasto.
...
FUNC VOID Info_Mod_Andre_Steinmonster_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster_40_01"); //Ach, bardzo milo. Mysle, ze warto zainwestowac w kopalnie.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster_40_02"); //Niedawno przybyl Paladin Trent z Wysp Poludniowych. Mysle, ze ma racje do pracy.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster_40_03"); //Niestety, nie skontaktowal sie jeszcze ze mna. Powinienes go najpierw szukac na nabrzezu.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster_40_04"); //Przynies go do mnie po tym, ja to z nim zalatwie.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster2_40_00"); //No cóz, czy go znalazles?
	AI_Output(hero, self, "Info_Mod_Andre_Steinmonster2_15_01"); //Znalazlem go, ale on juz wyjechal do Minentala.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster2_40_02"); //Jak? Nie rozumiem, mial sie najpierw skontaktowac ze mna.
	AI_Output(hero, self, "Info_Mod_Andre_Steinmonster2_15_03"); //Najwyrazniej chcial raczej dzialac niz mówic.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster2_40_04"); //Co przychodzi mu do glowy, aby nie wypelniac rozkazu przelozonego? Powiedz mu natychmiast skontaktowac sie ze mna, w przeciwnym razie jestem zmuszony go zdemotowac.
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster2_40_05"); //Wiem, ze otrzymal on wiele nagród w Myrtanie, ale nie moze sie zachowywac wobec mnie.
	AI_Output(hero, self, "Info_Mod_Andre_Steinmonster2_15_06"); //Nie sadzisz, ze troche za bardzo reagujesz?
	AI_Output(self, hero, "Info_Mod_Andre_Steinmonster2_40_07"); //W ogóle nie. Musi przestrzegac moich zasad. Teraz udaj sie do niego i dostarcz go.
};
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_00"); //Co myslales o przeksztalceniu jednej z paladynów w wrak psychiczny?
	AI_Output(hero, self, "Info_Mod_Andre_Trent_15_01"); //Zostal przeklety czarna ruda, jak ktos mógl wiedziec?
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_02"); //Poprzez wstepne spotkanie ze mna!
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_03"); //Ale cóz, dostales moja kopalnie do pracy i nie zostales przydzielony do mnie na te misje, ale do Hymira.
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_04"); //Paladyn Trent musi jednak poniesc konsekwencje.
	AI_Output(hero, self, "Info_Mod_Andre_Trent_15_05"); //Jakie sa konsekwencje?
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_06"); //No cóz, ja mam nad nim pelne polecenie i dlatego prowadzi teraz w Minentalu szpiegostwo, aby dowiedziec sie, co to jest nastepny ruch Orków.
	AI_Output(hero, self, "Info_Mod_Andre_Trent_15_07"); //A gdzie dokladnie maja szpiegowac?
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_08"); //W poblizu starego fortu, nad duzym jeziorem, nad którym znajduje sie stara wieza demoniczna. Orkiestry zdaja sie budowac tam swego rodzaju miejsce rytualu.
	AI_Output(self, hero, "Info_Mod_Andre_Trent_40_09"); //Jesli chcesz, mozesz je poprzec. Równiez dzieki temu mozna odzyskac moje zaufanie.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_00"); //Minelo juz kilka dni, wiec co nowego z orków?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_02"); //Brzmi to dobrze, gdy zadanie zostalo wykonane. Gdzie sa inni?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_04"); //A co z Paladyniem?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_06"); //Cóz, mimo wszystko, to dobra wiadomosc, ze orki nie zyja.
	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_07"); //Tutaj 500 zlotych monet mialo zrekompensowac Ci straty.

	B_GiveInvItems	(self, hero, ItMi_Gold, 500);

	AI_Output(self, hero, "Info_Mod_Andre_Trent2_40_08"); //Wkrótce przejmiemy opuszczona kopalnie wraz z naszymi narodami, ale oczywiscie nadal otrzymasz swój udzial.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_00"); //Musimy powaznie porozmawiac o waszej roli w zniknieciu Mario.
	AI_Output(hero, self, "Info_Mod_Andre_Mario_15_01"); //Co chcesz, abym o tym wiedzial?
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_02"); //Byles jednym z jego najblizszych powierników. Czy powiedzial ci cos przed ucieczka?
	AI_Output(hero, self, "Info_Mod_Andre_Mario_15_03"); //Nie, nie pamietam.
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_04"); //Uwolnil przestepce od wiezienia, a nastepnie uciekl niezauwazony.
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_05"); //Zaden straznik milicji w calym miescie nie pamieta jego obecnosci.
	AI_Output(hero, self, "Info_Mod_Andre_Mario_15_06"); //Moze wiec poszedl tajemnicza sciezka? Lódz na morzu?
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_07"); //Nie wiem, panie posle. Ale teraz wzmocnie swoja kontrole nad ta droga.
	AI_Output(hero, self, "Info_Mod_Andre_Mario_15_08"); //Czy to zatem jest?
	AI_Output(self, hero, "Info_Mod_Andre_Mario_40_09"); //Tak, wyjdz stad.
};
...
FUNC VOID Info_Mod_Andre_TomKraut_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut_40_01"); //Kup ten przestepca? W tym przypadku nie jest tak latwo sobie poradzic.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut_40_02"); //Byly juz pewne dowody na to, ze jest zaangazowany w chwasty w obrebie naszych murów miejskich..... ale nie wystarczy, aby go aresztowac.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut_40_03"); //Rosliny chwastów, które chcial przemycac tutaj, sa wreszcie namacalnym dowodem jego zaangazowania w dzialalnosc przestepcza.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut_40_04"); //Swoja kare odbierze tutaj, dopóki nie stanie sie czarny. I teraz juz wiecej mnie nie martwcie.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut2_40_00"); //Hej, co ty tu robisz?
	AI_Output(hero, self, "Info_Mod_Andre_TomKraut2_15_01"); //Watpie w wine Tomka.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut2_40_02"); //Naprawde sadze, ze na razie musze pana wyrzucic z tych przeslanek.
	...
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut2_40_05"); //(wrestling over) The.... to jest wysokosc.
	AI_Output(hero, self, "Info_Mod_Andre_TomKraut2_15_06"); //Jestem powazny..... Moze zielarz móglby ci powiedziec.....
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut2_40_07"); //(dostarczajace zlosc) Wszystkie sluszne. Dostane kogos.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut2_40_08"); //Chce jednak panstwu powiedziec, ze pojawia sie reperkusje. Teraz wyjdz z tego miejsca!
...
FUNC VOID Info_Mod_Andre_TomKraut5()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut5_40_01"); //Tak, tak, tak, wkrótce. Pozostalo tylko kilka formalnosci...... i uporzadkowac cos z bramistrzami.....
...
{
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut3_40_00"); //(laying) Uh........ wydaje sie, ze doszlo tu do niefortunnego nieporozumienia.
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut3_40_01"); //Rzekomy chwast marshowy..... byl to wlasciwie zwykly chwast.
...
{
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut4_40_00"); //Sam w sobie Hmm, dziwny, ten z brama.... Powinienem zobaczyc, czy w klatce piersiowej jest jakies ziolo.
	...
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut4_40_01"); //(sama w sobie) Ale cos takiego tez...... brak ziól.
	AI_Output(hero, self, "Info_Mod_Andre_TomKraut4_15_02"); //Wiec niewinny Toma?
	AI_Output(self, hero, "Info_Mod_Andre_TomKraut4_40_03"); //(z zaskoczeniem) Um..... tak wydaje sie, ze doszlo do pewnych nieporozumien.
...
FUNC VOID Info_Mod_Andre_HaradLehrling_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling_40_01"); //Potem mówcie!
	...
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling_40_03"); //Gdyby tylko tak bylo!
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling_40_04"); //Nie mozemy sobie pozwolic na to, aby nasz jedyny kowal w miescie zaopatrywal naszych konkurentów. To nie jest ladne, ale nie mozna tego zmienic.
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling_40_05"); //A poniewaz on nie wykazuje zrozumienia, musimy mu przynajmniej zapobiec dalszemu szkodzeniu nam.
};
...
FUNC VOID Info_Mod_Andre_HaradLehrling2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling2_40_01"); //Jesli obiecal, trzeba by sie nad tym zastanowic.
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling2_40_02"); //W koncu pilnie potrzebujemy nowych dostaw broni.
	AI_Output(hero, self, "Info_Mod_Andre_HaradLehrling2_15_03"); //Zobacze, co moge zrobic.
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling2_40_04"); //Zycze powodzenia.
...
FUNC VOID Info_Mod_Andre_HaradLehrling3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling3_40_02"); //To dobra wiadomosc. Tak, tak naprawde wlasnie teraz mamy ogromne potrzeby.
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling3_40_03"); //Miecze milicjantów i paladynów mozna bylo prawie wszystkie wymieniac na nowsze.
...
FUNC VOID Info_Mod_Andre_HaradLehrling4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_HaradLehrling4_40_01"); //Czysta praca. Twoje umiejetnosci robia wrazenie.
...
FUNC VOID Info_Mod_Andre_Kompass_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kompass_40_01"); //Pozwólcie mi widziec..... To jest kompas Esmeraldy. Doskonaly! Hmm, i zlodziej?
	AI_Output(hero, self, "Info_Mod_Andre_Kompass_15_02"); //Placil za to zyciem.
	AI_Output(self, hero, "Info_Mod_Andre_Kompass_40_03"); //To byla kara za ten czyn. Zarobiles nagrode i nagrode za odzyskanie kompasu.
	AI_Output(self, hero, "Info_Mod_Andre_Kompass_40_04"); //W imieniu Paladynów chcialbym panstwu równiez podziekowac. Jestes wzorem do nasladowania dla kazdego obywatela tego miasta.
...
{
	AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_00"); //Czy przyszedles/as zaplacic grzywne?

	if (B_GetTotalPetzCounter(self) > Andre_LastPetzCounter)
	{
		AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_01"); //Zastanawialem sie, czy nawet nie osmieliscie sie tu przyjechac!
		AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_02"); //Najwyrazniej nie sa to ostatnie oskarzenia!

		if (Andre_Schulden < 1000)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_03"); //Ostrzegam cie! Grzywna, która musisz zaplacic jest teraz wyzsza!
		...
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_04"); //Zapusciles mnie tak zle!
		};
	}
	else if (B_GetGreatestPetzCrime(self) < Andre_LastPetzCrime)
	{
		AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_05"); //Pojawily sie nowe rzeczy.
		
		if (Andre_LastPetzCrime == CRIME_MURDER)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_06"); //Nagle nie ma juz nikogo, kto oskarzalby cie o morderstwo.
		};
		
		if (Andre_LastPetzCrime == CRIME_THEFT)
		|| ( (Andre_LastPetzCrime > CRIME_THEFT) && (B_GetGreatestPetzCrime(self) < CRIME_THEFT) )
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_07"); //Nikt nie pamieta, ze widzisz sie przy kradziezy.
		};
		
		if (Andre_LastPetzCrime == CRIME_ATTACK)
		|| ( (Andre_LastPetzCrime > CRIME_ATTACK) && (B_GetGreatestPetzCrime(self) < CRIME_ATTACK) )
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_08"); //Nie ma juz zadnych swiadków tego, ze kiedykolwiek walczyles.
		};
		
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_09"); //Widocznie wszystkie zarzuty przeciwko Tobie zniknely.
		};
		
		AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_10"); //Nie wiem, co sie stalo, ale ostrzegam: nie graj ze mna.
				
		// ------- Schulden erlassen oder trotzdem zahlen ------
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_11"); //Zrezygnowalem z waszego zadluzenia.
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_12"); //Upewnij sie, ze nie popadniesz ponownie w klopoty.
		...
		{
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_13"); //Jedno jest pewne: nadal trzeba zaplacic kare w calosci.
			B_Say_Gold (self, hero, Andre_Schulden);
			AI_Output (self, hero, "Info_Mod_Andre_PMSchulden_40_14"); //Co to jest?
		};
	};
...
FUNC VOID Info_Mod_Andre_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_00"); //Musisz byc nowym facetem, który spowodowal klopoty w tym miescie.
	};	
	
	if (B_GetGreatestPetzCrime(self) == CRIME_MURDER) 
	{
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_01"); //Ciesze sie, ze przyszedles do mnie, zanim sytuacja sie pogorszyla.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_02"); //Morderstwo jest powaznym wykroczeniem!
		...
		{
			AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_03"); //Nie wspominajac o innych rzeczach, które zrobiles.
		};

		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_04"); //Straznicy maja rozkaz osadzania kazdego mordercy na miejscu.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_05"); //Wiekszosc mieszkanców nie toleruje zabójcy w miescie!
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_06"); //Nie interesuje mnie to, ze moge panstwa umiescic na szubienicy. Jestesmy na wojnie i potrzebujemy kazdego czlowieka, którego mozemy dostac.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_07"); //Ale nie bedzie latwo sprawic, by ludzie znów byli laskawi.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_08"); //Mozesz okazac swoja pokute placac grzywne - oczywiscie kara musi byc odpowiednia.
	};
		
	if (B_GetGreatestPetzCrime(self) == CRIME_THEFT) 
	{
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_09"); //Dobrze! Jestes oskarzony o kradziez! Sa swiadkowie!

		if ((PETZCOUNTER_City_Attack + PETZCOUNTER_City_Sheepkiller) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_10"); //Nie chce nawet mówic o innych rzeczach, które slyszalem.
		};

		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_11"); //Nie bede tolerowal takich zachowan w miescie!
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_12"); //Bedziesz musial zaplacic grzywne za swoje przestepstwo!
	...
	{
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_13"); //Jesli walczysz z riffem w porcie, to jest jedna rzecz....
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_14"); //Ale jesli zaatakujecie obywateli lub zolnierzy króla, bede musial cie pociagnac do odpowiedzialnosci.

		if (PETZCOUNTER_City_Sheepkiller > 0)
		{
			AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_15"); //I nie sadze, aby tak bylo w przypadku owiec.
		};

		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_16"); //Jesli pozwole wam sie z tym uporac, wszyscy beda robic to, co chca.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_17"); //Placi sie wiec odpowiednia grzywne - a cala sprawa zostanie zapomniana.
	...
	{
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_18"); //Slyszalem, ze balaganiles sie z naszymi owcami.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_19"); //Zdajesz sobie sprawe, ze nie moge tego przepuscic.
		AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_40_20"); //Bedziesz musial wyplacic odszkodowanie!
...
func void Info_Mod_Andre_PETZMASTER_PayNow()
{
	...
	AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_PayNow_40_01"); //Dobrze! Doloze wszelkich staran, aby wszyscy w miescie dowiedzieli sie o tym - wiec Twoja reputacja zostanie w rozsadny sposób przywrócona.
...
func void Info_Mod_Andre_PETZMASTER_PayLater()
{
	...
	AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_PayLater_40_01"); //Nastepnie zobacz, ze zloto dostaniesz jak najszybciej.
	AI_Output (self, hero, "Info_Mod_Andre_PETZMASTER_PayLater_40_02"); //I ostrzegam cie, ze jesli cokolwiek zawdzieczasz sobie, to bedzie ci gorzej.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Tom()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Tom_40_01"); //Ciesze sie, ze powiedziales mi. Oto Twoja nagroda.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Nagur()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Nagur_40_01"); //Wiemy, jak temu zapobiec. Dziekujemy za pomoc.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Meldor()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Meldor_40_01"); //Masz jakies dowody?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Meldor_40_03"); //To wystarczy. Oto Twoja nagroda.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Gerbrandt()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Gerbrandt_40_01"); //Tak naprawde natychmiast je zatrzymamy.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Gerbrandt_40_02"); //Oto Twoja nagroda.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Kardif()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif_40_01"); //Czy posiadasz dowód oskarzenia?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif_40_03"); //To prawda, zrobimy aresztowanie. Oto Twoja laska.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Kardif2()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_02"); //Co? Gdzie jest teraz przestepca?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_04"); //To sprawia, ze czuje sie lepiej. Mialem przeczucie, ze nie byl to dobry pomysl, zeby go wypuscic..... po odbyciu kary.
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_06"); //Tak wlasnie jest. Moi mezczyzni natychmiast przeszukaja wszystkie pola. Ten przestepca kardio otrzyma sprawiedliwa kare.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_07"); //W kazdym razie pomógles w tym miescie powaznie uderzac w zbrodnie.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_08"); //Masz prawo do wiekszej nagrody z naszego miejskiego skarbu.

	B_GiveInvItems	(self, hero, ItMi_Gold, 500);

	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Kardif2_40_09"); //Innos bedzie Ci towarzyszyc w kolejnych krokach.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Den()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Den_40_01"); //Gosc milicji?
	AI_Output(hero, self, "Info_Mod_Andre_Kopfgeld_Den_15_02"); //Tak.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Den_40_03"); //Nie toleruje takich zachowan w milicji. Wyrzuce go.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Den_40_04"); //Oto mala nagroda dla Ciebie.
...
FUNC VOID Info_Mod_Andre_Kopfgeld_Wilfried()
{
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Wilfried_40_01"); //Czy?
	AI_Output(hero, self, "Info_Mod_Andre_Kopfgeld_Wilfried_15_02"); //Puscilem go w dól. To byla samoobrona.
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Wilfried_40_03"); //Masz dowody?
	...
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Wilfried_40_05"); //(niezmotywowane) Gratulacje. Wykonal pan wspaniala prace.
	AI_Output(hero, self, "Info_Mod_Andre_Kopfgeld_Wilfried_15_06"); //Czy dostaje kolejna nagrode?
	AI_Output(self, hero, "Info_Mod_Andre_Kopfgeld_Wilfried_40_07"); //Nie ode mnie. Zapytaj jednak ofiary.
