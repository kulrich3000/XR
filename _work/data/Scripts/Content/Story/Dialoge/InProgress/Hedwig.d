...
FUNC VOID Info_Mod_Hedwig_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_00"); //Podnies kubki! Ach, kapelusze!
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_04"); //Wlasnie o to chodzi! To caly cel!
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_06"); //Hej, Salmey, przynies kolejna runde!
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_08"); //Oczywiscie tak jest. Pijemy sie, dopóki nie jestesmy niemal nieprzytomni, zdesperowani glosno w domu i rzucamy sie przed lózko.
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_10"); //Och, tak, wy bedziecie. Nie dajesz w tym momencie cholery.
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_12"); //Nie trzeba go wycierac.
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_13"); //Nie jestes gonna wytrzec go, wszystko w porzadku? I Ty tez, Berta?
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_15"); //Tysiac razy o tym mówilismy! Gonna twojego meza tym razem oczysci ten balagan!
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_18"); //Zdecydowalismy sie na takie rozwiazanie.
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Hi_21_20"); //(trujace) Co wiec? Czy protestowales/as?
...
FUNC VOID Info_Mod_Hedwig_Kneipe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Kneipe_21_01"); //Nicei spróbuj, ale mozna powiedziec Ditmarowi, ze trzymamy fort.
	AI_Output(self, hero, "Info_Mod_Hedwig_Kneipe_21_02"); //Tak dlugo, jak niektórzy mistrzowie stworzenia nie zyskuja wgladu, nasza misja nie jest zakonczona.
};
...
FUNC VOID Info_Mod_Hedwig_Kneipe2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Kneipe2_21_01"); //No cóz, jestes dla mnie zartem! Nie znasz zony strazniczki!
...
FUNC VOID Info_Mod_Hedwig_Kneipe3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hedwig_Kneipe3_21_01"); //To bezuzyteczne. Chce, zeby czul sie sam, jak to jest, zeby nie czul sie przez caly dzien.
};
...
{
	AI_Output(self, hero, "Info_Mod_Hedwig_EXIT_21_00"); //Zobacze cie..... miejmy nadzieje.
