...
FUNC VOID Info_Mod_Baldur_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_01"); //I am Baldur, hunter in the service of the druids and rangers.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_02"); //Ranger? Druids? What...?
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_03"); //Rangers are also hunters, but they are partly committed to close combat.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_04"); //And the Druids?
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_05"); //These are the leaders of the Rangers. And also all hunters.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_06"); //Wise men who know their way around medicine and magic.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_07"); //They don't hunt and fight rarely, they are nature-loving and pray to Adanos.
...
FUNC VOID Info_Mod_Baldur_CyrcoMine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_03_01"); //That's what I mean! That's a bunch we've got!
	AI_Output(hero, self, "Info_Mod_Baldur_CyrcoMine_15_02"); //You up for another round? I got another mission.
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_03_03"); //No, let it go. I hurt my arm. Better not.
};
...
FUNC VOID Info_Mod_Baldur_Felle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_03_01"); //There's a pile of them. Help yourself.
	AI_Output(hero, self, "Info_Mod_Baldur_Felle_15_02"); //I'll have 10 pieces.
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_03_03"); //Go right ahead. I don't need to drag her down.
...
FUNC VOID Info_Mod_Baldur_AlterMann_Info()
{
	if (Mod_BDT_AlterWaldMann == 0)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_00"); //Ahh, you mean the old man of the woods. Yeah, I know something about him.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_01"); //It is said to be centuries old and to protect the animals of the forest around Khorata.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_02"); //It is said that he is blind, but at the same time he has a magical talent.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_03"); //That's all I can think of right now. Maybe someone else knows more.
	...
	else if (Mod_BDT_AlterWaldMann == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_04"); //The old man of the forest? Yes, I heard he was once a servant of Adano.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_05"); //It is unclear whether he was a ranger like us, a magician of water, or a transforming mage.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_06"); //His magical abilities, as well as his strong attachment to the animal and plant world are proof that he has something of everything.
	...
	else if (Mod_BDT_AlterWaldMann == 2)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_07"); //Well, I can't tell you much about him.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_08"); //The problem is also that he does not talk to anyone, not even us, even if we are pursuing similar goals.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_09"); //Alone with the animals of the forest he entertains himself.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_10"); //Well, if I were a boar, I'm sure I could tell you more about him.
	...
	else if (Mod_BDT_AlterWaldMann == 3)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_11"); //The old man of the forest? Well, he's supposed to be closely related to the fauna and flora.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_12"); //It is said that he leads pack animals such as boar or wolves to protect the forest against intruders.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_13"); //Even it is said that it is often found in the shape of a green wolf.
	...
	else if (Mod_BDT_AlterWaldMann == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_14"); //You're interested in stories about the old man of the forest?
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_15"); //Well, I don't know much about this mystical oddball.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_16"); //It is said to reside mostly in the dark forest, but also near water bodies such as lakes.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_17"); //Rarely has someone seen him....
