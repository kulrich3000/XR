...
{
	AI_Output(self, hero, "Info_Mod_Akil_Hi_16_00"); //If your life is dear to you, leave this house. Only sickness and death can be found here.
};
...
FUNC VOID Info_Mod_Akil_Blablabla_Info()
{
	...
	AI_Output(Self, hero, "Info_Mod_Akil_Blablabla_16_01"); //Unlucky one! Go while you still can! If you want to talk, go to Telbor.
...
FUNC VOID Info_Mod_Akil_Heilung_Info()
{
	...
	AI_Output(Self, hero, "Info_Mod_Akil_Heilung_16_01"); //Thanks a lot, I don't know how to make it good.
...
{
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_00"); //This fool, if only he had taken the potion.
	AI_Output(hero, self, "Info_Mod_Akil_Randolph_15_01"); //Are you talking about Randolph?
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_02"); //Yeah. After the incident with the dark figure, he seemed to be doing very well at first.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_03"); //What's more, he had strength and stamina for three and worked effortlessly on a day that would otherwise have taken a week.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_04"); //But as time went by, he became more and more melancholy and began to withdraw from the others on the farm.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_05"); //He seemed tormented by voices that no one else heard and often woke up screaming at night.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_06"); //And yesterday, yes, he completely lost his mind.
	AI_Output(hero, self, "Info_Mod_Akil_Randolph_15_07"); //Keep talking.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_08"); //There's not much more to tell.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_09"); //When working in the fields, he suddenly began to fight wildly with his hands around him and shouted,"I wish they'd leave him alone.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_10"); //And before you knew it, he ran into the big forest and disappeared.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_11"); //Telbor still tried to track him, but lost his trail near the stone circle.
	AI_Output(Self, hero, "Info_Mod_Akil_Randolph_16_12"); //As much as I hope for it, my hope of seeing him again in one hour's time disappears.
...
{
	AI_Output(Self, hero, "Info_Mod_Akil_RandolphWiederFit_16_00"); //Randolph's back and healed. And you seem to be playing a decisive role.
	AI_Output(Self, hero, "Info_Mod_Akil_RandolphWiederFit_16_01"); //It's not much I have, but take this gold as a thank you.
...
FUNC VOID Info_Mod_Akil_Untier_Info()
{
	...
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_01"); //Trouble?! That's for sure.
	AI_Output(self, hero, "Info_Mod_Akil_Untier_16_02"); //Yesterday, when I wanted to bring a load of heavily pickled sheep's legs to Orlan's tavern, I was struck by the most heinous beast I've ever seen.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_03"); //It was high as a tall man, running on all fours and hissing bestially.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_04"); //I dropped my valuable cargo and ran back to the yard.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_05"); //From a distance I could see how this monster was coming over the flesh.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_06"); //Afterwards it wound up on the ground for a few minutes - he probably didn't get all that salt - and then he ran into the woods hissing past my farm.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_07"); //May this beast die from the salt meat.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_08"); //But I really don't know how to make up for the loss.
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_16_09"); //The meat would have brought me some gold coins and times are so hard...
...
{
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_F_16_00"); //Thank you very much. I don't know how to make it up to you.
...
FUNC VOID Info_Mod_Akil_Untier_B()
{
	...
	AI_Output(Self, hero, "Info_Mod_Akil_Untier_B_16_01"); //(hopefully) Yes?
...
{
	AI_Output(Self, hero, "Info_Mod_Akil_Lich_16_00"); //Better get to town, it's not safe here.
	AI_Output(hero, self, "Info_Mod_Akil_Lich_15_01"); //What has happened?
	AI_Output(Self, hero, "Info_Mod_Akil_Lich_16_02"); //These dreadful demons appeared out of nowhere and tormented us to the bone.
	AI_Output(self, hero, "Info_Mod_Akil_Lich_16_03"); //If those three paladins hadn't turned up, it would have been bad for us.
	AI_Output(hero, self, "Info_Mod_Akil_Lich_15_04"); //Where are the paladins now?
	AI_Output(Self, hero, "Info_Mod_Akil_Lich_16_05"); //After they had killed the fiends - thanks to Innos - they walked to the burial cave near Orlan.
};
