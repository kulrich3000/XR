...
FUNC VOID Info_Mod_Orun_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Hi_03_01"); //Nazywam sie Baal Orun i zajmuje sie produkcja chwastów bagiennych.
};
...
FUNC VOID Info_Mod_Orun_Cyrco_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_01"); //Hu?
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_02"); //Glosne) Dobre popoludnie.
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_03"); //Tak. Ja równiez sie zgadzam. Czego chcesz?
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_04"); //Pochodze z Cyrco, druidu.
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_05"); //Tak. Znam go równiez. Jak on postepuje?
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_06"); //Dobre. Oto jego dokument. Do-ku-ment.
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_07"); //Dokument? Prosze mi to dac.

	B_GiveInvItems	(hero, self, ItWr_MagicPaper, 1);

	B_UseFakeScroll ();

	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_08"); //Hmm..... czary potezna magia..... czarna magia.... zly magia....
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_09"); //A co? Co to jest?
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_10"); //RUHE!
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_11"); //Hm.... Widze cos..... Uwaga.... jaskinia....... bardzo mocna magia.... Obcy?
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_12"); //Tak Mistrz?
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_13"); //Obcy!
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_14"); //Tutaj!
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_15"); //Och, widze. Sluchaj: Mialem wizje. Widzialem ja w poblizu jaskini otoczonej silna czarna magia. Nie poszedlbym tam sam.
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_16"); //I na pewno?
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_17"); //Tak. Jestem tego pewien.
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_18"); //Dziekuje.
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_19"); //Co Anke?
...
FUNC VOID Info_Mod_Orun_Woher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Woher_03_01"); //Przed wrzuceniem do kolonii bylem zolnierzem milicji Khorinis.
	AI_Output(self, hero, "Info_Mod_Orun_Woher_03_02"); //Jednak po tym jak przypadkowo ranilem jakiegos obywatela podczas operacji, zostalem wrzucony do kolonii.
	AI_Output(self, hero, "Info_Mod_Orun_Woher_03_03"); //Poczatkowo dolaczylem do ludu Gomeza i szybko stalem sie wplywowym cieniem, ale kiedy uslyszalem o obozie bagiennym, zostalem do niego przyciagniety.
};
