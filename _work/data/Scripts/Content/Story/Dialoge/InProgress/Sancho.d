...
FUNC VOID Info_Mod_Sancho_Alissandro_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Alissandro_03_01"); //(still bored) Wrong password.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_03_01"); //Hi, what do you want?
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_15_02"); //I'm looking for information.
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_03_03"); //It's gonna cost you a little something.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_15_04"); //How much?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_03_05"); //50 gold.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_C_03_01"); //Then get out of here!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_B_03_01"); //Well, because it's you, it's 80 now.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_E_03_01"); //Then get out of here!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_D_03_01"); //Oh, there's still 20 gold missing. I'm really sorry, buddy, but you must have miscounted.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_G_03_01"); //Forget it, buddy. Get the fuck out of here before I split your insolent skull!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_I_03_01"); //What?
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_01"); //What do you want to know now?
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_02"); //Have there been some guards around here lately?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_03"); //Coincidentally, yes.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_04"); //Where did they go?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_05"); //Nowhere.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_06"); //So they're still here?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_07"); //In principle, yes.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_08"); //Can I talk to you?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_09"); //No.
	
	B_Say	(hero, self, "$WIESONICHT");

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_11"); //Cause then you'd have to start with a pack of snapper looking for their parts.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_12"); //You were killed by snappers?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_13"); //No.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_14"); //Like now? You just said....
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_15"); //... that they were eaten by them! We killed them. (laughs dirty)
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_17"); //None of us had seen her in the Minental, but it's not that unusual. They had a note with them.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_18"); //Can I see the note?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_19"); //Of course it is. That would cost you another 50 gold.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_K()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_K_03_01"); //50 gold or leave it. You want the note and I have it, I don't care.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_L()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_L_03_01"); //All right, here, take the note. I can't read it anyway.

	B_GiveInvItems	(self, hero, ItWr_MagicPaper, 1);

	Mod_SanchoHatZettel = 2;

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_L_03_02"); //Now, don't distract me anymore.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_J()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_J_03_01"); //All right, here, take the note. I can't read it anyway.

	B_GiveInvItems	(self, hero, ItWr_MagicPaper, 1);

	Mod_SanchoHatZettel = 2;

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_J_03_02"); //Now, don't distract me anymore.
...
FUNC VOID Info_Mod_Sancho_Umgehauen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Umgehauen_03_01"); //Ow, you've got a pretty good punch. He's coming from some guards who came by here the other day.
	AI_Output(self, hero, "Info_Mod_Sancho_Umgehauen_03_02"); //Keep it, I can't use it anyway. Now leave me alone.
...
FUNC VOID Info_Mod_Sancho_WasFuerLosung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung_03_01"); //The slogan that allows you to come into the camp without being hacked to pieces by me and the boys inside, you nag.
};
...
FUNC VOID Info_Mod_Sancho_WasFuerLosung2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_01"); //Hey, man, you're getting on my nerves.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_02"); //If you want that damn slogan, you're gonna have to help our boys in Khorinis.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_03"); //But don't think you can just go and get it.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_04"); //If they really need your help at some point, they'll talk to you.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_05"); //Now, don't bother me anymore.
};
...
{
	AI_Output(self, hero, "Info_Mod_Sancho_Nek_03_00"); //What are you doing here?
	AI_Output(hero, self, "Info_Mod_Sancho_Nek_15_01"); //I have Nek's amulet. Look.

	B_GiveInvItems	(hero, self, ItAm_Nek, 1);

	AI_Output(self, hero, "Info_Mod_Sancho_Nek_03_02"); //Fact. Here's your gold.
...
FUNC VOID Info_Mod_Sancho_Dam_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_01"); //You're just not loosening up, are you?
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_02"); //Okay, then I have a proposition for you.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_03"); //If you can do that, the others will not mind that you are allowed into our camp, even if you are not yet one of us.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_04"); //I hear....
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_05"); //Okay, you brought me the amulet. You know what this is all about?
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_06"); //Well, it once belonged to a guardsman named Nek who blessed the temporal...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_07"); //Ha, and you really believe that.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_08"); //Actually... yes.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_09"); //Well, listen, kid.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_10"); //He did not mark the amulet with his name... but the amulet with his name.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_11"); //What?!
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_12"); //The amulet is not an ordinary protective amulet.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_13"); //It belongs to a genre of artifacts with unfortunate characteristics.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_14"); //The nek amulet for its part takes possession of its wearer over time... and bring him death sooner or later.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_15"); //What...?! But at least that would explain a lot...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_16"); //In any case, these pieces have a high collector's value with black magicians and occultists.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_17"); //They come from a cursed bog in Relendel.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_18"); //And there must also be the other part of the amulet, which represents the back of the nek amulet.... at least it did.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_19"); //Nek was a treasure hunter in the bog before the colony... and he once told about another amulet...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_20"); //But since he didn't carry it, it could still be there.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_21"); //And I'm supposed to find this now.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_22"); //Exactly. What do you say?
};
...
FUNC VOID Info_Mod_Sancho_Dam2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_01"); //Good. The other part is the Dam amulet. It brings damnation to the bearer.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_02"); //This set - death and damnation - should have a much higher value than the single pieces.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_03"); //If you get it for me, I'm sure no one in the camp will have any objection to you coming by the camp and trading with our boys.... however.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_04"); //Gives enough in our warehouse, which is of value and benefit.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_05"); //Check out the golden liquid manure at the tavern near the moor.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_06"); //You all right? Okay. Then get on your way.
...
FUNC VOID Info_Mod_Sancho_Dam3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_01"); //(unbelieving) What?! Can't be. Show me!

	B_GiveInvItems	(hero, self, ItAm_Dam, 1);

	AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_02"); //Actually. That's what I call clean work. I didn't think you'd survive the moor.

	if (self.aivar[AIV_PASSGATE] == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_03"); //You have more than earned the entrance to our camp... even if you're not yet a bandit.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_04"); //But I can give you a hint. One of our boys has positioned himself in the port city.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_05"); //He is looking for capable and experienced men, those who already belong to a big guild.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_06"); //But shouldn't be the City Watch...
...
FUNC VOID Info_Mod_Sancho_Parole_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Parole_03_01"); //Well, you may pass.
...
FUNC VOID Info_Mod_Sancho_Asylanten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_01"); //(laughs) You don't know that yet?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_02"); //(confidential) We sneak up to the Old Camp at night, sneak out the guards and storm the castle.
	AI_Output(hero, self, "Info_Mod_Sancho_Asylanten_15_03"); //Is that so?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_04"); //How stupid do you think I am to blabber our plans?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_05"); //Do you want me to volunteer to go to jail?
	AI_Output(hero, self, "Info_Mod_Sancho_Asylanten_15_06"); //But you don't plan on moving to Khorinis next?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_07"); //Let's not worry about that. (laughs) But I'll let you know when the time comes, kid.
...
func void Info_Mod_Sancho_FirstWarn_Info()
{
	...
	{
		AI_Output (self, hero,"Info_Mod_Sancho_FirstWarn_03_00"); //HALT! No one is allowed to enter the camp without a password.
	}
	else
	{
		AI_Output (self, hero,"Info_Mod_Sancho_FirstWarn_03_01"); //(bored) Password?
	};
...
{
	AI_Output (self, hero,"Info_Mod_Sancho_SecondWarn_03_00"); //I'll tell you one last time. One more step and you'll enter the world of pain!
...
func void Info_Mod_Sancho_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_Sancho_Attack_03_00"); //You asked for it...
