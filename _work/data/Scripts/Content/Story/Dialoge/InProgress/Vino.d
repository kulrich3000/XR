...
FUNC VOID Info_Mod_Vino_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Hi_28_01"); //Nice work, bum. While you were making yourself comfortable in your cupola.
	AI_Output(hero, self, "Info_Mod_Vino_Hi_15_02"); //You have some misconceptions, I'm afraid.
	AI_Output(self, hero, "Info_Mod_Vino_Hi_28_03"); //I saw all the things they sent in. A prince could have lived on that!
...
FUNC VOID Info_Mod_Vino_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Hi_B_28_01"); //Shut the fuck up!
...
FUNC VOID Info_Mod_Vino_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Hi_A_28_01"); //You're busting my balls, man. Get the fuck out of here!
...
FUNC VOID Info_Mod_Vino_Hi_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Hi_D_28_01"); //I'll show you!
...
FUNC VOID Info_Mod_Vino_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Hi_C_28_01"); //Yeah, get lost!
...
{
	AI_Output(self, hero, "Info_Mod_Vino_Pruegel_28_00"); //I work all day for moments like that.
...
{
	AI_Output(self, hero, "Info_Mod_Vino_KingImRing_28_00"); //Hey, you there!
	AI_Output(hero, self, "Info_Mod_Vino_KingImRing_15_01"); //Are you talking to me?
	AI_Output(self, hero, "Info_Mod_Vino_KingImRing_28_02"); //You insulted me pretty bad once.
	AI_Output(hero, self, "Info_Mod_Vino_KingImRing_15_03"); //You're saying, finished?
	AI_Output(self, hero, "Info_Mod_Vino_KingImRing_28_04"); //I've waited a long time for this moment.
	AI_Output(hero, self, "Info_Mod_Vino_KingImRing_15_05"); //Why don't you be reasonable?
	AI_Output(self, hero, "Info_Mod_Vino_KingImRing_28_06"); //Now it's your turn!
...
FUNC VOID Info_Mod_Vino_Brennerei_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_01"); //What's going on? I almost got caught.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_02"); //It's only thanks to Nandor that I'm still alive. He pulled me out of the cave when I lost my senses...
	AI_Output(hero, self, "Info_Mod_Vino_Brennerei_15_03"); //What exactly happened?
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_04"); //These loathsome beasts.... and left the barrels where they were.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_05"); //But when I heard these noises at the door, I put them aside to listen with the ear at the door.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_06"); //And when I looked down again.... there were these horrible creatures hanging on my legs.... and then it went black on me.
	...
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_08"); //Actually, I feel quite recovered already.... but I still can't go back to the yard.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_09"); //At the platform below, countless of these disgusting spider beasts are still crawling.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei_28_10"); //As long as they're there, I won't set foot in the cave.
...
FUNC VOID Info_Mod_Vino_Brennerei2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei2_28_01"); //Really? None of those nasty beasts left?
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei2_28_02"); //All right, I'll take a look to see if it's really safe.
...
{
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei3_28_00"); //Ahh, there you are. Thank you so much for your help with the spider thing.
	AI_Output(hero, self, "Info_Mod_Vino_Brennerei3_15_01"); //You're up again?
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei3_28_02"); //Yeah, I'm doing great.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei3_28_03"); //(slightly melancholy) Well, only in the distillery I will probably not set foot in the distillery for the time being, as long as the spiders are cavorting in the caves and corridors.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei3_28_04"); //(again more cheerful) Anyway, here, as a little thank-you some gold and some of my good herbal liquors.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei3_28_05"); //They have an invigorating effect and quickly revive every sick person. To your health.
...
FUNC VOID Info_Mod_Vino_Brennerei4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_01"); //Really? That's great news. I'll soon be able to visit my distillery again.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_02"); //I had already missed my alchemy table....
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_03"); //Hmm, but how can I thank you now? I'm out of Schnapps.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_04"); //But wait... take this ring here.

	B_GiveInvItems	(self, hero, ItRi_Alchemist, 1);

	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_05"); //I found him back in the cave before I started burning.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_06"); //I had the impression that he helped me to quickly grasp the basics of alchemy.
	AI_Output(self, hero, "Info_Mod_Vino_Brennerei4_28_07"); //Well, now I don't need it anymore. Maybe he'll do you some good.
