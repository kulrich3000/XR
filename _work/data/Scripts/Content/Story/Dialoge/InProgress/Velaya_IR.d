...
{
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Hi_39_00"); //Nieszczesliwy) Och, nie tak wyobrazalem sobie wielki swiat.
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Hi_39_01"); //Przypomina mi o zimnych, wilgotnych scianach, w których uwieziono mnie od tak dawna.
	AI_Output(hero, self, "Info_Mod_Velaya_IR_Hi_15_02"); //Cóz, nie chcemy rozbijac tu namiotów zbyt dlugo.
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Hi_39_03"); //Tak, zróbmy to, do czego tu przyjechalismy, a potem przejdzmy pod otwarte niebo tak szybko, jak potrafimy.
};
...
FUNC VOID Info_Mod_Velaya_IR_Hebel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Hebel_39_00"); //Oczywiscie tak jest. Moze to moze, ze gdzies nas zaprowadzi....
...
{
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Ambient01_39_00"); //Nie, nie nudzi cie az tyle okropnych rzeczy.
...
FUNC VOID Info_Mod_Velaya_IR_GehtLos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_IR_GehtLos_39_00"); //Cóz, lepiej niz nudny tutaj na pokladzie.... W przeciwnym razie podróz bylaby bezplatna.
...
FUNC VOID Info_Mod_Velaya_IR_GehBack_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_IR_GehBack_39_00"); //Cóz, jesli mnie potrzebujesz, wiesz, gdzie mnie znalezc.
...
FUNC VOID Info_Mod_Velaya_IR_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Lehrer_39_01"); //Oczywiscie, nie mam przy sobie luku dla zabawy wokól ramion i perly z boku.
	AI_Output(self, hero, "Info_Mod_Velaya_IR_Lehrer_39_02"); //Potrafie pokazac wam, jak stac sie bardziej umiejetnymi i jak prawidlowo wyciagac luk.
};
