...
FUNC VOID Info_Mod_Eremit_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Hi_20_01"); //No thief, no thief! Just play!
	AI_Output(self, hero, "Info_Mod_Eremit_Hi_20_02"); //I told you to get out of here. It was clear that someone would find you.
	AI_Output(self, hero, "Info_Mod_Eremit_Hi_20_03"); //But I want to play!
};
...
FUNC VOID Info_Mod_Eremit_WerBistDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_01"); //Which one of us do you mean?
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_02"); //(seriously) Of course, me. Why would he want to talk to you, child's head?
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_03"); //You take that back immediately!
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_04"); //Seriously, forget it.
	AI_Output(hero, self, "Info_Mod_Eremit_WerBistDu_15_05"); //Hey, be quiet. Can't you, uh, agree before you say anything?
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_06"); //In secret?
	AI_Output(hero, self, "Info_Mod_Eremit_WerBistDu_15_07"); //Yeah, that's right.
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_08"); //(Children, enthusiastic) Ohhhh...
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_09"); //I don't want it to fail because of me.
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_10"); //Seriously, I'm embarrassed anyway when someone has to listen to the comments of this retarded person.
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_11"); //You take that back!
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_12"); //(really) No!
	AI_Output(hero, self, "Info_Mod_Eremit_WerBistDu_15_13"); //Shh.
	AI_Output(self, hero, "Info_Mod_Eremit_WerBistDu_20_14"); //(clears throat, normal voice) Hello. Reminds us darkly of old times, so to speak.
...
FUNC VOID Info_Mod_Eremit_Woher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_01"); //Originally we came from the mainland and produced maps together.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_02"); //Until we hired this ship to create a map of Khorini's coast.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_03"); //We weren't even in shallow waters when we were attacked and sunk by an Orkgaleere.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_04"); //On a barrel of port wine we made it to the beach - the only one.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_05"); //Until then, the Piranhas had already nibbled off four toes.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_06"); //Just three to me.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_07"); //You just can't count any further than three.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_08"); //Afterwards we settled in comfortably.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_09"); //Not on the beach, the buccaneers live there. We didn't want anything to do with them.
	AI_Output(hero, self, "Info_Mod_Eremit_Woher_15_10"); //Didn't you ever try to get back to the mainland?
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_11"); //Nah, man. There's only one annoying woman waiting for us who doesn't want to have children.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_12"); //We can also draw maps here.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_13"); //Through trade with the pirates, we are supplied with the essentials, and that is all we need.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_14"); //The loneliness gets boring sometimes and we get on each other's nerves.
	AI_Output(self, hero, "Info_Mod_Eremit_Woher_20_15"); //Sometimes we wish for a third in the alliance.
...
FUNC VOID Info_Mod_Eremit_WiesoDieb_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_01"); //Water magicians are the guys in the robes?
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_02"); //On the one hand... (must overcome) we wanted to play with them.
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_03"); //On the other hand, we need the ingredients for a few recipes left by the old people.
	AI_Output(hero, self, "Info_Mod_Eremit_WiesoDieb_15_04"); //So you can read her language?
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_05"); //Reading, speaking, whatever you want.
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_06"); //I read all the texts I found.
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_07"); //At the beginning I didn't understand a word, of course, but I had time.
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_08"); //Wenn es ein Wort gibt, dass das alte Volk beschreibt, dann ist es "magical".
	AI_Output(self, hero, "Info_Mod_Eremit_WiesoDieb_20_09"); //In that respect, they were ahead of you.
};
...
FUNC VOID Info_Mod_Eremit_AlteSprache_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_AlteSprache_20_01"); //In due course of time, it could be negotiated.
	AI_Output(self, hero, "Info_Mod_Eremit_AlteSprache_20_02"); //Fnidhdr gröggel snüt!
	AI_Output(self, hero, "Info_Mod_Eremit_AlteSprache_20_03"); //Just watch your mouth!
};
...
FUNC VOID Info_Mod_Eremit_Prisma_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_01"); //A magic prism? We've heard about that, too.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_02"); //For a while it used to be fashionable for the old folk.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_03"); //However, the parts disappeared as quickly as they came up. Don't ask why.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma_15_04"); //You wouldn't happen to know how to make a prism like that, would you?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_05"); //Yes, we'd probably manage that.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_06"); //(seriously) Well, me anyway.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_07"); //All we need is a black pearl.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma_15_08"); //If I bring you one, will you grind my prism?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_09"); //Yeah. On one condition.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma_15_10"); //Which is?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_11"); //We can keep the water magicians' stuff.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma_15_12"); //Satan's gonna rip my head off, but fine.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_13"); //We'll make our way back, come by as far as you're ready.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma_20_14"); //On this map we have marked where you can find us.
...
FUNC VOID Info_Mod_Eremit_Prisma2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma2_20_01"); //And you even brought your friends to play with you?
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_00"); //We've heated them up pretty good. They didn't stand a chance against the three of us.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma3_15_01"); //How do they always know where I am right now?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_02"); //Nothing is impossible. Maybe they know a few tricks of the old people.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma3_15_03"); //What tricks?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_04"); //We're just guessing. They may have marked you magically so that you can draw a fine trace anywhere you go, which is visible to the caster.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_05"); //Have you ever come close to one of them before killing him?
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma3_15_06"); //Several times.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_07"); //At least that's one possibility.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma3_15_08"); //And how could I get rid of the marker?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_09"); //I don't know about that. The spell is not designed to be easily broken.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_10"); //You might be able to trick him by redirecting him to another item.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_12"); //Exactly.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma3_15_13"); //All right, but how do I start?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_14"); //Don't ask us... What do your robes say? Maybe one of them has an idea.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_15"); //Or someone who knows the old people better than we do. If there's such a thing.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_16"); //It would be better if you stripped the marker before we proceeded. So many visitors is a little bit annoying to us.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma3_20_17"); //By the time you get back, we'll have finished polishing the prism.
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_00"); //Come on, come on! We still have some way to go!
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma4_15_01"); //Where are we headed?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_02"); //There's a cave near here where Beliar's power is strong. That will have to be enough.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma4_15_03"); //Beliar? What the hell is she doing?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_04"); //Beliar is the only one of the three gods who embodies the irrepressible like Radanos, the god of the ancient people.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_05"); //Since we can't ask Radanos for help anymore, we have to make do with Beliar.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma4_15_06"); //I have a bad feeling...
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_07"); //It would also be unwise to feel secure in Beliar's presence.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma4_20_09"); //But now let's go!
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_00"); //You must assist us with the ritual.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma5_15_01"); //How does it even work?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_02"); //The prism is not yet receptive enough for multiple spells, so we will cast an expansion spell to increase the magical volume of the prism.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_03"); //This may take some time. The prism will try to repel the spell.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_04"); //But with Beliars and your help, it should work.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_05"); //My head is buzzing!
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma5_15_06"); //What can I do?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_07"); //The two of us have enough to do to maintain the stretch spell.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_08"); //You have to make sure he stays in the prism.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma5_15_09"); //And how?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_10"); //As long as it is in the prism, it lights up.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_11"); //Ermattet das Prisma, musst du schnell handeln - du hast nur wenige Sekunden, um den Zauber "Beliar's anger" zu wirken, der den Dehnzauber zurück in seinen eigentlichen Bestimmungsort treibt.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_12"); //Here's some spell rolls. If the first few attempts do not work, we will give you even more.

	B_GiveInvItems	(self, hero, ItSc_BeliarsRage, 6);

	AI_Output(self, hero, "Info_Mod_Eremit_Prisma5_20_13"); //Are you ready?
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma7_20_00"); //That hasn't quite worked yet. Again!
...
FUNC VOID Info_Mod_Eremit_Prisma8_Info()
{
	if (!Mod_PrismaZauber_Eremit) {
		AI_Output(self, hero, "Info_Mod_Eremit_Prisma8_20_00"); //You're out of spells. Here, take some new ones.
		...
		AI_Output(self, hero, "Info_Mod_Eremit_Prisma8_20_01"); //Phew, we're still not finished. We still have a few spells left, but with your wear and tear, we won't be able to.
		AI_Output(self, hero, "Info_Mod_Eremit_Prisma8_20_02"); //Are you trying to deceive us?
		AI_Output(self, hero, "Info_Mod_Eremit_Prisma8_20_03"); //If you want more spells, we'll charge 300 gold pieces from now on.
...
FUNC VOID Info_Mod_Eremit_Prisma9_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_00"); //That's what we got. There lies your finished prism.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma9_15_01"); //How can I thank you?
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_02"); //A simple thank you is enough.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma9_15_03"); //Thanks.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_04"); //We can also give you a hint for use.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_05"); //The prism only becomes active if you take it out of your luggage and put it on.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_06"); //All damage spells you now cast will charge the prism.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_07"); //However, only three to four spells can be placed in the prism at the same time.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_08"); //If you talk more, the spells will be lost.
	AI_Output(hero, self, "Info_Mod_Eremit_Prisma9_15_09"); //I'll keep that in mind.
	AI_Output(self, hero, "Info_Mod_Eremit_Prisma9_20_10"); //May it bring you luck on your travels.
...
FUNC VOID Info_Mod_Eremit_ScrollJG_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_01"); //Adanos? Spare us this new-fashioned nonsense!
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_02"); //You're not a fan of water?
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_03"); //No, he didn't appear in the old writings we read. We were able to decipher four of the languages.
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_04"); //Four? I only know three, which is the fourth?
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_05"); //The language of scholars.
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_06"); //Then we came across another language. It was so terrible that today we still panic when we think of it.
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_07"); //Hmm. Then you can teach me the language of the scholars, too?
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_08"); //We don't know if you're ready for this yet.
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_09"); //Well, try it then. I didn't fall on my head.
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_10"); //So hear:"Ralgnatiru chrenid kar. “
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_11"); //Stop it. I don't understand a word.
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_12"); //Yes, you are. Sorry about that.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_14"); //Let me see that.

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_15"); //Yeah. The scholarly language.
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_16"); //What do you mean?
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_17"); //You got some gold for us? We have to go shopping with the pirates again.
	AI_Output(hero, self, "Info_Mod_Eremit_ScrollJG_15_18"); //How much did you have in mind?
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_20_19"); //You seem to care. About 500 gold...
...
FUNC VOID Info_Mod_Eremit_ScrollJG_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_B_20_01"); //This text explains how to use a certain spell.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_B_20_09"); //Certainly. We wish you luck.
...
FUNC VOID Info_Mod_Eremit_ScrollJG_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_ScrollJG_A_20_01"); //No. We have to buy in advance.
...
FUNC VOID Info_Mod_Eremit_Zeremoniendolch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch_20_01"); //That's what we mean. What are you looking for?
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch_20_03"); //We'd know something by now. But for us to tell you that, you have to do us a favor.
	AI_Output(hero, self, "Info_Mod_Eremit_Zeremoniendolch_15_04"); //And what's that?
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch_20_05"); //We're running out of food. And then we'd like to have something else than the water from the lake by the pirates.
};
...
FUNC VOID Info_Mod_Eremit_Zeremoniendolch2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch2_20_01"); //Boaar! It's been a long time since you drank that kind of good stuff! Where'd you get that?
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch2_20_05"); //How do you get there?
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch2_20_07"); //We'll think it over. But first, what we urgently need. We'll write you a note.
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch2_20_08"); //Meanwhile, you could get us fresh water from the lake in the valley basin near the pirates. Here's a bucket.
...
FUNC VOID Info_Mod_Eremit_Zeremoniendolch3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch3_20_01"); //And here's our list. And we also need a new hunting bow and a new pan.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch3_20_03"); //It doesn't matter. The main thing is that it is dry and burns well.
	AI_Output(hero, self, "Info_Mod_Eremit_Zeremoniendolch3_15_04"); //And then you'll tell me where I can find a place of sacrifice?
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch3_20_05"); //I promise.
...
FUNC VOID Info_Mod_Eremit_Zeremoniendolch4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch4_20_01"); //Let me see that. Let's see first.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch4_20_02"); //Great, everything included. We will give you a suggestion: If our tip helps you, we will get the delivery free of charge. If not, we'll pay for it.
	AI_Output(hero, self, "Info_Mod_Eremit_Zeremoniendolch4_15_03"); //Fine, fine. Where is this damn sacrificial site?
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch4_20_04"); //So listen: Right around the corner, on the way up from the valley, is a hidden turnoff to a small plateau.
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch4_20_05"); //You'll find a crypt there. And in there could be your sacrificial site.
	AI_Output(hero, self, "Info_Mod_Eremit_Zeremoniendolch4_15_06"); //Have you ever been there before?
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch4_20_07"); //Save it! It's full of monsters. No one can get us in. We may be a little strange, but we're not suicidal.
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch5_20_00"); //So, do you have your dagger?
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch5_20_02"); //That's what we said. Then we don't owe you anything.
	AI_Output(hero, self, "Info_Mod_Eremit_Zeremoniendolch5_15_03"); //That's the deal. Goodbye, I have to keep going.
	AI_Output(self, hero, "Info_Mod_Eremit_Zeremoniendolch5_20_04"); //May the sun show you the way. Old saying.
};
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch_20_00"); //What do you want?
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch_15_01"); //Do you know a pirate named Darrion?
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch_20_02"); //Darrion? I know him.
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch_15_03"); //You've translated a book for him.
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch_20_04"); //What if it were? I don't know what that's your business!
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch_15_05"); //He's hurt, he's....
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch_20_06"); //I don't care about that! Go ahead and leave me alone.
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_00"); //Wait a minute! That smell.... this beguiling scent... do you have any mould cheese with you?!
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch2_15_01"); //What if I did?
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_02"); //Uh... I have to apologize for my rudeness, I didn't mean that. You wanted to know about Darrion, didn't you?
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_03"); //He came to me with a book, it was written in the ancient scriptures of this land. He was particularly interested in describing a flower.
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_04"); //I translated his page and he disappeared again.
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch2_15_05"); //Otherwise?
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_06"); //I haven't seen him since.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_08"); //Oh, yeah! Thank you very much!
	
	B_UseItem(self, ItFo_Cheese);
	
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_09"); //Oh yes, tell Darrion, if you don't see him, don't let him put the plant in.
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_10"); //The book describes that the plant is somehow related to some kind of monster.
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_11"); //Genau hab ich es nicht verstanden, aber der Autor stellt irgendeine Beziehung zwischen einer dieser Pflanzen und fünf "giant marshes" her.
	AI_Output(hero, self, "Info_Mod_Eremit_Sumpfmensch2_15_12"); //And why didn't you tell Darrion that?!
	AI_Output(self, hero, "Info_Mod_Eremit_Sumpfmensch2_20_13"); //That was on the next page, I hadn't translated it yet....
...
FUNC VOID Info_Mod_Eremit_NettHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_NettHier_20_01"); //You can do anything with a lot of time.
	AI_Output(self, hero, "Info_Mod_Eremit_NettHier_20_02"); //Since we've been together, the room is a little tight, so we sleep together in one bed.
	AI_Output(self, hero, "Info_Mod_Eremit_NettHier_20_03"); //But if you have only the essentials to live with, you will also be able to cope with little space.
};
...
FUNC VOID Info_Mod_Eremit_PreLehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer_20_00"); //We could teach you the language of ancient culture...
	AI_Output(hero, self, "Info_Mod_Eremit_PreLehrer_15_01"); //Fine. Well, what do I have to...?
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer_20_02"); //(interrupts) We said we could... but we don't have the nerve to do it right now!
	AI_Output(hero, self, "Info_Mod_Eremit_PreLehrer_15_03"); //Why, what's going on?
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer_20_04"); //Ah... those goddamn harpies are making our lives really hard.
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer_20_05"); //Whenever we want to cook something nice, they come in and... oh, damn it, there they are again!
...
{
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer2_20_00"); //See, that's what we meant! Whenever we want to fry ourselves, these creatures come flying at us and defile everything with their stench and filth.
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer2_20_01"); //These damn beasts have their nests somewhere around here...
	AI_Output(hero, self, "Info_Mod_Eremit_PreLehrer2_15_02"); //Have you tried taking her down yet?
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer2_20_03"); //How?! Can we go up to their nests?! And we don't get along on ranged either.
	AI_Output(self, hero, "Info_Mod_Eremit_PreLehrer2_20_04"); //If this goes on like this, we will probably have to find another place to live...
...
FUNC VOID Info_Mod_Eremit_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Lehrer_20_01"); //Then you got them all? Great, finally we have our peace again.
	AI_Output(self, hero, "Info_Mod_Eremit_Lehrer_20_02"); //We don't know how to thank you.... hmm, where... take these tablets.
	...
	AI_Output(self, hero, "Info_Mod_Eremit_Lehrer_20_03"); //And if you can't read them yet, we will of course teach you.
...
FUNC VOID Info_Mod_Eremit_Lernen_Info ()
{
	...
	AI_Output (self, other, "Info_Mod_Eremit_Lernen_20_01"); //Which one do you want to learn?
...
{	
	AI_Output (self, other, "Info_Mod_Eremit_Lernen_20_05"); //Probably for reasons of strategic secrecy, the warriors wrote their lyrics backwards.
	AI_Output (self, other, "Info_Mod_Eremit_Lernen_20_06"); //For example:"Tlah! Rew ad? "or" Elorap! "So it shouldn't be too hard to read these blackboards.
};
...
FUNC VOID Info_Mod_Eremit_Lernen_Yes()
{
	...
	{
		AI_Output (self, other, "Info_Mod_Eremit_Lernen_20_04"); //We don't think we can teach you anything else about it...
	}
