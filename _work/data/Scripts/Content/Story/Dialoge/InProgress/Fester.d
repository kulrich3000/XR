...
FUNC VOID Info_Mod_Fester_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_05_01"); //Hey, you're new at camp. You're gonna want to move up fast and make a difference with us.
	AI_Output(hero, self, "Info_Mod_Fester_Hi_15_02"); //Sure, why not.
	AI_Output(self, hero, "Info_Mod_Fester_Hi_05_03"); //Very good. Very good. Then you'd just have to accompany me and two other boys on the hunt, kill some Molerat and Scavenger, not hard at all. What do you say?
...
FUNC VOID Info_Mod_Fester_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_B_05_01"); //So, so, but the first one who moans when there's nothing to eat in the camp will decide. Tse, tse, tse, such a good-for-nothing.
...
FUNC VOID Info_Mod_Fester_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_Hi_A_05_01"); //Fantastic. Engardo and Nodrak were supposed to have already started running and wait for us in front of the camp. Here we go. Let's go.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_VorLager_05_00"); //Come on, let's go.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_00"); //Ahh, here's a good spot.
	AI_Output(hero, self, "Info_Mod_Fester_AtSmallCave_15_01"); //Huh, shall we lay in wait here?
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_02"); //Uh, yeah, something like that.

	CreateInvItems	(self, ItMi_Joint, 1);

	B_UseItem	(self, ItMi_Joint);

	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_03"); //Ahh, lovely.
	AI_Output(hero, self, "Info_Mod_Fester_AtSmallCave_15_04"); //Uh, what is now...?
	AI_Output(self, hero, "Info_Mod_Fester_AtSmallCave_05_05"); //Oh, the hunt. Well, you see those well-nourished Scavenger and Molerats back there? Hunt them down and bring me ten Scavenger and ten Moleratkeulen each. Any more questions?
...
FUNC VOID Info_Mod_Fester_HabFleisch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_HabFleisch_05_01"); //Laundry? Oh, the meat. Well done, kid.
	AI_Output(self, hero, "Info_Mod_Fester_HabFleisch_05_02"); //Now we go a little bit further to hunt something else in a cave.
...
FUNC VOID Info_Mod_Fester_AtGreatCave_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_AtGreatCave_05_01"); //Did I say shot? I meant take care of it.
	AI_Output(self, hero, "Info_Mod_Fester_AtGreatCave_05_02"); //Uh, but just a minute. Some giant orcs have settled in the cave. Go inside and take care of her.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_GobbosTot_05_00"); //Very good, now we can make some bogweed... uh, practice alchemy. Wait a minute till we're done.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_PotionReady_05_00"); //There, now you can go back. Go ahead, we'll follow you.
...
{
	AI_Output(self, hero, "Info_Mod_Fester_BackAtCamp_05_00"); //Hey, you did a really good job... for a rookie. Will Lee and Sylvio report that you've done reasonably well.
	AI_Output(self, hero, "Info_Mod_Fester_BackAtCamp_05_01"); //Here's some weed and ore for your reward.
...
FUNC VOID Info_Mod_Fester_KesselProblem_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_01"); //What...?! Who are you and what do you want?
	...
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_03"); //What...?! Damn it! Hey, man, don't give me any trouble.
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_04"); //I just traded some things for ore.
	AI_Output(hero, self, "Info_Mod_Fester_KesselProblem_15_05"); //Couple of things?
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_06"); //Yeah, well, a little swampweed. Man, what's the big deal?
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_07"); //I deserved most of it with other stuff, for example that shadow runner's fur he wanted.
	...
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_09"); //Hey, come on. Don't you talk about the swampweed thing.
	AI_Output(self, hero, "Info_Mod_Fester_KesselProblem_05_10"); //If you keep your mouth shut, you won't regret it either.
...
FUNC VOID Info_Mod_Fester_KesselProblem2_Info()
{
	if (Mod_NL_TalkesselProblem == 5)
	{
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_00"); //Phew, thank you so much for not telling Lee about the herb.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_01"); //I barely got away with a black eye.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_02"); //Well, I have to be a little more careful for now. Hence... Here, take the herb.
		...
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_03"); //And... er... another little recipe.

		B_GiveInvItems	(self, hero, ItWr_Weisenchronik, 1);

		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_04"); //Preferably before sleeping.... then you're gonna have a super relaxed night, and you're gonna be fine the next morning.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_05"); //Have fun with that. But don't exaggerate, huh?
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_06"); //Great, because of you I'm allowed to work the next few weeks from morning till night.
		AI_Output(self, hero, "Info_Mod_Fester_KesselProblem2_05_07"); //Did you really do a great job.... Son of a bitch!
	};
};
