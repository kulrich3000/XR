...
FUNC VOID Info_Mod_Garvell_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Hi_05_01"); //I'm Garvell.
	AI_Output(hero, self, "Info_Mod_Garvell_Hi_15_02"); //And what are you doing here?
	AI_Output(self, hero, "Info_Mod_Garvell_Hi_05_03"); //I'll build a ship so I can get to the mainland as soon as the war with the orcs is over.
};
...
FUNC VOID Info_Mod_Garvell_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_05_02"); //What?! Why would I do that?
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_05_03"); //I have more than enough to do here on my own ship....
...
FUNC VOID Info_Mod_Garvell_Irdorath_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_B_05_02"); //What are you talking about? Do you think maybe I've never seen a ship from the inside before?
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_B_05_03"); //With such an offer you might impress a boy.... so really...
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_B_05_04"); //And now don't bother me no more at work.
...
FUNC VOID Info_Mod_Garvell_Irdorath_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_A_05_01"); //What, threatening disaster?
	AI_Output(self, hero, "Info_Mod_Garvell_Irdorath_A_05_02"); //Then I should hurry even more with the building of my ship to get ready in time....
...
FUNC VOID Info_Mod_Garvell_Paddel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Paddel_05_01"); //True enough. Best quality. Cedarwood from the mainland. Extra large exclusive sheet. And especially easy to do so.
	AI_Output(hero, self, "Info_Mod_Garvell_Paddel_15_02"); //All right, all right. Give me two paddles.
	AI_Output(self, hero, "Info_Mod_Garvell_Paddel_05_03"); //Here. 200 gold apiece.
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Paddel_05_05"); //Are you out of your mind? This is first-class merchandise. But I don't want to argue. 300 for both of them.
	AI_Output(hero, self, "Info_Mod_Garvell_Paddel_15_06"); //Farim says he'll get it from you for 100 gold, too...
	AI_Output(self, hero, "Info_Mod_Garvell_Paddel_05_07"); //That was rejects, too. I'm sure they'll be over soon.
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Paddel_05_10"); //You're ruining me. Here are the paddles. And don't come back.
...
{
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_05_00"); //Hey, you. You can handle magic, right?
...
FUNC VOID Info_Mod_Garvell_Fenia_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_B_05_01"); //All right, have a nice day.
...
FUNC VOID Info_Mod_Garvell_Fenia_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_A_05_01"); //In that case, I have a little request for you.
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_A_05_02"); //I've got this telekinesis part here.... acquired.
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_A_05_03"); //Could you take Fenia in an unobserved moment with her (hustelt) brassiere?
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_A_05_04"); //She won't notice anything either....
...
FUNC VOID Info_Mod_Garvell_Fenia_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_D_05_01"); //Oh, what a shame. Then I'll have to find another victim.
...
FUNC VOID Info_Mod_Garvell_Fenia_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia_C_05_01"); //Here's your part of the story. Good luck!
	...
	B_LogEntry	(TOPIC_MOD_GARVELL_FENIA, "I am to steal Fenia, the merchant, on behalf of Garvell, from the brassiere with the help of a telekinesis spell. How infantile!");
...
FUNC VOID Info_Mod_Garvell_Fenia2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia2_05_01"); //(laughs extensively) Wonderful, wonderful!
	AI_Output(hero, self, "Info_Mod_Garvell_Fenia2_15_02"); //So you just fucked with me?
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia2_05_03"); //That's how it is. It's a blast, I tell you. (laughs)
	AI_Output(hero, self, "Info_Mod_Garvell_Fenia2_15_04"); //Well, I've got the part of speech. Let's see what you got.
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia2_05_05"); //Wha...?

	AI_StopProcessInfos	(self);
	
	B_LogEntry	(TOPIC_MOD_GARVELL_FENIA, "Jetzt sollte ich die Spruchrolle mal bei Garvell selbst anwenden...");
};
...
{
	AI_Output(self, hero, "Info_Mod_Garvell_Fenia3_05_00"); //Give me back my gold!
...
FUNC VOID Info_Mod_Garvell_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garvell_Flugblaetter_05_01"); //Oh, thank you. Thank you. Let's see....

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Garvell_Flugblaetter_05_02"); //Ah yes. Maybe I'll stop by Matteo's.
