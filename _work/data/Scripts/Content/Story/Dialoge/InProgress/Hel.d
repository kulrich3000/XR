...
{
	AI_Output(self, hero, "Info_Mod_Hel_Hi_19_00"); //(slanting) Ahh, invaders and new slaves for my servants. I'll feed on your blood.
...
{
	AI_Output(self, hero, "Info_Mod_Hel_GhuleFutsch_19_00"); //Ahh, be damned.
...
{
	AI_Output(self, hero, "Info_Mod_Hel_InKrypta_19_00"); //You're persistent. But all the more pleasure it will give me to dress with your guts the ceiling of my rooms.
	AI_Output(self, hero, "Info_Mod_Hel_InKrypta_19_01"); //(inviting) Inubis!
