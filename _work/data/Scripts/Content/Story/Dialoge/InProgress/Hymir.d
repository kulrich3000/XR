...
{
	AI_Output(self, hero, "Info_Mod_Hymir_Hi_16_00"); //Jestes wiec jednym z tych, o których wszyscy mówia. Wykonales dla nas wiele pracy.
	AI_Output(self, hero, "Info_Mod_Hymir_Hi_16_01"); //Nie mozemy jednak jeszcze wydobywac rudy, poniewaz w kopalni znajduja sie te dziwne kamienne potwory.
	AI_Output(self, hero, "Info_Mod_Hymir_Hi_16_02"); //Potrzebujemy troche wiecej czasu na przygotowanie sie, a potem bedziemy szturmowac kopalnie.
	AI_Output(self, hero, "Info_Mod_Hymir_Hi_16_03"); //Wróccie wiec pózniej.
...
{
	AI_Output(self, hero, "Info_Mod_Hymir_MineLos_16_00"); //Jestesmy juz gotowi. Dookola kopalni wciaz kreca sie kamienne potwory.
	AI_Output(self, hero, "Info_Mod_Hymir_MineLos_16_01"); //Teraz to od panstwa zalezy zniszczenie ich i otwarcie kopalni.
	AI_Output(self, hero, "Info_Mod_Hymir_MineLos_16_02"); //Idz do Granmaru, czeka na Ciebie w kopalni. Pomoze ci on w wykonaniu twojego zadania.
...
FUNC VOID Info_Mod_Hymir_MineFertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_01"); //To milo slyszec, wiec udalo Ci sie dostac do malej linii archprince.
	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_02"); //I prosze mi wierzyc, bardzo niewiele osób zdolalo to zrobic w tak krótkim czasie.
	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_03"); //Teraz stanowia Panstwo 10% dochodu kopalni. Pieniadze z Ole mozna otrzymac co tydzien.

	B_GiveInvItems	(self, hero, ItMi_Nugget, 5);

	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_04"); //Oczywiscie teraz dostajesz nowa zbroje.

	CreateInvItems	(hero, ItAr_Erzbaron_Blau, 1);

	B_ShowGivenThings	("Królewska zbroja arcyksiecia otrzymala");

	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_05"); //Nawiasem mówiac, Paladyn byl z mna tuz przed wami. Powiedzial, ze zawdziecza wam swoje zycie.
	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_06"); //Pan Andre wraz z milicja wyslal go osobiscie do Minentala. Powiedz im, zeby szpiegowali na orkach.
	AI_Output(self, hero, "Info_Mod_Hymir_MineFertig_16_07"); //Nawiasem mówiac, Lord Andre chcial ponownie z wami porozmawiac, ale mysle, ze jest jeszcze czas.
...
FUNC VOID Info_Mod_Hymir_Trent_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Trent_16_01"); //Co.....? Jeszcze nie dotarlismy jeszcze nawet do gonny. Moze Pan Andre posyla nam teraz nowych ludzi.
	AI_Output(self, hero, "Info_Mod_Hymir_Trent_16_02"); //W kazdym razie nalezy to swietowac. Udaj sie do Melcadoru i zaopatrz sie w bron rudy i swieze piwo.
	AI_Output(self, hero, "Info_Mod_Hymir_Trent_16_03"); //Nie ma juz dla Ciebie nic wiecej do zrobienia. Usiadz i ciesz sie zyciem tak samo jak ja!
...
{
	AI_Output(self, hero, "Info_Mod_Hymir_Eroberung_06_16_00"); //... i weszlismy do obozu......
};
...
{
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_00"); //Przeslanie od Hagena? Zastanawiam sie, czego od mnie chce od siebie odwaga.

	B_GiveInvItems	(hero, self, ItWr_HagenForHymir, 1);

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_01"); //Ha, nie daj mi sie smiac. Teraz, gdy jego tylek plonie, mamy go wyciagnac z ognia.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_02"); //Wszelkie prawa. A jak....? Jestes nowym kapitanem? Caly czas staje sie to przyjemniejsze.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_03"); //A co z Andre ---. Jedyny, który ma troche przyzwoitosci i kregoslupa?
	AI_Output(hero, self, "Info_Mod_Hymir_Treue_15_04"); //On nie zyje. Ofiaruje sie za miasto, gdy bylo zagrozone.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_05"); //(wstrzasy) Co.... on nie zyje? Dla miasta....?
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_07"); //Poswiecony? Nie mów mi nic.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_08"); //Hagen musial uzyc go jako pionka ofiary, aby potem uczynic z siebie szlachetnego zbawiciela.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_09"); //I teraz mamy wziac dla niego upadek. Tu wszystko sie konczy.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_10"); //Nie ma nawet przyzwoitosci, by sie pojawic, ale wysyla sprawnego chlopca.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue_16_11"); //Nie.... Nie. a teraz lepiej wydostac sie z moich oczu.
...
FUNC VOID Info_Mod_Hymir_Treue2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_00"); //Czy jest to mozliwe? Hagen, Ty tutaj?
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_02"); //l-- (znowu wychwytuje sie) Tak, otrzymalem Panski list.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_03"); //I nawet jesli stoisz tu przed mna, nie widze powodu, by w to wchodzic.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_04"); //Najlepiej wiesz, ze nasz pobyt w tej kolonii zawdzieczamy Tobie.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_05"); //A fakt, ze Andre zostawil swoje zycie pod twoim dowództwem nie do konca poprawia sytuacje.
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_08"); //(czyta) Aby rozpuscic roboty[....] maszyna mordercza[....] Ona wziela ich zycie od[...] nikt bez winy nie jest.....
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_09"); //Hmm, to jest wlasciwie pismo odreczne Andresa.... i wydaje mi sie, ze to co powiedziales mi o swoim losie jest prawda.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_10"); //W swietle tych wydarzen nie chce juz zasadniczo sprzeciwiac sie wspólpracy z miastem.
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_11"); //Z pewnoscia nie robie tego, aby zrobic ci przysluge, Hagen, ale dla dobra przykladu Andre nam dal.
	...
	AI_Output(self, hero, "Info_Mod_Hymir_Treue2_16_14"); //.... Zabiore Cie do miasta na kolejna odprawe.
    
	TRIA_Finish();

	AI_StopProcessInfos	(self);

	B_LogEntry	(TOPIC_MOD_MILIZ_TREUE, "Hymir teleportowal sie do miasta z Lordem Hagenem. Czasami powinienem zakonczyc.");
