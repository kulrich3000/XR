...
{
	AI_Output(self, hero, "Info_Mod_Cadar_Hi_16_00"); //Ach, nowe oblicze w naszym bagnie. Witamy.
	AI_Output(self, hero, "Info_Mod_Cadar_Hi_16_01"); //Jestem Cor Cadarem, duchowym przywódca naszej wspólnoty.
};
...
{
	AI_Output(self, hero, "Info_Mod_Cadar_Eroberung_16_02_00"); //Zaoferuje Ci kilka nowicjuszy spódnic. Udajecie udawac, ze wyruszacie na zablocona bartholo i jedziecie do obozu.
...
FUNC VOID Info_Mod_Cadar_Asylanten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_01"); //(uzywane) plany? Przyszlosc sama pokaze nam, co jest dla nas dostepne.
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_02"); //Tak dlugo, jak dlugo prowadzimy normalne zycie: kultywowanie rdestnicy, palenie tytoniu raz na jakis czas i dzielenie sie naszymi duchowymi doswiadczeniami.
	AI_Output(hero, self, "Info_Mod_Cadar_Asylanten_15_03"); //Nie planujesz wiec opuscic Minental?
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_04"); //Nie.
	AI_Output(hero, self, "Info_Mod_Cadar_Asylanten_15_05"); //A jak czujesz sie o innych grupach w Minental?
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_06"); //Wszyscy ci, którzy chca handlowac z nami sa goscmi powitanymi.
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_07"); //Slyszalem jednak, ze stary obóz stracil wiekszosc swojego dawnego statusu, a stosunki z nowym obozem nigdy nie byly tak silne, jak bysmy sobie tego zyczyli.
	AI_Output(hero, self, "Info_Mod_Cadar_Asylanten_15_08"); //Dziekujemy za informacje.
	AI_Output(self, hero, "Info_Mod_Cadar_Asylanten_16_09"); //Pozwólcie spac.... Niech gwiazdy beda dla Ciebie dobre.
...
FUNC VOID Info_Mod_Cadar_Woher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cadar_Woher_16_01"); //Zanim wrzucono mnie do zapory, bylem magikiem ognia wladcy.
	AI_Output(self, hero, "Info_Mod_Cadar_Woher_16_02"); //Interesowaly mnie jednak równiez inne kierunki magów. Szczególnie lubilem sie orkmagicznym, ale w zamian musialem go poprzec.
	AI_Output(self, hero, "Info_Mod_Cadar_Woher_16_03"); //W koncu okazalo sie, ze podparlem orki i wrzucilem mnie do zapory.
	AI_Output(self, hero, "Info_Mod_Cadar_Woher_16_04"); //Poszedlem wtedy do Bractwa, aby nauczyc sie tego rodzaju magii i wkrótce potem zostalem poslem Cor Kalom.
	AI_Output(self, hero, "Info_Mod_Cadar_Woher_16_05"); //Po jego smierci i smierci Y' Beriona bylem najwyzszym guru w obozie i w zwiazku z tym zostalem duchowym przywódca Bractwa.
};
...
FUNC VOID Info_Mod_Cadar_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cadar_Lehrer_16_01"); //Moge pokazac, jak uczyc sie czegos wiecej na podstawie twoich doswiadczen, z których mozesz skorzystac, aby zdobyc wiecej umiejetnosci.
...
FUNC VOID Info_Mod_Cadar_SchnellesLernen_Perk_Info()
{
	if (hero.lp > 4)
	{
		AI_Output(self, hero, "Info_Mod_Cadar_SchnellesLernen_Perk_16_00"); //Teraz bedziesz mógl czerpac wiecej wiedzy z wlasnego doswiadczenia. Uzywaj tej wiedzy madrze.
