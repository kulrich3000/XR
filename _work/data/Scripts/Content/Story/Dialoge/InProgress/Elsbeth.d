...
FUNC VOID Info_Mod_Elsbeth_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_01"); //I'm from the Old Camp. I didn't want it the way the Baron wanted it.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Hi_15_02"); //And then he kicked you out.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_03"); //Kind of. Landed with the bums out by the gate.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_04"); //At some point this Baldur came along and took me here.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Hi_15_05"); //Are you happy about it?
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_06"); //You bet. This is where they repeat you as a woman, even though they're rough guys.
...
{
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_00"); //I see you're always on the move.
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_02"); //And yet you're always friendly, it seems to me.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Ambi_15_03"); //Well, well. I can do it differently.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_04"); //Anyway, I find you sympathetic. You may call me Beth.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Ambi_15_05"); //Nice to meet you, Beth. Maybe I can do you a favor?
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_06"); //You can do that. I'm running out of wood for the stove.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_07"); //I could use some new branches. A dozen should do it.
...
FUNC VOID Info_Mod_Elsbeth_Holz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Holz_19_01"); //That's sweet. Thank you very much.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Holz_15_02"); //You're welcome, but I have to leave now.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Holz_19_03"); //Then I wish you success in your tasks.
