...
FUNC VOID Info_Mod_Friedel_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Hi_03_00"); //Jestem Friedel, ucze mlodych mezczyzn jak walczyc.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(hero, self, "Info_Mod_Friedel_Hi_15_01"); //Czy mozesz mnie czegos nauczyc?
		AI_Output(self, hero, "Info_Mod_Friedel_Hi_03_02"); //Tak dlugo, jak dlugo jestescie niedoswiadczeni, bede w stanie pokazac wam jedna lub dwie sztuczki.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_01"); //Nicei! To daloby nam trzeci uczestnik.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_02"); //Pozostale dwie osoby beda moimi praktykantami, którzy zdaja ostatnie egzaminy z polowania na szczury.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_03"); //Czy mozemy zatem wystartowac?
	AI_Output(hero, self, "Info_Mod_Friedel_Wettstreit_15_04"); //Chcialbym poznac zasady.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_05"); //Mozna to zaaranzowac!
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_06"); //Nad jeziorem zawsze sa szczury.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_07"); //Uczestnicy zaczynaja w tym samym czasie i musza zabic wszystkie szczury wokól jeziora.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_08"); //Kto odnosi najwieksze sukcesy, ten wygrywa i otrzymuje nagrode pieniezna.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_09"); //Kiedy bedziesz gotowy, mozemy zaczac.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_A_03_01"); //Nie trac wiec czasu!
...
FUNC VOID Info_Mod_Friedel_Wettstreit2_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_00"); //Z calym szacunkiem, nawet gdybym mial z wami trudny czas.
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_01"); //Zostaniesz za to wynagrodzony.
		...
		B_LogEntry	(TOPIC_MOD_KHORATA_WETTSTREIT, "Podnioslam nagrode. Wtedy przypuszczam, ze teraz moge wrócic do sluz.");
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_02"); //Dzis nie wystarczylo.

		if (Mod_REL_Wettstreit_Verloren == 0)
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_03"); //Ale poniewaz w tym roku mamy tak wiele szczurów, jutro bedziemy mogli rywalizowac. Moze to sprawi, ze odniesiesz wiekszy sukces.
...
{
	AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_00"); //Nowy w naszych szeregach. Oto kapital poczatkowy.
	...
	if (Mod_Verhandlungsgeschick > 0)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_02"); //Ma pani racje. Ale trzeba to zrobic!
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_03"); //To nie wystarczy do konca zycia! Idz do pracy!
		};
	};
};
...
FUNC VOID Info_Mod_Friedel_Unruhen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Unruhen_03_01"); //Wszystko w porzadku, nawet jesli nie ma racji.
...
FUNC VOID Info_Mod_Friedel_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Freudenspender_03_01"); //Czy kochasz mnie? Nie, nie chce!
};
...
FUNC VOID Info_Mod_Friedel_Lernen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Lernen_03_01"); //Czego chcesz sie nauczyc?
