...
{
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_00"); //Spójrzmy na to, nowe oblicze. Ale poczekaj.... przed upadkiem zapory, czy nie widzialem cie w nowym obozie?
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_01"); //Tak, to prawda. Wyglada na to, ze ma pan dobra pamiec.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_02"); //No cóz, nie szkodzi to, ze nie chce sie skonczyc jako cialo bagienne.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_03"); //Poniewaz najlepszym sposobem, aby sie nim stac jest zagubienie sie w moczarze.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_04"); //To trwa wiecej niz tylko ciche podeszwy, aby nie skonczyly sie jak tusze na pierwszym nalocie.
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_06"); //Ale jeden nie musi wykluczac drugiego.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_07"); //Kiedy juz nauczysz sie, jak dobrze dzialac, mozesz byc prawie tak spokojny podczas biegania, jak gdybys wykradal sie.
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_08"); //Dzwieki przydatne dla mnie.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_09"); //Tak, to nie jest wada. Ci, którzy opanuja ciche podeszwy, zyja lepiej.... i dluzej.
};
...
FUNC VOID Info_Mod_Wedge_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_01"); //No cóz, nie wiem.... Czy mozna nawet wymazac sie racjonalnie?
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_02"); //Nie zmarnuje cennego czasu z trampolina, która ma nogi golema.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_03"); //Mówienie o drogocennosci i czasie.... Jesli jestes naprawde powazny, mozesz poluzowac do 300 monet.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_04"); //Mówienie o drogocennosci i czasie.... Jesli jestes naprawde powazny, mozesz poluzowac 1800 monet.
	};
};
...
FUNC VOID Info_Mod_Wedge_Lernen_Info()
{
	...
	&& (hero.lp < 15)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_00"); //Zbierz niezbedne doswiadczenie, Greenbill.
	}
	...
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_01"); //I zloto? Nie ma bowiem mowy o smierci....
	}
	else if (Npc_GetTalentSkill(hero, NPC_TALENT_SNEAK) == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_02"); //Poczatkujacy, ucza sie jak dosc dobrze przeslizgiwac sie. Za pomoca swoich kroków zagluszales kazdy troll.
	}
	else
	{
		if (Mod_Schwierigkeit != 4)
		...
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_03"); //Godny czlowieka chce nauczyc sie, jak spokojnie i szybko postawic noge.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_04"); //Musisz sie upewnic, ze delikatnie nakladasz piete i równomiernie zwijasz stope.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_05"); //Miekkie buty równiez nie sa wada. Prosze pozwolic mi pokazac.

		AI_PlayAni	(self, "T_PLUNDER");

		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_06"); //Wiec teraz nie powinienes szumic podczas biegania.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_07"); //Baw sie z nowymi umiejetnosciami.
