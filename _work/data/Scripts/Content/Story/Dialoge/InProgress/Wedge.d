...
{
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_00"); //Look at that, a new face. But wait... before the barrier came down, didn't I see you in the new camp?
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_01"); //Yeah, that's right. You seem to have a good memory.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_02"); //Well, there's no harm in not wanting to end up as a bog body.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_03"); //Because the best way to become one is to get lost in the moor.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_04"); //It takes more than just quiet soles to not end up as carcasses on the first raid.
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_06"); //But one doesn't have to rule out the other.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_07"); //Once you've learned how to perform properly, you can be almost as quiet while running as if you were sneaking.
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_08"); //Sounds useful to me.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_09"); //Yes, it's not a disadvantage. Those who master the quiet soles live better... and longer.
};
...
FUNC VOID Info_Mod_Wedge_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_01"); //Well, I don't know... can you even sneak reasonably?
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_02"); //I won't waste my precious time with a trample that has the feet of a golem.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_03"); //Speaking of precious and time... if you're really serious, you'll be able to loosen up to 300 coins.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_04"); //Speaking of precious and time... if you're really serious, you'll be able to loosen 1800 coins.
	};
};
...
FUNC VOID Info_Mod_Wedge_Lernen_Info()
{
	...
	&& (hero.lp < 15)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_00"); //Collect the necessary experience, Greenbill.
	}
	...
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_01"); //And the gold?! For nothing is death...
	}
	else if (Npc_GetTalentSkill(hero, NPC_TALENT_SNEAK) == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_02"); //Beginners, learn how to sneak reasonably well. With your steps you drown out every troll.
	}
	else
	{
		if (Mod_Schwierigkeit != 4)
		...
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_03"); //All right, a worthy man wants to learn to put his foot down quietly and yet speedily.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_04"); //You have to make sure that you apply your heel gently and roll your foot evenly.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_05"); //Soft shoes are no disadvantage either. Let me show you.

		AI_PlayAni	(self, "T_PLUNDER");

		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_06"); //So, now you shouldn't make so much noise when running.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_07"); //Have fun with your new skill.
