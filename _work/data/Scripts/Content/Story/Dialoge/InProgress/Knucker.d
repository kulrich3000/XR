...
{
	AI_Output(self, hero, "Info_Mod_Knucker_Hi_22_00"); //Hej, niemowle, co ty tu robisz?
...
{
	AI_Output(self, hero, "Info_Mod_Knucker_Hi_D_22_00"); //(niezainteresowany) Tak Tak Tak....... Mozesz cos dla mnie zrobic. Mam strzalke na lapie. Chce, zeby pan ja pan wyciagnal.
...
FUNC VOID Info_Mod_Knucker_Hi_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Knucker_Hi_F_22_01"); //Wtedy bede cie pieczyl i zjesc.
...
FUNC VOID Info_Mod_Knucker_Hi_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Knucker_Hi_E_22_01"); //Ahh, tak samo lepiej. Wykonales dobra robote, ty duzy czlowiek. Mozesz przejsc teraz.
