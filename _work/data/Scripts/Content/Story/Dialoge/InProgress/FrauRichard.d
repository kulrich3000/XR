...
FUNC VOID Info_Mod_FrauRichard_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_Hi_19_01"); //Yes, thank you! What's happening?
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_Hi_19_03"); //Have you seen my husband? The rats kidnapped him and me.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_01"); //More or less. I'm not really comfortable here.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_02"); //The people - they are as cold as the air.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_03"); //Even during the day the village is extinct.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf2_19_01"); //I've done it many times before, but the way up to the stone circle is so long and arduous.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf2_19_02"); //Recently there have been reports of a band of robbers and missing hikers.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf3_19_01"); //In that case, I'd like to go back to Relendel.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf3_19_02"); //Because of me, we can leave right away. I don't have anything to hang on to.
...
{
	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_00"); //We seem to have been lucky. There's not a soul on the road today.
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_02"); //And for the second time, I'm in your debt. Thank you, thank you.

	B_GiveInvItems	(self, hero, ItMi_Gold, 100);

	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_03"); //Come visit me in Khorata sometime!
