...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_00"); //Hey, you're the guy who's supposed to be spying on us in the old camp.
	AI_Output(hero, self, "Info_Mod_Sylvio_Hi_15_01"); //Yes, I should.
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_02"); //I want to tell you something: If you get anything, you should tell me first before you run to Lee, understand?
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_03"); //With this you can become an orc hunter in no time and earn additional gold and ore. We understand each other?
...
FUNC VOID Info_Mod_Sylvio_InfosAnLee_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_00"); //Didn't I tell you to come to me first?
	};

	AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_01"); //One of my best orc hunters was exposed and that will turn to me. And I don't like that at all.
	AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_02"); //Better watch out in the future if you don't make powerful enemies.
};
...
FUNC VOID Info_Mod_Sylvio_Infos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Infos_03_02"); //That's interesting. Go to Sentenza. He'll give you further instructions.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_00"); //By the way, there's another way for you to prove yourself.
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_01"); //Go to Bullco. He'll tell you everything else.
	AI_Output(hero, self, "Info_Mod_Sylvio_Frauenraub_15_02"); //But Bullco is not an orcish hunter.
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_03"); //That's right, he's a dragon hunter. So what? Working for me is worthwhile. You'll find him outside the pub during the day.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaWeg_03_00"); //What?! You here? And unaccompanied?
	AI_Output(hero, self, "Info_Mod_Sylvio_VelayaWeg_15_01"); //I'm afraid it didn't work out.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaWeg_03_02"); //Didn't work?! After you've done that, there's probably a lot of other things that won't work out for you. Get out of my sight.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_00"); //Well, look who they brought us here. She'll give me a good time.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_01"); //You've done your thing more than well. You've come a lot closer to joining the ranks of the Orc hunters.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_02"); //Here's your reward. You've earned it fair.
...
FUNC VOID Info_Mod_Sylvio_Wettstreit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_01"); //What...? What do you say?
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_03"); //You wretch dares... you'll regret this.
	AI_Output(hero, self, "Info_Mod_Sylvio_Wettstreit_15_04"); //Just wanted to let you know and get back to Lee.
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_05"); //Okay, if you want a contest, I want you to have one.
};
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_AtStonehenge_03_00"); //You here? Damn it, where's my key and my slogan.
	AI_Output(self, hero, "Info_Mod_Sylvio_AtStonehenge_03_01"); //(To the hero) Well, it looks like I'm gonna have to take your key. You shouldn't have messed with me.
