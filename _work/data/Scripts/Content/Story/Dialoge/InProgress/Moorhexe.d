...
{
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_00"); //Co to jest zywa osoba w chuliganskim bagnie i widzi mnie!
	AI_Output(hero, self, "Info_Mod_Moorhexe_Hi_15_01"); //Wydaje sie wiec, ze......
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_02"); //Co w imieniu Beliara Pan tutaj robi? Czego chcesz?
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_03"); //Z pewnoscia nie skarby bagna, w przeciwnym razie zostalbys oslepiony przez chciwosc i zostawilbys swoje zycie w blotnistym stawie.
	AI_Output(hero, self, "Info_Mod_Moorhexe_Hi_15_04"); //Szukam przedmiotu, który prawdopodobnie dal Ci magik.
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_05"); //Co? Grzebien swiatla? Na swoja czesc przysiegam, ze bede go bronil. Nigdy go nie dostaniesz.
