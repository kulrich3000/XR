...
{
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Hi_16_00"); //Adanos must have led us here.
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Hi_16_01"); //I hope we can continue to be aware of his protective hand.
...
FUNC VOID Info_Mod_Vatras_IR_GehtLos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_IR_GehtLos_16_00"); //Well, the days of youthful agility and fast legs lie many years back with me.
	AI_Output(self, hero, "Info_Mod_Vatras_IR_GehtLos_16_01"); //I will stay here, pray for the success of the mission and watch over the ship. May Adanos keep you safe.
...
FUNC VOID Info_Mod_Vatras_IR_Kram_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Kram_16_01"); //I can help you increase your magical power and provide you with some of my spell rolls and potions.
};
...
FUNC VOID Info_Mod_Vatras_IR_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_IR_Lernen_BACK_16_01"); //Your magic skills are so good now, I can't teach you anything.
	};
	Info_ClearChoices	(Info_Mod_Vatras_IR_Lernen);
};
