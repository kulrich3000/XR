...
{
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Hi_16_00"); //Adanos musial nas tu poprowadzic.
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Hi_16_01"); //Mam nadzieje, ze nadal bedziemy swiadomi jego ochronnej reki.
...
FUNC VOID Info_Mod_Vatras_IR_GehtLos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_IR_GehtLos_16_00"); //Cóz, czasy mlodzienczej zrecznosci i szybkosci nóg leza u mnie wiele lat wstecz.
	AI_Output(self, hero, "Info_Mod_Vatras_IR_GehtLos_16_01"); //Zostane tu, pomodle sie za sukces misji i bede pilnowal statku. Niech Adanos zapewni Ci bezpieczenstwo.
...
FUNC VOID Info_Mod_Vatras_IR_Kram_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_IR_Kram_16_01"); //Moge Ci pomóc zwiekszyc swoja magiczna moc i dostarczyc ci niektóre moje zaklecia w rolkach i eliksirach.
};
...
FUNC VOID Info_Mod_Vatras_IR_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_IR_Lernen_BACK_16_01"); //Twoje magiczne umiejetnosci sa teraz tak dobre, ze nie moge cie niczego nauczyc.
	};
	Info_ClearChoices	(Info_Mod_Vatras_IR_Lernen);
};
