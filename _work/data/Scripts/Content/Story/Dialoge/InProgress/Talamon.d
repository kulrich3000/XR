...
FUNC VOID Info_Mod_Talamon_Hi_Info()
{
	...
	if (Kapitel < 5)
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Hi_16_01"); //I'm Talamon, guardian of the library.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Hi_16_02"); //I'm Talamon, deputy for Pyrokar.
	};
};
...
{
	AI_Output(self, hero, "Info_Mod_Talamon_Patherion_16_00"); //Good of you to come, brother! Garan sent me a messenger. Your presence in Patherion is welcome.
...
FUNC VOID Info_Mod_Talamon_Befoerderung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Talamon_Befoerderung_16_01"); //You have proved your loyalty to Innos and since Pyrokar has given me the authority to do so, I hereby declare you a priest of the order Innos'.
	AI_Output(self, hero, "Info_Mod_Talamon_Befoerderung_16_02"); //I hope you don't abuse the power that you have gained through this rank.
	AI_Output(self, hero, "Info_Mod_Talamon_Befoerderung_16_03"); //Here's your new robe.
...
FUNC VOID Info_Mod_Talamon_Ruestung_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_16_02"); //I hear there's a fire snapper at the Minental pass. With his skin, I could certainly improve your fire retreat a little bit.
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_16_03"); //I have heard that on the way to the excavation site the water magician is said to be a firefighter. With its fur I could certainly improve your fire magic robe a little bit.
...
FUNC VOID Info_Mod_Talamon_AllesKlar() {
	AI_Output(self, hero, "Info_Mod_Talamon_AllesKar_16_00"); //All clear.
};
...
FUNC VOID Info_Mod_Talamon_Ruestung_NOV_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_NOV_S_16_02"); //You must have a fire drill or I won't be able to fix it for you.
	}
	else if (Npc_HasItems(hero, ItAt_Feuersnapperhaut) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_NOV_S_16_03"); //If you don't have snapper skin on you, I can't improve your robe.
	};
...
FUNC VOID Info_Mod_Talamon_Ruestung_KDF_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_KDF_S_16_02"); //You must have a fire magic robe or I won't be able to fix it for you.
	}
	else if (Npc_HasItems(hero, ItAt_FireShadowFur) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_KDF_S_16_03"); //If you don't have the firecracker fur, I can't improve your robe.
	};
...
{
	AI_Output (self, hero,"Info_Mod_Talamon_FirstWarn_16_00"); //You're not allowed to go any further. Turn back!
...
{
	AI_Output (self, hero,"Info_Mod_Talamon_SecondWarn_16_00"); //Innos will judge his anger upon you if you do not turn back!
...
{
	AI_Output(self, hero, "Info_Mod_Talamon_EXIT_16_00"); //To honor magic!
