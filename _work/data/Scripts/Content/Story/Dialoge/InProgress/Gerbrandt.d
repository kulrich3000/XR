...
FUNC VoID Info_Mod_Gerbrandt_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Hi_03_01"); //Nie martw sie o mnie.
};
...
FUNC VOID Info_Mod_Gerbrandt_Person_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_01"); //To prawda. Mialem przyjaciela okolo dwa tygodnie temu. Wracal do domu dopiero pózno w nocy.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_02"); //Nastepnego dnia chcialem go zobaczyc, nie byl tam. Natychmiast powiadomilem milicje, ale oni niczego nie znalezli.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_03"); //Potem przyszedl do mnie Vatras, magik wody i kilku jego zwolenników i zapytal mnie o mojego przyjaciela.
};
...
FUNC VOID Info_Mod_Gerbrandt_Infos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_01"); //Zadal mi wiele pytan.
	AI_Output(hero, self, "Info_Mod_Gerbrandt_Infos_15_02"); //Jakie pytania?
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_03"); //Najpierw zapytal chlopaka, a ja mu podalem jego imie Fred.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_04"); //Potem chcial wiedziec, o której godzinie wyjechal. Nie znalem dokladnego czasu, bo juz wypilismy troche wina, ale bylo to okolo godziny 11.00.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_05"); //Na koniec zapytal, gdzie mieszkal Fred. Potem poprowadzilem go do domu.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_06"); //To wszystko.
...
FUNC VOId Info_Mod_Gerbrandt_Wo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Wo_03_01"); //Z pewnoscia, daj mi znac, kiedy jestesmy gotowi na wyjazd.
};
...
FUNC VOID Info_Mod_Gerbrandt_Los_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Los_03_01"); //Dobrze, podazaj za mna.
...
{
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Da_03_00"); //Oto jestesmy.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Da_03_01"); //Rozejrzyjcie sie, wróce. Jesli potrzebujesz pomocy, wiesz gdzie mnie znalezc.
...
FUNC VOID Info_Mod_Gerbrandt_Cornelius_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Cornelius_03_01"); //Czy moze pan to udowodnic?
	AI_Output(hero, self, "Info_Mod_Gerbrandt_Cornelius_15_02"); //Nie.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Cornelius_03_03"); //Wtedy nie traccie czasu z waszymi oskarzeniami lub wezme milicje.
...
FUNC VOID Info_Mod_Gerbrandt_SonjaFreier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_SonjaFreier_03_01"); //Cóz za pytanie! Oczywiscie nie!
};
