...
{
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_00"); //(yawns) Good morning, Your Majesty. Is it time to celebrate again?
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_02"); //Yeah, I remember yawning. She tasted my special drink, hehe. Nobody can take my specialty drunk.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_03"); //Give it to me.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_04"); //No.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_05"); //What? No.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_06"); //I can't do that. I don't have any more.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_07"); //Then make some.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_08"); //Of course, as soon as I'm awake. It takes a while to do this.
...
FUNC VOID Info_Mod_HofstaatTrunkenbold_Geliebte_B()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_01"); //Yes, Your Highness. You need drunkenness, viiiieeel drunkenness. Then you'll need a strange green fruit, that's all.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_15_02"); //Where do I get the drunk?
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_03"); //You can get it in a town. The foreigners call drink liquor or juniper. ts... ridiculous.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_15_04"); //What green fruit?
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_05"); //It is called melon. You'll get them in Khorata. Pour the drunk into the melon at an alchemy table.
...
FUNC VOID Info_Mod_HofstaatTrunkenbold_Geliebte_A()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_A_28_01"); //Good, good, good. (yawns) I'm on my way.

	AI_GotoWP	(self, "REL_262");
	AI_GotoWP	(self, "REL_272");

	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_A_28_02"); //It's not the time of the festival... and you're not the king! STIIRB!
