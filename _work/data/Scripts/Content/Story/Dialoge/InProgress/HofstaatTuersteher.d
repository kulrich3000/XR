...
{
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_00"); //Hey! You can't go through here!
	AI_Output(hero, self, "Info_Mod_HofstaatTuersteher_Hi_15_01"); //Why not?
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_02"); //Only members of the court are allowed in!
	AI_Output(hero, self, "Info_Mod_HofstaatTuersteher_Hi_15_03"); //Court?
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_04"); //Yeah, man! The rabble has no place in the castle!
	AI_Output(hero, self, "Info_Mod_HofstaatTuersteher_Hi_15_05"); //And how do I become a member of the court?
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_06"); //First of all, you must obtain citizenship for our empire here.
	AI_Output(hero, self, "Info_Mod_HofstaatTuersteher_Hi_15_07"); //How do I become a citizen?
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_08"); //You have two choices: marry one of us or open a shop.
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_09"); //Oh, by the way, if you were planning to get married, I wouldn't stick to the peasants.
	AI_Output(hero, self, "Info_Mod_HofstaatTuersteher_Hi_15_10"); //Why not?
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_Hi_05_11"); //Peasants are just rabble! You will be considered a rabble, but not a member of the state. To do this, you would have to move into a house with the farmer's wife...
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatTuersteher_NachFest_05_00"); //Hey, aren't you the royal pool attendant? The King is looking for you.
...
{
	AI_Output (self, hero,"Info_Mod_HofstaatTuersteher_FirstWarn_05_00"); //HALT! You're not allowed in here yet.
...
{
	AI_Output (self, hero,"Info_Mod_HofstaatTuersteher_SecondWarn_05_00"); //I'll tell you one last time. One more step and you'll enter the world of pain!
...
func void Info_Mod_HofstaatTuersteher_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_HofstaatTuersteher_Attack_05_00"); //You asked for it...
