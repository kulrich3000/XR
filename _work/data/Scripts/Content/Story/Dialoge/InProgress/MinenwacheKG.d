...
{
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_00"); //Zatrzymaj sie! Nikt nie moze wejsc do kopalni bez wyraznej zgody Hymira.
	AI_Output (hero, self, "Info_Mod_MinenwacheKG_Hi_15_01"); //Dlaczego nie wolno jeszcze nikomu w mojej kopalni?
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_02"); //Dla wlasnego bezpieczenstwa. W kopalni znajduja sie potwory, o których nic nie jest jeszcze znane, a jesli mnie o to poprosza, to byli oni odpowiedzialni za upadek kopalni.
	AI_Output (hero, self, "Info_Mod_MinenwacheKG_Hi_15_03"); //Jakie to sa potwory, jak minecrawler?
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_04"); //Nie wiemy, co jest glebsze w kopalni.
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_05"); //Bernd ocenia, ze kamienne potwory, które uniemozliwily nam wejscie do kopalni, uciekaja przed czyms.
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_06"); //Ze swej strony wierze, ze kamienne potwory maja magiczne pochodzenie, w przeciwnym razie nie mielibysmy z nimi zadnych problemów.
};
...
{
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_FirstWarn_05_00"); //HALT! Nikt nie moze w tym czasie wejsc do kopalni.
...
{
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_SecondWarn_05_00"); //Opowiem ci to po raz ostatni. Jeszcze jeden krok i wejdziesz w swiat bólu!
...
func void Info_Mod_MinenwacheKG_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_Attack_05_00"); //Poprosil pan o to.....
