...
{
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_00"); //Stop! No one is allowed into the mine except with express permission from Hymir.
	AI_Output (hero, self, "Info_Mod_MinenwacheKG_Hi_15_01"); //Why isn't anyone allowed in the mine yet?
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_02"); //It's for your own protection. There are monsters in the mine, about which nothing is yet known, and if you ask me, they were responsible for the collapse of the mine.
	AI_Output (hero, self, "Info_Mod_MinenwacheKG_Hi_15_03"); //What kind of monsters are they, like a minecrawler?
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_04"); //We don't know what's deeper in the mine.
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_05"); //Bernd estimates that the stone monsters who prevented us from entering the mine are fleeing from something.
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_05_06"); //For my part, I believe that the stone monsters have a magical origin, otherwise we wouldn't have had any problems with them.
};
...
{
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_FirstWarn_05_00"); //HALT! No one is allowed to enter the mine at this time.
...
{
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_SecondWarn_05_00"); //I'll tell you one last time. One more step and you'll enter the world of pain!
...
func void Info_Mod_MinenwacheKG_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_Attack_05_00"); //You asked for it...
