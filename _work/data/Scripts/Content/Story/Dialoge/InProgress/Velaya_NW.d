...
{
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_00"); //You can't have that, can you?
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_01"); //Ohh, I'm surprised to find you here too...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_02"); //Well, I couldn't be here without you, I would still be sitting in the valley of the river Minental, I would let myself be gawked in the bath and share my bed with the ore barons.... even if it wasn't as bad as it was in Gomez's day.
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_03"); //Hmm, that brings back memories...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_04"); //What do you say?
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_06"); //Sea voyage? The big wide world? How wonderful...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_07"); //Oh, if only I could go with you...
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_10"); //Friendly, ironic. Just listen to the gentleman. I have learned a lot in the last weeks....
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_11"); //Well, I guess you don't mean the fieldwork...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_12"); //Well, with my bow I can shoot out the eye of a boar at 10m...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_13"); //... and intrusive guys with the sword to show restraint when it goes where it hurts....
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath2_39_01"); //Great! And the ship, is that the fantastic big one in the back of the harbour?
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath2_39_02"); //Man, I gotta get a closer look at this.
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath3_39_01"); //Too bad. I'll go back then. You know where to find me if there's ever gonna be a seat left.
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath4_39_01"); //Very well, I'll be back at the harbour.
