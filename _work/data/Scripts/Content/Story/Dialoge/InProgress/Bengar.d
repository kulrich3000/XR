...
FUNC VOID Info_Mod_Bengar_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bengar_Hi_05_01"); //I'm Bengar, farmer of this farm.
};
...
FUNC VOID Info_Mod_Bengar_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_05_01"); //I just lost cars and men in a robbery a few days ago. I'm not taking that chance again!
	AI_Output(hero, self, "Info_Mod_Bengar_Aufgabe_15_02"); //That's why I'm here.
	AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_05_03"); //Like this? You want to walk alone and loaded to town?
	AI_Output(hero, self, "Info_Mod_Bengar_Aufgabe_15_04"); //Wouldn't be the first time.
	AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_05_05"); //All right, if you mean... I'll get 150 gold.
...
FUNC VOID Info_Mod_Bengar_Aufgabe_C()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_C_05_01"); //100 gold, then. The main thing is that you let something grow over.
	...
	{
		AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_C_05_02"); //Don't bullshit me, all right?
...
FUNC VOID Info_Mod_Bengar_Aufgabe_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_B_05_01"); //And here's the bread.
...
FUNC VOID Info_Mod_Bengar_Aufgabe_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Bengar_Aufgabe_A_05_01"); //(mockingly) Well, that's what I call advance planning! Come back when you get the gold.
...
{
	AI_Output(self, hero, "Info_Mod_Bengar_Kakos_05_00"); //Thank you very much. I can't believe what you did on that giant.
	AI_Output(self, hero, "Info_Mod_Bengar_Kakos_05_01"); //Worked us day and night, eating the hair off our heads, that bastard.
	AI_Output(self, hero, "Info_Mod_Bengar_Kakos_05_02"); //We couldn't have lasted much longer.
	AI_Output(self, hero, "Info_Mod_Bengar_Kakos_05_03"); //Here, take the treasure of the giant to thank him, which we should polish up for him.

	B_GiveInvItems	(self, hero, ItMi_Riesenschatz, 1);

	AI_Output(self, hero, "Info_Mod_Bengar_Kakos_05_04"); //(laughs spitefully) Where he is now, he won't need it anymore.
