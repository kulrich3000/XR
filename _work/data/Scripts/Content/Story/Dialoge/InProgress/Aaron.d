...
FUNC VOID Info_Mod_Aaron_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_01"); //Damn Beliar pendant! For a long time I tried to kill you, and now you come to church with me?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_02"); //I will not desecrate this holy place with your blood!
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_03"); //You call me Beliar Pendant? What makes you think I belong to Beliar?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_04"); //(surprised silence)
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_05"); //Is it possible Tojan told you that?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_06"); //How do you know that?
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_09"); //(surprised) What?
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_10"); //Tojan's playing the wrong game with us.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_11"); //You're just trying to mess with me so you can ram your knife through my back!
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_13"); //HA! I knew it. You must be a black magician. Every one of our brothers knows that this is not the most sacred place of the Innos Church. It's....
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_14"); //The chapel on the hill. I came through this chapel.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_15"); //You're lying!
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_17"); //... my diary? You were actually there. Then you can't be a Beliar pendant. Then.... Wasn't the monastery infiltrated?
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_18"); //Yes, I'm afraid so. But someone I wouldn't have suspected.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_19"); //You mean...
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_20"); //... Tojan.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_21"); //You're right. You're right. Everything fits.

	B_Say	(hero, self, "$WASMACHENWIRJETZT");

	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_22"); //We're gonna set him up. Come to the marketplace tomorrow night.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_23"); //Before that you should go to Tojan and point him out to me.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_00"); //There you are!

	B_Say	(hero, self, "$WASMACHENWIRJETZT");

	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_01"); //We'll find out from Tojan why he's here in the monastery.
	AI_Output(hero, self, "Info_Mod_Aaron_Falle_15_02"); //And how are you gonna do that?
	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_03"); //With a trick. We'll play to him that you killed me.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_KillTojan_03_00"); //Move aside, I'll kill him now!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_00"); //It's true.... He was my son.
	AI_Output(hero, self, "Info_Mod_Aaron_TojanDead_15_01"); //Then you're Ragon's son?
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_02"); //Yes... And my name is not Aaron, it's Garan.
	AI_Output(hero, self, "Info_Mod_Aaron_TojanDead_15_03"); //And the Witch Queen?
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_04"); //I don't exactly remember her.... Something is still missing in my memory.... But that doesn't matter now.
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_05"); //Now I must return to my place in the Innos Church. I will destroy the barrier with my four brothers.
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_06"); //I don't know how I can ever thank you!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_00"); //Ah, hello, brother. As you can see, I took my father's place.
	AI_Output(hero, self, "Info_Mod_Aaron_Barriere_15_01"); //I'm glad to see that.
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_02"); //We're considering a spell to destroy the barrier.
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_03"); //It shouldn't take us more than a day. Come back this time tomorrow.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_00"); //It is done, the barrier is destroyed!
	AI_Output(hero, self, "Info_Mod_Aaron_BarriereWeg_15_01"); //That's good news.
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_02"); //Indeed, brother. You can now return to Khorinis. Take these two runes.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_03"); //With them you can teleport to the chapel and here in the church.
...
FUNC VOID Info_Mod_Aaron_Back_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_00"); //Well, as you may know, the council of the gods has been called. That means the black mages can't besiege us any more.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_01"); //And why are they here at the monastery?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_02"); //Well, unfortunately, we're still under siege, but not by the black mages.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_03"); //Then who did?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_04"); //From the witches.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_05"); //What? Of witches? You mean from the mother of Tojan?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_06"); //It looks that way, yeah.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_07"); //Yeah, but the black mages don't really care, do they?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_08"); //Not exactly. The witches have long been allies of the black magicians.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_09"); //That is, if the witches attack us, it would be no different than if the black mages themselves attacked us.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_10"); //And that forces them to help us, so to speak.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_11"); //Exactly. Actually, we wouldn't accept this help, but the witches are in an overwhelming number that we wouldn't be able to manage on our own.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_12"); //I understand. So what are you gonna do now?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_13"); //Well, it's a good thing you just got here. The witches have taken over the altogether five camps of the black magicians.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_14"); //And you will attack the witches there.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_16"); //Of course, not alone. A group is already waiting for your orders in the monastery courtyard!
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_17"); //Now hurry up. The sooner you destroy the camps, the better!
...
FUNC VOID Info_Mod_Aaron_Hexen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_01"); //That should be enough for now. But now we must act quickly!

	B_Say	(hero, self, "$WASMEINSTDU");

	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_03"); //Cut off the snake's head! We must destroy the Witch Queen.
	AI_Output(hero, self, "Info_Mod_Aaron_Hexen_15_04"); //So you mean the...?
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_05"); //Yes, Tojan's mother. She'll pay for everything now!
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_06"); //I'm ordering you to do this job, brother. Be strong!
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_07"); //Now go destroy the Witch Queen. She settled in the old tower. But watch out, she's under heavy guard.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_00"); //You're back already? Did you destroy the Witch Queen?
	AI_Output(hero, self, "Info_Mod_Aaron_Door_15_01"); //No. I can't get through the door.
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_02"); //Did you try to break it?
	AI_Output(hero, self, "Info_Mod_Aaron_Door_15_03"); //Yeah, but it didn't work.
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_04"); //Well, then I'll come with you and open the door.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_00"); //Strange...
	AI_Output(hero, self, "Info_Mod_Aaron_DoorIn_15_01"); //That didn't look very difficult now.
	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_02"); //It wasn't. Whatever. We have to keep moving. AH!

	B_Say	(hero, self, "$WASISTDENN");

	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_03"); //I lost my rune. She must still be down the stairs. I'll go and get them quick.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Blut_03_00"); //Don't you need both our blood to reawaken our mother?
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Kill_03_00"); //Come on, let's kill them!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_00"); //Thank you, my friend. Without you, I would never have found out who I really am.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_01"); //I'd like to reward you richly.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_02"); //But I can't give you much, you have to be satisfied with this gift.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_03"); //This, my friend, is my father's legacy. What he's been looking for all his life. The sixth tear of Inno's.
	AI_Output(hero, self, "Info_Mod_Aaron_Party_15_04"); //He actually found her?
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_05"); //Yeah. before he got involved with my mother. You shall have her.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_06"); //Now let's celebrate!
