...
{
	AI_Output(self, hero, "Info_Mod_Serra_Hi_19_00"); //Hello stranger. You must have come a long way, I've never seen you around here before.
	AI_Output(hero, self, "Info_Mod_Serra_Hi_15_01"); //Yes, my place of origin is actually a long way off.
	AI_Output(self, hero, "Info_Mod_Serra_Hi_19_02"); //You must have done many adventures and killed countless monsters.... you know, that kind of thing looks like you to a handsome guy.
	AI_Output(hero, self, "Info_Mod_Serra_Hi_15_03"); //Yeah, that's a good point.
	AI_Output(self, hero, "Info_Mod_Serra_Hi_19_04"); //Hmm, you know, I've got a heavy package on me right now.
	AI_Output(self, hero, "Info_Mod_Serra_Hi_19_05"); //If you wear it for me and accompany me to my house, I would also reward you for this good deed.
	AI_Output(hero, self, "Info_Mod_Serra_Hi_15_06"); //Okay, let's see what we can do.
	AI_Output(self, hero, "Info_Mod_Serra_Hi_19_07"); //Here. It's not far away, either.
...
{
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_00"); //We're already there. Thank you for your selfless act of carrying the package.

	B_GiveInvItems	(hero, self, ItMi_SeraPaket, 1);

	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_01"); //You're a great man. Here's some gold coins for your reward.

	B_GiveInvItems	(self, hero, ItMi_Gold, 100);

	AI_Output(hero, self, "Info_Mod_Serra_AtHome_15_02"); //Thanks.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_03"); //Oh, if only all men were as good and generous as you.
	AI_Output(hero, self, "Info_Mod_Serra_AtHome_15_04"); //Why?
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_05"); //Oh, there's this man, his name is Alvar. An impossible man, a bully and a brute.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_06"); //He just won't leave me in peace... He even harassed me several times.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_07"); //I don't dare to go to the village shaman to accuse his behaviour.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome_19_08"); //Alvar would take terrible revenge on me.
...
{
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_00"); //Thank you very much. Then we could finally feel safe again.
	AI_Output(hero, self, "Info_Mod_Serra_AtHome2_15_01"); //What can I do? Strain him?
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_02"); //No, that wouldn't do any good. Then he could get worse for revenge.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_03"); //It should be something that embarrasses him in court and prevents him from ever harming a woman in the village again.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_04"); //Yeah, if you could bring us his diary.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_05"); //Maybe he kept something there about his misdeeds. Then he could be convicted.
	AI_Output(hero, self, "Info_Mod_Serra_AtHome2_15_06"); //His diary.... that could be arranged.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_07"); //Thank you so much. You don't know how much you're helping us with this.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_08"); //You should find it on his desk somewhere.
	AI_Output(self, hero, "Info_Mod_Serra_AtHome2_19_09"); //Good luck to you. We are deeply indebted to you.
...
{
	AI_Output(self, hero, "Info_Mod_Serra_AlvarTagebuch_19_00"); //You're back! Do you have the diary, my hero?
	...
	AI_Output(self, hero, "Info_Mod_Serra_AlvarTagebuch_19_02"); //Great, you're the biggest. Let me see that.
	AI_Output(self, hero, "Info_Mod_Serra_AlvarTagebuch_19_03"); //There must be something to find. You just have to read it carefully.
	AI_Output(hero, self, "Info_Mod_Serra_AlvarTagebuch_15_04"); //All right, all right. Good luck to you.
	AI_Output(self, hero, "Info_Mod_Serra_AlvarTagebuch_19_05"); //Yes, your selfless actions should be an example to all others.
...
{
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_19_00"); //Ahh, there's my hero.
	AI_Output(hero, self, "Info_Mod_Serra_AlvarDead_15_01"); //What's the deal with Alvar?
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_19_02"); //Hypocritical. What? Oh, you mean the terrible incident. Yes, the poor thing. He doesn't deserve it.
	AI_Output(hero, self, "Info_Mod_Serra_AlvarDead_15_03"); //What are you playing, what do you have to do with it?
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_19_04"); //(innocent) Nothing, nothing at all. It was the snow ghosts.... he was just too careless.
...
FUNC VOID Info_Mod_Serra_AlvarDead_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_B_19_01"); //I don't know what you mean.
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_B_19_02"); //It was you who stole his diary. There are witnesses.
	AI_Output(self, hero, "Info_Mod_Serra_AlvarDead_B_19_03"); //So you better be careful who you blame. If you don't do that, you may cause discontent in the village.
...
{
	AI_Output(self, hero, "Info_Mod_Serra_Traenenkristall_19_00"); //What, you here? Knatus, stop him!
	...
	AI_Output(self, hero, "Info_Mod_Serra_Traenenkristall_19_02"); //Me and Malfama cast a damage spell on Thys to pretend he was sick.
	AI_Output(self, hero, "Info_Mod_Serra_Traenenkristall_19_03"); //And now we're going to poison him to finally get power over this miserable village.
	AI_Output(self, hero, "Info_Mod_Serra_Traenenkristall_19_04"); //The inhabitants have fallen for all our intrigues and eat us out of our hands like stupid asses.
	AI_Output(self, hero, "Info_Mod_Serra_Traenenkristall_19_05"); //Knatus, the idiot, we've even dressed him to such an extent that he's ready to kill you....
