...
FUNC VOID Info_Mod_Sly_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Hi_28_01"); //Just take it easy, bro. Why don't you sit down and have some fun with us?
};
...
FUNC VOID Info_Mod_Sly_WasPassiert_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_WasPassiert_28_01"); //Nothing else... I think. As long as Cutter doesn't put us to work in the fields, we can't do anything.
	AI_Output(self, hero, "Info_Mod_Sly_WasPassiert_28_02"); //All right, now and then, somebody's going hunting. But I've never been able to do that before, and I don't want to end up as a wolf food.
};
...
FUNC VOID Info_Mod_Sly_LagerLeerer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_01"); //A little bit, yeah. Most people don't know what has become of them.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_02"); //Some of them wanted to go hunting and never came back.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_03"); //Either the poor bastards got hit, or the scumbags got out of the way.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_04"); //Therefore, we are not allowed to leave the camp without permission.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_05"); //Of course, if you really want to get out, you can't be hindered by the ban.
};
...
FUNC VOID Info_Mod_Sly_Arena_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_01"); //The arena would be something for me.... Whenever there are fights, I imagine I'm one of the fighters.
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_02"); //But I am just a simple shadow and I haven't had a sword in my hand for a long time.
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_03"); //I used to be good once, I was one of the best in the camp. But now?
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_04"); //Like me, they clean up the arena for breakfast.
};
...
FUNC VOID Info_Mod_Sly_Arena2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_01"); //You look like you got something in the box. I don't care about him.
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_02"); //If I succeed at the arena, you'll be a part of the profits.
	AI_Output(hero, self, "Info_Mod_Sly_Arena2_15_03"); //Fine. When do you want to start?
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_04"); //Let me get all sober first. Tomorrow morning we can, uh, meet on the lawn between the small pond and the marketplace.
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_05"); //There should be enough room.
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_00"); //Come on, come on. I'm already hot! How do we start?
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_03"); //Walking? I thought we were perfecting my swordplay?
	AI_Output(hero, self, "Info_Mod_Sly_Arena3_15_04"); //So you can make a punch and then be out of breath? Get on your feet!
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_05"); //All right, if I have to...
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena4_28_00"); //Ah, I'm dying!
	AI_Output(hero, self, "Info_Mod_Sly_Arena4_15_01"); //Before that, we have to duel. Do you have a gun?
	AI_Output(self, hero, "Info_Mod_Sly_Arena4_28_02"); //Yeah, yeah, yeah, all of it. Got something for you, too, so you don't hurt me too much.
...
FUNC VOID Info_Mod_Sly_Arena5_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_28_01"); //If by feelings you mean pain, it's definitely pain.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_28_02"); //Do you have any more tips for me?
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_00"); //Good. Thank you for your help. I think I'm getting it out. I'm gonna tell Scatty to put me on the list.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_01"); //If I win, you get half my paycheck.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_02"); //Now I'm going to practice a little more.
...
FUNC VOID Info_Mod_Sly_Arena6_Info()
{
	if (Mod_Sly_Arena == 5)
	{
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_00"); //Too bad I almost beat that caranto. This calls for revenge!
		AI_Output(hero, self, "Info_Mod_Sly_Arena6_15_01"); //So you're sticking with it?
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_02"); //Of course! Just get him dressed warm!

		B_GivePlayerXP	(50);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_03"); //Man, without your defensive advice, I wouldn't have cracked Gor Karanto. Tight, but deserved, I'd say.
		AI_Output(hero, self, "Info_Mod_Sly_Arena6_15_04"); //Congratulations.
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_05"); //Here's your share.

		B_GiveInvItems	(self, hero, ItMi_Gold, 150);

		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_06"); //I'm already looking forward to my next duel.
...
FUNC VOID Info_Mod_Sly_SLDSpy_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_01"); //Why do you ask?
	...
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_03"); //Ahh, a fresh resinous stem.

	B_UseItem	(self, ItMi_Joint);

	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_04"); //Oh, yes, about the news. I heard the guards are planning something big for the next few days.
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_05"); //Some kind of attack at dawn, they said. I'm really curious....
