...
FUNC VOID Info_Mod_Spieler_Orlan_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Hi_16_01"); //Are you suggesting you don't know Shagby?
	AI_Output(hero, self, "Info_Mod_Spieler_Orlan_Hi_15_02"); //I haven't played it yet, no. Can you explain the rules to me?
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Hi_16_03"); //Not now, no. I only play with experienced players.
};
...
FUNC VOID Info_Mod_Spieler_Orlan_RuedigerBesiegt_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_16_01"); //You know the game?
	AI_Output(hero, self, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_15_02"); //Sure. I already defeated Rüdiger.
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_16_03"); //Rüdiger, the whistle. Did his incredible stone guard scare you?
	AI_Output(hero, self, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_15_04"); //That's what happened.
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_16_05"); //Anyway, he can't compete with my creation.
	AI_Output(hero, self, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_15_06"); //You're one of the masters, too?
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_16_07"); //Oh, yeah. My rabbit creates completely new tactical possibilities for the player through his agility.
	AI_Output(self, hero, "Info_Mod_Spieler_Orlan_RuedigerBesiegt_16_08"); //If you still dare, I'll show it to you. The bet is 15 gold coins.
};
...
FUNC VOID Info_Mod_Spieler_Orlan_Spielende01_Info()
{
	if (MG_SiegState == 2)
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende01_16_00"); //What can you expect if Rüdiger was your teacher?

		B_GiveInvItems	(hero, self, ItMi_Gold, 15);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende01_16_01"); //Oh, that's bullshit! I completely missed it!
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende01_16_02"); //That's never gonna happen to me.
		...
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende01_16_04"); //I can't give it to you with a clear conscience after this stroke of luck.
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende01_16_05"); //You're gonna have to prove to me first that you've got some real talent. With a double commitment.
...
FUNC VOID Info_Mod_Spieler_Orlan_Spielende02_Info()
{
	if (MG_SiegState == 2)
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende02_16_00"); //You don't have to come this way.
	...
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende02_16_01"); //What a disgrace! It wouldn't have happened to me on better days.
		...
		{
			AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende02_16_02"); //All right, all right, you're the better of both of us.
			AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende02_16_03"); //Before I play with you again for money, I have to pull something out of the farmer's socks.
		};
...
FUNC VOID Info_Mod_Spieler_Orlan_Spielende03_Info()
{
	if (MG_SiegState == 2)
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende03_16_00"); //You don't have to come this way.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Spieler_Orlan_Spielende03_16_01"); //What a disgrace! It wouldn't have happened to me on better days.
