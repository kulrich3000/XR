...
FUNC VOID Info_Mod_Serpentes_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Serpentes_Hi_03_01"); //I'm Serpentes, the second-highest fire magician on Khorinis. What do you want from me?
};
...
{
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_00"); //Not so fast, Novice. I have a request for you.
	AI_Output(hero, self, "Info_Mod_Serpentes_Weindiebe_15_01"); //What's up?
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_02"); //As you probably know, our monastery makes a good living selling wine among other sources of income.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_03"); //I know this better than anyone else, because I take care of the finances of the monastery and keep an eye on income and expenses.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_04"); //Unfortunately, I regret to say that lately there has been a disproportionate mismatch between the outgoing wine and the gold income.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_05"); //The innkeeper Orlan has complained several times about missing deliveries of our wine.
	AI_Output(hero, self, "Info_Mod_Serpentes_Weindiebe_15_06"); //What does Gorax say?
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_07"); //Gorax?! He's an old drunkard who enjoys wine far more than he's good for.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_08"); //Although he insisted on using only the most reliable novices for the deliveries, he drank so much until noon that he could hardly tell the novices from the magicians.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_09"); //My sharp gaze, on the other hand, has told me that several novices have left the monastery through the entrance, which had not reached it before... and which I had never seen before.
	AI_Output(hero, self, "Info_Mod_Serpentes_Weindiebe_15_10"); //What does that mean and who could it be?
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_11"); //Now that our magical gate may be an entry point for enemies, but it does not prevent them from going out, I suspect the disciples of the dark God.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_12"); //I wouldn't be surprised if these demon magicians were brazen enough to send their novices in here to steal our wine.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_13"); //But enough of the conjecture: I want certainty!
	AI_Output(hero, self, "Info_Mod_Serpentes_Weindiebe_15_14"); //What am I supposed to do?
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_15"); //Only recently, one of these fake innovators left the monastery.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_16"); //If you hurry, you may be able to place it on the way between the monastery and the tavern.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe_03_17"); //Well, you know what to do.
...
{
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_00"); //And?! Speak up! What do you have to say about the wine thieves?
	AI_Output(hero, self, "Info_Mod_Serpentes_Weindiebe2_15_01"); //You were right, it was a novice of the black mages.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_02"); //Ha, I knew it. My keen mind did not deceive me.
	AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_03"); //Did you bring the culprit to justice?
	...
	if (Npc_IsDead(Mod_7761_SNOV_Novize_NW))
	{
		...
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_05"); //Excellent... I'm more than happy with you, Novice. This will teach the black mages a lesson.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_06"); //I doubt that any lackey of the Dark God will dare to enter our monastery.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_07"); //Let Inno's flames burn anyone who stands in our way.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_08"); //Here, you've earned this gold and the spell rolls!
		...
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_09"); //Go with Inno's blessing.
	}
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_11"); //What, you let him get away with it?!
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_12"); //I would have preferred it if you had purified him to death with Innos' flames.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_13"); //But I want to look it up for you this one time.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_14"); //Eventually you made sure that the servants of infamy will no longer steal from us.
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_15"); //Here, take the spell rolls and the gold as a reward.
		...
		AI_Output(self, hero, "Info_Mod_Serpentes_Weindiebe2_03_16"); //Now remove yourself again.
	};
...
FUNC VOID Info_Mod_Serpentes_Kimon_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Serpentes_Kimon_03_01"); //That's what he says? And how little do you think I care what he says?
	AI_Output(self, hero, "Info_Mod_Serpentes_Kimon_03_02"); //I gave him as much gold as his grapes were worth to me.
	AI_Output(hero, self, "Info_Mod_Serpentes_Kimon_15_03"); //But that was not enough.
	AI_Output(self, hero, "Info_Mod_Serpentes_Kimon_03_04"); //You question the word of the second-highest fire magician of Khorini?
	AI_Output(hero, self, "Info_Mod_Serpentes_Kimon_15_05"); //Yeah, that's what I'm doing.
	AI_Output(self, hero, "Info_Mod_Serpentes_Kimon_03_06"); //Get the hell out of here before I throw you out!
	AI_Output(hero, self, "Info_Mod_Serpentes_Kimon_15_07"); //Not until you pay for those damn grapes!
	AI_Output(self, hero, "Info_Mod_Serpentes_Kimon_03_08"); //All right, that's enough.
...
FUNC VOID Info_Mod_Serpentes_KimonsGold_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Serpentes_KimonsGold_03_01"); //I told you to get out of here!
