...
FUNC VOID Info_Mod_Regis_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Hi_03_01"); //I'm Regis. I know best what's going on in town.
};
...
FUNC VOID Info_Mod_Regis_Paladine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_01"); //At first they came to Khorinis only occasionally to throw a prisoner into the penal colony or to negotiate with the convicts.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_02"); //But after the barrier collapsed, the king sent a troop here to protect the city.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_03"); //Since then, they've taken control of the city. They fear that the mercenaries from the Minental will take over the city.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_04"); //The leader of the mercenaries is said to have had a problem with the king at that time and is therefore against the paladins and tries to eliminate them with his mercenaries in order to sail with the paladin ship to Myrtana and take revenge on the king.
};
...
FUNC VOID Info_Mod_Regis_MehrPaladine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_MehrPaladine_03_01"); //I told you everything I know.
	AI_Output(self, hero, "Info_Mod_Regis_MehrPaladine_03_02"); //If you want to know more, you should talk to the paladins in the Upper Quarter.
};
...
FUNC VOID Info_Mod_Regis_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Flugblaetter_03_01"); //Thanks for the paper. even though I've been sitting around his store all day anyway.
