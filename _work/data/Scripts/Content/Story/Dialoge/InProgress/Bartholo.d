...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_00"); //Wiem, czyz nie? Jakie znów bylo Twoje nazwisko?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_01"); //Um.... ....
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_02"); //Co tam jest do popchniecia?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_03"); //Dawniej wolalem, uh, Ru....
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_04"); //W kazdym razie, niezaleznie od wszystkiego. Co ty tu robisz?
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Laber_03_00"); //Wyjsc stad!
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Verrat_03_00"); //Powinien pan umrzec dawno temu, a teraz, gdy staje sie pan dla nas niebezpieczny, stracil swoje prawo do zycia.
...
FUNC VOID Info_Mod_Bartholo_KillBuddler_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_00"); //Brudny bastard, to znaczy, ze mozesz skontaktowac sie z Alissandro niezauwazony?
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_01"); //Ale wszystko zauwazam i dlatego dostajesz kare.
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_00"); //Jestem pewien, ze przywiezie mnie pan ambrozja.

	Snd_Play	("THRILLJINGLE_03.WAV");

	AI_TurnToNpc	(self, Mod_1874_HMG_Makanius_MT);

	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_01"); //Co teraz stalo sie pieklem?
...
FUNC VOID Info_Mod_Bartholo_Eroberung_Info()
{
	...
	AI_Output(self, Mod_1156_GRD_Gardist_MT, "Info_Mod_Bartholo_Eroberung_03_00"); //Co? Jak to sie stalo w piekle?
...
FUNC VOID Info_Mod_Bartholo_Anschluss_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_01"); //Aha! Zgubiony syn wraca, a moze co?
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_02"); //Dobrze, porozmawiaj z Thorusem. Nie bedzie sie cieszyl widzac cie, ale teraz ma klopoty.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_03"); //Prawdopodobnie dlatego nie musisz sie martwic o swoje zycie.
	AI_Output(hero, self, "Info_Mod_Bartholo_Anschluss_15_04"); //To brzmi obiecujaco....
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_05"); //To wiecej niz mozna sie spodziewac. Fakt, ze powierzyles sie magikom wody, nie przyniósl ci zadnych wyrazów wspólczucia.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_06"); //Nawiasem mówiac, pamietaj, aby trzymac karabin uwieziony, gdy idziesz do Thorusa. Jesli popelnisz blad i wyciagniesz go, poinformujemy Cie o tym.
};
...
FUNC VOID Info_Mod_Bartholo_Thorus_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_01"); //Jesli chce z Toba porozmawiac, nie powinno to byc problemem.
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_02"); //Ostrzegaj sie jednak: Jesli narysujesz swoja bron w jego obecnosci, bedziesz umarl wczesniej niz mozesz umrzec.
};
...
FUNC VOID Info_Mod_Bartholo_WarumNochHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_01"); //Jestem wierny Thorusowi. Wkrótce obóz znów ruszy pod góre.
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_02"); //Poza tym, nie chce sie skonczyc jak Stone tam....
};
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Ende_03_00"); //Znalazles mnie, wiec teraz jest juz za pózno. Ale nie zamierzam sie poddawac bez walki.
