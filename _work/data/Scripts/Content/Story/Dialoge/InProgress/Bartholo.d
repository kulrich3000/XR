...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_00"); //I know you, don't I? What was your name again?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_01"); //Um... Well...
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_02"); //What's there to push around?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_03"); //I used to be called, uh, Rü...
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_04"); //Anyway, whatever. What the hell are you doing here?
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Verrat_03_00"); //You should have died a long time ago and now that you are becoming dangerous to us, you have forfeited your right to life.
...
FUNC VOID Info_Mod_Bartholo_KillBuddler_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_00"); //You filthy bastard, you mean you could get in touch with Alissandro unnoticed?
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_01"); //But I notice everything, and that's why you get your punishment.
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_00"); //I'm sure you'll bring me the swampweed.

	Snd_Play	("THRILLJINGLE_03.WAV");

	AI_TurnToNpc	(self, Mod_1874_HMG_Makanius_MT);

	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_01"); //What the hell happened now?
...
FUNC VOID Info_Mod_Bartholo_Eroberung_Info()
{
	...
	AI_Output(self, Mod_1156_GRD_Gardist_MT, "Info_Mod_Bartholo_Eroberung_03_00"); //What? How the hell did this happen?
...
FUNC VOID Info_Mod_Bartholo_Anschluss_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_01"); //Aha! The lost son returns, or what?
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_02"); //Fine, talk to Thorus. He won't be happy to see you, but he's in trouble right now.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_03"); //That's probably why you don't have to worry about your life.
	AI_Output(hero, self, "Info_Mod_Bartholo_Anschluss_15_04"); //That sounds promising...
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_05"); //That's more than you can expect. The fact that you have entrusted yourself to the water magicians has not brought you any sympathy points here.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_06"); //By the way, remember to keep your gun stuck when you go to Thorus. If you make the mistake and pull them out, we'll give you short notice.
};
...
FUNC VOID Info_Mod_Bartholo_Thorus_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_01"); //If he wants to talk to you, that shouldn't be a problem.
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_02"); //But be warned: If you draw your weapon in his presence, you'll be dead sooner than you can shit your pants.
};
...
FUNC VOID Info_Mod_Bartholo_WarumNochHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_01"); //I'm loyal to Thorus. Soon the camp will be going uphill again.
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_02"); //Besides, I don't want to end up like Stone out there...
};
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Ende_03_00"); //You found me, so it's too late now. But I'm not going to give up without a fight.
