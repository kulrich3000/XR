...
FUNC VOID Info_Mod_Kardif_Daemonisch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Kardif_Daemonisch_14_01"); //Och, leniwy. Duza czesc moich klientów wisi wokól pubu Coragorn.
	...
	AI_Output(self, hero, "Info_Mod_Kardif_Daemonisch_14_04"); //Mój napar jest tysiac razy lepszy od tego, jaki ma ten chlubny Coragorn.
	AI_Output(self, hero, "Info_Mod_Kardif_Daemonisch_14_05"); //Ale nikt juz tego nie docenia.....

	B_LogEntry	(TOPIC_MOD_DAEMONISCH, "Kardif jest zdenerwowany faktem, ze duza czesc jego klienteli siedzi w pubie Coragorna i nadziewa sie miesem.");
};
