...
FUNC VOID Info_Mod_Hanna_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Hi_21_01"); //In my service area. If you are looking for a place to stay the night, you are welcome.
};
...
FUNC VOID Info_Mod_Hanna_Preis_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Preis_21_01"); //Hmm... You're the new guy from the Minental and you're probably not full of pockets.
	AI_Output(self, hero, "Info_Mod_Hanna_Preis_21_02"); //If you are peaceful and find a free bed, you can stay overnight for free.
	AI_Output(hero, self, "Info_Mod_Hanna_Preis_15_03"); //This is a pleasant surprise. I haven't had a lot of them lately.
	AI_Output(self, hero, "Info_Mod_Hanna_Preis_21_04"); //I can only be so generous because I am financially independent of the rest house.
	AI_Output(self, hero, "Info_Mod_Hanna_Preis_21_05"); //(background) But then another time maybe more...
};
...
FUNC VOID Info_Mod_Hanna_Gaeste_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Gaeste_21_01"); //Actually, anyone who comes from outside and doesn't feel like spending time in the red lantern.
	AI_Output(self, hero, "Info_Mod_Hanna_Gaeste_21_02"); //Nevertheless, it happens very rarely that I don't know my customers. It's always the same faces who are more or less drunk in the evenings.
};
...
FUNC VOID Info_Mod_Hanna_Rasthaus_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Rasthaus_21_01"); //(mockingly) I suppose you're from a backwoods region, if you don't think it's insolence to ask that kind of question.
	AI_Output(self, hero, "Info_Mod_Hanna_Rasthaus_21_02"); //I can manage very well on my own, and in the event of an emergency I know how to organise help. And for minor problems, it's always the beatings.
};
...
{
	AI_Output(self, hero, "Info_Mod_Hanna_ThorbenLehrling_21_00"); //Hello. I'd like to see Thorben.
	AI_Output(hero, self, "Info_Mod_Hanna_ThorbenLehrling_15_01"); //I represent him today. Do you want to order a piece of furniture?
	AI_Output(self, hero, "Info_Mod_Hanna_ThorbenLehrling_21_02"); //You're guessing right. A drunk guest took my drunken commode for a nighttime attacker and damaged it heavily with the sword.
	AI_Output(hero, self, "Info_Mod_Hanna_ThorbenLehrling_15_03"); //We'll take care of the repairs.
	AI_Output(self, hero, "Info_Mod_Hanna_ThorbenLehrling_21_04"); //Good. I'll be waiting for you in my house.
};
...
{
	AI_Output(self, hero, "Info_Mod_Hanna_Meldor_21_00"); //What can I do for you?
	AI_Output(hero, self, "Info_Mod_Hanna_Meldor_15_01"); //Marsh marsh marigold hawk sent me.
	AI_Output(self, hero, "Info_Mod_Hanna_Meldor_21_02"); //Oh, a new guy, huh?
	AI_Output(hero, self, "Info_Mod_Hanna_Meldor_15_03"); //What are you guys anyway?
	AI_Output(self, hero, "Info_Mod_Hanna_Meldor_21_04"); //Here, take this key and go through the basement door.

	B_GiveInvItems	(self, hero, ItKe_ThiefGuildKey_Hotel_MIS, 1);

	AI_Output(self, hero, "Info_Mod_Hanna_Meldor_21_05"); //That's where you'll find your answer.
...
FUNC VOID Info_Mod_Hanna_Keller_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Keller_21_01"); //What's happening?
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Keller_21_03"); //Thanks, we'll do it.
...
FUNC VOID Info_Mod_Hanna_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hanna_Flugblaetter_21_01"); //Oh, thank you. Thank you. Let's see....

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Hanna_Flugblaetter_21_02"); //Ah yes. Maybe I'll stop by Matteo's.
