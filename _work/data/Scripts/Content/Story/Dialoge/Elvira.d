...
{
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider_17_00"); //Wait! Wait! I have a job for you!
	AI_Output(hero, self, "Info_Mod_Elvira_Frauenkleider_15_01"); //Oh, yeah?
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider_17_02"); //I was robbed on my way to Khorata and robbed of my clothes.
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider_17_03"); //You'll get it back for me!
};
...
FUNC VOID Info_Mod_Elvira_Frauenkleider2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider2_17_01"); //You men are to blame for that!
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider2_17_02"); //First a bad conscience is persuaded me because I am not male, and then the sign of my femininity is also stolen from me!
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider2_17_03"); //What's left over?
};
...
FUNC VOID Info_Mod_Elvira_Frauenkleider3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider3_17_01"); //Does it matter? The robbers will have left no trace, after all, they only took my suitcase with them.
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider3_17_02"); //But there can't be that much of that rag here, can there?
...
FUNC VOID Info_Mod_Elvira_Frauenkleider3_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider3_B_17_01"); //(sarcastically) Thank you.
...
FUNC VOID Info_Mod_Elvira_Frauenkleider3_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider3_A_17_01"); //Well, at least you seem reasonable.
...
FUNC VOID Info_Mod_Elvira_Frauenkleider4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider4_17_01"); //Yes, they are. Didn't expect to see her again.
	AI_Output(self, hero, "Info_Mod_Elvira_Frauenkleider4_17_02"); //Take these potions as a thank you.
...
FUNC VOID Info_Mod_Elvira_Dorn_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_17_01"); //What's the matter?
...
FUNC VOID Info_Mod_Elvira_Dorn_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_C_17_01"); //You son of a bitch!
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_C_17_02"); //Then I don't really have a choice... I hope you're happy with what you're doing.
...
FUNC VOID Info_Mod_Elvira_Dorn_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_B_17_01"); //That bum who always looks at me crooked? Do you think he could get uncomfortable?
	AI_Output(hero, self, "Info_Mod_Elvira_Dorn_B_15_02"); //It's his smell already. Fanaticism is strong in him.
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_B_17_03"); //We should put a lockjaw on him.
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_B_17_04"); //You think you can pull Anselm over to our side to keep the guy quiet?
...
FUNC VOID Info_Mod_Elvira_Dorn_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_A_17_01"); //My daily schedule was actually a bit different. What's going on?
	AI_Output(hero, self, "Info_Mod_Elvira_Dorn_A_15_02"); //You will no longer be tolerated here. Either you volunteer or I help you.
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn_A_17_03"); //Sounds like you're serious. I wonder what your help looks like.
...
FUNC VOID Info_Mod_Elvira_Dorn2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn2_17_01"); //What a blackmailer! But if it satisfies him...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn2_17_02"); //I still prefer it to trouble with a slobberball like that.
...
{
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn3_17_01"); //You only offered Anselm 50 gold coins? Get out of here, thief!
};
...
FUNC VOID Info_Mod_Elvira_Dorn4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Dorn4_17_01"); //I'm glad you can be counted on. Here's a little compensation.
...
{
	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey_17_00"); //Ohh, I'm getting different. All so easy and funny it turns.
	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey_17_01"); //And before me... ohh... that handsome fellow.
	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey_17_02"); //Come here, don't hesitate, I won't bite unless you want to...
...
FUNC VOID Info_Mod_Elvira_DiebeKey2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey2_17_01"); //Like, what happened. l-- my robe.

	AI_EquipBestArmor	(self);

	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey2_17_02"); //Ohh, no, what did I do?
	AI_Output(self, hero, "Info_Mod_Elvira_DiebeKey2_17_03"); //Innos. I have sinned most gravely.... I must repent.
...
FUNC VOID Info_Mod_Elvira_DickeLuft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_DickeLuft_17_01"); //You'd need that if you wanted to land with the women.
	AI_Output(self, hero, "Info_Mod_Elvira_DickeLuft_17_02"); //With such a clumsy pickup line, that won't work!
	AI_Output(hero, self, "Info_Mod_Elvira_DickeLuft_15_03"); //So you don't have a role in saying that?
	AI_Output(self, hero, "Info_Mod_Elvira_DickeLuft_17_04"); //No. Transformations are not my specialty.
};
...
FUNC VOID Info_Mod_Elvira_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elvira_Freudenspender_17_01"); //Pleasure giver violates our code. So no.
};
