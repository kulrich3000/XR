...
{
	AI_Output(self, hero, "Info_Mod_Raven_Hi_03_00"); //Beliar's hairy butt! I've seen you before!
	AI_Output(hero, self, "Info_Mod_Raven_Hi_15_01"); //(clears throat)
	AI_Output(self, hero, "Info_Mod_Raven_Hi_03_02"); //Or why am I desperate to get your face polished?
};
...
FUNC VOID Info_Mod_Raven_WerBistDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_WerBistDu_03_01"); //I'm Raven, chief of the Demon Knights. And from now on, I'll be keeping a close eye on you, boy.
};
...
FUNC VOID Info_Mod_Raven_WarumDaemonenritter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_WarumDaemonenritter_03_01"); //(laughs) That we can shut up about little sausages like you if we want to.
	AI_Output(self, hero, "Info_Mod_Raven_WarumDaemonenritter_03_02"); //We are Beliar's forces, armed with the most powerful weapons, armour, spells and the approval of the Dark God.
	AI_Output(self, hero, "Info_Mod_Raven_WarumDaemonenritter_03_03"); //In the near future, our army will be invincible.
};
...
FUNC VOID Info_Mod_Raven_Belagerung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_01"); //Yes, thank you. Those damn Innos bastards. What's the meaning of this? I thought there was peace!
	...
	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_04"); //This scumbag. We're stuck here, and you're the only one who wants to help us?
	AI_Output(hero, self, "Info_Mod_Raven_Belagerung_15_05"); //I was planning to.
	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_06"); //(sighs) Well, then a lot of work is waiting for you!

	B_Say	(hero, self, "$WASISTZUTUN");

	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_07"); //Well, this attack has seriously weakened us. Talk to the important people here, they'll probably have enough to do for you to start a counterattack.
	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_08"); //Oh yes, I heard that in the valley basin on the way to Bengars Hof there should be a big group.
	AI_Output(self, hero, "Info_Mod_Raven_Belagerung_03_09"); //You should avoid them. We'll take care of that later.
...
FUNC VOID Info_Mod_Raven_BelagerungAufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungAufgabe_03_01"); //Not a damn thing! Help the others so we can prepare for a counterattack. Then we'll see.
...
FUNC VOID Info_Mod_Raven_BelagerungHilfe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungHilfe_03_01"); //You helped Scar get the novices new weapons. You fixed the Belarusian shrine for Fahim. You killed the demon. You have helped Eduard strengthen the weapons of our novices, and you have defeated most of the undead. All right, that's enough!
	AI_Output(hero, self, "Info_Mod_Raven_BelagerungHilfe_15_02"); //So what are the next steps?
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungHilfe_03_03"); //We must try to persuade the bandits to attack the remaining undead on the plateau. We cannot do this without support.
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungHilfe_03_04"); //Only after we kill the enemies can we take care of Inno's guard ourselves.
	AI_Output(hero, self, "Info_Mod_Raven_BelagerungHilfe_15_05"); //How am I supposed to convince the mercenaries?
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungHilfe_03_06"); //You have good contacts to the New Camp. Convince them to provide us with men!
	AI_Output(hero, self, "Info_Mod_Raven_BelagerungHilfe_15_07"); //I'm leaving soon.
	AI_Output(self, hero, "Info_Mod_Raven_BelagerungHilfe_03_08"); //Come on, hurry up. Time is not our ally! In the camp in front of the Free Mine you will surely find some supporters.
...
FUNC VOID Info_Mod_Raven_SoeldnerSold_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_SoeldnerSold_03_01"); //What's going on?
	...
	AI_Output(self, hero, "Info_Mod_Raven_SoeldnerSold_03_03"); //This is a joke, right?
	AI_Output(hero, self, "Info_Mod_Raven_SoeldnerSold_15_04"); //Not at all.
	AI_Output(self, hero, "Info_Mod_Raven_SoeldnerSold_03_05"); //(angry) All right. Here's ten. 000 gold pieces.

	B_GiveInvItems	(self, hero, ItMi_Gold, 10000);

	AI_Output(self, hero, "Info_Mod_Raven_SoeldnerSold_03_06"); //I hope the mercenaries don't want any more.
...
FUNC VOID Info_Mod_Raven_SoeldnerDabei_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_SoeldnerDabei_03_01"); //Very well, come to the plateau around midnight, there we will wait.
...
{
	AI_Output(self, hero, "Info_Mod_Raven_ArgibastDead_03_00"); //It is done, the siege is broken.
	AI_Output(hero, self, "Info_Mod_Raven_ArgibastDead_15_01"); //It wasn't easy.
	AI_Output(self, hero, "Info_Mod_Raven_ArgibastDead_03_02"); //You got that right. Now report to Xardas and let him know.
...
FUNC VOID Info_Mod_Raven_SchwarzesErz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_SchwarzesErz_03_01"); //What's this all about?
	...
	AI_Output(self, hero, "Info_Mod_Raven_SchwarzesErz_03_04"); //I know a way to turn normal ore into black ore. However, I need two chunks of ore to make black ore.
...
FUNC VOID Info_Mod_Raven_MagischesErz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_MagischesErz_03_01"); //That's good news. Come back tomorrow and pick up the black ore.
...
FUNC VOID Info_Mod_Raven_ErzFertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_ErzFertig_03_01"); //Yeah, there's four chunks of black ore here.

	B_GiveInvItems	(self, hero, ItMi_Zeitspalt_Addon, 4);

	AI_Output(self, hero, "Info_Mod_Raven_ErzFertig_03_02"); //I've been able to double the amount with a multiplication spell!
	AI_Output(hero, self, "Info_Mod_Raven_ErzFertig_15_03"); //Thanks.
	AI_Output(self, hero, "Info_Mod_Raven_ErzFertig_03_04"); //Go now and continue to perform your tasks!
...
FUNC VOID Info_Mod_Raven_ToteNovizen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_01"); //What's going on?
	AI_Output(hero, self, "Info_Mod_Raven_ToteNovizen_15_02"); //I think a demon committed the murders!
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_03"); //A demon? We would have noticed that by now! Besides, Innos' followers have nothing to do with demons!
	...
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_05"); //Even if we had, we would have noticed the presence of a demon long ago!
	AI_Output(hero, self, "Info_Mod_Raven_ToteNovizen_15_06"); //Is there any exception?
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_07"); //Yes, there are servants of evil who can use metarmorphoses. The power to transform into another being.
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_08"); //The demon should have settled in one of our novices!
	AI_Output(hero, self, "Info_Mod_Raven_ToteNovizen_15_09"); //How can I recognize the demon?
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_10"); //You'd have to lie in wait at night and kill him.
	AI_Output(hero, self, "Info_Mod_Raven_ToteNovizen_15_11"); //Then I'll do that.
	AI_Output(self, hero, "Info_Mod_Raven_ToteNovizen_03_12"); //All right, but be careful! The demon must have snapped,
...
FUNC VOID Info_Mod_Raven_Befoerderung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_Befoerderung_03_01"); //So you choose the path of struggle. That was the right decision.
	AI_Output(self, hero, "Info_Mod_Raven_Befoerderung_03_02"); //I will elevate you to the rank of Black Warrior.
	AI_Output(self, hero, "Info_Mod_Raven_Befoerderung_03_03"); //Here's your armour.
...
{
	AI_Output(self, hero, "Info_Mod_Raven_GomezLebenLassen_03_00"); //That's the truth. Let him live. I will also order the troops to leave your camp immediately.
...
FUNC VOID Info_Mod_Raven_Oric_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_Oric_03_00"); //shut up
...
FUNC VOID Info_Mod_Raven_GomezNervt_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_GomezNervt_03_00"); //If it hadn't been for me, that snapper pack at the end of the Mine Valley would have torn you apart and now you're working for me.

	AI_TurnToNpc	(self, hero);

	AI_Output(self, hero, "Info_Mod_Raven_GomezNervt_03_01"); //As compensation, I give you the sword called Innos's wrath, which Gomez used during the old camp.
	AI_Output(self, hero, "Info_Mod_Raven_GomezNervt_03_02"); //May it be in your hands a sign for the bright future of the Old Camp.
...
FUNC VOID Info_Mod_Raven_Teacher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_Teacher_03_01"); //Yeah, I can show you how to get stronger.
	AI_Output(self, hero, "Info_Mod_Raven_Teacher_03_02"); //Besides, I can teach you how to use two-handed weapons.
...
FUNC VOID Info_Mod_Raven_Lernen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Raven_Lernen_03_01"); //What do you want to learn?
