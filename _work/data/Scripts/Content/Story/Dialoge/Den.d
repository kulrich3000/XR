...
FUNC VOID Info_Mod_Den_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Hi_01_01"); //Ja jestem Den, City Watch of Khorinis.
};
...
FUNC VOID Info_Mod_Den_Stadtwache_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Stadtwache_01_01"); //Cóz, dlaczego podnioslo sie wyrzuty sumienia?
	AI_Output(hero, self, "Info_Mod_Den_Stadtwache_15_02"); //Jaki haniebny wydzwiek?
	AI_Output(self, hero, "Info_Mod_Den_Stadtwache_01_03"); //Mysle, ze nie slysze tego? Ale nie wszyscy jestesmy tak zli z milicja, tylko niewielu z nas pracuje z zlodziejska gildia i nie mam nic wspólnego z kradziezami trzy dni temu!
	AI_Output(hero, self, "Info_Mod_Den_Stadtwache_15_04"); //No cóz, nie musisz sie obawiac moich pytan.
	AI_Output(self, hero, "Info_Mod_Den_Stadtwache_01_05"); //Nie chce byc za nic oskarzany! Moje metody sa absolutnie czyste i nie bylem winny niczego podczas mojej trzyletniej sluzby!
};
...
FUNC VOID Info_Mod_Den_Raeuber_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_01"); //Zaledwie nic. Hilda nie pozwolila nam wykopac sobie w jej pysznych miesnych placków, aby znalezc jakies istotne wskazówki.
	AI_Output(hero, self, "Info_Mod_Den_Raeuber_15_02"); //Co pieprz miesny ma wspólnego z kradzieza owiec?
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_03"); //Nie mozna tego wczesniej wiedziec.
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_04"); //I bez zaglebienia sie w kaszanki miesne, przeszukiwanie domu nie bylo zakonczone, wiec nie moglem napisac raportu koncowego, co nie pomoglo nam w poszukiwaniu przestepców!
	AI_Output(hero, self, "Info_Mod_Den_Raeuber_15_05"); //Co wiesz o bandytach i tak?
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_06"); //Prosty gang ptaków, które wedruja po okolicy od kilku miesiecy i najwyrazniej niedawno zalozyly wlasny obóz.
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_07"); //Nie wiemy dokladnie, za ile dokladnie jestes odpowiedzialny. Ogólnie rzecz biorac, róznia sie od innych bandytów tym, ze nie maja kodeksu honorowego.
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_08"); //Znam kogos, kto zna kogos, kto zna kogos, kto ma krótkotrwaly kontakt z zlodziejami w tym miescie i kto dowiedzial sie, ze nawet zlodzieje gardza tymi zlodziejami.
	AI_Output(self, hero, "Info_Mod_Den_Raeuber_01_09"); //Te podbójki nie robia sobie nawzajem przyjazni, a jesli nie znajda sobie kolegów z braterstwa, staje sie dla nich na stale trudne.
};
...
FUNC VOID Info_Mod_Den_Dienstzeit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Dienstzeit_01_01"); //Nie ma nic! Nic powaznego! To zlodziejskie gildie, to bylo wyjatkowe!
	AI_Output(hero, self, "Info_Mod_Den_Dienstzeit_15_02"); //Masz kontakt z cecha zlodziei?
	AI_Output(self, hero, "Info_Mod_Den_Dienstzeit_01_03"); //Jestem z nadbrzeza, musisz zobaczyc dokad zmierzasz. Nikt nie przyzna sie do tego, ale zlodziej gildia kontroluje duza czesc terenu.
	AI_Output(self, hero, "Info_Mod_Den_Dienstzeit_01_04"); //Wszyscy maja z nia kontakt predzej czy pózniej.
};
...
{
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_00"); //Szukaj! Sluchaj!
	AI_Output(hero, self, "Info_Mod_Den_Problem_15_01"); //Rozmawiasz do mnie?
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_02"); //Tak, to prawda. Poprosil mnie pan, ze pewnego dnia.
	AI_Output(hero, self, "Info_Mod_Den_Problem_15_03"); //Jesli tak wlasnie chcesz to nazwac.
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_04"); //Powiedzialem panu wszystko, co chcial pan uslyszec. W zamian, moze móglbys mi zrobic laske - nic wielkiego, nie leku.
	AI_Output(hero, self, "Info_Mod_Den_Problem_15_05"); //Co o tym chodzi?
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_06"); //Jestem zmeczony patrolowaniem. Kazdego dnia policzam sobie mieszkanie, które powinno byc czyms dla mlodych zieleni.
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_07"); //W barakach jest otwór, Ruga odeszla. Cóz, nie jestem najgoretszym pretendentem do pracy, ale Rangar, leniwy skumbag.
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_08"); //Rangar jest pewny, ze ma brud na rekach, ale jak dziwnym jest, ze Lord Andre nie chce nic wiedziec o tym. Musi otworzyc oczy.
	AI_Output(hero, self, "Info_Mod_Den_Problem_15_09"); //Czym sie zajmujesz?
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_10"); //Chce, abyscie rzucili zle swiatlo na Rangar. Rozpowszechniac plotki o nim, przemycac nielegalne towary do jego klatki piersiowej, a nastepnie powiedziec Lord Andre o tym.
	AI_Output(self, hero, "Info_Mod_Den_Problem_01_11"); //Czy mozna to zrobic?
...
FUNC VOID Info_Mod_Den_Problem_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Problem_B_01_01"); //Nie jestes dobrym przyjacielem.
...
FUNC VOID Info_Mod_Den_Problem_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Problem_A_01_01"); //Kilka monet wyjdzie jako zaplata za ciebie.
...
FUNC VOID Info_Mod_Den_Verbotenes_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Verbotenes_01_01"); //Zrobilby to bagnisty lodyga. Pan Andre powiedzial nam, abysmy nie robili tego samego.
	AI_Output(self, hero, "Info_Mod_Den_Verbotenes_01_02"); //Jesli przylapuje kogos z milicji, to gonna jest klopotem.
	AI_Output(self, hero, "Info_Mod_Den_Verbotenes_01_03"); //Jeszcze lepszym rozwiazaniem byloby cale opakowanie bogweedów, ale nie latwo sie tam dostaniesz.
...
FUNC VOID Info_Mod_Den_RangarsTruhe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_RangarsTruhe_01_01"); //Jest blisko niego, przy scianie przy stoisku piwnym.
...
FUNC VOID Info_Mod_Den_Rangar_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Rangar_01_01"); //I co on powiedzial?
	AI_Output(hero, self, "Info_Mod_Den_Rangar_15_02"); //Sprawdzi rzeczy.
	AI_Output(self, hero, "Info_Mod_Den_Rangar_01_03"); //Bardzo dobrze, tutaj jest Twoja nagroda.
...
FUNC VOID Info_Mod_Den_Checker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Den_Checker_01_01"); //Hej, wykonuje swoja prace sumiennie! Tak wiele wiedzy mozna zdobyc bez spedzania lat na bieganiu spraw dla zlodziei!
};
