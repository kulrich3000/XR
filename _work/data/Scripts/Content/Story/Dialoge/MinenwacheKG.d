...
func void Info_Mod_MinenwacheKG_Hi_Info()
{
	...
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_07_02"); //Dla wlasnego bezpieczenstwa. W kopalni znajduja sie potwory, o których nic nie jest jeszcze znane, a jesli mnie o to poprosza, to byli oni odpowiedzialni za upadek kopalni.
	...
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_07_05"); //Bernd ocenia, ze kamienne potwory, które uniemozliwily nam wejscie do kopalni, uciekaja przed czyms.
	AI_Output (self, hero, "Info_Mod_MinenwacheKG_Hi_07_06"); //Ze swej strony wierze, ze kamienne potwory maja magiczne pochodzenie, w przeciwnym razie nie mielibysmy z nimi zadnych problemów.
};
...
{
	AI_Output (self, hero,"Info_Mod_MinenwacheKG_SecondWarn_07_00"); //Opowiem ci to po raz ostatni. Jeszcze jeden krok i wejdziesz w swiat bólu!
