...
INSTANCE ItSc_Zerfleischen (C_Item)
{
	name 				=	NAME_Spruchrolle;
	...
	description			=	NAME_SPL_Zerfleischen;
	...
	TEXT	[2]			=	NAME_Damage;			
	COUNT	[2]			=	SPL_DAMAGE_Zerfleischen;
	
	TEXT	[5]			=	NAME_Value;				
	COUNT	[5]			=	value;
};

INSTANCE ItSc_SuckEnergy (C_ITEM)
{
	name		= NAME_Spruchrolle;
...
INSTANCE ItSc_SummonGuardian (C_ITEM)
{
	name		= NAME_Spruchrolle;
	...
	visual		= "ItSc_SummonGuardian.3DS";
	material	= MAT_LEATHER;
...
INSTANCE ItSc_BeliarsRage (C_ITEM)
{
	name		= NAME_Spruchrolle;
...
INSTANCE ItSc_SummonZombie (C_ITEM)
{
	name		= NAME_Spruchrolle;
...
INSTANCE ItSc_Icelance_Fake (C_Item)
{
	name 				=	NAME_Spruchrolle;
...
INSTANCE ItSc_ModifiedZap (C_Item)
{
	name 				=	NAME_Spruchrolle;
	...
	description			=	"Zmieniona lampa blyskowa";
	...
	TEXT	[2]			=	NAME_Damage;				
	COUNT	[2]			=	SPL_DAMAGE_ModifiedZap;
