...
INSTANCE  ItBe_Bewaehrung (C_Item)  //Hakon(Kap4)
{
	...
	description		=  "probation belt";
	
	TEXT[0]			= "Protects against freezing";
	TEXT[1]			= NAME_Prot_Edge;
	COUNT[1]		= 20;
	TEXT[2] 		= NAME_Prot_Point;
	COUNT[2]		= 20;
...
INSTANCE  ItBe_GolemBand (C_Item)
{
	...
	description		=  "Solid ribbon of the golem";
	
	TEXT[0]			= "Prevents throws away";
	TEXT[1] 		= NAME_Prot_Edge;
	COUNT[1]		= 25;
	TEXT[2] 		= NAME_Prot_Point;
	COUNT[2]		= 25;
...
INSTANCE  ItBe_Dornenguertel (C_Item)
{
	...
	description		=  "thorn belt";

	TEXT[1]			= "Attackers get to feel the sharp thorns.";
	TEXT[2]			= "But even the wearer suffers some scratches.";
