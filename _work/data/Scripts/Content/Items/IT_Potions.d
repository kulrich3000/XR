...
INSTANCE ItPo_Health_01(C_Item)
{
	...
	description		= 	"Istota uzdrawiania";
...
INSTANCE ItPo_Health_02(C_Item)
{
	...
	description		= 	"Ekstrakt z ekstraktu leczniczego";
...
INSTANCE ItPo_SekobMedizin (C_Item)
{
	...
	description		= 	"Medycyna dla Sekob.";
...
INSTANCE ItPo_Health_03(C_Item)
{
	...
	description		= 	"Eliksir uzdrawiania";
...
INSTANCE ItPo_Health_05(C_Item)
{
	...
	description		= 	"Napoje szybko lecznicze";
...
INSTANCE ItPo_Health_06(C_Item)
{
	...
	description		= 	"Lekki eliksir leczniczy";
...
INSTANCE ItPo_Health_07(C_Item)
{
	...
	description		= 	"Napój lekkiego leczenia";
...
INSTANCE ItPo_Perm_DEX(C_Item)
{
	...
	description		= 	"Eliksir umiejetnosci";
...
INSTANCE ItPo_PermHealth_Gut(C_Item)
{
	...
	description		= 	"Eliksir zycia (nadal zamkniety)";
...
INSTANCE ItPo_AdanosWohltat(C_Item)
{
	...
	description		= 	"blogoslawienstwo Adanosa";
...
INSTANCE ItPo_Regeneration(C_Item)
{
	...
	description		= 	"odbudowa eliksiru";
	
	TEXT[1]			= 	"2 % HP i Mana przez 1 minute";
...
INSTANCE ItPo_Perm_Mana(C_Item)
{
	...
	description		= 	"Eliksir Ducha Swietego";
...
INSTANCE ItPo_Wissen(C_Item)
{
	...
	description		= 	"poszerzanie wiedzy";
	TEXT[5]			= 	NAME_Value;					
	COUNT[5]		= 	Value_ManaMaxElixier*2;
};
...
INSTANCE ItPo_Speed(C_Item)
{
	...
	description		= 	"Szybkosc";
	TEXT[1]			= 	"Zezwolenie na krótki sprint ";
...
INSTANCE ItPo_Speed_Andre (C_Item)
{
	...
	description		= 	"Szybkosc";
	TEXT[1]			= 	"Pozwala na sprint dlugoterminowy ";
...
INSTANCE ItPo_KamalGift(C_Item)
{
	...
	description		= 	"eliksir trucizna";
	TEXT[1]			= 	"przez Kamala dla sedziego";
...
{
	name 			=	"Przyjemny slobber przypominajacy dawce";
...
INSTANCE ItPo_OnarsTrank(C_Item)
{
	...
	description		= 	"mieszane ziola";
	TEXT[1]			= 	"Z Sagitta dla Onarta";
...
INSTANCE ItPo_Genesung (C_Item)
{
	...
	description		= 	"Napój z odzyskiem";
	
	TEXT[1]			= 	"lagodzic choroby";	
...
INSTANCE ItPo_GiftNeutralisierer (C_Item)
{
	...
	description		= 	"Zanieczyszczenia wywolane tymczasowa odpornoscia toksyczna";

	TEXT[1]			=	"Powoduje, ze 10 minut jest odporny na dzialanie jakichkolwiek toksyn.";
...
{
	name 			=	"Smocza zupa do spalania mangonu";
...
FUNC VOID UseDrachensud()
{
	...
	Print	("Wartosci broni stale rosna!");
...
INSTANCE ItPo_ZufallsDrink (C_Item)
{
	...
	TEXT[2]			= 	"Czas trwania dzialania (w minutach):";	
	COUNT[2]		= 	10;
	TEXT[5]			= 	NAME_Value;					
	COUNT[5]		= 	value;
};
...
FUNC VOID UseItPo_Weisenchronik()
{
	if (Mod_Weisenchronik_Intus == FALSE)
	{
		...
		PrintScreen	("Czujesz sie zmeczony!", -1, -1, FONT_SCREEN, 2);
...
{
	name 			=	"Picie posluszenstwa snappera";
...
INSTANCE ItPo_Purpurmond(C_Item)
{
	...
	{		
		if (Npc_IsPlayer(self))
		{
			...
			{
				PrintScreen	("Wy przesadziliscie!", -1, -1, FONT_SCREEN, 2);
