...
func void Use_StonePlate ()
{
	...
	else //(C_SCHasStPlSkill() == TRUE)
	{
		...
		else if (StoneplateItem == DexStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_RaiseAttribute_Rest	(self, ATR_DEXTERITY,	DEX_StPlLevel1);
							concatText = ConcatStrings (concatText,	IntToString(DEX_StPlLevel1));
							B_Say (self, self, "STONEPLATE_1");
						}
						else if (StoneplateLevel == 2)
						{
							B_RaiseAttribute_Rest	(self, ATR_DEXTERITY,	DEX_StPlLevel2);
							concatText = ConcatStrings (concatText,	IntToString(DEX_StPlLevel2));
							B_Say (self, self, "STONEPLATE_2");
						}
						else if (StoneplateLevel == 3)
						{
							B_RaiseAttribute_Rest	(self, ATR_DEXTERITY,	DEX_StPlLevel3);
		...
		else if (StoneplateItem == HitPointStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_RaiseAttribute_Rest	(self, ATR_HITPOINTS_MAX,	HPMax_StPlLevel1);	
							Npc_ChangeAttribute	(self, ATR_HITPOINTS,		HPMax_StPlLevel1);

							self.aivar[AIV_Damage] += HPMax_StplLevel1;
						...
						{
							B_RaiseAttribute_Rest	(self, ATR_HITPOINTS_MAX,	HPMax_StPlLevel2);	
							Npc_ChangeAttribute	(self, ATR_HITPOINTS,		HPMax_StPlLevel2);

							self.aivar[AIV_Damage] += HPMax_StPlLevel2;
						...
						{
							B_RaiseAttribute_Rest	(self, ATR_HITPOINTS_MAX,	HPMax_StPlLevel3);	
							Npc_ChangeAttribute	(self, ATR_HITPOINTS,		HPMax_StPlLevel3);

							self.aivar[AIV_Damage] += HPMax_StPlLevel3;
		...
		else if (StoneplateItem == ManaStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_RaiseAttribute_Rest	(self, ATR_MANA_MAX,	ManaMax_StPlLevel1);
						...
						{
							B_RaiseAttribute_Rest	(self, ATR_MANA_MAX,	ManaMax_StPlLevel2);
						...
						{
							B_RaiseAttribute_Rest	(self, ATR_MANA_MAX,	ManaMax_StPlLevel3);
