...
{	
	...
	TEXT[3]				=    "Swieze jablko";
	TEXT[4]				=    "kruchy i soczysty";
	TEXT[5]				= 	NAME_Value;		
	COUNT[5]			= 	Value_Apple;
...
{	
	name 				=	"Demoniczny gulasz damacyjny";
...
{	
	...
	TEXT[4]				= 	"Chlodny, pikantny, pikantny";		
	TEXT[5]				= 	NAME_Value;		COUNT[5]	= 100;
...
{	
	...
	TEXT[4]				= 	"Koragony piwa specjalnego";		
...
{	
	name 				=	"Frakcja Kamienia Filozofowskiego";
	...
	TEXT[1]				= 	"Czlowiek, ciesze sie, ze nie mam calego kamienia.....";	
