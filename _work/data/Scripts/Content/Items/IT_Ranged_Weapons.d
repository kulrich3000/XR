...
{
	name 				=	"rear transformation arrow";
...
{
	name 				=	"Arrow with gold ore-blood tip";
...
{
	name 				=	"Bolt with gold ore blood tip";
...
INSTANCE ItRw_Geisterbogen (C_Item)
{
	...
	description			= name;
	TEXT[0]				= "50% more damage against undead";
	TEXT[1]				= NAME_Range;					COUNT[1]	= range/100;
	TEXT[2]				= NAME_Damage;					COUNT[2]	= damageTotal;
	TEXT[3] 			= NAME_Dex_needed;				COUNT[3]	= cond_value[2];
	TEXT[5]				= NAME_Value;					COUNT[5]	= value;
...
{
	name 				=	"Dragonfighter crossbow (self-built)";
...
{ 
	...
	Print	("Explosive arrow chosen as ammunition!");
...
{ 
	...
	Print	("Growth arrow chosen as ammunition!");
...
{ 
	...
	Print	("Arrow with barbs selected as ammunition!");
...
{ 
	...
	Print	("Precision arrow chosen as ammunition!");
...
{ 
	...
	Print	("Reconversion arrow selected as ammunition!");
...
{ 
	...
	Print	("Animal poison dart chosen as ammunition!");
...
{ 
	...
	Print	("Bolts with barbs selected as ammunition!");
...
{ 
	...
	Print	("Explosive bolt selected as ammunition!");
...
{ 
	...
	Print	("Phytotoxic stud chosen as ammunition!");
...
{ 
	...
	Print	("Precision bolts selected as ammunition!");
...
{ 
	...
	Print	("Reconversion bolts selected as ammunition!");
...
{ 
	...
	Print	("Animal poison bolts selected as ammunition!");
