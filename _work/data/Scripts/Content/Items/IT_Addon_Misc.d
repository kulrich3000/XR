...
INSTANCE ItMi_Scavengerdung	(C_Item)
{
	...
	TEXT[0]				= 	"";
	TEXT[1]				= 	"A bag with scavenger earthing";
	TEXT[4]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
{
	name 				=	"Black lump of ore from the queen of the Erznager";
