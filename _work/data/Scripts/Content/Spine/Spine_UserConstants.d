...
const string SPINE_ACHIEVEMENT_NAMES[MAX_ACHIEVEMENTS] = {
	...
	"Arena",
	"Wycofanie",
	"Znajomosc starozytnych ludzi",
	"Wiedza o twórczosci",
	"pomocnicy",
	"zdolnosc do cierpienia",
	"lowcy szczurów",
	"bezinteresownosc",
	"trzmiele",
	"MAD",
	"Kobiety na pokladzie",
	"Przyjaciel Lizards.",
	"Wróg Lizardów",
	"junkie",
	"Obywatelehoratów",
	...
	"sciagacz buraków",
	"odszraniany",
	"Mistrz przeksztalcenia",
	"milosnicy ogrodnicy",
	"ognioodporny",
	"13 razy 6 razy",
	"deja-vu",
	"W pelni podlaczone do sieci",
	"Przebudza sie spiacy",
	"Prawdziwa przyjazn",
	"chroman",
	"nurkowie",
	"Spieler",
	...
	"cien",
	"Royal Guardsman",
	"magik przeksztalcajacy",
	"bagno",
	"pirat",
	"Assassine",
	"wychodzacy",
	"Wielki Grek Pólnocny",
	"Lekki ciezar",
	"przyrzad",
	"Ciezki"
};
...
const string SPINE_ACHIEVEMENT_DESCRIPTIONS[MAX_ACHIEVEMENTS] = {
	"Prolog",
	"Rozdzial 1 Zakonczony",
	"Rozdzial 2 wypelniony",
	"Rozdzial 3 wypelniony",
	"Rozdzial 4 wypelniony",
	"Rozdzial 5 wypelniony",
	"Rozdzial 6 Zakonczony",
	"Wszystkie znalezione paczki wanilii",
	"8 stoisk na tle przeczytanej historii ksiazki",
	"18 stoisk na tle przeczytanej historii",
	"80% wszystkich spelnionych drugorzednych zadan",
	"Zwiedzanie miasta z przewodnikiem z Hubertem.",
	"Ponad 20 szczurów zabitych w rywalizacji w Khorata.",
	"Maly czerwony kaptur ratowal Cie, poswiecajac sie.",
	"100 kruszywa robaków miesnych",
	"Tajemnica rozwiazana w swiatyni podpodlogowej",
	"Wszystkie rodzaje kobiet na pokladzie do Irdorath.",
	"Wszystkie zadania jaszczurkowe pomyslnie wykonane",
	"Wszystkie jaszczurki wygaszone",
	"Wszystkie halucynacje zakonczone",
	"Uznawany za obywatela Khoraty",
	"Wszystkie trzy kamienie duszy otrzymuja wszystkie trzy",
	"Kazde potwór zabil co najmniej raz",
	"Buraki bukszpanowe ciagniete za chwalenie buraków",
	"Usuwanie olbrzyma lodu w lodowisku",
	"Turniej Griseldas wygral",
	"Pytania &quot; Cenne dokumenty&kwot; dokonczony",
	"wynik testu pozarowego",
	"Poszukiwanie &quot; 13 razy wiecej niz 6&quot; dokonczony",
	"Pobieranie pancerza gasienicowego",
	"Wszystkie Sanktuaria Beliar aktywowane",
	"Spiaca maska odkryla",
	"Poszukiwanie &quot; Spotkanie&quot; dokonczony",
	"Chromaninowa ukladanka rozwiazana",
	"Ogromna perla przed znalezieniem przez Khorinisa",
	"Zwyciezyla runda Schagby",
	"Zestaw Honoru Zakonczony",
	"Spanie z róznymi rodzajami kobiet",
	"Akry Oszczedzone Hof",
	"Sad Akila nie ocalil",
	"100 otwartych misji",
	"Wprowadz kazdy swiat",
	"10 zadan wykonanych tego samego dnia",
	"Ukonczenie praktyki w Haradzie",
	"Ukonczenie praktyki w szpitalu",
	"Praktyka z Matteo ukonczona",
	"Ukonczenie praktyki w Constantino",
	...
	"Podlaczone do gildii glównej",
	"Gry z kazda gildia.",
	"Dolaczyc do milicji",
	"Polaczeni najemnicy",
	"Laczy klasztor Innos.",
	"podlaczone kardony",
	"Satury i pierscien przylaczony do wody",
	"Powiazane z mysliwymi",
	"Zwiazane z zlodziejami",
	"Polaczeni bandyci",
	"Zwiazane z Starym Obozem.",
	"Dolaczenie do Gwardii Królewskiej",
	"Polaczyli sie z magikami przemiannymi",
	"Podlaczenie do obozu bagiennego",
	"Polaczeni piraci",
	"Powiazany z zabójcami",
	"Wystapienie do 700 róznych krajowych punktów kontaktowych",
	"Kapiel w lodowej wodzie bez ubran",
	"Zakonczone w swietle lub wyzej",
	"Wypelnione w funduszach lub wyzszych",
	"Zamkniete w Schwer."
};
