...
FUNC VOID ParcivalVorKneipeScene()
{
	...
	{
		AI_Output(Mod_504_PAL_Parcival_REL, NULL, "Info_Mod_ParcivalVorKneipeScene_13_01"); //Moja sluzba tutaj nie jest juz potrzebna i moge jak najszybciej powrócic do Khorinis.... Wiecej z tego zgnilego srodowiska.
	};
	...
	{
		AI_Output(Mod_7673_MIL_Miliz_REL, NULL, "Info_Mod_ParcivalVorKneipeScene_06_02"); //Jestem tutaj w imieniu dowódcy Garonda.
	};
	...
	{
		AI_Output(Mod_7673_MIL_Miliz_REL, NULL, "Info_Mod_ParcivalVorKneipeScene_06_04"); //Teraz, gdy okolicznosci na to pozwola, stara osada zostanie odbudowana (....) pod Panstwa kierunkiem i we wspólpracy z wykwalifikowanymi ludzmi z tego obszaru.
	};

	if (Mod_ParcivalVorKneipeScene_Counter == 34)
	{
		AI_Output(Mod_7673_MIL_Miliz_REL, NULL, "Info_Mod_ParcivalVorKneipeScene_06_05"); //Za Króla!
	};
	...
	{
		AI_Output(hero, NULL, "Info_Mod_ParcivalVorKneipeScene_15_07"); //(jednak samemu) No cóz, wydaje sie, ze jeszcze przez jakis czas ma tu do wykonania swój obowiazek.
	};
