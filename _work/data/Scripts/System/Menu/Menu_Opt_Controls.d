...
instance MENU_ITEM_NEXTMENU(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "dalsze klawisze.....";
	text[1]		= "Ustawic dodatkowe 2 przyciski gotyckie.";  // Kommentar
...
{
	text[0]			=	"Dmuchanie lewy";
	text[1]			=   "Klawisz ENTF do usuwania oraz RETURN do jego zdefiniowania."; // Kommentar
...
INSTANCE MENU_ITEM_INP_WEAPON_LEFT(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Nacisnac pozadany przycisk.";
...
{
	text[0]		=	"ustawienie domyslne";
	text[1]		=	"Aktywuje ustawienie domyslne."; // Kommentar
...
{
	text[0]		=	"alternatywne";
	text[1]		=	"Aktywuje alternatywna konfiguracje standardowa."; // Kommentar
