...
const string MENU_GFA_LABEL   = "Free Aiming";            // "Free aiming"
const string MENU_GFA_CHOICES = "off|on";                   // "off|on"
const string MENU_GFA_DESCR   = "Requires mouse control"; // "Requires mouse controls"
...
INSTANCE MENUITEM_OPT_GFA(C_MENU_ITEM_DEF) {
    ...
    posx            = 1000;                  posy = MENU_START_Y + MENU_DY * MENU_ID_GFA;
    dimx            = 3000;                  dimy = 750;
...
INSTANCE MENUITEM_OPT_GFA_CHOICE(C_MENU_ITEM_DEF) {
    ...
    posx                  = 5000;            posy = MENU_START_Y + MENU_DY * MENU_ID_GFA + MENU_CHOICE_YPLUS;
