...
instance MENU_STATUS (C_MENU_DEF) 
{
	...
	//items[60]	= "MENU_ITEM_TALENT_9_TITLE";
	//items[61]	= "MENU_ITEM_TALENT_9_SKILL";
	items[62]	= "MENU_ITEM_TALENT_21_TITLE";
	items[63]	= "MENU_ITEM_TALENT_21_SKILL";
	items[64]	= "MENU_ITEM_TALENT_20_TITLE";
	items[65]	= "MENU_ITEM_TALENT_20_SKILL";

	items[66]	= "MENU_ITEM_GIFT_TITLE";
	items[67]	= "MENU_ITEM_GIFT_WERT";
	items[68]	= "MENU_ITEM_KRANKHEIT_TITLE";
	items[69]	= "MENU_ITEM_KRANKHEIT_WERT";
...
INSTANCE MENU_ITEM_TALENT_9_TITLE(C_MENU_ITEM_DEF) { posx = STAT_B_X1;posy = STAT_TAL_Y +  15*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_9_SKILL(C_MENU_ITEM_DEF) { posx = STAT_B_X2;posy = STAT_TAL_Y +  15*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
INSTANCE MENU_ITEM_TALENT_21_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 8*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_21_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X2;posy = STAT_TAL_Y + 8*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
INSTANCE MENU_ITEM_TALENT_19_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 17*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_19_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X2;posy = STAT_TAL_Y + 17*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
INSTANCE MENU_ITEM_GIFT_TITLE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "poison resistance";
	fontName 	= STAT_FONT_DEFAULT;
	flags 		= flags & ~IT_SELECTABLE;
};
INSTANCE MENU_ITEM_GIFT_WERT(C_MENU_ITEM_DEF)
{
	posx 		= STAT_B_X2; 				posy = STAT_TAL_Y + 14*STAT_DY;
	text[0]		= "xxx";
	fontName 	= STAT_FONT_DEFAULT;
	flags 		= flags & ~IT_SELECTABLE;
};
...
INSTANCE MENU_ITEM_KRANKHEIT_WERT(C_MENU_ITEM_DEF)
{
	posx 		= STAT_B_X2; 				posy = STAT_TAL_Y + 15*STAT_DY;
	text[0]		= "xxx";
	fontName 	= STAT_FONT_DEFAULT;
	flags 		= flags & ~IT_SELECTABLE;
};
