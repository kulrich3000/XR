...
INSTANCE MENUITEM_LEAVE_GAME_YES(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Tak";
	text[1]		= "Tak, chcê zakoñczyæ modyfikacjê."; // Kommentar
...
{
	text[0]		= "Na pewno chcesz zacz¹æ od nowa?";   		
	type		= MENU_ITEM_TEXT;
	// Position und Dimension	
	posx		=    0;		posy		= 3400;
	dimx		= 8100;		dimy		=  750;
...
INSTANCE MENUITEM_REALLY_NEWGAME_YES(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Tak";
	text[1]		= "Tak, chcia³bym rozpocz¹æ now¹ rozgrywkê."; // Kommentar
...
INSTANCE MENUITEM_REALLY_NEWGAME_NO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Nie";
	text[1]		= "Nie, jednak nie."; // Kommentar
